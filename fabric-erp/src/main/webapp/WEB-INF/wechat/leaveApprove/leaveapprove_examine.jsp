...
<body>
	<section class="taskDetail newDet">
		<div class="taskDetail_list1">
			<dl>
				<dt>
					<span><img src="${tripRecord.employee.headImgUrl }" /></span><strong>${tripRecord.employee.name }<b>${fn:substring(tripRecord.createTime, 0,19)}</b></strong>
				</dt>
			</dl>
			<ul>
				...
				<li>开始时间：${fn:substring(tripRecord.vacateendDate, 0,19)}</li>
				<li>结束时间：${fn:substring(tripRecord.vacateStartdate, 0,19)}</li>
			</ul>
