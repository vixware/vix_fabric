...
<script type="text/javascript">
	...
	function goSaveOrUpdate(id) {
		...
		success : function(data) {
			location.href = '${vix}/wechat/jobLogAction!goSaveOrUpdate.action?ids=' + ids + "&id=" + id;
		}
		});
	};
</script>
...
<body>
	<section class="selCon">
		...
		<div class="selCon_btn">
			<h2>
				<span><a href="#" class="btn">取消</a> </span><span><a href="#" class="btn" onclick="goSaveOrUpdate('${workLog.id}');">确定</a> </span>
			</h2>
		</div>
	</section>
</body>
