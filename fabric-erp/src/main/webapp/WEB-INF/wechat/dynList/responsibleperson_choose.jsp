...
<script type="text/javascript">
	...
	function goWechatTask(id) {
		...
		success : function(data) {
			location.href = '${vix}/wechat/weChatTaskPlanAction!goWechatTask.action?ids=' + ids + "&id=" + id;
		}
		});
	};
</script>
...
<body>
	<section class="selCon">
		...
		<div class="selCon_btn">
			<h2>
				<span><a href="#" class="btn">取消</a> </span><span><a href="#" class="btn" onclick="goWechatTask('${vixTask.id}');">确定</a> </span>
			</h2>
		</div>
	</section>
</body>
