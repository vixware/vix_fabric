...
<script type="text/javascript">
	function goSaveOrUpdate(id) {
		window.location.href = "${vix}/wechat/conferenceAssistantAction!goApplicationMg.action?id=" + id;
	};
	function deleteById() {
		var ids = '';
		...
		success : function(html) {
			window.location = "${vix}/wechat/conferenceAssistantAction!goMyList.action";
		}
		});
	};
</script>
		...
		<div class="subJob">
			<s:if test="applicationMgList.size > 0">
				<s:iterator value="applicationMgList" var="entity" status="s">
					<dl>
						<dt>
							<span name="chkId" value="${entity.id}"></span> <strong><a href="#" onclick="goSaveOrUpdate('${entity.id}');"> ${entity.meetingTheme}</a><b> 地点: ${entity.meetingRequest.meetingName}</b><b> 时间: ${fn:substring(entity.meetingStartTime,11,19)} 至 ${fn:substring(entity.meetingEndTime, 11,19)}</b> </strong>
						</dt>
						<dd>
