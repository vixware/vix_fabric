...
<script type="text/javascript">
	...
	function deleteById() {
		...
		success : function(html) {
			window.location = "${vix}/wechat/conferenceAssistantAction!goList.action";
		}
		});
	};
</script>
		...
		<div class="subJob">
			<s:if test="applicationMgList.size > 0">
				<s:iterator value="applicationMgList" var="entity" status="s">
					<dl>
						<dt>
							<span name="chkId" value="${entity.id}"></span> <strong><a href="#" onclick="goSaveOrUpdate('${entity.id}');"> ${entity.meetingTheme}</a><b> 时间: ${fn:substring(entity.meetingStartTime, 11,19)} 至 ${fn:substring(entity.meetingEndTime, 11,19)}</b> </strong>
						</dt>
						<dd>
