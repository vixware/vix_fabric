...
<script type="text/javascript">
	function goSaveOrUpdate(id) {
		window.location = "${vix}/wechat/weChatTaskPlanAction!goTaskDetail.action?id=" + id;
	};
	function deleteById() {
		var ids = '';
		...
		success : function(html) {
			window.location = "${vix}/wechat/weChatTaskPlanAction!goTaskList.action";
		}
		});
	};
	function searchByName() {
		loadContent('${vix}/wechat/weChatTaskPlanAction!goTaskList.action?searchname=' + $('#searchname').val());
	};
</script>
<style type="text/css">
#searchId {
