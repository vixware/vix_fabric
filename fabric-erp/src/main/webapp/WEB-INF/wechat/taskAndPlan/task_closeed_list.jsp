...
<script type="text/javascript">
	function goSaveOrUpdate(id) {
		window.location.href = "${vix}/wechat/weChatTaskPlanAction!goCloseedTask.action?id=" + id;
	};
	...
	function deleteById() {
		...
		success : function(html) {
			window.location = "${vix}/wechat/weChatTaskPlanAction!goCloseedTaskList.action";
		}
		});
	};
	function searchByName() {
		loadContent('${vix}/wechat/weChatTaskPlanAction!goCloseedTaskList.action?searchname=' + $('#searchname').val());
	};
</script>
<style type="text/css">
#searchId {
