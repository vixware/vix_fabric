...
<h2 class="email-open-header">
	Reply to > Re: Timelogs of last client <span class="label txt-color-white">inbox</span> <a href="javascript:void(0);" rel="tooltip" data-placement="left" data-original-title="Print" class="txt-color-darken pull-right"><i class="fa fa-print"></i></a>
</h2>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-md-11">
					...
					</select> <em><a href="javascript:void(0);" class="show-next" rel="tooltip" data-placement="bottom" data-original-title="Carbon Copy">CC</a></em>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="form-group">
				...
				<div class="col-md-11">
					<select multiple style="width: 100%" class="select2" data-select-search="true">
						...
						<option value="hr@smartadmin.com">hr@smartadmin.com</option>
						<option value="IT@smartadmin.com">IT@smartadmin.com</option>
					</select> <em><a href="javascript:void(0);" class="show-next" rel="tooltip" data-placement="bottom" data-original-title="Blind Carbon Copy">BCC</a></em>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="inbox-info-bar no-padding">
		<div class="row">
			<div class="form-group">
				...
				<div class="col-md-11">
					<input class="form-control" placeholder="Email Subject" type="text" value="Re: Timelogs of last client"> <em><a href="javascript:void(0);" class="show-next" rel="tooltip" data-placement="bottom" data-original-title="Attachments"><i class="fa fa-paperclip fa-lg"></i></a></em>
				</div>
			</div>
		</div>
	</div>
