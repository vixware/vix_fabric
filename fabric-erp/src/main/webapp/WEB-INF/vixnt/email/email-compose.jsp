...
<h2 class="email-open-header">
	撰写新邮件  <a href="javascript:void(0);" rel="tooltip" data-placement="left" data-original-title="Print" class="txt-color-darken pull-right"><i class="fa fa-print"></i></a>
</h2>
...
<form enctype="multipart/form-data" action="dummy.php" method="POST" class="form-horizontal" id="email-compose-form">
	...
	<div class="inbox-info-bar no-padding">
		<div class="row">
			<div class="form-group">
				<label class="control-label col-md-1"><strong>收件人</strong></label>
				<div class="col-md-11">
	...
	<div class="inbox-info-bar no-padding hidden">
		<div class="row">
			<div class="form-group">
				<label class="control-label col-md-1"><strong>抄送</strong></label>
				<div class="col-md-11">
					<select multiple style="width: 100%" class="select2" data-select-search="true">
	...
	<div class="inbox-info-bar no-padding hidden">
		<div class="row">
			<div class="form-group">
				<label class="control-label col-md-1"><strong>密送</strong></label>
				<div class="col-md-11">
					<select multiple style="width: 100%" class="select2" data-select-search="true">
	...
	<div class="inbox-info-bar no-padding">
		<div class="row">
			<div class="form-group">
				...
				<div class="col-md-11">
					<input class="form-control" placeholder="Email Subject" type="text"> <em><a href="javascript:void(0);" class="show-next" rel="tooltip" data-placement="bottom" data-original-title="Attachments"><i class="fa fa-paperclip fa-lg"></i></a></em>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="inbox-message no-padding">
		...
		<div id="emailbody">
			...
			<br>
			<small>CEO - SmartAdmin <br> 231 Ajax Rd, Detroit MI - 48212, USA<br>
			<i class="fa fa-phone"> (313) 647 4761</i></small><br>
	...
	<div class="inbox-compose-footer">
		...
		<button class="btn btn-info" type="button">草稿</button>
