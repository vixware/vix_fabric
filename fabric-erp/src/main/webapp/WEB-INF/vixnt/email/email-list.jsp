	...
	<tbody>
		<tr id="msg1" class="unread">
			<td class="inbox-table-icon">
				<div class="checkbox">
					<label> <input type="checkbox" class="checkbox style-2"> <span></span>
					</label>
				</div>
			</td>
		...
		<tr id="msg17">
			...
			<td class="inbox-data-from hidden-xs hidden-sm">
				<div>New server for datacenter needed New server for datacenter ne...</div>
			</td>
			<td class="inbox-data-message">
				<div>
...
<script>
	...
	function getMail($this) {
		...
		loadURL("${nvix}/nvixnt/system/nvixMailAction!goEmailOpened.action", $('#inbox-content > .table-wrap'));
	}
