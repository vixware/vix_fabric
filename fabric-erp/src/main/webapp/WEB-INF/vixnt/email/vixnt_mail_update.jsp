							...
							<tr>
								...
								<td>
									<div class="mail_edit_check">
										<label><input name="" type="checkbox" value="" checked="checked" />保存到"已发送"</label> <label><input name="" type="checkbox" value="" />紧急</label> <label><input name="" type="checkbox" value="" />需要回执纯文本</label> <label><input name="" type="checkbox" value="" />使用信纸</label> <label><input
											name="" type="checkbox" value="" />短信提醒我</label> <label><input name="" type="checkbox" value="" />对邮件加密</label>
									</div>
								</td>
							</tr>
							<tr>
						...
						<tr>
							...
							<td>
								<div class="mail_editbtn">
									<a href="javascript:;" onclick="$('#mailFile').click()"><img src="${vix}/common/img/mail_9.png" />添加附件</a> <a href="javascript:;" onclick="$('#mailBigFile').click()"><img src="${vix}/common/img/mail_10.png" />超大附件</a> <a href="javascript:;" onclick="$('#mailImgFile').click()"><img
										src="${vix}/common/img/mail_11.png" />图片</a> <a href="javascript:;"><img src="${vix}/common/img/mail_13.png" />截屏</a> <a href="javascript:;"><img src="${vix}/common/img/mail_16.png" />网盘</a> <a href="javascript:;"><img src="${vix}/common/img/mail_12.png" />表情</a> <a href="javascript:;"><img
										src="${vix}/common/img/mail_14.png" />音乐</a> <a href="javascript:;"><img src="${vix}/common/img/mail_15.png" />文字格式↑</a>
