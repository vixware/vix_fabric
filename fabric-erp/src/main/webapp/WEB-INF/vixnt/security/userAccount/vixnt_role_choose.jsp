...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/nvixntUserAccountAction!goChooseRoleList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
