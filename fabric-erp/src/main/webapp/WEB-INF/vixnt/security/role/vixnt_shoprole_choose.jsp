...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/nvixntRoleAction!goShopRoleSingleList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
