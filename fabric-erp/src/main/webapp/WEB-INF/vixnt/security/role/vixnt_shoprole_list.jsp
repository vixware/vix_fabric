	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-user"></i> 连锁管理 <span>> 基础数据管理 </span><span>> 角色管理 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var wxpRoleTable = initDataTable("wxpRoleTableId", "${nvix}/nvixnt/nvixntRoleAction!goShopRoleSingleList.action", wxpRoleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/nvixntRoleAction!goSaveOrUpdateRole.action?id=' + id, "wxpRoleForm", "新增角色", 750, 350, wxpRoleTable);
	};
	//删除
