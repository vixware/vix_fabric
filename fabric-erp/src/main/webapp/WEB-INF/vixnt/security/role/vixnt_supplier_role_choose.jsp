...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/nvixntRoleAction!goSupplierRoleList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
