	...
	<fieldset>
		...
		<div class="jarviswidget jarviswidget-color-white">
			...
			<div class="widget-body">
				...
				<input type="hidden" id="addAuthorityIds" name="addAuthorityIds" value="" /> 
				<input type="hidden" id="deleteAuthorityIds" name="deleteAuthorityIds" value="" />
...
<script type="text/javascript">
	...
	function initAuthorityTree() {
		...
		var treeNodeTmp = [];
		$.ajax({
		url : "${nvix}/nvixnt/nvixntRoleAction!findShopAuthorityTreeData.action",
		data : {
		bizType : bizTypeTmp,
		roleId : '${id}'
		},
