...
<script type="text/javascript">
	...
	var chooseItemTable = initDataTable("chooseItemTableId", "${nvix}/nvixnt/produce/nvixBomStructAction!getChooseItemJson.action", chooseItemTableColumns, function(page, pageSize, orderField, orderBy) {
