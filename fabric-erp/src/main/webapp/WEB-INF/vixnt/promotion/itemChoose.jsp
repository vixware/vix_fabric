		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					<div class="col-md-4">
						<input type="text" value="" placeholder="商品名称" class="form-control" id="selectName">
					</div>
					<button onclick="chooseWarehouseTable.ajax.reload();" type="button" class="btn btn-info">
						<i class="glyphicon glyphicon-search"></i> 检索
					</button>
					<button type="button" class="btn btn-defaule" onclick="$('#customerName').val('');chooseWarehouseTable.ajax.reload();">
...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseCustomerTableId", "${nvix}/nvixnt/nvixntItemGiftAction!getItemSingleList.action", chooseCustomerColumns, function(page, pageSize, orderField, orderBy) {
