...
<script type="text/javascript">
	...
	var chooseChannelTable = initDataTable("chooseChannelTableId", "${nvix}/nvixnt/channel/vixntChannelAction!goChannelDistributorList.action", chooseChannelTableColumns, function(page, pageSize, orderField, orderBy) {
