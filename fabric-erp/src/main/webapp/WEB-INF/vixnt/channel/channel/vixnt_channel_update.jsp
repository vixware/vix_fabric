	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-chain"></i> 渠道管理<span>> 新增渠道 </span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('drp_distributionsystem','${nvix}/nvixnt/channel/vixntChannelAction!goList.action');">
	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="channelDistributorForm">
				...
				<input type="hidden" id="type" name="channelDistributor.type" value="${channelDistributor.type}" /> 
				<input type="hidden" id="organizationId" name="channelDistributor.organization.id" value="${channelDistributor.organization.id}" /> 
				...
				<input type="hidden" id="salesEmployeeId" name="channelDistributor.salesEmployee.id" value="${channelDistributor.salesEmployee.id}" />
				<fieldset>
					<legend>基本信息:</legend>
					...
					<div class="form-group">
						<label class="col-md-2 control-label"> 授权金额:</label>
						<div class="col-md-3">
							<input id="amount" name="channelDistributor.amount" value="${channelDistributor.amount}" data-prompt-position="topLeft" class="form-control" type="text" />
						</div>
						<label class="col-md-2 control-label"> 授权次数:</label>
						<div class="col-md-3">
							<input id="quantity" name="channelDistributor.quantity" value="${channelDistributor.quantity}" data-prompt-position="topLeft" class="form-control" type="text" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function chooseSalesEmployee() {
		chooseListData('${nvix}/nvixnt/nvixntUserAccountAction!goEmployeeChoose.action', 'single', '选择人员', 'salesEmployee');
	};
	...
	function saveOrUpdate() {
		if ($("#channelDistributorForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/channel/vixntChannelAction!saveOrUpdate.action",
			dataType : "text",
			success : function(id) {
				loadContent('', '${nvix}/nvixnt/channel/vixntChannelAction!goList.action');
			}
			});
		} else {
			return false;
