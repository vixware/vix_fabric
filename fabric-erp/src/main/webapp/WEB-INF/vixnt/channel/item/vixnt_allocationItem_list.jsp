	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-cube"></i> <a> 渠道管理</a><span> > 渠道商品管理 </span>
			</h1>
		</div>
			...
			<div class="page-title">
				<div class="btn-group">
					<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
						<i class="fa fa-gear"></i>&nbsp;选择分配&nbsp;<span class="caret"></span>
					</button>
...
<script type="text/javascript">
	...
	"width" : "10%",
	"data" : function(data) {
		if (data.itemImageFilePath != null && data.itemImageFilePath != "" && data.itemImageFilePath != "undefined") {
