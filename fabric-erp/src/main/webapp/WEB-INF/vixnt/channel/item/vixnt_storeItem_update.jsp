	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 门店管理 <span>&gt; 门店业务管理</span> <span>&gt; 门店商品管理</span>
			</h1>
		</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div id="itemCategoryTreeMenu" class="input-group">
										<input id="itemCatalogId" name="storeItem.itemCatalog.id" type="hidden" value="${storeItem.itemCatalog.id}" /> <input id="itemCatalogName" name="storeItem.itemCatalog.name" type="text" onfocus="showItemCategory(); return false;" value="${storeItem.itemCatalog.name}" type="text" readonly="readonly" class="form-control validate[required]" />
