...
<script type="text/javascript">
	...
	var chooseSupplierTable = initDataTableNoPaging("chooseFixedPriceId", "${nvix}/nvixnt/channel/vixntChannelOrderItemPriceAction!fixedPrice.action", chooseFixedPriceColumns, function() {
