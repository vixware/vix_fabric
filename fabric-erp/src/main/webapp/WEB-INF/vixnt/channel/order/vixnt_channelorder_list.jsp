	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 渠道管理</span><span>&gt; 渠道订单管理</span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var salesOrderTable = initDataTable("salesOrderTableId", "${nvix}/nvixnt/channel/vixntChannelOrderAction!goSingleList.action", salesOrderColumns, function(page, pageSize, orderField, orderBy) {
	...
	var allSalesOrderTable = initDataTable("allSalesOrderTableId", "${nvix}/nvixnt/channel/vixntChannelOrderAction!goAllSingleList.action", allSalesOrderColumns, function(page, pageSize, orderField, orderBy) {
		var selectname = $("#selectname").val();
		selectname = Url.encode(selectname);
		return {
		"page" : page,
	...
	var toRevTable = initDataTable("toRevTableId", "${nvix}/nvixnt/channel/vixntChannelOrderAction!goToRevList.action", toRevColumns, function(page, pageSize, orderField, orderBy) {
		var selectname = $("#selectname").val();
		selectname = Url.encode(selectname);
		return {
		"page" : page,
	...
	var toInvTable = initDataTable("toInvTableId", "${nvix}/nvixnt/channel/vixntChannelOrderAction!goToInvList.action", toInvColumns, function(page, pageSize, orderField, orderBy) {
		var selectname = $("#selectname").val();
		selectname = Url.encode(selectname);
		return {
		"page" : page,
	...
	var toFinTable = initDataTable("toFinTableId", "${nvix}/nvixnt/channel/vixntChannelOrderAction!goToFinList.action", toFinColumns, function(page, pageSize, orderField, orderBy) {
		var selectname = $("#selectname").val();
		selectname = Url.encode(selectname);
		return {
		"page" : page,
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/channel/vixntChannelOrderAction!goSaveOrUpdate.action?id=' + id,
		cache : false,
	...
	function show(id) {
		$.ajax({
		url : '${nvix}/nvixnt/channel/vixntChannelOrderAction!show.action?id=' + id,
		cache : false,
		success : function(html) {
			$("#mainContent").html(html);
		}
	...
	function goSaveOrUpdatePurchaseOrder(id) {
		$.ajax({
		url : '${nvix}/nvixnt/channel/vixntChannelOrderAction!goSaveOrUpdatePurchaseOrder.action?id=' + id,
		cache : false,
		success : function(html) {
			$("#mainContent").html(html);
		}
	...
	function goSaveOrUpdateInbond(id) {
		$.ajax({
		url : '${nvix}/nvixnt/channel/vixntChannelOrderAction!converterPurchaseOrderToStockrecords.action?requireGoodsOrderId=' + id,
		cache : false,
		success : function(html) {
			$("#mainContent").html(html);
		}
	...
	function goConfirmReceipt(id) {
		$.ajax({
		url : '${nvix}/nvixnt/channel/vixntChannelOrderAction!goConfirmReceipt.action?id=' + id,
		cache : false,
		success : function(html) {
			$("#mainContent").html(html);
		}
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/channel/vixntChannelOrderAction!deleteById.action?id=' + id, '是否删除订单?', salesOrderTable);
	};
</script>