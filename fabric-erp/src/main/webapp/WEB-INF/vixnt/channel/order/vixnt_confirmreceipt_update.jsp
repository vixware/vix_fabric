	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				<button class="btn btn-primary" type="button" onclick="confirmReceipt();">
...
<script type="text/javascript">
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/channel/vixntChannelOrderAction!deleteSaleOrderItemById.action?id=' + id, '是否删除要货单明细?', saleOrderItemTable);
	};
	function goSaveOrUpdate(id) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/channel/vixntChannelOrderAction!goUpdatePriceAndAmount.action?id=' + id, "updatePriceForm", "修改销售价格与数量", 750, 305, saleOrderItemTable);
	};
	//确认收货
	function confirmReceipt() {
		$.ajax({
		url : '${nvix}/nvixnt/channel/vixntChannelOrderAction!confirmReceipt.action?requireGoodsOrderId=' + $('#requireGoodsOrderId').val(),
		cache : false,
		success : function() {
