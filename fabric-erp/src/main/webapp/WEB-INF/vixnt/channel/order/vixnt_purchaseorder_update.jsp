...
<script type="text/javascript">
	...
	var saleOrderItemTable = initDataTable("saleOrderItemTableId", "${nvix}/nvixnt/channel/vixntChannelOrderAction!goPurchaseOrderList.action", stockRecordLinesColumns, function(page, pageSize, orderField, orderBy) {
