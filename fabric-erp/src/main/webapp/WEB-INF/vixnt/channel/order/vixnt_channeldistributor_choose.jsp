...
<script type="text/javascript">
	...
	var chooseChannelDistributorTable = initDataTable("chooseChannelDistributorTableId", "${nvix}/nvixnt/channel/vixntChannelOrderAction!goChannelDistributorList.action", channelDistributorColumns, function(page, pageSize, orderField, orderBy) {
		return {
		"page" : page,
		"pageSize" : pageSize,
