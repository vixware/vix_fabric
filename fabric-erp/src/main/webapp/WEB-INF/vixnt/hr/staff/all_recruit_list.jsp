	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i>招聘管理<span>> 招聘汇总</span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var vehicleTable = initDataTable("employeeTableId", "${nvix}/nvixnt/hr/nvixRecruitStaffAction!allRecruitList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/hr/nvixRecruitStaffAction!deleteAllRecruitById.action?id=' + id, '是否删除该申请?', vehicleTable);
	};
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixRecruitStaffAction!goSaveOrUpdateAllRecruit.action?id=' + id,
		cache : false,
