		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					<div class="col-md-4">
						<input type="text" value="" placeholder="计划名称" class="form-control" id="planName">
					</div>
					<button onclick="choosePurchasePlanTable.ajax.reload();" type="button" class="btn btn-info">
						<i class="glyphicon glyphicon-search"></i> 检索
					</button>
					<button type="button" class="btn btn-default" onclick="$('#planName').val('');choosePurchasePlanTable.ajax.reload();">
			...
			<table id="choosePurchasePlanTableId" class="table table-striped table-bordered table-hover" width="100%">
				<thead>
					<tr>
						...
						<th width="35%">计划名称</th>
						<th width="35%">部门与人员</th>
						<th width="20%">课程总费用</th>
					</tr>
				</thead>
			</table>
		</div>
...
<script type="text/javascript">
	...
	var choosePurchasePlanTable = initDataTable("choosePurchasePlanTableId", "${nvix}/nvixnt/hr/nvixTrainAction!writeList.action", choosePurchasePlanColumns, function(page, pageSize, orderField, orderBy) {
