...
<script type="text/javascript">
	...
	var vehicleTable = initDataTable("regularTableId", "${nvix}/nvixnt/hr/nvixHrManageAction!goBorrowList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixHrManageAction!goSaveOrUpdateBorrow.action?id=' + id,
		cache : false,
