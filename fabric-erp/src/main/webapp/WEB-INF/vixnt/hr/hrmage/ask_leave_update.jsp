	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i>人事事务管理<span>> 请假 </span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('','${nvix}/nvixnt/hr/nvixHrManageAction!goAskLeave.action');">
	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="regularForm">
			    ...
			    <input type="hidden" id="types" name="regular.types" value="leave" />
				<fieldset>
					...
					<div class="form-group">
						<label class="col-md-2 control-label"><span class="text-danger">*</span>请假类别:</label>
						<div class="col-md-3">
							<select id="leaveType" name="regular.leaveType" class="form-control validate[required]">
							    <option value="">请选择</option>
								<option value="1" <c:if test='${regular.leaveType == "1"}'>selected="selected"</c:if>>病假</option>
								<option value="2" <c:if test='${regular.leaveType == "2"}'>selected="selected"</c:if>>事假</option>
							</select>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-md-2 control-label"><span class="text-danger">*</span>请假开始日期:</label>
						<div class="col-md-3">
						...
						<label class="col-md-2 control-label"><span class="text-danger">*</span>请假结束日期:</label>
						<div class="col-md-3">
							<div class="input-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<textarea id="leaveName" name="regular.leaveName" class="form-control" rows="4">${regular.leaveName}</textarea>
						</div>
					</div>
				</fieldset>
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if ($("#regularForm").validationEngine('validate')) {
			...
			dataType : "text",
			success : function(id) {
				loadContent('', '${nvix}/nvixnt/hr/nvixHrManageAction!goAskLeave.action');
			}
			});
		} else {
			return false;
