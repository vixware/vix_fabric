			...
			<div class="widget-body no-padding">
				<form role="search" class="navbar-form navbar-left">
					<div class="form-group">
						当事人: <input type="text" value="" class="form-control" id="litigant" style="width: 250px;">
					</div>
					<button onclick="vehicleTable.ajax.reload();" type="button" class="btn btn-info">
						<i class="glyphicon glyphicon-search"></i> 检索
					</button>
					<button onclick="$('#litigant').val('');vehicleTable.ajax.reload();" type="button" class="btn btn-default">
...
<script type="text/javascript">
	...
	var vehicleTable = initDataTable("regularTableId", "${nvix}/nvixnt/hr/nvixHrManageAction!goPassList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
		var litigant = $("#litigant").val();
		return {
		"page" : page,
		"pageSize" : pageSize,
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixHrManageAction!goSaveOrUpdatePass.action?id=' + id,
		cache : false,
