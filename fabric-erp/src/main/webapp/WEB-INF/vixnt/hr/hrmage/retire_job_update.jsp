	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i>人事事务管理<span>> 辞退 </span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('','${nvix}/nvixnt/hr/nvixHrManageAction!goRetire.action');">
	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="regularForm">
			    ...
			    <input type="hidden" id="types" name="regular.types" value="refuse" />
				<fieldset>
					...
					<div class="form-group">
						<label class="col-md-2 control-label"><span class="text-danger">*</span>当前状态:</label>
						<div class="col-md-3">
							<select id="becomeFullMemberState" name="regular.becomeFullMemberState" class="form-control validate[required]">
							    <option value="">请选择</option>
								<option value="1" <c:if test='${regular.becomeFullMemberState == "1"}'>selected="selected"</c:if>>已辞退</option>
								<option value="0" <c:if test='${regular.becomeFullMemberState == "0"}'>selected="selected"</c:if>>未辞退</option>
							</select>
						</div>
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if ($("#regularForm").validationEngine('validate')) {
			...
			dataType : "text",
			success : function(id) {
				loadContent('', '${nvix}/nvixnt/hr/nvixHrManageAction!goRetire.action');
			}
			});
		} else {
			return false;
