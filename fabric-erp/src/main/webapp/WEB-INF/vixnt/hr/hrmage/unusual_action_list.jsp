...
<script type="text/javascript">
	...
	var vehicleTable = initDataTable("regularTableId", "${nvix}/nvixnt/hr/nvixHrManageAction!goUnusualList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixHrManageAction!goSaveOrUpdateUnusual.action?id=' + id,
		cache : false,
