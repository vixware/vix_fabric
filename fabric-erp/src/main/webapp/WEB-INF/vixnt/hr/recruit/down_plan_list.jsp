...
<script type="text/javascript">
	...
	var vehicleTable = initDataTable("employeeTableId", "${nvix}/nvixnt/hr/nvixRecruitPlanAction!downPlanList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixRecruitPlanAction!goSaveOrUpdateDown.action?id=' + id,
		cache : false,
