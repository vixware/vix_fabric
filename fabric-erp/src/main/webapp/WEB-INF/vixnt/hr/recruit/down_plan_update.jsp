	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i>招聘计划<span>> 下达</span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('','${nvix}/nvixnt/hr/nvixRecruitPlanAction!goDownPlanList.action');">
			...
			<form class="form-horizontal" id="planForm">
				...
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-3">
							<input id="recruitment" name="plansummary.recruitment" value="${plansummary.recruitment}" data-prompt-position="topLeft" class="form-control validate[required]" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"><span class="text-danger">*</span> 招聘部门:</label>
						<div class="col-md-3">
							<input id="recruitmentDepartment" name="plansummary.recruitmentDepartment" value="${plansummary.recruitmentDepartment}" data-prompt-position="topLeft" class="form-control validate[required]" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label"><span class="text-danger">*</span> 发布状态:</label>
						<div class="col-md-3">
							<select id="releaseState" name="plansummary.releaseState" class="form-control validate[required]" readonly="readonly" disabled="disabled">
						...
						<div class="col-md-3">
							<select id="releaseMode" name="plansummary.releaseMode" class="form-control validate[required]" readonly="readonly" disabled="disabled">
							    <option value="">请选择</option>
				   	...
				   	<div class="form-group">
						...
						<div class="col-md-3">
							<div class="input-group">
								<input id="releaseTime" name="plansummary.releaseTime" value="${plansummary.releaseTimeStr}" data-prompt-position="topLeft" class="form-control validate[custom[date]]" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" type="text" readonly="readonly"/> 
						...
						<div class="col-md-3">
							<input id="auditPerson" name="plansummary.auditPerson" value="${plansummary.auditPerson}" data-prompt-position="topLeft" class="form-control validate[required]" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">备注:</label>
						<div class="col-md-8">
							<textarea id="remarks" name="plansummary.remarks" class="form-control" rows="4" readonly="readonly">${regular.remarks}</textarea>
						</div>
					</div>
												   ...
												   <div class="tab-pane no-padding active" id="writePlanTab">
														<div id="writePlanSearchForm" style="margin: 5px;">
															<div class="form-group" style="margin: 0 5px;">
																<div class="col-md-3">
																	<input type="text" value="" id="programName" placeholder="计划主题" class="form-control" readonly="readonly"/>
																</div>
