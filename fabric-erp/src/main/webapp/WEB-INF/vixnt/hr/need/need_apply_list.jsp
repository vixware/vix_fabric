			...
			<div class="widget-body no-padding">
				<form role="search" class="navbar-form navbar-left">
					<div class="form-group">
						申请名称: <input type="text" value="" class="form-control" id="applicationName" style="width: 250px;">
					</div>
...
<script type="text/javascript">
	...
	var vehicleTable = initDataTable("employeeTableId", "${nvix}/nvixnt/hr/nvixNeedAction!needApplyList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixNeedAction!goSaveOrUpdateNeedApply.action?id=' + id,
		cache : false,
