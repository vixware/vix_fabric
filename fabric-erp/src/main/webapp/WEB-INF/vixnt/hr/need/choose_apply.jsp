		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					<div class="col-md-4">
						<input type="text" value="" placeholder="名称" class="form-control" id="applicationName">
					</div>
					<button onclick="choosePurchasePlanTable.ajax.reload();" type="button" class="btn btn-info">
						<i class="glyphicon glyphicon-search"></i> 检索
					</button>
					<button type="button" class="btn btn-default" onclick="$('#applicationName').val('');choosePurchasePlanTable.ajax.reload();">
...
<script type="text/javascript">
	...
	var choosePurchasePlanTable = initDataTable("choosePurchasePlanTableId", "${nvix}/nvixnt/hr/nvixNeedAction!needApplyList.action", choosePurchasePlanColumns, function(page, pageSize, orderField, orderBy) {
