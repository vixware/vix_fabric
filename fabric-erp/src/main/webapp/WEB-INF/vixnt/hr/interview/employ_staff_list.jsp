	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i>甄选录用<span>> 录用管理</span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var vehicleTable = initDataTable("employeeTableId", "${nvix}/nvixnt/hr/nvixInterviewAction!employList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixInterviewAction!goSaveOrUpdateEmploy.action?id=' + id,
		cache : false,
