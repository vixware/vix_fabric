	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i>甄选录用<span>> 后备简历库</span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	"data" : function(data) {
		...
		"width" : "10%",
		"data" : function(data) {
			if (data.intoTheCategory  == '1') {
				return "<span class='label label-info'>普通人才</span>";
			}else if (data.intoTheCategory  == '2') {
				return "<span class='label label-primary'>后备人才</span>";
			}else if (data.intoTheCategory  == '3') {
				return "<span class='label label-primary'>高级人才</span>";
			}
			return "";
		}
	}, {
	...
	var vehicleTable = initDataTable("employeeTableId", "${nvix}/nvixnt/hr/nvixInterviewAction!resumeLibraryList.action", vehicleColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixInterviewAction!goSaveOrUpdateResumeLibrary.action?id=' + id,
		cache : false,
