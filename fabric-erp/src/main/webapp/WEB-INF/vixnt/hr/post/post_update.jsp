...
<form id="organizationUnitForm" class="form-horizontal" style="padding: 20px 15px;" action="${nvix}/nvixnt/hr/nvixntPostAction!saveOrUpdate.action">
...
<script type="text/javascript">
	...
	function chooseParentOrgPosition(orgId) {
		...
		$.ajax({
		url : '${nvix}/nvixnt/hr/nvixntPostAction!goChoosePosition.action',
		data : "orgId=" + orgId,
		cache : false,
