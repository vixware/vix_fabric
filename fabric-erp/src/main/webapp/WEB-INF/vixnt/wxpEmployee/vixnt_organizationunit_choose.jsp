...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/wxpEmployeeAction!goOrganizationUnitList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
