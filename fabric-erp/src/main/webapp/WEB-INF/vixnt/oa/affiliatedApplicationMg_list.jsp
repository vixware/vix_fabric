...
<script type="text/javascript">
	...
	var wxpEmployeeTable = initDataTable("wxpEmployeeTableId", "${nvix}/nvixnt/conferenceManagementAction!goAffiliatedApplicationMgList.action?id=" + $('#id').val(), wxpEmployeeColumns, function(page, pageSize, orderField, orderBy) {
