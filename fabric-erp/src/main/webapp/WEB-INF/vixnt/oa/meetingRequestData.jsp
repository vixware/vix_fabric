	...
	<div class="row hidden-mobile">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-puzzle-piece"></i> 会议室基础数据
			</h1>
		</div>
			...
			<div class="page-title">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="javascript:void(0);" onclick="loadContent('','${nvix}/nvixnt/conferenceManagementAction!goApplyApplicationMg.action');">申请会议室</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="table-responsive">
							<div id="meetingRequestSearchForm" class="input-group input-group-lg">
								<form class="navbar-form navbar-left" role="search">
									...
									<button onclick="$('#searchCode').val('');$('#searchCodeA').val('');$('#searchCodeB').val('');meetingRequestTable.ajax.reload();" type="button" class="btn btn-default">
...
<script type="text/javascript">
	...
	function saveState(id) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/conferenceManagementAction!goSaveState.action?id=' + id, "meetingRequestForm", "控制会议室是否启用", 800, 400, meetingRequestTable);
	}
	...
	"orderable" : false,
	"data" : function(data) {
		var update = "<a class='btn btn-xs btn-default' onclick=\"saveMeetingRD('" + data.id + "');\" title='修改'><span class='txt-color-blue pull-right'><i class='fa fa-pencil'></i></span></a>";
		var updates = "<a class='btn btn-xs btn-default' onclick=\"saveState('" + data.id + "');\" title='状态'><span class='txt-color-blue pull-right'><i class='fa fa-dot-circle-o'></i></span></a>";
		var del = "<a class='btn btn-xs btn-default' onclick=\"deletessById('" + data.id + "');\" title='删除'><span class='txt-color-red pull-right'><i class='fa fa-times'></i></span></a>";
