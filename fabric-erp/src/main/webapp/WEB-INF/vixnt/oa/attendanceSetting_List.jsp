	...
	<div class="row hidden-mobile">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-puzzle-piece"></i> 签到类型
			</h1>
		</div>
									...
									<div class="table-responsive">
										<div id="attendanceRuleSearchForm" class="input-group input-group-lg">
											<form class="navbar-form navbar-left" role="search">
												...
												<button onclick="$('#searchRuleType').val('');attendanceRuleTable.ajax.reload();" type="button" class="btn btn-default">
...
<script type="text/javascript">
	...
	var attendanceRuleColumns = [
		...
		{"name":"ruleType","data" : function(data) {return data.ruleType;}},
