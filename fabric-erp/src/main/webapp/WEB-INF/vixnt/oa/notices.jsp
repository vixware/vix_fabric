		...
		<div class="margin-bottom-10">
			<p class="note margin-bottom-10">
				<a href="javascript:void(0);"><i class="fa fa-calendar"></i> <fmt:formatDate value="${entity.activeStartDate}" type="both" pattern="yyyy-MM-dd" />&nbsp;&nbsp; </a> <a href="javascript:void(0);"><i class="fa fa-calendar"></i> <fmt:formatDate value="${entity.activeEndDate}" type="both" pattern="yyyy-MM-dd" />&nbsp;&nbsp; </a> <a
					href="javascript:void(0);"><i class="fa fa-child"></i>${entity.uploadPersonName}&nbsp;&nbsp;</a> <a href="javascript:void(0);"><i class="fa fa-comments"></i> ${entity.readTimes}条阅读记录&nbsp;&nbsp;</a> <a href="javascript:void(0);" style="color: #E63F00;"><i class="fa fa-caret-down"></i> <s:if test="%{#entity.bulletinType == 0}">全体公告</s:if> <s:elseif
						test="%{#entity.bulletinType == 1}">内部公告</s:elseif> </a>
			</p>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="text-center error-box">
								...
								<h2 class="font-xl">
									<strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> 找 <u>不到</u> 公告通知</strong>
								</h2>
								<br />
								<p class="lead">
									公告通知是企业内部发布公告通知的一个窗口，每个人都可以发布公告通知，公告通知可以是针对整个企业来发布，也可以针对人员内部发布；<b>发布公告通知</b>的时候需要选择发送对象，是发给所有人还是某些人。
								</p>
								<p class="font-md">
									<b>无该公告通知内容，请在上方输入框重新输入公告通知标题！</b>
								</p>
							</div>
						</div>
					</div>
