	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-file-text-o"></i> 办公 <span>> 报销管理 </span><span>> 住宿报销标准 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var transportTable = initDataTable("transportTableId", "${nvix}/nvixnt/nvixAccomodationsExpensesStandardsAction!goSingleList.action", transportColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/nvixAccomodationsExpensesStandardsAction!goSaveOrUpdate.action?id=' + id, "transportForm", title, 750, 450, transportTable);
	};
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/nvixAccomodationsExpensesStandardsAction!deleteById.action?id=' + id, '是否删除住宿报销标准?', transportTable);
	};
	pageSetUp();
</SCRIPT>