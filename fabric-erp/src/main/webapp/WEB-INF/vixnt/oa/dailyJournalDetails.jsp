				...
				<div class="row">
					<div class="col-md-12 padding-left-0">
						<h3 class="margin-top-0">
							<a href="javascript:void(0);" onclick="loadContent('log_logComment','${nvix}/nvixnt/dailyJournalAction!goList.action?source=${source }');"> ${workLog.title} </a>
						</h3>
						<p class="note margin-bottom-10">
							<a href="javascript:void(0);"><i class="fa fa-user"></i>&nbsp;${workLog.employee.name}&nbsp;</a> <a href="javascript:void(0);"><i class="fa fa-calendar"></i> ${workLog.startTimeTimeStr}--${workLog.logDateStr} </a> <a href="javascript:void(0);"><i class="fa fa-eye"></i>&nbsp;查看次数：(${workLog.readTimes})&nbsp;</a> <a href="javascript:void(0);"
								style="color: #E63F00;" onclick="loadContent('','${nvix}/nvixnt/dailyJournalAction!goWorkLogAttachment.action?id=${workLog.id }');"><i class="fa fa-file"></i>&nbsp;&nbsp;附件(${workLog.uploaderNum})</a>
						</p>
						<p class="description margin-bottom-10">&nbsp;日志内容:${workLog.logContent}</p>
...
<script type="text/javascript">
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/dailyJournalAction!deleteEvaluationReviewById.action?id=' + id, '是否删除该评论?', null, null, function() {
			loadContent('log_logComment', '${nvix}/nvixnt/dailyJournalAction!goViewLog.action?id=${workLog.id}');
		});
	};
</script>