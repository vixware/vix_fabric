			...
			<div class="page-title">
				<a data-toggle="modal" href="#testid">
					<button class="btn btn-primary" type="button" onclick="saveOrUpdate('');">
						<i class="glyphicon glyphicon-plus"></i>&nbsp;收文登记
					</button>
				</a>
			</div>
		</div>
...
<script type="text/javascript">
	...
	var receiveDocumentTable = initDataTable("receiveDocumentTableId", "${nvix}/nvixnt/document/nvixReceiveDocumentAction!goListContent.action", receiveDocumentColumns, function(page, pageSize, orderField, orderBy) {
		var title = $("#title").val();
	...
	function saveOrUpdate(id) {
		goSaveOrUpdateEntity('${nvix}/nvixnt/document/nvixReceiveDocumentAction!goSaveOrUpdate.action?id=' + id);
	}

	//删除
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/document/nvixReceiveDocumentAction!deleteById.action?id=' + id, '是否删除该收文?', receiveDocumentTable);
	}
