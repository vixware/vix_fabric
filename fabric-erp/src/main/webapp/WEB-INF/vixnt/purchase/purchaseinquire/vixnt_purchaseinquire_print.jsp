...
<div class="content" style="margin-top: 15px; overflow: hidden">
	<div id="div_print">
		<table width="100%" cellspacing="0" cellpadding="4" border="0" bgcolor="#F7F7F7">
			<tbody>
				<tr>
					<td align="center" style="font-size: 15px">采购询价单</td>
				</tr>
			</tbody>
		</table>
		<table width="100%" cellspacing="0" cellpadding="4" border="0" bgcolor="#F7F7F7" class="pickinglisttable">
			<tbody>
				<tr>
					...
					<td height="25">&nbsp;&nbsp;${purchaseInquire.code}</td>
					<th align="right" height="25">日期:</th>
					<td height="25">&nbsp;&nbsp;<fmt:formatDate value="${purchaseInquire.createTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
				</tr>
				<tr>
					<th align="right" height="25">主题:</th>
					<td height="25">&nbsp;&nbsp;${purchaseInquire.name}</td>
					<th align="right" height="25">制单人:</th>
					<td height="25">&nbsp;&nbsp;${purchaseInquire.creator}</td>
				</tr>
				<tr>
					<th align="right" height="25">备注:</th>
					<td height="25" colspan="3">&nbsp;&nbsp;${purchaseInquire.memo}</td>
				</tr>
			</tbody>
		</table>
		<table width="100%" cellspacing="0" cellpadding="0" border="1" class="pickinglisttable">
			<tbody>
				...
				<s:iterator value="purchaseInquire.purchaseInquiryDetails" var="stockRecordLines" status="s">
					<tr bgcolor="#FFFFFF">
