...
<script type="text/javascript">
	...
	var choosePurchasePlanTable = initDataTable("choosePurchasePlanTableId", "${nvix}/nvixnt/purchase/vixntPurchaseInquireAction!goSingleList.action", choosePurchasePlanColumns, function(page, pageSize, orderField, orderBy) {
