	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-success" type="button" onclick="loadContent('','${nvix}/nvixnt/purchase/vixntPurchasePlanAction!goSourceList.action?id='+$('#purchasePlanId').val());">
...
<script type="text/javascript">
	...
	var purchasePlanItemsColumns = [ {
		...
		function goBeforeOrAfter(tag){
			goSaveOrUpdateEntity('${nvix}/nvixnt/purchase/vixntPurchasePlanAction!goShowBeforeAndAfter.action?str='+tag+'&id='+$('#purchasePlanId').val());
		}
		var LODOP;
		function print(){
			$.ajax({
				url : '${nvix}/nvixnt/purchase/vixntPurchasePlanAction!printPurchasePlan.action?id='+$("#purchasePlanId").val(),
				cache : false,
