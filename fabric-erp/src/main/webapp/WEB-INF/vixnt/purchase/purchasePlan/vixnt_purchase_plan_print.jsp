	...
	<div id="div_print">
		...
		<table width="100%" cellspacing="0" cellpadding="4" border="0" bgcolor="#F7F7F7" class="pickinglisttable">
			<tbody>
				<tr>
					...
					<td height="25">&nbsp;&nbsp;${purchasePlan.code}</td>
					<th align="right" height="25">主题:</th>
					<td height="25">&nbsp;&nbsp;${purchasePlan.name}</td>
				</tr>
				<tr>
					<th align="right" height="25">日期:</th>
					<td height="25">&nbsp;&nbsp;<fmt:formatDate value="${purchasePlan.createTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
					<th align="right" height="25">制单人:</th>
					<td height="25">&nbsp;&nbsp;${purchasePlan.creator}</td>
				</tr>
				<tr>
					<th align="right" height="25">备注:</th>
					<td height="25" colspan="3">&nbsp;&nbsp;${purchasePlan.memo}</td>
				</tr>
			</tbody>
		</table>
		<table width="100%" cellspacing="0" cellpadding="0" border="1" class="pickinglisttable">
			<tbody>
				...
				<s:iterator value="purchasePlan.purchasePlanItems" var="stockRecordLines" status="s">
					<tr bgcolor="#FFFFFF">
