		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-align-right">
			<div class="page-title">
				<a data-toggle="modal" href="#">
					<button class="btn btn-warning" type="button" onclick="loadContent('purchase_purchaseorder','${nvix}/nvixnt/purchase/vixntPurchaseOrderAction!goList.action');"">
						采购订单
					</button>
					<button class="btn btn-primary" type="button" onclick="loadContent('purchase_purchaseArrival','${nvix}/nvixnt/purchase/vixntPurchaseArrivalAction!goList.action');">
						采购到货
					</button>
				</a>
			</div>
