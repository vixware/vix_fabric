	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-success" type="button" onclick="loadContent('','${nvix}/nvixnt/purchase/vixntPurchaseOrderAction!goSourceList.action?id='+$('#purchaseOrderId').val());">
			...
			<form class="form-horizontal" id="purchaseOrderForm">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<select id="businessTypeCode" name="purchaseOrder.businessTypeCode" class="form-control" disabled="disabled">
						...
						<div class="col-md-3">
							<select id="orderTypeCode" name="purchaseOrder.orderTypeCode" class="form-control" disabled="disabled">
...
<script type="text/javascript">
	...
	function goBeforeOrAfter(tag){
		goSaveOrUpdateEntity('${nvix}/nvixnt/purchase/vixntPurchaseOrderAction!goShowBeforeAndAfter.action?str='+tag+'&id='+$('#purchaseOrderId').val());
	}
	var LODOP;
	function print(){
		$.ajax({
			url : '${nvix}/nvixnt/purchase/vixntPurchaseOrderAction!printPurchaseOrder.action?id='+$("#purchaseOrderId").val(),
			cache : false,
