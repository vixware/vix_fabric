	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-fw fa-shopping-cart"></i> 采购管理 <span>&gt; 采购订单</span>
			</h1>
		</div>
							...
							<s:iterator value="baseEntityList" var="entity" status="s">
								<li>
									...
									<div class="smart-timeline-content">
										...
										<p>
											<s:if test="#s.First">
												<a href="javascript:void(0);" onclick="loadContent('','${nvix}/nvixnt/purchase/vixntPurchaseOrderAction!goShowPurchaseOrder.action?id=${entity.id}');" class="btn btn-xs btn-success"><i class="fa fa-eye"></i> 查看</a>
											</s:if>
											<s:else>
