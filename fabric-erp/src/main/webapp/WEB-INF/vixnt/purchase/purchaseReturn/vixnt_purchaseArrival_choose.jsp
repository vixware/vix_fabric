...
<script type="text/javascript">
	...
	var choosePurchasePlanTable = initDataTable("choosePurchasePlanTableId", "${nvix}/nvixnt/purchase/vixntPurchaseArrivalAction!goSingleList.action", choosePurchasePlanColumns, function(page, pageSize, orderField, orderBy) {
