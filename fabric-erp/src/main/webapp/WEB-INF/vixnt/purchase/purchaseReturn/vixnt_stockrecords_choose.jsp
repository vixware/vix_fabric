...
<script type="text/javascript">
	...
	var choosePurchasePlanTable = initDataTable("choosePurchasePlanTableId", "${nvix}/nvixnt/purchase/vixntPurchaseReturnAction!goStockRecordsSingleList.action", choosePurchasePlanColumns, function(page, pageSize, orderField, orderBy) {
