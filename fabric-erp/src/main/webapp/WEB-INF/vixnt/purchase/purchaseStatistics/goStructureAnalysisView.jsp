			...
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 采购智能分析 <span>&gt; 类型结构分析</span>
					</h1>
...
<script type="text/javascript">
/** categoryArrMoney  categoryArrName categoryTotalDouble  查询'产品类别采购分析列表'的参数 **/
...
function myNumArrToMillionYuan(objArr) {
	...
	function queryTopmoney() {
		$.ajax({     
			url: '${nvix}/nvixnt/purchase/vixntPurchaseStatisticsAction!queryStructurePurchaseTopView.action', 
			type: "POST",  
data: {queryTime:$('#queryTime').val(),controlSQL:'PurchaseStructureBarAndPieTop',supplierID:$('#querySupplier').val(),categoryId:$('#selectId').val()},
		    dataType: "json",
...
"data" : function(data) {
	...
	var materielCategoryTable = initDataTable("materielCategoryTableId", "${nvix}/nvixnt/purchase/vixntPurchaseStatisticsAction!queryStructurePurchaseTopTable.action", materielCategoryColumns, function(page, pageSize, orderField, orderBy) {
...
function exportExcel() {
	...
	var categoryArrNameV = Url.encode(JSON.stringify(categoryArrName));  
	var categoryTotalDoubleV = Url.encode(categoryTotalDouble);
	form.action = "${nvix}/nvixnt/purchase/vixntPurchaseStatisticsAction!outExcelToStructurePurchaseTopTable.action?categoryArrMoney="+categoryArrMoneyV+"&categoryArrName="+categoryArrNameV+"&categoryTotalDouble="+categoryTotalDoubleV;
	form.submit();
}
</script>