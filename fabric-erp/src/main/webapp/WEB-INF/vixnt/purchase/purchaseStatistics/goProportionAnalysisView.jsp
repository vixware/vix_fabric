			...
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 采购智能分析 <span>&gt; 资金比重分析</span>
					</h1>
...
function queryMdSupplierTop() {
		$.ajax({
			url: "${nvix}/nvixnt/purchase/vixntPurchaseDetailedListAction!querySupplierOrderMoneyPieChartTop.action",
		 	type: "POST",
		 	data: {queryTime:$('#queryTime').val(),supplierID:$('#querySupplier').val()},
		    dataType: "json",
			success:function(json){
				var numberArr  = myNumArrToMillionYuan(json.valueArr);//[191,81];
				var stringArr  = json.nameArr;//['已完成采购订单','在途采购订单'];
				var arraySeries = [];  
				var map ={}; 
...
function queryMdMaterielTop() {
	$.ajax({
		url: "${nvix}/nvixnt/purchase/vixntPurchaseDetailedListAction!queryMaterielOrderMoneyPieChartTop.action", //querySupplierOrderMoneyPieChartTop  //queryMaterielOrderMoneyTop
	 	type: "POST",
	 	data: {queryTime:$('#queryTime').val(),supplierID:$('#querySupplier').val()},
	    dataType: "json",
		success:function(json){
