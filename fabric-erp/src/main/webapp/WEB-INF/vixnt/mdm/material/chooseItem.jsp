...
<script type="text/javascript">
	...
	var chooseItemTable = initDataTable("chooseItemTableId", "${nvix}/nvixnt/mdm/nvixntMaterialAction!getChooseItemJson.action", chooseItemTableColumns, function(page, pageSize, orderField, orderBy) {
