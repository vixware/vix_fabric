		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					...
					<button type="button" class="btn btn-default" onclick="$('#searchName').val('');chooseItemTable.ajax.reload();">
...
<script type="text/javascript">
	...
	var chooseItemTable = initDataTable("chooseItemTableId", "${nvix}/nvixnt/mdm/nvixntSalePriceAction!goChannelItemList.action", chooseItemTableColumns, function(page, pageSize, orderField, orderBy) {
