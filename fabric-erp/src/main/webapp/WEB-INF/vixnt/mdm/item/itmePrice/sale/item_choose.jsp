...
<script type="text/javascript">
	...
	var chooseItemTable = initDataTable("chooseItemTableId", "${nvix}/nvixnt/mdm/nvixntSalePriceAction!getItemList.action", chooseItemTableColumns, function(page, pageSize, orderField, orderBy) {
