...
<script type="text/javascript">
	...
	var itemTable = initDataTable("itemtableid", "${nvix}/nvixnt/nvixntCommissionPlanAction!getItemCatalogJson.action", itemColumns, function(page, pageSize, orderField, orderBy) {
