			...
			<form id="saleReturnBillForm" class="form-horizontal">
				...
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-3">
							<input type="hidden" id="customerAccountId" name="saleReturnBill.customerAccount.id" value="${saleReturnBill.customerAccount.id}" class="form-control" readonly="readonly"/>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<div class="input-group">
								<input id="rbDate" name="saleReturnBill.rbDate" value="${saleReturnBill.rbDateTimeStr }" data-prompt-position="topLeft" class="form-control validate[required]" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text" /> <span class="input-group-addon"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',el:'rbDate'});"><i class="fa fa-calendar"></i></span>
							</div>
						</div>
					</div>
					<div class="form-group">
							...
							<div class="widget-body no-padding">
								<div style="margin: 5px;">
									<div class="form-group" style="margin: 0 0px;">
										<div class="col-md-3">
											<input type="text" value="" placeholder="${vv:varView('vix_mdm_item')}名称" class="form-control" id="searchItemName">
										</div>
...
var saleReturnBillItemColumns = [ {
	...
	"orderable" : false,
	"data" : function(data) {
		return data.saleOrderItem.unit == null ? "" : data.saleOrderItem.unit;
	}
	}, {
	...
	function saveOrUpdate() {
		if ($("#saleReturnBillForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/nvixntSaleReturnBillAction!saveOrUpdate.action",
			dataType : "text",
			success : function() {
				loadContent('', '${nvix}/nvixnt/nvixntSaleReturnBillAction!goList.action');
			}
			});
		} else {
			return false;
