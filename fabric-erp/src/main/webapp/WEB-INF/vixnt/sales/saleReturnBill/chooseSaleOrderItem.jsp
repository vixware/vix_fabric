			...
			<table id="chooseCustomer" class="table table-striped table-bordered table-hover" width="100%">
				<thead>
					<tr>
						...
						<th width="8%">条形码</th>
						<th width="8%">SKU</th>
						<th width="35%">${vv:varView('vix_mdm_item')}名称</th>
...
<script type="text/javascript">
	...
	var chooseCustomerColumns = [
		...
		{"name":"code","data" : function(data) {return data.price == null ? "￥ 0" : ("￥" + data.price);}}
	];
	
	var selectType = chooseType == "multi" ? "2" : "1";
	var isGenerateIndex = chooseType == "multi" ? "1" : "0";
	var chooseCustomerTable = initDataTable("chooseCustomer","${nvix}/nvixnt/nvixntSaleReturnBillAction!goSingleListForSaleOrder.action",chooseCustomerColumns,function(page,pageSize,orderField,orderBy){
