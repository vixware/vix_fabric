...
<script type="text/javascript">
	...
	var customerAccountTable = initDataTable("customerAccountTableId", "${nvix}/nvixnt/nvixntSalesStatisticsClickAction!clickSeeTheTodayCustomerQuery.action", customerAccountColumns, function(page, pageSize, orderField, orderBy) {
