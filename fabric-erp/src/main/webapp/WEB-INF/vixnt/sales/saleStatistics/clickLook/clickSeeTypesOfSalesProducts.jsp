...
<script type="text/javascript">
	...
	var customerAccountTable = initDataTable("customerAccountTableId", "${nvix}/nvixnt/nvixntSalesStatisticsClickAction!clickSeeTypesOfSalesProductsQuery.action", customerAccountColumns, function(page, pageSize, orderField, orderBy) {
