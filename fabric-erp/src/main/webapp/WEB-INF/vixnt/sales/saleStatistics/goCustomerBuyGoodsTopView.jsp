			...
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 销售智能分析 <span>&gt; 客户购买排行</span>
					</h1>
...
function myNumArrToMillionYuan(objArr) {
	...
	function queryTopMoney() {
		$.ajax({    
			url: '${nvix}/nvixnt/nvixntSalesAnalysisAction!queryCustomerBuyTopView.action', 
			type: "POST",
			data: {queryTime:$('#queryTime').val(),controlSQL:'CustomerBuyTopmoney',regionalID:$('#queryRegional').val(),employeeID:$('#queryEmployee').val(),topNum:'10'},
		    dataType: "json",
...
function queryTopNum() {
		$.ajax({    
			url: '${nvix}/nvixnt/nvixntSalesAnalysisAction!queryCustomerBuyTopView.action', 
			type: "POST",
			data: {queryTime:$('#queryTime').val(),controlSQL:'CustomerBuyTopnum',regionalID:$('#queryRegional').val(),employeeID:$('#queryEmployee').val(),topNum:'10'},
		    dataType: "json",
			success:function(json){
