...
"data" : function(data) {
	...
	var salesDetailsListTable = initDataTable("salesDetailsListTableId", "${nvix}/nvixnt/nvixntSalesStatisticsAction!searchSaleDetailedTable.action", salesDetailsListColumns, function(page, pageSize, orderField, orderBy) {
...
function exportExcel() {
	...
	var customerAccountID = $("#queryInvWarehouse").val();
	customerAccountID = Url.encode(customerAccountID);  
	form.action = "${nvix}/nvixnt/nvixntSalesStatisticsAction!outExcelToSaleDetailedTable.action?queryTime="+queryTime+"&regionalID="+regionalID+"&customerAccountID="+customerAccountID;
	form.submit();
}
</script>