	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-shopping-cart"></i> 销售管理<span>> 业务类型 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var bizTypeTable = initDataTable("bizTypeTableId", "${nvix}/nvixnt/nvixntSaleBizTypeAction!goSingleList.action", bizTypeColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/nvixntSaleBizTypeAction!goSaveOrUpdate.action?id=' + id, "bizTypeForm", title, 850, 350, bizTypeTable);
	};

	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/nvixntSaleBizTypeAction!deleteById.action?id=' + id, '是否删除会员等级?', bizTypeTable);
	};
</script>