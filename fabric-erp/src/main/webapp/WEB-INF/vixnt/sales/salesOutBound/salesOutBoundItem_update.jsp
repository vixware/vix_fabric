...
<script type="text/javascript">
	...
	var chooseEcProductTable = initDataTable("chooseEcProduct", "${nvix}/nvixnt/nvixntSalesOutBoundAction!goInventoryCurrentStockListContent.action", chooseEcProductColumns, function(page, pageSize, orderField, orderBy) {
	...
	function mergeStockInDetail() {
		if ($('#stockRecordLinesForm').validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/nvixntSalesOutBoundAction!saveOrUpdateWimStockRecordLines.action",
