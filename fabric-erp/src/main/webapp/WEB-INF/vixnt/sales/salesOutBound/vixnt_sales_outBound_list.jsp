	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-fw fa-table"></i> 销售管理 <span>&gt; 销售订单</span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-align-right">
			<div class="page-title">
				<button class="btn btn-default" type="button" onclick="loadContent('sales_order','${nvix}/nvixnt/nvixntSalesOutBoundAction!goList.action');">
							...
							<s:iterator value="baseEntityList" var="entity" status="s">
								<li>
									...
									<div class="smart-timeline-content">
										...
										<p>
											<s:if test="#s.First">
												<a href="javascript:void(0);" onclick="loadContent('','${nvix}/nvixnt/nvixntSalesOutBoundAction!goShowOutBound.action?id=${entity.id}');" class="btn btn-xs btn-success"><i class="fa fa-eye"></i> 查看</a>
											</s:if>
											<s:else>
