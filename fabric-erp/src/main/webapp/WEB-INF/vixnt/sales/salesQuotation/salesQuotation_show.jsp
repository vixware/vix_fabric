	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-success" type="button" onclick="loadContent('','${nvix}/nvixnt/nvixSalesQuotationAction!goSourceList.action?id='+$('#id').val());">
...
<script type="text/javascript">
	...
	function goBeforeOrAfter(tag){
		goSaveOrUpdateEntity('${nvix}/nvixnt/nvixSalesQuotationAction!goShowBeforeAndAfter.action?str='+tag+'&id='+$('#id').val());
	}
	var LODOP;
	function print(){
		$.ajax({
			url : '${nvix}/nvixnt/nvixSalesQuotationAction!printSalesQuotation.action?id='+$("#id").val(),
			cache : false,
			success : function(html) {
				LODOP = getLodop();
