	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-tasks"></i> <a data-toggle="modal" href="#" style="cursor: pointer;">供应商管理 </a><span>> 订单管理 </span>
			</h1>
		</div>
			...
			<div class="page-title">
				<div class="btn-group">
					<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
						<i class="glyphicon glyphicon-plus"></i>&nbsp;待配货订单 <span class="caret"></span>
					</button>
					<ul class="dropdown-menu js-status-update pull-right">
						<li><a href="javascript:void(0);" onclick="loadContent('','${nvix}/nvixnt/vixntSupplierSalesOrderAction!goAllToSellDataList.action');">待发货订单列表</a></li>
...
<script type="text/javascript">
	...
	"data" : function(data) {
		...
		var exportExcel = "<a href='javascript:void(0);' class='btn btn-xs btn-default' onclick=\"exportExcel('" + data.id + "');\" title='导出'><span class='txt-color-blue pull-right'><i class='glyphicon glyphicon-export'></i></span></a>";
		...
		return update + "&nbsp;&nbsp;" + exportExcel + "&nbsp;&nbsp;" + prepareitemover;
	}
	} ];
	var allSalesOrderTable = initDataTable("allSalesOrderTableId", "${nvix}/nvixnt/vixntSupplierSalesOrderAction!goTadayAllToDoDataList.action", allSalesOrderColumns, function(page, pageSize, orderField, orderBy) {
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntSalesOrderAction!deleteById.action?id=' + id, '是否删除要货单?', allSalesOrderTable);
	};
	function prepareItemOver(id) {
		updateEntityByConfirm('${nvix}/nvixnt/vixntSupplierSalesOrderAction!prepareItemOver.action?purchaseOrderId=' + id, "确认配货完成!", allSalesOrderTable);
	};
