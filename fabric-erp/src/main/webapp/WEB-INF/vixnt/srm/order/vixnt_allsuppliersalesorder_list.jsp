			...
			<div class="page-title">
				<div class="btn-group">
					<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
						<i class="glyphicon glyphicon-plus"></i>&nbsp;所有订单 <span class="caret"></span>
					</button>
					...
					<ul class="dropdown-menu js-status-update pull-right">
						...
						<li><a href="javascript:void(0);" onclick="loadContent('','${nvix}/nvixnt/vixntSupplierSalesOrderAction!goList.action');">今日订单列表</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div>
			<div class="widget-body no-padding">
				<form role="search" class="navbar-form navbar-left">
					...
					<button onclick="$('#selectitemname').val('');allSalesOrderTable.ajax.reload();" type="button" class="btn btn-default">
...
<script type="text/javascript">
	...
	var allSalesOrderTable = initDataTable("allSalesOrderTableId", "${nvix}/nvixnt/vixntSupplierSalesOrderAction!goSingleList.action", allSalesOrderColumns, function(page, pageSize, orderField, orderBy) {
