	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 供应商管理 <span onclick="">&gt; 供应商订单管理</span>
			</h1>
		</div>
	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="">
				<fieldset>
					<input type="hidden" id="salesOrderId" name="requireGoodsOrder.id" value="${requireGoodsOrder.id}" />
...
<script type="text/javascript">
	...
	var saleOrderItemTable = initDataTable("saleOrderItemTableId", "${nvix}/nvixnt/vixntSupplierSalesOrderAction!goSaleOrderItemList.action", saleOrderItemColumns, function(page, pageSize, orderField, orderBy) {
