	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-truck"></i> 供应商管理<span>> 供应商寻源 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	"data" : function(data) {
		...
		var filing = "<a href='javascript:void(0);' class='btn btn-xs btn-default' onclick=\"filing('" + data.id + "');\" title='建档'><span class='txt-color-blue pull-right'><i class='fa fa-folder-open-o'></i></span></a>";
		var del = "<a href='javascript:void(0);' class='btn btn-xs btn-default' onclick=\"deleteById('" + data.id + "');\" title='删除'><span class='txt-color-red pull-right'><i class='fa fa-times'></i></span></a>";
		return update + "&nbsp;&nbsp;"+ filing +"&nbsp;&nbsp;"+ del;
	}
	} ];
	
	var supplierTable = initDataTable("supplierTableId", "${nvix}/nvixnt/vixntSupplierAction!goSingleSourceList.action", supplierColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntSupplierAction!goSaveOrUpdateSourceSupplier.action?id=' + id,
		cache : false,
