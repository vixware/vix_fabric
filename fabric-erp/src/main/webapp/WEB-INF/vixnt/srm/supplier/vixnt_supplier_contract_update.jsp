	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-truck"></i> 供应商管理 <span onclick="">&gt; 框架合作协议</span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('srm_contract','${nvix}/nvixnt/vixntSupplierContractAction!goList.action');">
			...
			<form class="form-horizontal" id="contractForm">
				...
				<legend>基本信息</legend>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input id="projectCode" name="contract.projectCode" value="${contract.projectCode}" data-prompt-position="topLeft" class="form-control" type="text" />
						</div>
						<label class="col-md-2 control-label"> 项目名称:</label>
						<div class="col-md-3">
							<input id="projectName" name="contract.projectName" value="${contract.projectName}" data-prompt-position="topLeft" class="form-control" type="text" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	var contractChildItemTable = initDataTable("contractChildItemTableId", "${nvix}/nvixnt/vixntSupplierContractAction!getcontractChildItemList.action", contractChildItemColumns, function(page, pageSize, orderField, orderBy) {
	...
	var contractSubjectTable = initDataTable("contractSubjectTableId", "${nvix}/nvixnt/vixntSupplierContractAction!getContractSubjectList.action", contractSubjectColumns, function(page, pageSize, orderField, orderBy) {
		var id = $("#contractId").val();
		return {
		"page" : page,
		"pageSize" : pageSize,
	...
	var contractWarningTable = initDataTable("contractWarningTableId", "${nvix}/nvixnt/vixntSupplierContractAction!getContractWarningtList.action", contractWarningColumns, function(page, pageSize, orderField, orderBy) {
		var id = $("#contractId").val();
		return {
		"page" : page,
		"pageSize" : pageSize,
	...
	var applicationFormTable = initDataTable("applicationFormTableId", "${nvix}/nvixnt/vixntSupplierContractAction!getApplicationFormList.action", applicationFormColumns, function(page, pageSize, orderField, orderBy) {
	...
	var priceConditionsTable = initDataTable("priceConditionsTableId", "${nvix}/nvixnt/vixntSupplierContractAction!getPriceConditionsList.action", priceConditionsColumns, function(page, pageSize, orderField, orderBy) {
	...
	if(!$("#contractId").val()){
		if ($("#contractForm").validationEngine('validate')) {
			$("#contractForm").ajaxSubmit({
				type : "post",
				url : "${nvix}/nvixnt/vixntSupplierContractAction!saveOrUpdate.action",
				dataType : "text",
				success : function(result) {
					var r = result.split(":");
					if(r[0]=="1"){
						$("#contractId").val(r[1]);
						openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateContractChildItem.action?contractId="+r[1]+"&id="+id,"contractChildItemForm","合同子项",750,350,contractChildItemTable);
					}else{
						showMessage(r[1]);
						return;
					}
		...
		openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateContractChildItem.action?contractId="+$("#contractId").val()+"&id="+id,"contractChildItemForm","合同子项",750,350,contractChildItemTable);
	}
}
function deleteContractChildItemById(id){
	deleteEntityByConfirm('${nvix}/nvixnt/vixntSupplierContractAction!deleteContractChildItemById.action?id=' + id, '是否删除合同子项?', contractChildItemTable);
}
//保存标的
function addcontractSubject(id){
	if(!$("#contractId").val()){
		if ($("#contractForm").validationEngine('validate')) {
			$("#contractForm").ajaxSubmit({
				...
				success : function(result) {
					...
					if(r[0]=="1"){
						$("#contractId").val(r[1]);
						openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateContractSubject.action?contractId="+r[1]+"&id="+id,"contractSubjectForm","合同标的",750,550,contractSubjectTable);
					}else{
						showMessage(r[1]);
						return;
					}
		...
		openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateContractSubject.action?contractId="+$("#contractId").val()+"&id="+id,"contractSubjectForm","合同标的",750,550,contractSubjectTable);
	}
}
function deleteContractSubjectById(id){
	deleteEntityByConfirm('${nvix}/nvixnt/vixntSupplierContractAction!deleteContractSubjectById.action?id=' + id, '是否删除合同标的?', contractSubjectTable);
}
//保存预警
function addcontractWarning(id){
	if(!$("#contractId").val()){
		if ($("#contractForm").validationEngine('validate')) {
			$("#contractForm").ajaxSubmit({
				...
				success : function(result) {
					...
					if(r[0]=="1"){
						$("#contractId").val(r[1]);
						openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateContractWarning.action?contractId="+r[1]+"&id="+id,"contractWarningForm","合同预警",750,350,contractWarningTable);
					}else{
						showMessage(r[1]);
						return;
					}
		...
		openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateContractWarning.action?contractId="+$("#contractId").val()+"&id="+id,"contractWarningForm","合同预警",750,350,contractWarningTable);
	}
}
function deleteContractWarningById(id){
	deleteEntityByConfirm('${nvix}/nvixnt/vixntSupplierContractAction!deleteContractWarningById.action?id=' + id, '是否删除合同预警?', contractWarningTable);
}
//保存审批
function addapplicationForm(id){
	if(!$("#contractId").val()){
		if ($("#contractForm").validationEngine('validate')) {
			$("#contractForm").ajaxSubmit({
				...
				success : function(result) {
					...
					if(r[0]=="1"){
						$("#contractId").val(r[1]);
						openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateApplicationForm.action?contractId="+r[1]+"&id="+id,"applicationFormForm","合同审批",750,350,applicationFormTable);
					}else{
						showMessage(r[1]);
						return;
					}
		...
		openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdateApplicationForm.action?contractId="+$("#contractId").val()+"&id="+id,"applicationFormForm","合同审批",750,350,applicationFormTable);
	}
}
function deleteApplicationFormById(id){
	deleteEntityByConfirm('${nvix}/nvixnt/vixntSupplierContractAction!deleteApplicationFormById.action?id=' + id, '是否删除合同审批?', applicationFormTable);
}
//保存价格条件
function addpriceConditions(id){
	if(!$("#contractId").val()){
		if ($("#contractForm").validationEngine('validate')) {
			$("#contractForm").ajaxSubmit({
				...
				success : function(result) {
					...
					if(r[0]=="1"){
						$("#contractId").val(r[1]);
						openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdatePriceConditions.action?contractId="+r[1]+"&id="+id,"priceConditionsForm","价格条件",750,350,priceConditionsTable);
					}else{
						showMessage(r[1]);
						return;
					}
		...
		openSaveOrUpdateWindow("${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdatePriceConditions.action?contractId="+$("#contractId").val()+"&id="+id,"priceConditionsForm","价格条件",750,350,priceConditionsTable);
	}
}
function deletePriceConditionsById(id){
	deleteEntityByConfirm('${nvix}/nvixnt/vixntSupplierContractAction!deletePriceConditionsById.action?id=' + id, '是否删除价格条件?', priceConditionsTable);
}
...
function saveOrUpdate() {
	if ($("#contractForm").validationEngine('validate')) {
		...
		dataType : "text",
		success : function(id) {
			loadContent('srm_supplier', '${nvix}/nvixnt/vixntSupplierContractAction!goList.action');
		}
		});
	} else {
		return false;
