	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-user"></i> 供应商管理 <span>> 员工管理 </span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('drp_storeperson','${nvix}/nvixnt/vixntSupplierAction!goList.action');">
	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="employeeForm">
				...
				<input type="hidden" id="supplierId" name="emp.supplier.id" value="${emp.supplier.id}" />
				<input type="hidden" id="roleId" name="addUserAccountRoleIds" value="${addUserAccountRoleIds }" />
				<fieldset>
					<legend>基本信息:</legend>
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if ($("#employeeForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/vixntSupplierAction!saveOrUpdateEmployee.action",
			dataType : "text",
			success : function(result) {
				showMessage(result, 'success');
				loadContent('drp_storeperson', '${nvix}/nvixnt/vixntSupplierAction!goList.action');
			}
			});
		} else {
			return false;
