	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-truck"></i> 供应商管理 <span onclick="">&gt; 供应商查看</span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				<button class="btn btn-success" type="button" onclick="saveOrUpdate('Y');">
					<i class="fa fa-save"></i> 评估通过
				</button>
				<button class="btn btn-success" type="button" onclick="saveOrUpdate('N');">
					<i class="fa fa-save"></i> 评估不通过
				</button>
				<button class="btn btn-default" type="button" onclick="loadContent('srm_supplier','${nvix}/nvixnt/vixntSupplierAction!goAuditingList.action');">
			...
			<form class="form-horizontal" id="supplierForm">
				...
				<legend>基本信息</legend>
					<div class="form-group">
						...
						<div class="col-md-3">
							<input id="code" name="supplier.code" value="${supplier.code}" data-prompt-position="topLeft" class="form-control validate[required]" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"><span class="text-danger">*</span> 名称:</label>
						<div class="col-md-3">
							<input id="name" name="supplier.name" value="${supplier.name}" data-prompt-position="topLeft" class="form-control validate[required]" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label"> 拼音:</label>
						<div class="col-md-3">
							<input id="pinYin" name="supplier.pinYin" value="${supplier.pinYin}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"> 法人:</label>
						<div class="col-md-3">
							<input id="artificialPerson" name="supplier.artificialPerson" value="${supplier.artificialPerson}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label"><span class="text-danger">*</span> 类型:</label>
						<div class="col-md-3">
							<select id="type" name="supplier.type" class="form-control validate[required]" disabled="disabled">
						...
						<div class="col-md-3">
							<select id="industry" name="supplier.industry" class="form-control" disabled="disabled">
					...
					<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group">
										<input class="form-control validate[custom[number]]" id="registeredCapital" name="supplier.registeredCapital" value="${supplier.registeredCapital }" type="text" readonly="readonly"> <span class="input-group-addon">(¥)</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-3">
							<select id="currencyTypeId" name="supplier.currencyType.id" class="form-control validate[required]" disabled="disabled">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input id="contacts" name="supplier.contacts" value="${supplier.contacts}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"> 手机: </label>
						<div class="col-md-3">
							<div class="input-group">
								<input id="cellphone" name="supplier.cellphone" value="${supplier.cellphone}" data-prompt-position="topLeft" class="form-control validate[custom[phone]]" type="text" readonly="readonly"/> <span class="input-group-addon"><i class="fa fa-phone"></i></span>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-3">
							<div class="input-group">
								<input id="telephone" name="supplier.telephone" value="${supplier.telephone}" data-prompt-position="topLeft" class="form-control validate[custom[phone]]" type="text" readonly="readonly"/> <span class="input-group-addon"><i class="fa fa-phone"></i></span>
							</div>
						</div>
						<label class="col-md-2 control-label"> 传真:</label>
						<div class="col-md-3">
							<div class="input-group">
								<input id="portraiture" name="supplier.portraiture" value="${supplier.portraiture}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/> <span class="input-group-addon"><i class="fa fa-fax"></i> </span>
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<textarea id="memo" name="supplier.memo" class="form-control validate[chinese]" rows="4" readonly="readonly">${supplier.memo }</textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input id="purchaserCode" name="supplier.purchaserCode" value="${supplier.purchaserCode}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"> 采购员:</label>
						<div class="col-md-3">
							<input id="purchaser" name="supplier.purchaser" value="${supplier.purchaser}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label"> 成本中心编码:</label>
						<div class="col-md-3">
							<input id="costCenterCode" name="supplier.costCenterCode" value="${supplier.costCenterCode}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"> 成本中心:</label>
						<div class="col-md-3">
							<input id="costCenter" name="supplier.costCenter" value="${supplier.costCenter}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label"> 委外仓库:</label>
						<div class="col-md-3">
							<input id="outSourcingWarehouse" name="supplier.outSourcingWarehouse" value="${supplier.outSourcingWarehouse}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"> 委外货位:</label>
						<div class="col-md-3">
							<input id="outSourcingPositon" name="supplier.outSourcingPositon" value="${supplier.outSourcingPositon}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input id="exceedPercent" name="supplier.exceedPercent" value="${supplier.exceedPercent}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"> 超交数量:</label>
						<div class="col-md-3">
							<input id="exceedAmount" name="supplier.exceedAmount" value="${supplier.exceedAmount}" data-prompt-position="topLeft" class="form-control" type="text" readonly="readonly"/>
						</div>
					</div>
					<div class="form-group">
		...
		if ($("#supplierForm").validationEngine('validate')) {
			if(type == "Y"){
				$("#supplierForm").ajaxSubmit({
					type : "post",
					url : "${nvix}/nvixnt/vixntSupplierAction!saveOrUpdateAuditing.action",
					dataType : "text",
					success : function(id) {
						loadContent('srm_supplier', '${nvix}/nvixnt/vixntSupplierAction!goList.action');
					}
					});
			}else if(type == "N"){
				loadContent('srm_supplier', '${nvix}/nvixnt/vixntSupplierAction!goAuditingList.action');
			}
		} else {
			return false;
		}
...
function saveOrUpdate(tag){
	var id = $("#supplierId").val();
	if(tag == "Y"){
		layer.confirm('是否通过评估?',{
			btn:['确定','取消']
		},function(action){
			$.ajax({
				url : '${nvix}/nvixnt/vixntSupplierAction!saveOrUpdateAuditing.action?id=' + id,
				cache : false,
				success : function(result) {
					var r = result.split(":");
					showMessage(r[1]);
					if(r[0] == "0"){
						loadContent('srm_supplier','${nvix}/nvixnt/vixntSupplierAction!goBuildingList.action');
					}else{
						loadContent('srm_supplier','${nvix}/nvixnt/vixntSupplierAction!goList.action');
					}
				}
