...
<script type="text/javascript">
	...
	var chooseSupplierTable = initDataTable("chooseSupplierTableId", "${nvix}/nvixnt/vixntSupplierAction!goSingleSourceList.action", chooseSupplierColumns, function(page, pageSize, orderField, orderBy) {
