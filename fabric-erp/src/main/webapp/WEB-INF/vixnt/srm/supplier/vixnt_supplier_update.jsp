	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-truck"></i> 供应商管理 <span onclick="">&gt; 供应商清单</span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('srm_supplier','${nvix}/nvixnt/vixntSupplierAction!goList.action');">
	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="supplierForm">
				...
				<input type="hidden" id="purchaserEmployeeId" name="supplier.purchaserEmployee.id" value="${supplier.purchaserEmployee.id}" />
				<fieldset>
					<legend>基本信息</legend>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group">
										<input id="purchaserEmployeeName" name="supplier.purchaserEmployee.name" value="${supplier.purchaserEmployee.name }" class="form-control validate[required]" type="text" readonly="readonly" />
										<div class="input-group-btn">
										...
										<div class="jarviswidget" id="salesOrderDetailTabs" style="margin: 0; padding: 12px 12px 12px 12px;" data-widget-togglebutton="false" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false">
											<header>
												<ul class="nav nav-tabs pull-left in">
													...
													<li><a data-toggle="tab" href="#supplierBankTab" onclick="supplierBankInfoTable.ajax.reload();"><span class="hidden-mobile hidden-tablet">银行信息</span> </a></li>
													<li><a data-toggle="tab" href="#supplierAptitudeTab" onclick="supplierAptitudeInfoTable.ajax.reload();"><span class="hidden-mobile hidden-tablet">资质信息</span> </a></li>
													<li><a data-toggle="tab" href="#supplierAccountingTab" onclick="supplierAccountingInfoTable.ajax.reload();"><span class="hidden-mobile hidden-tablet">财务信息</span> </a></li>
													<li><a data-toggle="tab" href="#supplierCreditTab" onclick="supplierCreditTable.ajax.reload();"><span class="hidden-mobile hidden-tablet">信用</span> </a></li>
													<li><a data-toggle="tab" href="#supplierIndicatorsTab" onclick="supplierIndicatorsTable.ajax.reload();"><span class="hidden-mobile hidden-tablet">指标</span> </a></li>
												</ul>
											</header>
...
<script type="text/javascript">
	...
	function chooseEmployee() {
		chooseListData('${nvix}/nvixnt/vixntSupplierAction!goEmployeeChoose.action', 'single', '选择人员', 'purchaserEmployee');
	};
</script>