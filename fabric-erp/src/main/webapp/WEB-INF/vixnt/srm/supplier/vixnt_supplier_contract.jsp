	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-truck"></i> <a style="cursor: pointer;">供应商管理</a><span>> 框架合作协议 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	"title" : "编码",
	"data" : function(data) {
		return data.masterContractCoding;
	}
	}, {
	"title" : "协议类型",
	"data" : function(data) {
	...
	var supplierTable = initDataTable("supplierTableId", "${nvix}/nvixnt/vixntSupplierContractAction!goSingleList.action", supplierColumns, function(page, pageSize, orderField, orderBy) {
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntSupplierContractAction!deleteById.action?id=' + id, '是否删除协议?', supplierTable);
	};
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntSupplierContractAction!goSaveOrUpdate.action?id=' + id,
		cache : false,
