	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-book"></i> 合同管理 <span>> 履行状态 </span>
			</h1>
		</div>
			...
			<div class="widget-body no-padding">
				<div>
					<form role="search" class="navbar-form navbar-left">
						...
						<button onclick="modeTypeTable.ajax.reload();" type="button" class="btn btn-info">
							<i class="glyphicon glyphicon-search"></i> 检索
						</button>
						<button onclick="$('#searchName').val('');modeTypeTable.ajax.reload();" type="button" class="btn btn-default">
...
<script type="text/javascript">
	...
	var modeTypeTable = initDataTable("areaLevelTableId", "${nvix}/nvixnt/contract/vixntModeTypeAction!goSingleList.action", modeTypeColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/contract/vixntModeTypeAction!goSaveOrUpdate.action?id=' + id, "modeTypeForm", title, 750, 375, modeTypeTable);
	};
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/contract/vixntModeTypeAction!deleteById.action?id=' + id, '是否删除会员标签?', modeTypeTable);
	};
	pageSetUp();
</SCRIPT>