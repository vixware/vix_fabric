	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-book"></i> 合同管理 <span>> 所属合同组 </span>
			</h1>
		</div>
			...
			<div class="widget-body no-padding">
				<div>
					<form role="search" class="navbar-form navbar-left">
						...
						<button onclick="contractGroupTypeTable.ajax.reload();" type="button" class="btn btn-info">
							<i class="glyphicon glyphicon-search"></i> 检索
						</button>
						<button onclick="$('#searchName').val('');contractGroupTypeTable.ajax.reload();" type="button" class="btn btn-default">
...
<script type="text/javascript">
	...
	var contractGroupTypeTable = initDataTable("areaLevelTableId", "${nvix}/nvixnt/contract/vixntContractGroupTypeAction!goSingleList.action", contractGroupTypeColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/contract/vixntContractGroupTypeAction!goSaveOrUpdate.action?id=' + id, "contractGroupTypeForm", title, 750, 375, contractGroupTypeTable);
	};
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/contract/vixntContractGroupTypeAction!deleteById.action?id=' + id, '是否删除会员标签?', contractGroupTypeTable);
	};
	pageSetUp();
</SCRIPT>