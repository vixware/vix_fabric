...
<form id="priceConditionsForm" class="form-horizontal" style="padding: 35px 15px;" action="${nvix}/nvixnt/vixntSupplierContractAction!saveOrUpdatePriceConditions.action">
