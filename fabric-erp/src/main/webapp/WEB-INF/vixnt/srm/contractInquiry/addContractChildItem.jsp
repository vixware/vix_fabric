...
<form id="contractChildItemForm" class="form-horizontal" style="padding: 35px 15px;" action="${nvix}/nvixnt/vixntSupplierContractAction!saveOrUpdateContractChildItem.action">
