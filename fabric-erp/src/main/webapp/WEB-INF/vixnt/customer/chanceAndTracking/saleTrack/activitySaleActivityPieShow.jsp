	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i> 客户关系管理 <span>> 销售跟踪 </span><span>> 销售活动类型分布 </span>
			</h1>
			<input type="hidden" value="" id="queryTime">
			<input type="hidden" value="activitySaleActivity" id="queryType">  
					...
					<div class="row">
						<div class="col-lg-12">
							<ul class="list-group no-margin chooseSort">    
								...
								<li class="list-group-item"> <span class="btn bg-color-red txt-color-white badge pull-right"><i class="fa fa-times"></i></span><span id='alreadySltSupplier'>销售活动类型分布</span></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="well padding-10">
					...
					<script type="text/javascript">
						var testdataBsSuggest = $("#sltSupplier").bsSuggest({
						     ...
						     data:{
						    	 "value" : [
									{"id" : "activitySaleActivity","word" : "销售活动类型分布"},
						   		]
						     }
						 });
						 /**选择供应商时**/
							...
							<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="jarviswidget" data-widget-editbutton="false" role="widget">
									<header>
										...
										<h2>销售活动类型分布(按销售活动的'开始日期'和'结束日期'统计)</h2>
									</header>
...
var qCondition = new queryCondition("", "activitySaleActivity","","");//不能删除，后面用
/** 点击时间按钮 **/
...
<script type="text/javascript">
	...
	function queryCustomerAccountDistribute() {
		$.ajax({
			url : "${nvix}/nvixnt/nvixSaleChanceStatisticsAction!saleChanceDatePieQuery.action",
			type: "POST",
			dataType: "json",
...
<script type="text/javascript">
	...
	var akindCustomerTable = initDataTable("akindCustomerTableId", "${nvix}/nvixnt/nvixSaleChanceStatisticsAction!saleChanceDatePieQueryTable.action", akindCustomerColumns, function(page, pageSize, orderField, orderBy) {
