	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i> 客户关系管理 <span>> 销售跟踪 </span><span>> 各阶段机会预期金额漏斗</span>
			</h1>
			<input type="hidden" value="ThisQuarterOT" id="queryTime">
			<input type="hidden" value="ExpectedMoneyFunnel!all" id="queryType">  
		</div>
	</div>
				...
				<div class="well padding-10">
					...
					<script type="text/javascript">
						var testdataBsSuggest = $("#sltSupplier").bsSuggest({
						     ...
						     /* {
						    	 "value" : [
									{"id" : "ExpectedMoneyFunnel!all","word" : "统计全部状态的销售机会"},
									{"id" : "ExpectedMoneyFunnel!all","word" : "仅统计'状态=跟踪中'的销售机会"},
									{"id" : "ExpectedMoneyFunnel!all","word" : "仅统计'状态=放弃'的销售机会"},
						   		]
						     } */
						 });
						 /**选择供应商时**/
...
var qCondition = new queryCondition("ThisQuarterOT", "ExpectedMoneyFunnel!all");//不能删除，后面用
/** 点击时间按钮 **/
					...
					myChart.setOption(option);
		 		    ...
		 		    if(valueArrVarLength>=1){
		 		    	...
		 		    	for(var i=0 ;i<valueArrVarLength;i++){
		 		    		...
		 		    		$("#funnelAdditionalView").append("<div style='height:"+everyHeightMy+"px;'><strong style='color:#474747;'>"+nameArrVar[i]+"</strong><strong style='margin:0px 0px 0px 10px;color:#4FB4FF;'>"+(Number(valueArrVar[i]).toFixed(2))+"元</strong></div>");
			 		   	}
		 		    }
				}
			}
