...
<script type="text/javascript">
	...
	var chooseCrmProjectTable = initDataTable("chooseCrmProject","${nvix}/nvixnt/nvixBackSectionPlanAction!goCrmProjectSingleListJson.action",chooseCrmProjectColumns,function(page,pageSize,orderField,orderBy){
