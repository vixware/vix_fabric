...
<script type="text/javascript">
	...
	var chooseItemTableColumns = [ {
		"data" : function(data) {
			return "<input id='entityId' name='entityId' value='" + data.id + "' type='radio' onchange=\"itemChange('${entityName}','" + data.code + "','" + data.name + "','" + data.price + "');\"/>";
		}
	}, {
		"data" : function(data) {
			return data.name;
	...
	var chooseItemTable = initDataTable("chooseItemTableId", "${nvix}/nvixnt/nvixSalesInvoiceAction!getItemList.action", chooseItemTableColumns, function(page, pageSize, orderField, orderBy) {
	...
	function itemChange(entityName,code,name,price){
		$("#"+entityName+"Code").val(code);
		$("#"+entityName+"Name").val(name);
		$("#"+entityName+"Price").val(price);
	}
</script>