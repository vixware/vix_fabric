		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					...
					<div class="col-md-4">
						<input type="text" value="" placeholder="姓名" class="form-control" id="searchName">
					</div>
					<button onclick="chooseEmployeeTable.ajax.reload();" type="button" class="btn btn-info">
						<i class="glyphicon glyphicon-search"></i> 检索
					</button>
					<button type="button" class="btn btn-default" onclick="$('#employeeName').val('');chooseEmployeeTable.ajax.reload();">
...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/nvixCrmProjectAction!goEmployeeList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
		var employeeName = $("#searchName").val();
