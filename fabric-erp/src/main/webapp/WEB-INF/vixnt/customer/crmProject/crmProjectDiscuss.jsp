...
<body class="">
	<aside id="left-panel">
		...
		<nav>
			<ul>
				<c:forEach items="${crmProjectList}" var="crmProject" varStatus="s">
					<li <c:if test="${s.index == 0}">class='active'</c:if>><a id="${crmProject.id}" href="javascript:void(0);" title="${crmProject.subject}" onclick="loadCrmProjectDiscuss('${crmProject.id}')"><i class="fa fa-lg fa-fw fa-puzzle-piece"></i> <span class="menu-item-parent">${crmProject.subject}</span></a></li>
				</c:forEach>
			</ul>
		</nav> 
											...
											<div class="col-sm-12 col-md-12 col-lg-8">
												...
												<div class="row">
													<div class="col-sm-12 col-md-12 col-lg-12  task-detail-title">
														...
														<span class="text-danger"></span><span class=" text-muted">${crmProject.subject }</span>
													</div>
												</div>
...
<script type="text/javascript">
	...
	function loadCrmProjectDiscuss(id){
		$("#evaluationReviewId").load("${nvix}/nvixnt/nvixCrmProjectAction!loadCrmProjectDiscuss.action?id=" + id);
	}
</script>
</body>
</html>