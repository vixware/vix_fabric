	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-user"></i> 客户关系管理 <span>> 客户分析 </span><span>> 所属行业分布 </span>
			</h1>
			<input type="hidden" value="" id="queryTime">
			<input type="hidden" value="customerIndustry" id="queryType">  
					...
					<div class="row">
						<div class="col-lg-12">
							<ul class="list-group no-margin chooseSort">    
								...
								<li class="list-group-item"> <span class="btn bg-color-red txt-color-white badge pull-right"><i class="fa fa-times"></i></span><span id='alreadySltSupplier'>所属行业分布</span></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="well padding-10">
					...
					<script type="text/javascript">
						var testdataBsSuggest = $("#sltSupplier").bsSuggest({
						     ...
						     data:{
						    	 "value" : [
									{"id" : "customerIndustry","word" : "所属行业分布"},
						   		]
						     }
						 });
						 /**选择供应商时**/
...
var qCondition = new queryCondition("", "customerIndustry","contractTotalAmountTop","20");//不能删除，后面用
/** 点击时间按钮 **/
