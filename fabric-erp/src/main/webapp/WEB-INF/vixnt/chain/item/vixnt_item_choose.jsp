...
<script type="text/javascript">
	...
	"data" : function(data) {
		if (chooseType == 'single') {
			return "<input id='entityId' name='entityId' value='" + data.id + "' type='radio' onchange=\"radioChange('${entityName}','" + data.id + "','" + data.name + "','" + data.price + "');\"/>";
		}
		return "";
	}
	}, {
	...
	var itemTable = initDataTable("itemtableid", "${nvix}/nvixnt/vixntAllocationItemAction!goChooseListContent.action?parentId=" + $("#parentId").val(), itemColumns, function(page, pageSize, orderField, orderBy) {
	...
	function radioChange(entityName,id,name,price){
