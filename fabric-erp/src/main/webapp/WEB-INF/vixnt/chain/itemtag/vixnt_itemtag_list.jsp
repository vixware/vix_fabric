	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-cube"></i> 商品管理 <span>> 商品标签管理 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var itemTagTable = initDataTable("itemTagTableId", "${nvix}/nvixnt/nvixItemTagAction!goSingleList.action", itemTagColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/nvixItemTagAction!goSaveOrUpdate.action?id=' + id, "itemTagForm", title, 750, 350, itemTagTable);
	};
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/nvixItemTagAction!deleteById.action?id=' + id, '是否删除商品标签?', itemTagTable);
	};
	pageSetUp();
</SCRIPT>