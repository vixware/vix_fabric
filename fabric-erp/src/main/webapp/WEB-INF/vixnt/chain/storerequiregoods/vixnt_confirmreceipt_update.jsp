...
<script type="text/javascript">
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntStoreRequireGoodsAction!deleteSaleOrderItemById.action?id=' + id, '是否删除要货单明细?', saleOrderItemTable);
	};
	function goSaveOrUpdate(id) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/vixntStoreRequireGoodsAction!goUpdatePriceAndAmount.action?id=' + id, "updatePriceForm", "修改销售价格与数量", 750, 305, saleOrderItemTable);
	};
	//确认收货
	function confirmReceipt() {
		$.ajax({
		url : '${nvix}/nvixnt/vixntStoreRequireGoodsAction!confirmReceipt.action?requireGoodsOrderId=' + $('#requireGoodsOrderId').val(),
		cache : false,
		success : function() {
