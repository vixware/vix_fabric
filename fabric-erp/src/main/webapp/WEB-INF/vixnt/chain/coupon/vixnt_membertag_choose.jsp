...
<script type="text/javascript">
	...
	var itemTable = initDataTable("itemtableid", "${nvix}/nvixnt/vixntMembershipSubdivisionAction!goMemberTagList.action", itemColumns, function(page, pageSize, orderField, orderBy) {
