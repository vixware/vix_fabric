...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseCustomerTableId", "${nvix}/nvixnt/vixntDispenseCouponAction!goSingleList.action", chooseCustomerColumns, function(page, pageSize, orderField, orderBy) {
