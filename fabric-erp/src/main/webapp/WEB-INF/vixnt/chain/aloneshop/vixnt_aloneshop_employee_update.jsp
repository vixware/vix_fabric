	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('drp_storeperson','${nvix}/nvixnt/vixntAloneShopAction!goList.action');">
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if ($("#employeeForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/vixntAloneShopAction!saveOrUpdateStorePerson.action",
			dataType : "text",
			success : function(id) {
				loadContent('drp_storeperson', '${nvix}/nvixnt/vixntAloneShopAction!goList.action');
			}
			});
		} else {
			return false;
