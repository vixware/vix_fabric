	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-weixin"></i> 连锁管理 <span>> 公众号管理 </span>
			</h1>
		</div>
	</div>
		...
		<div>
			...
			<div class="widget-body">
				<form id="wxpWeixinSiteForm" class="form-horizontal">
					...
					<input type="hidden" id="channelDistributorId" name="wxpWeixinSite.channelDistributor.id" value="${wxpWeixinSite.channelDistributor.id}" />
					<fieldset>
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if ($("#wxpWeixinSiteForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/vixntAloneShopAction!saveOrUpdateWeixinSite.action",
			dataType : "text",
			success : function() {
