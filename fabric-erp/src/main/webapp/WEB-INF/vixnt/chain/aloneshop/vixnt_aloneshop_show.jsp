	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-fw fa-user"></i> 连锁管理 <span>&gt; 独立店铺管理</span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	function goSaveOrUpdateAccount(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/vixntAccountManagementAction!goSaveOrUpdate.action?parentId=' + id, "userAccountForm", title, 900, 475, employeeTable);
	};
