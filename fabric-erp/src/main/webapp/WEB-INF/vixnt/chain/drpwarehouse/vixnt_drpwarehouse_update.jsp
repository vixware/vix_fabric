...
<form id="invWarehouseForm" class="form-horizontal" style="padding: 40px 40px;" action="${nvix}/nvixnt/vixntDrpWarehouseAction!saveOrUpdate.action">
	<input type="hidden" id="id" name="invWarehouse.id" value="${invWarehouse.id}" /> <input type="hidden" id="channelDistributorId" name="invWarehouse.channelDistributor.id" value="${invWarehouse.channelDistributor.id}" />
	<fieldset>
		<div class="form-group">
			<label class="col-md-2 control-label"><span class="text-danger">*</span>仓库编码:</label>
			<div class="col-md-4">
				<input id="code" name="invWarehouse.code" value="${invWarehouse.code}" class="form-control validate[required]" type="text" />
			</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="input-group">
							<input id="warehousePersonName" name="invWarehouse.warehousePerson" value="${invWarehouse.warehousePerson }" class="form-control" type="text" readonly="readonly" />
							<div class="input-group-btn">
								<button onclick="chooseEmployee();" type="button" class="btn btn-info">
									<i class="glyphicon glyphicon-plus"></i>
								</button>
								<button onclick="$('#warehousePersonName').val('');" type="button" class="btn btn-default">
...
<script type="text/javascript">
	function chooseEmployee() {
		chooseListData('${nvix}/nvixnt/vixntDrpWarehouseAction!goEmployeeChoose.action', 'single', '选择人员', 'warehousePerson');
	};
</script>