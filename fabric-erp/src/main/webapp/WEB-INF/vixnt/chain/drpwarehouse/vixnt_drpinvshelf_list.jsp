	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-cubes"></i> 门店管理<span> > 门店业务管理 </span><span> > 货位管理 </span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('drp_warehouse','${nvix}/nvixnt/vixntDrpWarehouseAction!goList.action');">
...
<script type="text/javascript">
	...
	var invShelfTable = initDataTable("invShelfTableId", "${nvix}/nvixnt/vixntDrpWarehouseAction!goInvShelfSingleList.action", invShelfColumns, function(page, pageSize, orderField, orderBy) {
	...
	function deleteShelf(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntDrpWarehouseAction!doListInvShelfById.action?id=' + id, '是否删除货位?', invShelfTable);
	};
	//新增货位
	$("#invShelfForm").validationEngine();
	function goSaveOrUpdateShelf(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/vixntDrpWarehouseAction!goSaveOrUpdateShelf.action?parentId=' + $('#wareHouseId').val() + "&id=" + id, "invShelfForm", title, 900, 425, invShelfTable);
	};
