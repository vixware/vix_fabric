...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseCustomerTableId", "${nvix}/nvixnt/nvixCustomerAccountClipAction!getItemIsServiceItemList.action", chooseCustomerColumns, function(page, pageSize, orderField, orderBy) {
