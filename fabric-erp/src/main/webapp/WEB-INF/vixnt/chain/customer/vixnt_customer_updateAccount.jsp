	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="customerAccountForm">
				...
				<input type="hidden" id="customerIsReport" name="customerAccount.isReport" value="${customerAccount.isReport}" />
				<input type="hidden" id="isReport" name="customerAccountClip.isReport" value="${customerAccountClip.isReport}" />
				...
				<input type="hidden" id="creatTime" name="customerAccount.createTime" value="${customerAccount.createTime}" />
				<input type="hidden" id="updateTime" name="customerAccount.updateTime" value="${customerAccount.updateTime}" />
				<input type="hidden" id="creatTimeCustomerAccountClip" name="customerAccountClip.createTime" value="${customerAccountClip.createTime}" />
				<input type="hidden" id="updateTimeCustomerAccountClip" name="customerAccountClip.updateTime" value="${customerAccountClip.updateTime}" />
				<input type="hidden" id="isTempCustomerAccountClip" name="customerAccountClip.isTemp" value="${customerAccountClip.isTemp}" />
				<input type="hidden" id="money" name="customerAccountClip.money" value="${customerAccountClip.money}" />
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<div class="input-group">
								<input id="cardEntityPayMoney" name="customerAccountClip.payMoney" value="${customerAccountClip.payMoney}" class="form-control validate[required,custom[number]]" type="text" readonly="readonly"/><span class="input-group-addon"><i class="fa">元</i></span>
						    </div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-3">
							<input id="clipPointValue" name="customerAccountClip.pointValue" value="${customerAccountClip.pointValue}" class="form-control validate[required]" type="text" readonly="readonly"/>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<%-- <input id="clipExpiryDate" name="customerAccountClip.expiryDate" value="${customerAccountClip.expiryDate}" class="form-control validate[required]" type="text" /><span class="input-group-addon"><i class="fa">年</i></span> --%>
								<input id="endTime" name="customerAccountClip.expiryDate" value="${customerAccountClip.expiryDateStr}" data-prompt-position="topLeft" class="form-control validate[custom[date]]" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" type="text" readonly="readonly"/>
						</div>
						<label class="col-md-2 control-label"><span class="text-danger">*</span>是否启用:</label>
						<div class="col-md-3">
							<div data-toggle="buttons" class="btn-group">
