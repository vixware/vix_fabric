...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseCustomerTableId", "${nvix}/nvixnt/nvixCustomerAccountAction!goChooseCustomer.action", chooseCustomerColumns, function(page, pageSize, orderField, orderBy) {
