...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseCustomerTableId", "${nvix}/nvixnt/nvixCustomerTagAction!goSingleList.action", chooseCustomerColumns, function(page, pageSize, orderField, orderBy) {
		var searchName = $("#customerName").val();
