...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseCustomerTableId", "${nvix}/nvixnt/nvixCustomerAccountAction!getChannelDistributorList.action", chooseCustomerColumns, function(page, pageSize, orderField, orderBy) {
