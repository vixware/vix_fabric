	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-home"></i> 连锁管理<span>> 连锁店铺管理 </span>
			</h1>
		</div>
		...
		<div class="widget-body">
			<form class="form-horizontal" id="channelDistributorForm">
				...
				<fieldset>
					...
					<%-- <div class="form-group">
						<label class="col-md-2 control-label"> 负责人:
						</label>
						<div class="col-md-3">
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group">
										...
										<div class="input-group-btn">
											<button onclick="chooseEmployee();" type="button" class="btn btn-primary">
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if ($("#channelDistributorForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/vixntDistributionSystemAction!saveOrUpdate.action",
			dataType : "text",
			success : function(id) {
				loadContent('', '${nvix}/nvixnt/vixntDistributionSystemAction!goList.action');
			}
			});
		} else {
			return false;
