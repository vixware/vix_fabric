...
<form id="vixntDistributionSystemForm" class="form-horizontal" style="padding: 40px 40px;" action="${nvix}/nvixnt/vixntDistributionSystemAction!saveChannelDistributorByArea.action">
