	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-globe"></i> <a>会员营销</a> <span>> <a onclick="">智能营销 </a></span><span>> <a onclick="">营销活动 </a></span>
			</h1>
		</div>
			...
			<article style="width: 260px; float: left; margin-right: 20px">
				<div class="tree-box">
					...
					<script type="text/javascript">
						...
						async : {
						enable : true,
						url : "${nvix}/nvixnt/vixntMarketingActivitiesAction!findStoreTypeTreeToJson.action",
...
<script type="text/javascript">
	...
	"data" : function(data) {
		...
		var chooseOrganizationUnit = "<a href='javascript:void(0);' class='btn btn-xs btn-default' onclick=\"goChooseOrganizationUnit('" + data.id + "');\" title='会员列表'><span class='txt-color-blue pull-right'><i class='fa fa-exchange'></i></span></a>";
		...
		return update + "&nbsp;&nbsp;" + chooseOrganizationUnit + "&nbsp;&nbsp;" + del;
	}
	} ];

	var wxpEmployeeTable = initDataTable("wxpEmployeeTableId", "${nvix}/nvixnt/vixntMarketingActivitiesAction!goListContent.action", wxpEmployeeColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntMarketingActivitiesAction!goSaveOrUpdate.action?id=' + id,
		cache : false,
	...
	function deleteEntityById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntMarketingActivitiesAction!deleteEntityById.action?id=' + id, "是否删除该活动!", wxpEmployeeTable, "删除活动");
	};
	pageSetUp();
</script>