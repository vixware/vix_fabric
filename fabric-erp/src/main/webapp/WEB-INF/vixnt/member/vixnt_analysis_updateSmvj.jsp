...
<div id="content">
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		  ...
		  <c:if test="${ not empty controlSQL }">
		      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
				<div class="page-title">   
					<button class="btn btn-default" type="button" onclick="loadContent('','${nvix}/nvixnt/vixntMemberManageDataAction!goMemberListNewHtml.action${controlSQL}');"> 
						<i class="fa fa-rotate-left"></i> 返回   
					</button>
				</div>
			  </div> 
    	  </c:if>
       	  <c:if test="${empty controlSQL }">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
				<div class="page-title">   
