...
<div id="content">
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						<i class="fa fa-list-alt fa-fw "></i> 工作台   <input type="hidden" value="${queryTime }" id="queryTime"  />
					</h1>
				</div>
				
				<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
					   <div class="text-right">
							<button class="btn btn-primary"  type="button" onclick="addCustomer();" style="margin-top:7px;">     
								   会员办理
							</button>
							<button class="btn btn-warning"  type="button" onclick="customerPay();" style="margin-top:7px;">
								   会员充值
							</button>
							<button class="btn btn-info" type="button" onclick="customerLoss();" style="margin-top:7px;">
								   会员卡挂失
							</button>
						</div>
				</div>
									...
									<div class="well well-lg" style="background-color:#ffa160;">
										<div class="row">
											<div class="col-md-12 text-center txt-color-white">
												<strong class="">当前总消费金额 </strong><br>    
<a class="myHoverLine" href="javascript:;" onClick="controlSQLWdMethod('Money{${queryTime }}','${queryTime }');"><strong class="font-lg"><span id="d05Tnum">¥0.00</span></strong></a>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-2">
									<div class="well well-lg" style="background-color:#7cc522;">
										<div class="row">
											<div class="col-md-12 text-center txt-color-white">
												<strong class="">当前进店客户</strong><br>     <!-- workHomePage代表工作台 -->
<a class="myHoverLine" href="javascript:;" onClick="controlSQLWdMethod('IntoTS{${queryTime }}','${queryTime }');"><strong class="font-lg"><span id="d07Tnum">&nbsp;0人</span></strong></a>   
											</div>
										</div>   
									</div>
								</div>
								<div class="col-md-2">
									<div class="well well-lg" style="background-color:#5fd0ff;">
										<div class="row">
											<div class="col-md-12 text-center txt-color-white">
												<strong class="">当前新增会员卡</strong><br>  
<a class="myHoverLine" href="javascript:;" onClick="controlSQLWdMethod('IncreaseC{${queryTime }}','${queryTime }');"><strong class="font-lg"><span  id="d06Tnum">&nbsp;0张</span></strong></a>
											</div>
										</div>  
									</div>
								</div>
...
<input value="${startTime }" placeholder="时间" style="width: 130px;" id="startTimeA" name="startCreateTime"  data-prompt-position="topLeft" class="form-control " onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" /> <span class="input-group-addon"
										...
										<button type="button" class="btn btn-default"  onclick="$('#startTimeA').val('');loadContent('','${nvix}/nvixnt/vixNtIndexAction!goListContent.action');">
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="row">
										<div class="col-xs-3 col-sm-3 text-center">
											<h5>
<a class="myHoverLine" href="javascript:;" onClick="controlSQLWdMethod('OrderNum{${queryTime }}','${queryTime }');"><span class="font-lg txt-color-red padding-5"><span id="d01Tnum">0.00元</span></span></a>
												<div class="padding-5"></div>
												<strong class="txt-color-greenLight">当前总营业收入</strong>
											</h5>
											<div class="padding-5"></div>
											<p><strong class="txt-color-pink">与昨天对比：</strong><span id="d01Cstr">增加</span><span id="d01Cnum">0.00元</span> </p>
										</div>
										<div class="col-xs-3 col-sm-3 text-center" style="border-left: 1px dashed #c0c0c0;padding: 0 10px;">
											<h5>    
<a class="myHoverLine"   href="javascript:;" onClick="controlSQLWdMethod('RechargeM{${queryTime }}','${queryTime }');"><span class="font-lg txt-color-red padding-5"><span id="d02Tnum">0.00元</span></span></a>
<!-- RechargeM 充值记录	 -->						  <div class="padding-5"></div>
												<strong class="txt-color-greenLight">当前总储值收入</strong>
											</h5>
											<div class="padding-5"></div>
											<p><strong class="txt-color-pink">与昨天对比：</strong><span id="d02Cstr">增加</span><span id="d02Cnum">0.00元</span> </p>
										</div>
										<div class="col-xs-3 col-sm-3 text-center" style="border-left: 1px dashed #c0c0c0;padding: 0 10px;">
											<h5>
<a class="myHoverLine"   href="javascript:;" onClick="controlSQLWdMethod('NewAdd{${queryTime }}','${queryTime }');"><span class="font-lg txt-color-red padding-5"><span id="d03Tnum">0</span>人</span></a>
												<div class="padding-5"></div>
												<strong class="txt-color-greenLight">当前新增会员</strong>
											</h5>
											<div class="padding-5"></div>
											<p><strong class="txt-color-pink">与昨天对比：</strong><span id="d03Cstr">增加</span><span id="d03Cnum">0</span>人 </p>
										</div>
										<div class="col-xs-3 col-sm-3 text-center" style="border-left: 1px dashed #c0c0c0;padding: 0 10px;">
											<h5>
<a class="myHoverLine" href="javascript:;" onClick="controlSQLWdMethod('OrderNum{${queryTime }}','${queryTime }');"><span class="font-lg txt-color-red padding-5"><span id="d04Tnum">0</span>笔</span></a>
												<div class="padding-5"></div>
												<strong class="txt-color-greenLight">当前订单数量</strong>
											</h5>
											<div class="padding-5"></div>
											<p><strong class="txt-color-pink">与昨天对比：</strong><span id="d04Cstr">增加</span><span id="d04Cnum">0</span>笔 </p>
										</div>
									</div>
									<hr class="simple" style="border-color:#c0c0c0;">
								</div>
					...
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="jarviswidget">
							<header>
								...
								<div>
									<div class="col-sm-12 col-md-6" id="mytableTopB">
									</div>
									<div class="col-sm-12 col-md-6" id="mytableTopA">
									</div>
								</div>
						</div>
					</article>
			    	...
			    	,yes: function(index, layero){
			    		...
			    		if(clipId != ''){
			    			...
			    			$.ajax({
			    				...
			    				data:{'customerAccountClipId':clipId},
 		...
 		success:function(json){
 			...
 			var	option = {
				    ...
				    xAxis : [
				        {  
				        	type : 'category',
				            data : json.timeStr //['8:00~9:00','9:00~10:00','10:00~11:00','10:00~11:00','11:00~12:00','11:00~12:00']
				        }
				    ],
				    yAxis : [
				        {
	...
	$(document).ready(function() {
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonA.action",  
	     	type: "POST",
	     	data: {controlSQL:'NTtotalBusinessIncome',queryTime:$("#queryTime").val()},//查询‘总营业收入’ numRt：返回数字  用 NT 代表，  totalBusinessIncome 总营业收入
	        dataType: "json",
	 		success:function(json){
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonA.action",  
	     	type: "POST",
	     	data: {controlSQL:'NTtotalRecharge',queryTime:$("#queryTime").val()},//查询‘总储值收入’ numRt：返回数字  用 NT 代表，  NTtotalRecharge 
	        dataType: "json",
	 		success:function(json){
		...
		/* $.ajax({    
		 ...
		 $.ajax({    
				url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonA.action",  
		     	type: "POST",
		     	data: {controlSQL:'NTregisterMemberNum',queryTime:$("#queryTime").val()},// numRt：返回数字  用 NT 代表，  registerMemberNum 当前注册会员人数
		        dataType: "json",
		 		success:function(json){
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonA.action",  
	     	type: "POST",
	     	data: {controlSQL:'NTtodayOrdersNumBlock',queryTime:$("#queryTime").val()},// NTtodayOrdersNumBlock 当前订单数目，付款或者不付款都查询  Block数据块显示
	        dataType: "json",  
	 		success:function(json){
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonB.action",  
	     	type: "POST",
	     	data: {controlSQL:'NTtodayConsumptionMoney',queryTime:$("#queryTime").val()},//numRt：返回数字  用 NT代表，NTtodayConsumptionMoney 当前‘总消费金额’
	        dataType: "json",
	 		success:function(json){
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonB.action",  
	     	type: "POST",
	     	data: {controlSQL:'NTtodayAddCardNum',queryTime:$("#queryTime").val()},// todayAddCardNum 当前新增会员卡  
	        dataType: "json",
	 		success:function(json){     
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonB.action",  
	     	type: "POST",
	     	data: {controlSQL:'NTtodayIntoStoreCustomers',queryTime:$("#queryTime").val()},//NTtodayIntoStoreCustomers 当前进店客户，(充值的+下订单付费的+下订单不付费的)
	        dataType: "json",
	 		success:function(json){ 
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentJsonC.action",  
	     	type: "POST",
	     	data: {controlSQL:'JVtodayPassengerFlowTop',topNum:'24',queryTime:$("#queryTime").val()},// jsonKeyValueForView：为视图view返回Json键值对; 用 JV 代表;  查询  '当前销售情况排行' 客流量  todayPassengerFlowTop
	        dataType: "json",
	 		success:function(json){
		...
		queryMethod_C($("#queryTime").val(),$("#queryTime").val());
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentHtmlA.action",  
	     	type: "POST",
	     	data: {topNum:'10',queryTime:$("#queryTime").val()},//查询：客户消费排行TOP10
	        cache : false,
	 		success:function(html){ 
		...
		$.ajax({    
			url: "${nvix}/nvixnt/vixNtIndexAction!nvixContentHtmlB.action",  
	     	type: "POST",
	     	data: {topNum:'10',queryTime:$("#queryTime").val()},//查询：商品销量排行 TOP10
	        cache : false,
	 		success:function(html){ 
