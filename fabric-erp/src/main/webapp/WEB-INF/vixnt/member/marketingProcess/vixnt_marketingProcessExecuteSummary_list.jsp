	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-globe"></i> 会员营销 <span>&gt; 智能营销</span><span>&gt; 营销流程执行汇总</span>
			</h1>
		</div>
	</div>
	<!-- row -->
		...
		<div>
			<div class="widget-body no-padding">
				<form class="navbar-form navbar-left" role="search">
					...
					<button onclick="marketingActivitiesTable.ajax.reload();" type="button" class="btn btn-primary">
...
<script type="text/javascript">
	...
	var marketingActivitiesTable = initDataTable("marketingActivitiesTableId", "${nvix}/nvixnt/vixntAllMarketingProcessExecuteSummaryAction!goListContent.action", marketingActivitiesColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntAllMarketingProcessExecuteSummaryAction!goSaveOrUpdate.action?id=' + id,
		cache : false,
