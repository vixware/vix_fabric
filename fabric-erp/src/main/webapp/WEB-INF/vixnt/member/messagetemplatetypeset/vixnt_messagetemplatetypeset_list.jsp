	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-home"></i> 会员交互管理 <span>> 短信设置 </span> <span>> 短信模板类型设置 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var memberTagTable = initDataTable("areaLevelTableId", "${nvix}/nvixnt/vixntMessageTemplateTypeSetAction!goSingleList.action", memberTagColumns, function(page, pageSize, orderField, orderBy) {
	...
	function saveOrUpdate(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/vixntMessageTemplateTypeSetAction!goSaveOrUpdate.action?id=' + id, "memberTagForm", title, 750, 350, memberTagTable);
	};
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntMessageTemplateTypeSetAction!deleteById.action?id=' + id, '是否删除会员等级?', memberTagTable);
	};
	pageSetUp();
</SCRIPT>