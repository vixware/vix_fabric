	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-globe"></i> <a>会员营销</a><span>> 优惠券管理 </span><span>> 会员优惠券管理 </span>
			</h1>
		</div>
	</div>
	<section id="" class="">
	...
	function goSaveOrUpdate(id) {
		if (id != null && id != '') {
			...
			if ($('#selectTreeType').val() != '' && $('#selectTreeType').val() != null && $('#selectTreeType').val() == 'CH') {
				$.ajax({
				url : '${nvix}/nvixnt/nvixCustomerAccountAction!goSaveOrUpdate.action?id=' + id + '&parentId=' + $('#selectId').val(),
				cache : false,
				success : function(html) {
					$("#mainContent").html(html);
				}
