...
<div class="client_selection" id="send_message" title="短信发送" style="display: none; width: 450px;">
	<table style="width: 100%">
		...
		<tr>
			...
			<td><s:select id="nodeParam-send_message" headerKey="" headerValue="--请选择--" list="%{messageSendTemplateList}" listValue="name" listKey="messageContent" value="name" multiple="false" theme="simple" onchange="changeDisplay(this);">
				</s:select></td>
		</tr>
		<tr>
...
<div class="client_selection" id="send_coupon" title="优惠券发放" style="display: none; width: 450px;">
	<table style="width: 100%">
		...
		<tr>
			...
			<td><s:select id="nodeParam-send_coupon" headerKey="" headerValue="--请选择--" list="%{couponList}" listValue="name" listKey="id" value="name" multiple="false" theme="simple">
				</s:select></td>
		</tr>
	</table>
</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 会员交互管理 <span onclick="">&gt; 智能营销</span><span onclick="">&gt; 营销流程管理</span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('', '${nvix}/nvixnt/vixntMarketingProcessManagementAction!goList.action');">
	...
	<div class="jarviswidget">
		...
		<div class="widget-body">
			<form class="form-horizontal" id="marketingActivitiesForm">
				<fieldset>
					<input type="hidden" id="id" name="marketingActivities.id" value="${marketingActivities.id}" /> <input type="hidden" id="code" name="marketingActivities.code" value="${marketingActivities.code}" />
					<div class="form-group">
						<label class="col-md-2 control-label"><span class="text-danger">*</span> 主题:</label>
						<div class="col-md-8">
							<input id="name" name="marketingActivities.name" value="${marketingActivities.name}" class="form-control" type="text" placeholder="日志标题" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-3">
							<div class="input-group">
								<input id="startTime" name="marketingActivities.startTime" value="${marketingActivities.startTimeTimeStr}" data-prompt-position="topLeft" class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text" /> <span class="input-group-addon" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',el:'startTime'});"><i
						...
						<div class="col-md-3">
							<div class="input-group">
								<input id="endTime" name="marketingActivities.endTime" value="${marketingActivities.endTimeTimeStr}" data-prompt-position="topLeft" class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text" /> <span class="input-group-addon" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',el:'logDate'});"><i
									class="fa fa-calendar"></i></span>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function saveOrUpdate() {
		if ($("#marketingActivitiesForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/vixntMarketingProcessManagementAction!saveOrUpdate.action",
			dataType : "text",
			success : function(id) {
				loadContent('', '${nvix}/nvixnt/vixntMarketingProcessManagementAction!goList.action');
			}
			});
		} else {
			return false;
