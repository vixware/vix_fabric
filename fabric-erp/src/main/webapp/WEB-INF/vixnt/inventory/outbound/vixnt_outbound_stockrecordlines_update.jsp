...
<script type="text/javascript">
	...
	var chooseEcProductTable = initDataTable("chooseEcProduct", "${nvix}/nvixnt/vixntOutBoundAction!goInventoryCurrentStockListContent.action", chooseEcProductColumns, function(page, pageSize, orderField, orderBy) {
	...
	function mergeStockInDetail() {
		...
		if ($('#stockRecordLinesForm').validationEngine('validate')) {
				...
				type : "post",
				url : "${nvix}/nvixnt/vixntOutBoundAction!saveOrUpdateWimStockRecordLines.action",
				...
				success : function(result) {
					...
					$.ajax({
					url : '${nvix}/nvixnt/vixntOutBoundAction!getStockRecordTotal.action?id=' + $("#stockRecordsId").val(),
					cache : false,
