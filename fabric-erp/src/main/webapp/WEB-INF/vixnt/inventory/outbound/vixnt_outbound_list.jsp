	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-cubes"></i> 库存管理 <span>&gt; 出库管理</span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var stockRecordsTable = initDataTable("stockRecordsTableId", "${nvix}/nvixnt/vixntOutBoundAction!goSingleList.action", stockRecordsColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntOutBoundAction!goSaveOrUpdate.action?id=' + id,
		cache : false,
	...
	function show(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntOutBoundAction!goShowOutBound.action?id=' + id,
		cache : false,
		success : function(html) {
			$("#mainContent").html(html);
		}
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntOutBoundAction!deleteById.action?id=' + id, '是否删除出库单?', stockRecordsTable);
	};
</script>