	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 库存管理 <span>> 库存报表 </span><span>> 存货分布表 </span>
			</h1>
...
<form action="" method="post" name="exportMD" id="exportMD" target="form_iframe" style="margin: 0"></form>
	<div class="jarviswidget">
		<header>
			...
			<h2>物料:<span style="color:#428BCA" id="itemNameLook">所有物料</span></h2>  
			<h2>编号:<span style="color:#428BCA" id="itemCodeLook" >---</span></h2>
			<h2>规格:<span style="color:#428BCA" id="specificationLook" >---</span></h2>
			<h2>单位:<span style="color:#428BCA" id="measureUnitnameLook" >---</span></h2>
...
form.action = "${nvix}/nvixnt/vixntStockQueryStatisticsAction!outExcelToStockHasDistributionTable.action?queryTime="+queryTime+"&itemID="+itemID+"&invWarehouseID="+invWarehouseID;
	form.submit();
}
/** 把页面查询条件封装成js对象 **/
...
var arrivalListColumns = [{ 
	...
	var arrivalListTable = initDataTable("arrivalListTableId", "${nvix}/nvixnt/vixntStockQueryStatisticsAction!searchStockHasDistributionTable.action", arrivalListColumns, function(page, pageSize, orderField, orderBy) {
		var queryTime = $("#queryTime").val();
