...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/vixntInboundWarehouseAction!goPurchaseOrderList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
