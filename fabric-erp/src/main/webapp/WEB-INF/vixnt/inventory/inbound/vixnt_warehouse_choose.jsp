...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseWarehouseTableId", "${nvix}/nvixnt/vixntInboundWarehouseAction!goInvWarehouseList.action", chooseWarehouseColumns, function(page, pageSize, orderField, orderBy) {
