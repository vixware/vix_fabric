			...
			<div class="page-title">
				<s:if test="isAllowAudit == 1">
					<button type="button" class="btn bg-color-blueLight txt-color-white" onclick="approvalSalesOrder('');">
						<i class="fa fa-share-square-o"></i> 提交审批
					</button>
				</s:if>
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							...
							<button class="btn btn-default" type="button" onclick="loadContent('inv_vixntinboundwarehouse','${nvix}/nvixnt/vixntInboundWarehouseAction!goList.action');">
								<i class="fa fa-rotate-left"></i> 返回
							</button>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function deleteWimStockrecordlinesById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntInboundWarehouseAction!deleteStockRecordLinesById.action?id=' + id, '是否删除入库单明细?', stockRecordLinesTable);
	};
