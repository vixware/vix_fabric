...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseWarehouseTableId", "${nvix}/nvixnt/vixntShopTakeStockAction!goInvWarehouseList.action", chooseWarehouseColumns, function(page, pageSize, orderField, orderBy) {
