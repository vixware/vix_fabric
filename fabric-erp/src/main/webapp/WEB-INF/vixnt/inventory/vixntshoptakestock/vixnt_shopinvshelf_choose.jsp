...
<script type="text/javascript">
	...
	var chooseInvShelfTable = initDataTable("chooseInvShelfTableId", "${nvix}/nvixnt/vixntShopTakeStockAction!goInvShelfSingleList.action", chooseInvShelfColumns, function(page, pageSize, orderField, orderBy) {
