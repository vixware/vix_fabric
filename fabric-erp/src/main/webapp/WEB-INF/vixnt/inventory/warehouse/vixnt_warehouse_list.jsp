	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-cubes"></i> 库存管理<span> > 仓库管理 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var invWarehouseTable = initDataTable("invWarehouseTableId", "${nvix}/nvixnt/vixntWarehouseAction!goInvWarehouseList.action", invWarehouseColumns, function(page, pageSize, orderField, orderBy) {
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntWarehouseAction!deleteById.action?id=' + id, '是否删除仓库?', invWarehouseTable);
	};
	//新增仓库
	$("#invWarehouseForm").validationEngine();
	function goSaveOrUpdate(id, title) {
		openSaveOrUpdateWindow('${nvix}/nvixnt/vixntWarehouseAction!goSaveOrUpdate.action?id=' + id, "invWarehouseForm", title, 900, 515, invWarehouseTable);
	};
	function goInvShelfList(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntWarehouseAction!goInvShelfList.action?wareHouseId=' + id,
		cache : false,
