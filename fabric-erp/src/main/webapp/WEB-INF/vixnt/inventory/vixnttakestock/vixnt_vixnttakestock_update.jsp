	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-cubes"></i> 库存管理 <span>&gt; 盘点管理</span>
			</h1>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-8 text-align-right">
			<div class="page-title">
				...
				<button class="btn btn-default" type="button" onclick="loadContent('', '${nvix}/nvixnt/vixntTakeStockAction!goList.action');">
		...
		<div>
			<div class="widget-body">
				<form class="form-horizontal" id="stockTakingForm">
					<fieldset>
						<input type="hidden" id="stockTakingId" name="stockTaking.id" value="${stockTaking.id}" /> 
						<input type="hidden" id="warehouseId" name="stockTaking.invWarehouse.id" value="${stockTaking.invWarehouse.id}" />
						<input type="hidden" id="channelDistributorId" name="stockTaking.channelDistributor.id" value="${stockTaking.channelDistributor.id}" />
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<div class="input-group">
									<input id="createTime" name="stockTaking.createTime" value="${stockTaking.createTimeStr}" data-prompt-position="topLeft" class="form-control validate[required]" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text" /> <span class="input-group-addon" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',el:'createTime'});"><i
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<input id="maker" name="stockTaking.maker" value="${stockTaking.maker}" type="text" class="form-control">
							</div>
						</div>
...
<script type="text/javascript">
	...
	var stockTakingItemTable = initDataTable("stockTakingItemTableId", "${nvix}/nvixnt/vixntTakeStockAction!goStockTakingItemList.action?id=${stockTaking.id}", stockTakingItemColumns, function(page, pageSize, orderField, orderBy) {
	...
	function deleteStockTakingItemById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntTakeStockAction!deleteStockTakingItemById.action?id=' + id, '是否删除盘点单明细?', vixntTakeStockTable);
	};
	...
	function saveOrUpdate() {
		if ($("#stockTakingForm").validationEngine('validate')) {
			...
			type : "post",
			url : "${nvix}/nvixnt/vixntTakeStockAction!saveOrUpdate.action",
			dataType : "text",
			success : function(id) {
				loadContent('', '${nvix}/nvixnt/vixntTakeStockAction!goList.action');
			}
			});
		} else {
			return false;
