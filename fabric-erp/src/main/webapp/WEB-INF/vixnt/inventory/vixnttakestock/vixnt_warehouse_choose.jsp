...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseWarehouseTableId", "${nvix}/nvixnt/vixntWarehouseAction!goInvWarehouseList.action", chooseWarehouseColumns, function(page, pageSize, orderField, orderBy) {
