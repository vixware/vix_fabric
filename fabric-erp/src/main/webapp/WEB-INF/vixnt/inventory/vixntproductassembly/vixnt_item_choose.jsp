...
<script type="text/javascript">
	...
	var itemTable = initDataTable("itemtableid", "${nvix}/nvixnt/vixntAllocationItemAction!goChooseListContent.action", itemColumns, function(page, pageSize, orderField, orderBy) {
