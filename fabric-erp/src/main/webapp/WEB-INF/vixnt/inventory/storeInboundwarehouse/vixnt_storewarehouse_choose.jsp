		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					<div class="col-md-4">
						<input type="text" value="" placeholder="名称" class="form-control" id="warehouseName">
					</div>
					<button onclick="chooseWarehouseTable.ajax.reload();" type="button" class="btn btn-info">
						<i class="glyphicon glyphicon-search"></i> 检索
					</button>
					<button type="button" class="btn btn-default" onclick="$('#warehouseName').val('');chooseWarehouseTable.ajax.reload();">
						<i class="glyphicon glyphicon-repeat"></i> 清空
					</button>
				</div>
			</div>
			<table id="chooseWarehouseTableId" class="table table-striped table-bordered table-hover" width="100%">
				<thead>
					<tr>
						<th width="10%"><s:if test="chooseType == 'multi'">
								<div class="btn-group">
									...
									<ul class="dropdown-menu js-status-update pull-left">
										<li><a id="all" onclick="changeDataTableSelect('chooseWarehouseTableId','all');" href="javascript:void(0);">全选</a></li>
										<li><a id="reverse" onclick="changeDataTableSelect('chooseWarehouseTableId','reverse');" href="javascript:void(0);">反选</a></li>
										<li><a id="cancle" onclick="changeDataTableSelect('chooseWarehouseTableId','cancle');" href="javascript:void(0);">取消</a></li>
									</ul>
								</div>
...
<script type="text/javascript">
	...
	var chooseWarehouseTable = initDataTable("chooseWarehouseTableId", "${nvix}/nvixnt/vixntStoreInboundWarehouseAction!goInvWarehouseList.action", chooseWarehouseColumns, function(page, pageSize, orderField, orderBy) {
