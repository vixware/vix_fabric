...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/vixntStoreInboundWarehouseAction!goPurchaseOrderList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
