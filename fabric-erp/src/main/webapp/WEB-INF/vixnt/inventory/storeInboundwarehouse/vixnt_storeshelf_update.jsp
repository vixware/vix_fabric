...
<form id="stockRecordLinesForm" class="form-horizontal" style="padding: 20px 15px;" action="${nvix}/nvixnt/vixntStoreInboundWarehouseAction!updateStockRecordLines.action">
	<fieldset>
