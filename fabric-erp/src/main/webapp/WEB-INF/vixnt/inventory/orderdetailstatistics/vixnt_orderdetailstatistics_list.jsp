	...
	<div class="row">
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa fa-lg fa-fw fa-bar-chart-o"></i> 连锁经营管理 <span>&gt; 门店销售统计表</span>
			</h1>
		</div>
	</div>
	<section>
...
<script type="text/javascript">
	...
	var salesOrderTable = initDataTable("salesOrderTableId", "${nvix}/nvixnt/orderDetailStatisticsAction!goSingleList.action", salesOrderColumns, function(page, pageSize, orderField, orderBy) {
