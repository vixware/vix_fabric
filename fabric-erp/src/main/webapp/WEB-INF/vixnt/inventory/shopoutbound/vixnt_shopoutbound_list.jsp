...
<script type="text/javascript">
	...
	var stockRecordsTable = initDataTable("stockRecordsTableId", "${nvix}/nvixnt/vixntShopOutBoundAction!goSingleList.action", stockRecordsColumns, function(page, pageSize, orderField, orderBy) {
	...
	function goSaveOrUpdate(id) {
		$.ajax({
		url : '${nvix}/nvixnt/vixntShopOutBoundAction!goSaveOrUpdate.action?id=' + id,
		cache : false,
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/vixntShopOutBoundAction!deleteById.action?id=' + id, '是否删除出库单?', stockRecordsTable);
	};
</script>