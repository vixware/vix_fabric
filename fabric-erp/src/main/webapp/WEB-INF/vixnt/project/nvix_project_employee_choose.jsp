		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					<div class="col-md-4">
						<input type="text" value="" placeholder="姓名" class="form-control" id="employeeName">
					</div>
...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/nvixProjectAction!goProjectEmployeeList.action?parentId=" + $('#projectid').val(), chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
