			...
			<div class="page-title">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="javascript:void(0);" onclick="loadContent('','${nvix}/nvixnt/nvixProjectAction!goProjectList.action');">列表视图</a></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="jarviswidget" id="" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
					...
					<div>
						<div class="widget-body no-padding">
							<div id="ecOrderAuditSearchForm" style="padding-bottom: 60px;">
...
<script type="text/javascript">
	...
	function goProjectTaskDetails(id) {
		loadContent('mid_teamtask', '${nvix}/nvixnt/nvixProjectAction!goProjectTaskDetails.action?id=' + id);
	};
	//删除
