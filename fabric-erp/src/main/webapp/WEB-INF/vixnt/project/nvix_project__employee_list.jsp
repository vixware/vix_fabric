			...
			<s:if test="empList.size > 0">
				<s:iterator value="empList" var="entity" status="s">
					<div class="col-sm-3 col-md-3 col-lg-3 text-center app-del">
						<span class="glyphicon glyphicon-minus"></span> <a data-toggle="modal" href="#" onclick="deleteProjectEmployee('${entity.id }','${project.id }');"><img src="${entity.headImgUrl }" class="btn-circle no-padding btn-xl"></a>
					</div>
				</s:iterator>
			</s:if>
			<div class="col-sm-3 col-md-3 col-lg-3 text-center app-del">
