		...
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
			<h1 class="page-title txt-color-blueDark">
				...
				<s:else>
					...
					<a data-toggle="modal" href="#" style="cursor: pointer;" onclick="loadContent('','${nvix}/nvixnt/nvixProjectAction!goList.action');">项目管理 </a>
					<span>> <a data-toggle="modal" href="#" style="cursor: pointer;" onclick="loadContent('','${nvix}/nvixnt/nvixProjectAction!goProjectTracing.action?id=${project.id}');">项目跟踪管理 </a> <a data-toggle="modal" href="#" style="cursor: pointer;"
						onclick="loadContent('','${nvix}/nvixnt/nvixProjectAction!goProjectTaskDetails.action?id=${vixTask.id}');">> 任务详情 </a> <span>> 人员列表</span>
				</s:else>
			</h1>
		</div>
	</div>
...
<script type="text/javascript">
	function goInformation(id) {
		$.ajax({
		url : '${nvix}/nvixnt/nvixProjectAction!goProjectTaskEmployeeListContent.action?id=' + id,
		cache : false,
