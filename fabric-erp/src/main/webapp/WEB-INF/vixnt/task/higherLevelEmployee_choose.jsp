...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/taskAndPlanAction!goHigherLevelEmployeeList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
