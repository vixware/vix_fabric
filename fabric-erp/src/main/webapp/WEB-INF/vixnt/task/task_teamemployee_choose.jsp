...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/taskAndPlanAction!goTeamEmployeeList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
