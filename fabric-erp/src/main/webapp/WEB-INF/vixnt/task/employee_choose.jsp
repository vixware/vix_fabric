...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/taskAndPlanAction!goEmployeeList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
