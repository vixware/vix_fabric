			...
			<div id="content">
				...
				<!-- <div class="col-sm-12 col-md-12 col-lg-3">
					<div class="well" style="min-height:720px;">
							搜索	
							<h4 class="semi-bold text-center">任务</h4>
							<hr/>
							...
							<div>
								...
								<div class="widget-body">
									<div class="tree smart-form">
										<ul>
											<li>
												<span><i class="fa fa-lg fa-folder-open"></i>&nbsp;待处理●2</span>
												<ul>
													<li>
														<span><i class="fa fa-lg fa-plus-circle"></i> 测试号</span>
														<ul>
													...
													<li>
														<span> <a href="javascript:;">添加任务</a></span>
													</li>
												</ul>
											</li>
											<li>
												<span><i class="fa fa-lg fa-folder-open"></i>&nbsp;进行中●2</span>
												<ul>
													<li><span><i class="icon-leaf"></i>测试已修改问题，并进行关闭</span></li>
													<li><span><i class="icon-leaf"></i>复测已修改问题</span></li>
													<li><span><i class="icon-leaf"></i> 复测已修改问题</span></li>
													<li><span><a href="javascript:;">添加任务</a></span></li>
												</ul>
											</li>
											<li>
												<span><i class="fa fa-lg fa-folder-open"></i>&nbsp;已完成●1</span>
												<ul>
													<li><span><i class="icon-leaf"></i>验收成功</span></li>
													<li><span><a href="javascript:;">添加任务</a></span></li>
												</ul>
											</li>
											<li>
												<span><i class="fa fa-lg fa-folder-open"></i>&nbsp;售后●0</span>
												<ul>
													<li><span><a href="javascript:;">添加任务</a></span></li>
												</ul>
											</li>
				...
				<div class="col-sm-12 col-md-12 col-lg-12" id="gtt">
...
$(function() {
  ...
  workSpace.css({width:$("#gtt").width() - 20,height:$("#main").height() - 100});
  ...
  $("#main").resize(function(){
    ...
    workSpace.css({width:$("#gtt").width() - 20,height:$("#main").height() - 20});
          ...
          $(this).remove();
				...
				<%-- <div class="col-sm-12 col-md-12 col-lg-3">
					<div class="well" style="min-height:720px;">
							...
							<h4 class="semi-bold text-center">项目菜单</h4>
							<hr/>
							
							<!-- 项目菜单 -->
							<h6><i class="fa fa-gear"></i> &nbsp;项目设置</h6>
							<h6><i class="fa fa-file-text"></i> &nbsp;项目信息</h6>
							<h6><i class="fa fa-tags"></i> &nbsp;标签</h6>
							<h6><i class="fa fa-wrench"></i> &nbsp;应用与插件</h6>
							<h6><i class="fa fa-align-left"></i>&nbsp;查看更多</h6>
							<hr/>
							<h6><i class="fa fa-flag-checkered"></i>&nbsp;任务统计</h6>
							<h6><i class="fa fa-list-ul"></i>&nbsp;项目动态</h6>
							<div class="chat-body no-padding profile-message">
								<ul>
									<li class="message" style="margin:20px 0;">
										<img src="${nvix}/vixntcommon/base/images/touxiang.png" class="" alt="sunny"> 
										<span class="message-text"> 
											<a href="javascript:void(0);" class="username double-line">达达 <span>2017-12-20 13:00</span></a>
											创建日程：11:30-12:00吃饭
										</span>
									</li>
									<li class="message" style="margin:20px 0;">
										<img src="${nvix}/vixntcommon/base/images/touxiang-1.png" class="" alt="sunny"> 
										<span class="message-text"> 
											<a href="javascript:void(0);" class="username double-line">吉吉</a>
											创建日程：16:00-19:00学习
										</span>
									</li>
									<li class="message" style="margin:20px 0;">
										<img src="${nvix}/vixntcommon/base/images/touxiang-2.png" class="" alt="sunny"> 
										<span class="message-text"> 
											<a href="javascript:void(0);" class="username double-line">城城</a>
											上传文件：不能说的秘密
										</span>
									</li>
								</ul>
