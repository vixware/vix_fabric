...
<input type="hidden" id="meetingids" value="${meetingids}" />
<div class="jarviswidget jarviswidget-color-darken" style="padding: 6px;">
		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					<div class="col-md-4">
						<input type="text" value="" placeholder="主题" class="form-control" id="meetingTheme">
					</div>
					<button onclick="chooseEmployeeTable.ajax.reload();" type="button" class="btn btn-info">
						<i class="glyphicon glyphicon-search"></i> 检索
					</button>
					<button type="button" class="btn btn-default" onclick="$('#meetingTheme').val('');chooseEmployeeTable.ajax.reload();">
...
<script type="text/javascript">
	...
	var chooseEmployeeTable = initDataTable("chooseemployee", "${nvix}/nvixnt/taskAndPlanAction!goMeetingList.action?meetingids=" + $("#meetingids").val(), chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
