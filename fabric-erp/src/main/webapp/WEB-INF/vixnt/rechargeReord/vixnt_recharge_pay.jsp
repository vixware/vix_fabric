...
<input id="customerAccountClipId" name="rechargeRecord.customerAccountClip.id" value="${rechargeRecord.customerAccountClip.id}" class="form-control validate[required]" type="hidden" readonly="readonly" />
...
<input id="storedValueRuleSetId" type="hidden" name="rechargeRecord.storedValueRuleSet.id" value="${rechargeRecord.storedValueRuleSet.id }" />	
	<fieldset>
		<div class="form-group">
			<label class="col-md-2 control-label">支付金额:</label>
			<div class="col-md-3">
				<input id="payMoney" name="rechargeRecord.payMoney" value="${rechargeRecord.payMoney}" class="form-control validate[required]" type="text" readonly="readonly" />
			</div>
		</div>
		<div class="form-group">
