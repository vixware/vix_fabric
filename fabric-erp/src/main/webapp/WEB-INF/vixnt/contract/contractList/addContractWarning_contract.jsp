...
<form id="contractWarningForm" class="form-horizontal" style="padding: 35px 15px;" action="${nvix}/nvixnt/contract/vixntContractAction!saveOrUpdateContractWarning.action">
