...
<script type="text/javascript">
	...
	var chooseCustomerTable = initDataTable("chooseCustomer","${nvix}/nvixnt/contract/vixntContractAction!chooseCustomer.action",chooseCustomerColumns,function(page,pageSize,orderField,orderBy){
