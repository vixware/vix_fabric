	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<h1 class="page-title txt-color-blueDark">
				<i class="fa-fw fa fa-book"></i> <a style="cursor: pointer;">合同管理</a><span>> 合同预警 </span>
			</h1>
		</div>
...
<script type="text/javascript">
	...
	var supplierTable = initDataTable("supplierTableId", "${nvix}/nvixnt/contract/vixntContractWarningAction!goSingleList.action", supplierColumns, function(page, pageSize, orderField, orderBy) {
	...
	function deleteById(id) {
		deleteEntityByConfirm('${nvix}/nvixnt/contract/vixntContractWarningAction!deleteById.action?id=' + id, '是否删除预警?', supplierTable);
	};
