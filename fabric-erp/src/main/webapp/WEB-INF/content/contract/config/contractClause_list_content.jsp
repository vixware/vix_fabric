...
function deleteEntity(id){
	asyncbox.confirm('确定要删除么?','<s:text name='合同条款'/>',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="260"><s:text name="ctm_numbers" /></th>
			<th width="260"><s:text name="ctm_terms_contents" /></th>
			<th><s:text name="ctm_type" /></th>
			<th><s:text name="ctm_state" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.clauseContent}</a></td>
					<td><a href="#" style="color: gray;">${entity.type}</a></td>
					<td><a href="#" style="color: gray;">${entity.mode}</a></td>
					<td>
