...
function deleteEntity(id){
	asyncbox.confirm('确定要删除么?','<s:text name='合同分类'/>',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
...
<table class="list" style="width: 1200px;">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('name');" width="40%">名称&nbsp; <s:if test="%{pager.orderField == 'name' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('memo');" width="30%">备注&nbsp; <s:if test="%{pager.orderField == 'memo' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
