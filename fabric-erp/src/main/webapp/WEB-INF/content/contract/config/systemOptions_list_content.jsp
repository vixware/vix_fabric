	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#"><s:text name="系统选项" /> </a></li>
			</ul>
		</div>
	</h2>
						...
						<div class="nt">
							...
							<div class="nt_line">
								<table width="100%">
									<tbody>
										<tr class="alt">
											<td align="right"><label> <input type="checkbox" name="CheckInventoryPermissions" />
											</label></td>
								...
								<table width="100%">
									<tbody>
										<tr class="alt">
											...
											<td><label> <input type="text" name="RemoteIdentificationNumber" class="ipt time_aoto_input wb50" />
											</label></td>
										</tr>
									</tbody>
								</table>
								...
								<table width="100%">
									<tbody>
										<tr class="alt">
											...
											<td><label> <input type="text" name="SpecialInvoicesDefaultRate" class="ipt time_aoto_input wb50" />
											</label></td>
										</tr>
									</tbody>
								</table>
						...
						<div class="nt">
							...
							<div class="nt_line">
								<table width="100%">
									<tbody>
										<tr class="alt">
											<td align="right"><label> <input type="radio" name="BaseStringSet" value="0" />
											</label></td>
											<td><label>基于基串精确匹配</label></td>
											<td align="right"><label> <input type="radio" name="BaseStringSet" value="1" />
											</label></td>
								...
								<table width="100%">
									<tbody>
										<tr class="alt">
											...
											<td><label>基于基串向后匹配</label></td>
											<td align="right"><label> <input type="radio" name="BaseStringSet" value="2" />
											</label></td>
											<td><label>基于基串向前匹配</label></td>
										</tr>
										<tr class="">
											<td align="right"><label> <input type="radio" name="BaseStringSet" value="3" />
											</label></td>
											<td><label>基于基串前后模糊匹配</label></td>
											<td align="right"><label> <input type="radio" name="BaseStringSet" value="4" />
											</label></td>
											<td><label>查询全部不做模糊匹配</label></td>
											<td align="right"><label></label></td>
											<td><label></label></td>
								...
								<table width="100%">
									<tbody>
										<tr class="alt">
											...
											<td><label> <input type="text" name="ControlTheNumberOfPrints" class="ipt time_aoto_input wb50" />&nbsp;次
											</label></td>
