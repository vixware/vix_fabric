	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#"><s:text name="新增采购合同" /> </a></li>
			</ul>
		</div>
	</h2>
</div>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdate1();"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <%-- <a href="#"><img width="22" height="22" title="保存并提交审批" src="${vix}/common/img/dt_submit.png" /></a>  --%>
					...
					</span> <strong><b><s:text name="新增采购合同" /> </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										<tr>
											...
											<td><input id="firstParty" name="firstParty" value="${contract.firstParty}" type="text" size="8" class="validate[required] text-input" /> <span style="color: red;">*</span> <input type="hidden" id="firstParty" name="firstParty" value="${contract.id}" /> <input class="btn" type="button" value="选择信息" onclick="chooseRadioSupplier();" />
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							...
							<li><a onclick="javascript:$('#a3').attr('style','');tab(6,3,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />合同附件</a></li>
							<li><a onclick="javascript:$('#a4').attr('style','');tab(6,4,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />合同预警</a></li>
							<li><a onclick="javascript:$('#a5').attr('style','');tab(6,5,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />合同审批</a></li>
