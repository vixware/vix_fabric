...
function deleteEntity(id){
	asyncbox.confirm('确定要删除么?','<s:text name='合同协议'/>',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="160" style="cursor: pointer;" onclick="orderBy('id');"><s:text name="ctm_numbers" />&nbsp;<img id="brandImg_id" src="${vix}/common/img/arrow.gif"></th>
			<th width="160" style="cursor: pointer;" onclick="orderBy('partyName');"><s:text name="甲方（姓名）" />&nbsp;<img id="brandImg_partyName" src="${vix}/common/img/arrow.gif"></th>
			<th width="170" style="cursor: pointer;" onclick="orderBy('bsquarename');"><s:text name="乙方（姓名）" />&nbsp;<img id="brandImg_bsquarename" src="${vix}/common/img/arrow.gif"></th>
			<th>签订地址</th>
			<th>签订时间</th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.partyName}</a></td>
					<td><a href="#" style="color: gray;">${entity.bsquarename}</a></td>
					<td><a href="#" style="color: gray;">${entity.contractSignedLocation}</a></td>
					<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.contractSignedTime}" type="both" pattern="yyyy-MM-dd" /></a></td>
					<td>
