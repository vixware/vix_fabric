		...
		<div class="box order_table" style="line-height: normal;">
			<table class="table-padding020">
				...
				<tr height="40">
					...
					<td><input id="newOpeningBank" name="supplier.openingBank" size="30px" type="text" class="validate[required] text-input" /> <span style="color: red;">*</span></td>
					<th align="right">银行帐号:&nbsp;</th>
					<td><input id="newBankAccount" name="supplier.bankAccount" size="30px" type="text" class="validate[required] text-input" /> <span style="color: red;">*</span></td>
				</tr>
				<tr height="40">
					<th align="right">联系人:&nbsp;</th>
					<td><input id="newContacts" name="supplier.contacts" size="30px" type="text" class="validate[required] text-input" /> <span style="color: red;">*</span></td>
					<th align="right">联系电话:&nbsp;</th>
					<td><input id="newTelephone" name="supplier.telephone" size="30px" type="text" class="validate[required] text-input" /> <span style="color: red;">*</span></td>
				</tr>
				<tr height="40">
					<th align="right">传真:&nbsp;</th>
					<td><input id="newPortraiture" name="supplier.portraiture" size="30px" type="text" class="validate[required] text-input" /> <span style="color: red;">*</span></td>
					<th align="right">邮件:&nbsp;</th>
					<td><input id="newEmail" name="supplier.email" size="30px" type="text" class="validate[required] text-input" /> <span style="color: red;">*</span></td>
				</tr>
				<tr height="40">
					<th align="right">地址:&nbsp;</th>
					<td colspan="3"><textarea id="newDeliveryAddress" rows="2" style="width: 500px" class="validate[required] text-input"></textarea> <span style="color: red;">*</span></td>
				</tr>
			</table>
		</div>
	</form>
