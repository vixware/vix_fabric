...
function deleteEntity(id){
	asyncbox.confirm('确定要删除么?','<s:text name='合同收款'/>',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="170" style="cursor: pointer;" onclick="orderBy('amount');"><s:text name="收款金额" />&nbsp;<img id="brandImg_amount" src="${vix}/common/img/arrow.gif"></th>
			<th width="170" style="cursor: pointer;" onclick="orderBy('aprPerson');"><s:text name="收款人" />&nbsp;<img id="brandImg_aprPerson" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('paymentPeople');"><s:text name="收款时间" />&nbsp;<img id="brandImg_paymentPeople" src="${vix}/common/img/arrow.gif"></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.aprPerson}</a></td>
					<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.aprTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" /></a></td>
