		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td id="isPublish_${entity.id}"><s:if test="%{#entity.isPublish == 1}">
						...
						<span style="color: green;">待审批</span>
					</s:elseif></td>
				<td>
					<div class="untitled" style="position: static; display: inline;">
						...
						<s:if test="%{#entity.isPublish==0 }">
							<a href="#" id="ip_link_${entity.id}" onclick="updateIsPublish('${entity.id}',${entity.isPublish})"> <span id="entity_${entity.id}" style="color: red;">通过</span>
							</a>
						</s:if>
						<s:elseif test="%{#entity.isPublish==1 }">
							<a href="#" id="ip_link_${entity.id}" onclick="updateIsPublish('${entity.id}',${entity.isPublish})"> <span id="entity_${entity.id}" style="color: green;">取消</span>
							</a>
						</s:elseif>
					</div>
				</td>
