				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						<s:if test="%{#entity.contractType==1 }">
							<a href="#" onclick="saveOrUpdate1('${entity.id}',${entity.contractType},${pager.pageNo});"> <span>查看修改</span>
							</a>
						</s:if>
						<s:elseif test="%{#entity.contractType==2 }">
							<a href="#" onclick="saveOrUpdate2('${entity.id}',${entity.contractType},${pager.pageNo});"> <span>查看修改</span>
							</a>
						</s:elseif>
						<s:elseif test="%{#entity.contractType==3 }">
							<a href="#" onclick="saveOrUpdate3('${entity.id}',${entity.contractType},${pager.pageNo});"> <span>查看修改</span>
							</a>
						</s:elseif>
						<s:elseif test="%{#entity.contractType==4 }">
							<a href="#" onclick="saveOrUpdate4('${entity.id}',${entity.contractType},${pager.pageNo});"> <span>查看修改</span>
							</a>
						</s:elseif>
						<s:elseif test="%{#entity.contractType==5 }">
							<a href="#" onclick="saveOrUpdate5('${entity.id}',${entity.contractType},${pager.pageNo});"> <span>查看修改</span>
							</a>
						</s:elseif>
