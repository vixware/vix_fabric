	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/contract/contractApprovalAction!goList.action?pageNo=${pageNo}');"><s:text name="查看采购框架协议" /> </a></li>
			</ul>
		</div>
	</h2>
</div>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong><b><s:text name="查看采购框架协议" /> </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
