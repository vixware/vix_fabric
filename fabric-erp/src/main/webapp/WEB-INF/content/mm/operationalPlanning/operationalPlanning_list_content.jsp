	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">20130523</span></td>
				<td><span style="color: gray;">齿轮</span></td>
				<td><span style="color: gray;">箱</span></td>
				<td><span style="color: gray;">吨</span></td>
				<td><span style="color: gray;">10</span></td>
				<td><span style="color: gray;">2013-06-23</span></td>
				<td>
