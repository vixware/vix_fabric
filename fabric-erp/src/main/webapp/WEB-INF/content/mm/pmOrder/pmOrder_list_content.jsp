	...
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');" width="10%">
			 ...
			 -->
			<th>${vv:varView("vix_mdm_item")}编码</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">itemCode_20130523</span></td>
				<td><span style="color: gray;">自行车</span></td>
				<td><span style="color: gray;">V1.2.4</span></td>
				<td><span style="color: gray;">车间A</span></td>
				<td><span style="color: gray;">辆</span></td>
				<td><span style="color: gray;">3000</span></td>
				<td><span style="color: gray;">2013-06-08</span></td>
				<td><span style="color: gray;">2013-06-08</span></td>
				<td><span style="color: gray;">2013-06-08</span></td>
				<td><span style="color: gray;">2013-06-08</span></td>
				<td>
