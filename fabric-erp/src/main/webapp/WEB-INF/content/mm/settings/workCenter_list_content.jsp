	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.departments}</span></td>
				<td><span style="color: gray;">${entity.position}</span></td>
				<td><span style="color: gray;">${entity.types}</span></td>
				<td><span style="color: gray;">${entity.establishmentUser}</span></td>
				<td>
