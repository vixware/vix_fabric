...
<!-- 
	...
	$('#dgdA1').datagrid({
		title:'工程${vv:varView("vix_mdm_item")}清单维护明细',
		iconCls:'icon-save',
		width:"auto",
		height:550,
		nowrap: true,
		...
		frozenColumns:[[
			...
			{field:'itemName',title:'${vv:varView("vix_mdm_item")}编码 ',width:200,
		...
		columns:[[
			{field:'specification',title:'${vv:varView("vix_mdm_item")}名称',width:100,
				formatter:function(value,rec){
					return '<span>类型1</span>';
				}
			},
			{field:'itemType',title:'${vv:varView("vix_mdm_item")}规格 ',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			},
			{field:'itemType2',title:'变更类别',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			},
			{field:'itemType3',title:'类别',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			},
			{field:'itemType4',title:'是否新版本',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">工程变更</a></li>
				<a href="#" onclick="loadContent('${vix}/mm/engineeringplayMaintenanceAction!goList.action');">工程${vv:varView("vix_mdm_item")}清单维护</a>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt>
					<span class="no_line"> <a onclick="saveOrUpdateCustomer();" href="#"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消"
						...
						</div> <a href="#"><img width="22" height="22" alt="导出" src="${vix}/common/img/dt_export.png"></a> <a href="#" onclick="loadContent('${vix}/mm/engineeringplayMaintenanceAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong> <b>新增工程${vv:varView("vix_mdm_item")}清单维护</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
							...
							<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											<td align="right">变更等级：</td>
											<td><input id="pinYin" name="BO_SPR_CMNM_pinYin" type="text" size="30" /></td>
											<td align="right">等级说明：</td>
											<td><input id="pinYin" name="BO_SPR_CMNM_pinYin" type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">变更申请人：</td>
											<td><input id="pinYin" name="BO_SPR_CMNM_pinYin" type="text" size="30" /></td>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							<li class="current"><a onclick="javascript:tab(7,1,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />工程${vv:varView("vix_mdm_item")}清单维护</a></li>
						</ul>
					</div>
