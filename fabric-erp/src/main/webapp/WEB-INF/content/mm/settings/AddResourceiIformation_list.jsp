...
<div class="right_content">
	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				<th width="50">选择</th>
				<th onclick="orderBy('resourcesCode');">资源编号</th>
				<th onclick="orderBy('resourcesName');">资源名称</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.resourcesCode}" type="radio" onclick="chkChange(this,'${entity.id}',${entity.resourcesCode},'${entity.resourcesName}')" /></td>
					<td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td>
					<td>${entity.resourcesName}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
