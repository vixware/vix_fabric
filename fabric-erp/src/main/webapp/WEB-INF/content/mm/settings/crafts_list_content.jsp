	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.craftsCode}</span></td>
				<td><span style="color: gray;">${entity.craftsName}</span></td>
				<td><span style="color: gray;">${entity.materialName}</span></td>
				<td><span style="color: gray;">${entity.types}</span></td>
				<td><span style="color: gray;">${entity.versionNumber}</span></td>
				<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.craDate}" type="both" pattern="yyyy-MM-dd" /></a></td>
				<td>
