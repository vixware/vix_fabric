	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">dep20130608</span></td>
				<td><span style="color: gray;">DOBLY清单</span></td>
				<td><span style="color: gray;">水</span></td>
				<td><span style="color: gray;">v1.2</span></td>
				<td><span style="color: gray;">正常</span></td>
				<td><span style="color: gray;">王柯淇</span></td>
				<td><span style="color: gray;">2013-12-30</span></td>
				<td>
