...
<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
	<div style="padding: 8px;">
		<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/common/json_tests/datagird_data11.json',onClickRow: onDlClickRow1">
			<thead>
				<tr>
					<th data-options="field:'code',width:100,align:'center',editor:'text'">任务单</th>
					<th data-options="field:'code1',width:100,align:'center',editor:'text'">编号</th>
					<th data-options="field:'code2',width:100,align:'center',editor:'text'">${vv:varView("vix_mdm_item")}编码</th>
					<th data-options="field:'code3',width:100,align:'center',editor:'text'">${vv:varView("vix_mdm_item")}名称</th>
					<th data-options="field:'code4',width:100,align:'center',editor:'text'">计量单位</th>
					<th data-options="field:'code5',width:100,align:'center',editor:'text'">投入量</th>
					<th data-options="field:'code6',width:100,align:'center',editor:'text'">生产任务类型</th>
					<th data-options="field:'code7',width:100,align:'center',editor:'text'">工作中心</th>
					<th data-options="field:'code8',width:100,align:'center',editor:'text'">责任部门</th>
					<th data-options="field:'code9',width:100,align:'center',editor:'text'">计划开工日期</th>
					<th data-options="field:'code99',width:100,align:'center',editor:'text'">计划完工日期</th>
				</tr>
			</thead>
		</table>
		<script type="text/javascript">
