	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.processCode}</span></td>
				<td><span style="color: gray;">${entity.processDescription}</span></td>
				<td><span style="color: gray;">${entity.orgName}</span></td>
				<td><span style="color: gray;">${entity.types}</span></td>
				<td><span style="color: gray;">${entity.samplingRate}</span></td>
				<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.creDate}" type="both" pattern="yyyy-MM-dd" /></a></td>
				<td>
					<div class="untitled" style="position: static; display: inline;">
						<span><img alt="" src="img/icon_untitled.png"></span>
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#" onclick="deleteEntity(${entity.id });"></a></i> <i><a href="#" title="<s:text name='cmn_show'/>"></a></i> <i><a href="#" onclick="saveOrUpdate(${entity.id });" title="<s:text name='cmn_update'/>"></a></i> <!-- 小i标题 --> <b></b>
							</strong>
							<!-- 小i内容 -->
							<p></p>
						</div>
