...
<div class="right_content">
	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				<th width="50">选择</th>
				<th onclick="orderBy('org');">工作中心编号</th>
				<th onclick="orderBy('orgName');">工作中心名称</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.org}" type="radio" onclick="chkChange(this,${entity.org},'${entity.orgName}')" /></td>
