...
<!-- 
	...
	$('#dgdA1').datagrid({
		...
		frozenColumns:[[
			...
			{field:'itemName',title:'工作序号 ',width:200,
		...
		columns:[[
			{field:'specification',title:'工作内容',width:100,
				formatter:function(value,rec){
					return '<span>类型1</span>';
				}
			},
			{field:'itemType',title:'工作中心',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			},
			{field:'itemType2',title:'操作人',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			},
			{field:'itemType3',title:'准备工时',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			},
			{field:'itemType4',title:'计划开工时间 ',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			},
			{field:'itemType5',title:'计划完工时间',width:100,
				formatter:function(value,rec){
					return '<span>10010</span>';
				}	
			}
...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="img/mm_cjgl.png" alt="" />生产管理</a></li>
				<li><a href="#">车间管理</a></li>
				<a href="#" onclick="loadContent('${vix}/mm/jobShopSchedulingAction!goSaveOrUpdate.action');">车间作业计划</a>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt>
					<span class="no_line"> <a onclick="saveOrUpdateCustomer();" href="#"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消"
						...
						</div> <a href="#"><img width="22" height="22" alt="导出" src="${vix}/common/img/dt_export.png"></a> <a href="#" onclick="loadContent('${vix}/mm/resourceInformationAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong> <b>新增车间作业计划</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><input id="pinYin" name="BO_SPR_CMNM_pinYin" type="text" size="30" /></td>
											<td align="right">原材料名称：</td>
											<td><input id="pinYin" name="BO_SPR_CMNM_pinYin" type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">工艺过程：</td>
											<td><input id="pinYin" name="BO_SPR_CMNM_pinYin" type="text" size="30" /></td>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							<li class="current"><a onclick="javascript:tab(7,1,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />车间作业计划</a></li>
						</ul>
					</div>
