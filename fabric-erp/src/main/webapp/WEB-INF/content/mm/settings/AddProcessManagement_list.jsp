...
<div class="right_content">
	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				<th width="50">选择</th>
				<th onclick="orderBy('processCode');">工艺路线编号</th>
				<th onclick="orderBy('processDescription');">工艺路线名称</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.processCode}" type="radio" onclick="chkChange(this,'${entity.id}',${entity.processCode},'${entity.processDescription}')" /></td>
					<td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td>
					<td>${entity.processDescription}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
