...
<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
	<div style="padding: 8px;">
		<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/common/json_tests/datagird_data11.json',onClickRow: onDlClickRow1">
			<thead>
				<tr>
					<th data-options="field:'code',width:100,align:'center',editor:'text'">阶层</th>
					<th data-options="field:'code1',width:100,align:'center',editor:'text'">序号</th>
					<th data-options="field:'code2',width:100,align:'center',editor:'text'">子项代码</th>
					<th data-options="field:'code3',width:100,align:'center',editor:'text'">品名规格</th>
					<th data-options="field:'code4',width:100,align:'center',editor:'text'">单位用量</th>
					...
					<th data-options="field:'code8',width:100,align:'center',editor:'text'">生效日期</th>
					<th data-options="field:'code9',width:100,align:'center',editor:'text'">失效日期</th>
					<th data-options="field:'code99',width:100,align:'center',editor:'text'">工艺路线</th>
					<th data-options="field:'code99',width:100,align:'center',editor:'text'">发料工序号码</th>
					<th data-options="field:'code99',width:100,align:'center',editor:'text'">状态</th>
					<th data-options="field:'code99',width:100,align:'center',editor:'text'">制造商</th>
					<th data-options="field:'code99',width:100,align:'center',editor:'text'">插件位置</th>
				</tr>
			</thead>
		</table>
		<script type="text/javascript">
