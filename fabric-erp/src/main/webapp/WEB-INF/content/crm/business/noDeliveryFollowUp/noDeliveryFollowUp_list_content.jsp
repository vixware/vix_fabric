	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s" id="invoiceId">
			...
			<tr>
				...
				<td width="20%"><input type="button" class="btn" value="关怀" onclick="saveOrUpdateExpediting(${invoiceId.id});" /> <input type="button" class="btn" value="跟进" onclick="saveOrUpdate(${invoiceId.id});" /></td>
			</tr>
		</s:iterator>
		<%
