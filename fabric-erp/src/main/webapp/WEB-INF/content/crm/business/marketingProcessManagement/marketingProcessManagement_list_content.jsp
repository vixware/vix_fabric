		...
		<tr class="alt">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" onclick="saveOrUpdate('${entity.id}',${pager.pageNo});" title="修改"><img src="${vix}/common/img/icon_edit.png" /></a><a href="#" onclick="goStart('${entity.id}');" title="<s:text name='启动'/>"><img src="${vix}/common/img/wfstart.png" /></a> <a href="#" onclick="goStop('${entity.id}');" title="<s:text name='停止'/>"><img
							src="${vix}/common/img/wfstop.png" /></a></td>
				</tr>
			</s:iterator>
			<%
