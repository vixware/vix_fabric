...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('code');">编码&nbsp;<img id="marketingAutomationProcessImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="30%"><span style="cursor: pointer;" onclick="orderBy('name');">主题&nbsp;<img id="marketingAutomationProcessImg_name" src="${vix}/common/img/arrow.gif"></span></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" onclick="saveOrUpdate('${entity.id}');" title="查看"><img src="${vix}/common/img/icon_show.gif" /></a></td>
				</tr>
			</s:iterator>
			<%
