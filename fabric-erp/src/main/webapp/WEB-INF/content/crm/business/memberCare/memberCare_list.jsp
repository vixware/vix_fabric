...
<script type="text/javascript">
	...
	function saveOrUpdate(id) {
		$.ajax({
		url : '${vix}/crm/business/memberCareAction!goSaveOrUpdate.action?id=' + id,
		cache : false,
			...
			callback : function(action) {
				if (action == 'ok') {
					if ($('#customerCareForm').validationEngine('validate')) {
						$.post('${vix}/crm/business/memberCareAction!saveOrUpdate.action', {
						...
						'customerAccount.memo' : $("#memo").val()
							...
							asyncbox.success(result, "<s:text name='vix_message'/>", function() {
								pager("start", "${vix}/crm/business/memberCareAction!goListContent.action?name=" + name, 'customerAccount');
							});
						});
					} else {
						return false;
	...
	function deleteById(id) {
		$.ajax({
		url : '${vix}/crm/business/memberCareAction!deleteById.action?id=' + id,
		cache : false,
		success : function(html) {
	...
	function orderBy(orderField) {
		...
		pager("start", "${vix}/crm/business/memberCareAction!goListContent.action?orderField=" + orderField + "&orderBy=" + orderBy, 'customerAccount');
	}

	bindSearch();
	function currentPager(tag) {
		loadName();
		pager(tag, "${vix}/crm/business/memberCareAction!goListContent.action?name=" + name, 'customerAccount');
	}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">客服管理</a></li>
				<li><a href="#" onclick="loadContent('${vix}/crm/business/memberCareAction!goList.action');">客户关怀</a></li>
			</ul>
		</div>
	</h2>
	<div class="drop">
