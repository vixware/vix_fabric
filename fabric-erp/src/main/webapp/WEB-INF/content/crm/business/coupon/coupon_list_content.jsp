...
<script type="text/javascript">
	function deleteEntity(id) {
		asyncbox.confirm('确定要删除该优惠券么?', '提示信息', function(action) {
			if (action == 'ok') {
				$.ajax({
				url : '${vix}/crm/business/couponAction!deleteCouponById.action?id=' + id,
				cache : false,
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><span style="cursor: pointer;" onclick="orderBy('name');">优惠券名称&nbsp;<img id="couponImg_name" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('amount');">优惠券面额&nbsp;<img id="couponImg_amount" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('type');">优惠券类别&nbsp;<img id="couponImg_type" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('userule');">使用限制&nbsp;<img id="couponImg_userule" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('effectiveDate');">生效日期&nbsp;<img id="couponImg_effectiveDate" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('cutOffDate');">截止日期&nbsp;<img id="couponImg_cutOffDate" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('memo');">备注&nbsp;<img id="couponImg_memo" src="${vix}/common/img/arrow.gif"></span></th>
