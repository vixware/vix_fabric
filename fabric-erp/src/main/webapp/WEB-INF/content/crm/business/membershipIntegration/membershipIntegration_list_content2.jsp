...
<input type="hidden" id="customer1TotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="customer1PageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="customer1TotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="customer1OrderField" value="${pager.orderField}" />
<input type="hidden" id="customer1OrderBy" value="${pager.orderBy}" />
<input type="hidden" id="customer1InfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="5%">
