...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('customerName');">姓名&nbsp;<img id="outBoundImg_customerName" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('mobile');">手机&nbsp;<img id="outBoundImg_mobile" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="60%"><span style="cursor: pointer;" onclick="orderBy('addr');">联系地址&nbsp;<img id="outBoundImg_addr" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('channelDistributor.name');">来源网店&nbsp;<img id="outBoundImg_channelDistributor" src="${vix}/common/img/arrow.gif"></span></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.mobile }</a></td>
					<td><a href="#" style="color: gray;">${entity.addr }</a></td>
