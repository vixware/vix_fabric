...
<div class="content" style="margin-top: 15px; margin-bottom: -10px; overflow: hidden">
	<div class="box order_table" style="line-height: normal;">
		<table class="table-padding020">
			...
			<tr height="30">
				<td><label for="datetypem"><input id="datetypem" name="datetype" type="radio" value="m" checked="checked" />按月统计：<input id="monthdate" class="int" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM'})" /></label></td>
			</tr>
			<tr height="30">
