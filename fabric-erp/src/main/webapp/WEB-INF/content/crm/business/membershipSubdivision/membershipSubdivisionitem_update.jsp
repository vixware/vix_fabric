...
<div class="content" style="margin-top: 15px; overflow: hidden">
	<form id="membershipSubdivisionDetailForm">
		<s:hidden id="membershipSubdivisionDetailId" name="membershipSubdivisionDetailId" value="%{membershipSubdivisionDetail.id}" theme="simple" />
		<div class="box order_table" style="line-height: normal;">
			<table>
				<tr height="40">
					...
					<th>值：</th>
					<td><input id="categoryValue" name="categoryValue" value="${membershipSubdivisionDetail.categoryValue }" type="text" class="validate[required] text-input"><img onclick="showTime('categoryValue','yyyy-MM-dd HH:mm:ss')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
				</tr>
			</table>
		</div>
	</form>
