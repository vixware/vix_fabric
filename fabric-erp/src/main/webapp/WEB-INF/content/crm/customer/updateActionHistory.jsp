			...
			<dl>
				...
				<dd class="clearfix">
					<div class="order_table">
						...
						<s:hidden id="customerAccountId" name="actionHistory.customerAccount.id" value="%{actionHistory.customerAccount.id}" theme="simple" />
						<table>
							<tr height="30">
								<td align="right">主题:&nbsp;</td>
								<td colspan="3"><input type="text" id="subject" name="actionHistory.subject" value="${actionHistory.subject}" /></td>
							</tr>
							<tr height="30">
