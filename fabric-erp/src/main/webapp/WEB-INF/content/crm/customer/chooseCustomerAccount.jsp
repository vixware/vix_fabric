...
function searchAccount(){
	loadName();
	pager("start","${vix}/crm/customer/crmCustomerAccountAction!goSubSingleList.action?name="+name+"&pageNo=${pageNo}",'customerAccount');
}
bindSearch();
...
function orderBy(orderField){
	...
	pager("start","${vix}/crm/customer/customerAccountrAction!goSubSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name+"&parentId="+$("#selectId").val(),'customerAccount');
}

function customerAccountPager(tag){
	loadName();
	pager(tag,"${vix}/crm/customer/crmCustomerAccountAction!goSubSingleList.action?name="+name+'&parentId='+$('#selectId').val());
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="customerAccountPager('start');"></a></span> <span><a class="previous" onclick="customerAccountPager('previous');"></a></span> <em>(<b class="customerAccountInfo"></b> <s:text name='cmn_to' /> <b class="customerAccountTotalCount"></b>)
