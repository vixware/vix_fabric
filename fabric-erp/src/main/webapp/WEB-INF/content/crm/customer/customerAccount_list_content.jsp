	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td width="15%"><span style="color: gray;">${entity.shorterName}</span></td>
				...
				<td width="80"><span style="color: gray;">${entity.customerSource.name }</span></td>
				<td width="80"><span style="color: gray;">${entity.customerStage.name }</span></td>
				<td><a href="#" onclick="saveOrUpdate('${entity.id}','${entity.type}');" title="<s:text name='cmn_update'/>"> <img src="${vix}/common/img/icon_edit.png" />
