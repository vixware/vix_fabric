...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/crm/market/printedRequisitionAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/crm/market/printedRequisitionAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/crm/market/printedRequisitionAction!goListContent.action?name="+name,'printedRequisition');
			});
		  }
	});
}
...
function orderBy(orderField){
	loadName();
	var orderBy = $("#printedRequisitionOrderBy").val();
	if(orderBy == 'desc'){
		orderBy = "asc";
	}else{
		orderBy = 'desc';
	}
	pager("start","${vix}/crm/market/printedRequisitionAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'printedRequisition');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/crm/market/printedRequisitionAction!goListContent.action?name="+name,'printedRequisition');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="printedRequisitionInfo"></b> <s:text name='cmn_to' /> <b class="printedRequisitionTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a></span> <span><a class="end" onclick="currentPager('end');"></a></span>
					</div>
				</div>
				<div id="printedRequisition" class="table"></div>
				<div class="pagelist drop">
					<ul>
