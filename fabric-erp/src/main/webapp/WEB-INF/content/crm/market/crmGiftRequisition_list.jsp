...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/crm/market/crmGiftRequisitionAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/crm/market/crmGiftRequisitionAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/crm/market/crmGiftRequisitionAction!goListContent.action?name="+name,'crmGiftRequisition');
			});
		  }
	});
}
...
function orderBy(orderField){
	loadName();
	var orderBy = $("#crmGiftRequisitionOrderBy").val();
	if(orderBy == 'desc'){
		orderBy = "asc";
	}else{
		orderBy = 'desc';
	}
	pager("start","${vix}/crm/market/crmGiftRequisitionAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'crmGiftRequisition');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/crm/market/crmGiftRequisitionAction!goListContent.action?name="+name,'crmGiftRequisition');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="crmGiftRequisitionInfo"></b> <s:text name='cmn_to' /> <b class="crmGiftRequisitionTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a></span> <span><a class="end" onclick="currentPager('end');"></a></span>
					</div>
				</div>
				<div id="crmGiftRequisition" class="table"></div>
				<div class="pagelist drop">
					<ul>
