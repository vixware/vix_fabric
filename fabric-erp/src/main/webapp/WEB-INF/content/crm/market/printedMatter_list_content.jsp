...
function deleteEntity(id){
	asyncbox.confirm('确定要删除该印刷品么?','<s:text name='vix_message'/>',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
...
loadOrderByImage("${vix}","printedMatter");
</script>
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');" width="8%">编号&nbsp;<img id="printedMatterImg_id" src="${vix}/common/img/arrow.gif">
			</th>
			<th onclick="orderBy('name');" width="15%">名称&nbsp;<img id="printedMatterImg_name" src="${vix}/common/img/arrow.gif">
			</th>
			<th onclick="orderBy('printedCount');" width="10%">印刷量&nbsp;<img id="printedMatterImg_printedCount" src="${vix}/common/img/arrow.gif">
			</th>
			<th onclick="orderBy('totalPrice');" width="10%">总价格&nbsp;<img id="printedMatterImg_totalPrice" src="${vix}/common/img/arrow.gif">
			</th>
			<th onclick="orderBy('stockNumber');" width="15%">库存数量&nbsp;<img id="printedMatterImg_stockNumber" src="${vix}/common/img/arrow.gif">
			</th>
			<th onclick="orderBy('printedMatterUnit.name');" width="15%">单位&nbsp;<img id="printedMatterImg_printedMatterUnit" src="${vix}/common/img/arrow.gif">
			</th>
			<th onclick="orderBy('memo');" width="15%">备注&nbsp;<img id="printedMatterImg_memo" src="${vix}/common/img/arrow.gif">
			</th>
			<th width="10%">操作</th>
		</tr>
		<% int count = 0; %>
