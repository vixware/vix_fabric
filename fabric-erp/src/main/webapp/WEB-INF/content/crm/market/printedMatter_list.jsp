...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/crm/market/printedMatterAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/crm/market/printedMatterAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/crm/market/printedMatterAction!goListContent.action?name="+name,'printedMatter');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/crm/market/printedMatterAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'printedMatter');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/crm/market/printedMatterAction!goListContent.action?name="+name,'printedMatter');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="printedMatterInfo"></b> <s:text name='cmn_to' /> <b class="printedMatterTotalCount"></b>)
