...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/crm/service/qualityAssuranceAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/crm/service/qualityAssuranceAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/crm/service/qualityAssuranceAction!goListContent.action?name="+name,'qualityAssurance');
			});
		  }
	});
}
...
function orderBy(orderField){
	loadName();
	var orderBy = $("#qualityAssuranceOrderBy").val();
	if(orderBy == 'desc'){
		orderBy = "asc";
	}else{
		orderBy = 'desc';
	}
	pager("start","${vix}/crm/service/qualityAssuranceAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'qualityAssurance');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/crm/service/qualityAssuranceAction!goListContent.action?name="+name,'qualityAssurance');
}
...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="${vix}/common/img/crm/faq.png" alt="" />供应链</a></li>
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="qualityAssuranceInfo"></b> <s:text name='cmn_to' /> <b class="qualityAssuranceTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a></span> <span><a class="end" onclick="currentPager('end');"></a></span>
					</div>
				</div>
				<div id="qualityAssurance" class="table"></div>
				<div class="pagelist drop">
					<ul>
