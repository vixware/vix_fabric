		...
		<div class="box order_table" style="line-height: normal;">
			<table>
				<tr height="30">
					...
					<td><input id="customerAccountName" name="customerComplaint.customerAccount.name" value="${customerComplaint.customerAccount.name}" type="text" /> <span><a class="abtn" href="###" onclick="chooseCustomerAccount();"><span>选择</span></a></span></td>
