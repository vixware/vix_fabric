...
function loadRoleName(){
	...
	roleName= Url.encode(roleName);
	roleName = encodeURI(roleName);
}

pager("start","${vix}/common/select/commonSelectRoleAction!goSingleList.action?tag=${tag}&chkStyle=${chkStyle}","role");
//排序 
function subOrderBy(orderField){
	...
	pager("start","${vix}/common/select/commonSelectRoleAction!goSingleList.action?tag=${tag}&chkStyle=${chkStyle}&orderField="+orderField+"&orderBy="+orderBy,"role");
}

function currentPager(tag){
	loadRoleName();
	pager(tag,"${vix}/common/select/commonSelectRoleAction!goSingleList.action?tag=${tag}&chkStyle=${chkStyle}&name="+roleName,'role');
}
</script>
<div class="content">
	<div class="drop" id="c_head">
		...
		<div>
			<label><s:text name="cmn_name" /><input type="text" class="int" id="roleName" value="${roleName}"></label> <label><input type="button" value="<s:text name='cmn_search'/>" class="btn" onclick="currentPager('start');" />
		</div>
