...
<table class="list">
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			<% count++; %>
			<tr>
				<td><input id="chkBrandId" name="chkBrandId" value="${entity.id}" type="${chkStyle}" <s:if test="%{checkedObjIds.contains(#entity.id+\",\")}">checked="checked"</s:if> onclick="chkChange(this,'${entity.id}','${entity.metaDataName}')" /></td>
