...
function searchForSelectEpmContent(){
	loadMetaDataName();
	pager("start","${vix}/common/select/commonSelectMetaDataAction!goChooseMetaDataList.action?tag=${tag}&chkStyle=${chkStyle}&checkedObjIds=${checkedObjIds}&metaDataName="+metaDataName,'metaDataChk');
}

loadMetaDataName();
//载入分页列表数据
pager("start","${vix}/common/select/commonSelectMetaDataAction!goChooseMetaDataList.action?tag=${tag}&chkStyle=${chkStyle}&checkedObjIds=${checkedObjIds}","metaDataChk");
...
function metaDataChkPager(tag,entity){
	...
	if(entity == 'metaDataChk'){
		pager(tag,"${vix}/common/select/commonSelectMetaDataAction!goChooseMetaDataList.action?tag=${tag}&chkStyle=${chkStyle}&checkedObjIds=${checkedObjIds}&metaDataName="+metaDataName+'&id='+$('#selectId').val(),entity);
	}
	/* if(entity == 'brand'){
...
function orderBy(orderField){
	...
	pager("start","${vix}/common/select/commonSelectMetaDataAction!goChooseMetaDataList.action?tag=${tag}&chkStyle=${chkStyle}&checkedObjIds=${checkedObjIds}&orderField="+orderField+"&orderBy="+orderBy+"&metaDataName="+metaDataName+"&id="+$("#selectId").val(),'metaDataChk');
}
		...
		<div id="left">
			...
			<script type="text/javascript">
				...
				function onClick(event, treeId, treeNode, clickFlag) {
					...
					pager("start","${vix}/common/select/commonSelectMetaDataAction!goChooseMetaDataList.action?chkStyle=${chkStyle}&checkedObjIds=${checkedObjIds}&id="+treeNode.id+"&metaDataName="+name,'metaDataChk');
				}
