...
<div style="padding: 10px;">
	...
	<script type="text/javascript">
		...
		var setting = {
			...
			async: {
				enable: true,
				url:"${vix}/common/select/commonSelectModuleAction!findIndustryModuleTreeToJson.action?checkedObjIds=${checkedObjIds}",
				autoParam:["treeId","treeType"]
			},
			callback: {
				onCheck: onCheckIndustryModule
			}
		};
		var type = $("#level").attr("checked")? "level":"all";
		setting.check.radioType = type;
		chooseDepzTree = $.fn.zTree.init($("#chooseCategoryZtree"), setting);
		function onCheckIndustryModule(e, treeId, treeNode) {
