...
<div class="right_content">
	<div class="pagelist drop">
		...
		<div>
			<span><a class="start" onclick="currentPager('start');"></a> </span> <span><a class="previous" onclick="currentPager('previous');"></a> </span> <em>(<b class="salesOrderInfo"></b>到 <b class="salesOrderTotalCount"></b>)
	...
	<div class="table">
		<table class="list">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				%>
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.id}" type="radio" onclick="chkChange(this,'${entity.id}','${entity.outerId}',${entity.totalFee})" /></td>
