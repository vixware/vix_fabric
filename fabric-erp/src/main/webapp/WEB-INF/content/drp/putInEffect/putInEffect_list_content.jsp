	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.viewership }</a></td>
				<td><a href="#" style="color: gray;">${entity.sectionPercentage }</a></td>
				<td><a href="#" style="color: gray;">${entity.audience }</a></td>
