...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="170"><s:text name="drp_serial_number" /></th>
			<th width="170"><s:text name="drp_theme" /></th>
			<th width="250"><s:text name="drp_competitor_name" /></th>
			<th><s:text name="drp_survey_type" /></th>
			<th><s:text name="drp_state" /></th>
			<th><s:text name="drp_investigators" /></th>
			<th><s:text name="drp_survey_time" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">xx食品基础信息</a></td>
				<td><a href="#" style="color: gray;">啸天犬</a></td>
				<td><a href="#" style="color: gray;">门店</a></td>
				<td><a href="#" style="color: gray;">完成</a></td>
				<td><a href="#" style="color: gray;">啸天犬</a></td>
				<td><a href="#" style="color: gray;">2013-3-1</a></td>
				<td>
