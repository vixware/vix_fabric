...
<table id="purchase_inquire_grid" class="list table" pager='<s:property value="pager.genPagerInfoJsonStr()" escape="false"/>' fillblank="1">
	<tbody>
		<tr class="alt">
			...
			<th width="260"><s:text name="drp_care_theme" /></th>
			<th width="260"><s:text name="drp_client_name" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			<tr>
				...
				<td><a href="#" style="color: gray;">xx客户关怀</a></td>
				<td><a href="#" style="color: gray;">哮天犬</a></td>
				<td><a href="#" style="color: gray;">一级客户</a></td>
				<td><a href="#" style="color: gray;">正常</a></td>
				<td><a href="#" style="color: gray;">3013-3-6</a></td>
				<td>
