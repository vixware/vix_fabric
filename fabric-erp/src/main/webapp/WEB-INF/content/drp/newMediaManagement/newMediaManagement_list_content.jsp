	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.mediaName }</a></td>
				<td><a href="#" style="color: gray;">${entity.programName }</a></td>
				<td><a href="#" style="color: gray;">${entity.percentageCoverage }</a></td>
				<td><a href="#" style="color: gray;">${entity.programSectionPercentage }</a></td>
