...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="drp_product_name" /></th>
			<th><s:text name="drp_order_sum" /></th>
			<th><s:text name="drp_sum_status" /></th>
			<th><s:text name="drp_shipping_address" /></th>
			<th><s:text name="drp_delivery_time" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">xx热水器</a></td>
				<td><a href="#" style="color: gray;">3千</a></td>
				<td><a href="#" style="color: gray;">已支付</a></td>
				<td><a href="#" style="color: gray;">北京市朝阳区</a></td>
				<td><a href="#" style="color: gray;">2013年1月2日</a></td>
				<td><a href="#" style="color: gray;">已发货</a></td>
