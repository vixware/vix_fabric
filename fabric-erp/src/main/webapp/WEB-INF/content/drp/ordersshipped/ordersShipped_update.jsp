	...
	function saveOrUpdatePlan (){
		...
		if ($ ('#purchasePlanForm').validationEngine ('validate')){
			...
			'piJson' : piJson
				...
				showMessage (result);
				setTimeout ("" , 1000);
				loadContent ('${vix}/drp/storeSalesrecordAction!goList.action?menuId=menuOrder');
			});
		}
	}
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateOrder()" href="#"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <a href="#"><img width="22" height="22" title="保存并提交审批"
							src="${vix}/common/img/dt_submit.png" /></a> <a href="#" onclick="loadContent('${vix}/drp/storeSalesrecordAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a></span> <strong><b>销售信息 </b></strong>
				</dt>
				<dd class="clearfix">
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					...
					<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
						<div style="padding: 8px;">
							<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/drp/storeSalesrecordAction!getPurchasePlanItemsJson.action?id=${purchasePlan.id}',onClickRow: onDlClickRow1">
								<thead>
									<tr>
					...
					<div id="a2" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
						<script type="text/javascript">
							$ ('#soAttach')
									.datagrid ({
									url : '${vix}/drp/storeSalesrecordAction!getAttachmentsJson.action?id=${purchasePlan.id}' ,
									width : 900 ,
									height : '450' ,
									fitColumns : true ,
									columns : [
									...
									handler : function (){
										...
										$
												.ajax ({
												url : '${vix}/drp/storeSalesrecordAction!addAttachments.action' ,
												cache : false ,
												success : function (html){
													asyncbox
															...
															callback : function (action , returnValue){
																if (action == 'ok'){
																	uploadFile ('${vix}/drp/storeSalesrecordAction!uploadAttachments.action?id=${purchasePlan.id}' , 'fileToUpload');
									...
									handler : function (){
										...
										for ( var i = 0;i < rows.length;i ++ ){
											...
											$.ajax ({
											url : '${vix}/drp/storeSalesrecordAction!deleteAttachments.action?afId=' + rows [ i ].id ,
											cache : false
											});
										}
									}
