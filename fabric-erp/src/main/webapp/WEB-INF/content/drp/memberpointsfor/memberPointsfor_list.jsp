...
function goSearch() {
	$.ajax({
	url : '${vix}/drp/memberPointsforAction!goSearch.action',
	cache : false,
	success : function(html) {
		asyncbox.open({
		modal : true,
		...
		callback : function(action) {
			if (action == 'ok') {
				loadcode();
				loadselectname();
				pager("start", "${vix}/drp/memberPointsforAction!goSingleList.action?code=" + code + "&name=" + selectname, 'category');
			}
		},
		btnsbar : $.btn.OKCANCEL
		});
...
<div class="sub_menu">
	...
	<div class="drop">
		<p>
			<a href="#" onclick="saveOrUpdate(0);"><span><s:text name='drp_exchange' /> </span> </a>
		</p>
	</div>
</div>
