...
<script type="text/javascript">
	...
	function saveOrUpdateChannelDistributor() {
		if ($('#channelDistributorForm').validationEngine('validate')) {
			$.post('${vix}/drp/distributionSystemRelationShipAction!saveOrUpdate.action', {
			...
			'channelDistributor.isHasParentChannelDistributor' : $("#isHasParentChannelDistributor").val(),
			...
			'channelDistributor.memo': memo.html()
				...
				showMessage(result);
				setTimeout("", 1000);
				loadContent('${vix}/drp/distributionSystemRelationShipAction!goList.action');
			});
		} else {
			return false;
		}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">设置 </a></li>
				<li><a href="#" onclick="loadContent('${vix}/drp/distributionSystemRelationShipAction!goList.action');">分销体系管理 </a></li>
			</ul>
		</div>
	</h2>
</div>
<input type="hidden" id="id" name="id" value="${channelDistributor.id}" />
<input type="hidden" id="organizationId" name="organizationId" value="${channelDistributor.organization.id}" />
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateChannelDistributor()" href="#"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#" onclick="loadContent('${vix}/drp/distributionSystemRelationShipAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回"
							src="${vix}/common/img/dt_goback.png"></a></span> <strong><b>新增 </b></strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><input id="telephone" name="telephone" value="${channelDistributor.telephone }" type="text" size="45" onchange="fieldChanged(this);" class="validate[custom[phone]] text-input" /><span style="color: red;">*</span></td>
											<td align="right">邮箱：</td>
											<td><input id="email" name="email" value="${channelDistributor.email }" type="text" size="45" onchange="fieldChanged(this);" class="validate[custom[email]] text-input" /><span style="color: red;">*</span></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input id="region" name="region" value="${channelDistributor.region }" type="text" size="45" onchange="fieldChanged(this);" class="validate[required] text-input" /><span style="color: red;">*</span></td>
											<td align="right">地址：</td>
											<td><input id="address" name="address" value="${channelDistributor.address }" type="text" size="45" onchange="fieldChanged(this);" class="validate[required] text-input" /><span style="color: red;">*</span></td>
										</tr>
										<tr>
								...
								<dd style="display: block;">
									<table style="border: none;">
										<tr>
											...
											<td width="35%"><input id="openingBank" name="openingBank" value="${channelDistributor.openingBank }" type="text" size="45" /></td>
											<td width="15%" align="right">银行帐号：</td>
											<td width="35%"><input id="bankAccount" name="bankAccount" value="${channelDistributor.bankAccount }" type="text" size="45" onchange="fieldChanged(this);" /></td>
										</tr>
										<tr>
											<td align="right">币种：</td>
											<td><s:select id="currencyTypeId" headerKey="-1" headerValue="--请选择--" list="%{currencyTypeList}" listValue="name" listKey="id" value="" multiple="false" theme="simple" onchange="fieldChanged(this);" class="validate[required] text-input"></s:select> <span style="color: red;">*</span></td>
											<td align="right">注册资金：</td>
											<td><input id="registeredCapital" name="registeredCapital" value="${channelDistributor.registeredCapital }" type="text" size="45" onchange="fieldChanged(this);" class="validate[required,custom[number]] text-input" /><span style="color: red;">*</span></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><select id="level" name="level" onchange="fieldChanged(this);" class="validate[required] text-input">
													<option value="">请选择</option>
										...
										<tr>
											...
											<td><select id="status" name="status" onchange="fieldChanged(this);" class="validate[required] text-input">
													<option value="">请选择</option>
