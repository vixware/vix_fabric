...
<script type="text/javascript">
    ...
    pager("start", "${vix}/drp/storeSalesrecordAction!goInventoryCurrentStockList.action?1=1", "inventoryCurrentStock");
    function currentPager(tag) {
	    pager(tag, "${vix}/drp/storeSalesrecordAction!goInventoryCurrentStockList.action", "inventoryCurrentStock");
    }
    ...
    function searchForContent(i) {
	    loadCode();
	    pager("start", "${vix}/drp/storeSalesrecordAction!goInventoryCurrentStockList.action?searchContent=" + code, 'inventoryCurrentStock');
    }
    /*重置搜索*/
    ...
    function srmStatus(status) {
	    pager("start", "${vix}/drp/storeSalesrecordAction!goInventoryCurrentStockList.action?status=" + status, 'inventoryCurrentStock');
    }
    //最近使用
    function srmRecent(rencentDate) {
	    pager("start", "${vix}/drp/storeSalesrecordAction!goInventoryCurrentStockList.action?updateTime=" + rencentDate, 'inventoryCurrentStock');
    }
</script>
