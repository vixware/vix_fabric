	...
	<div class="table">
		<table class="list">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				%>
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.id}" type="radio" onclick="chkChange(this,'${entity.inventoryCurrentStock.itemcode}','${entity.inventoryCurrentStock.itemname}','${entity.id}',${entity.redeemPoints},'${entity.inventoryCurrentStock.unit}',${entity.inventoryCurrentStock.price})" /></td>
					<td>${entity.inventoryCurrentStock.itemcode}</td>
					<td>${entity.inventoryCurrentStock.itemname}</td>
				</tr>
			</s:iterator>
			<%
