...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/drp/salesStorageAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/drp/salesStorageAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/drp/salesStorageAction!goSingleList.action?name="+name,'stockRecords');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/drp/salesStorageAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'stockRecords');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/drp/salesStorageAction!goSingleList.action?name="+name,'stockRecords');
}
