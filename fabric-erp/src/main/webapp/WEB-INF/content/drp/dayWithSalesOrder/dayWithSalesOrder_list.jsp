...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/drp/dayWithSalesOrderAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/drp/dayWithSalesOrderAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/drp/dayWithSalesOrderAction!goSingleList.action?name="+name,'salesOrder');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/drp/dayWithSalesOrderAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'salesOrder');
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/drp/dayWithSalesOrderAction!goSingleList.action?name="+name,'salesOrder');
}
