...
<script type="text/javascript">
	...
	pager("start", "${vix}/drp/rebatesManagementAction!goRefundRuleList.action?temp=1", "refundRule");
	var code = "";
	function loadCode() {
		code = $('#srm_code').val();
	...
	function searchForContent(i) {
		loadCode();
		pager("start", "${vix}/drp/rebatesManagementAction!goRefundRuleList.action?searchContent=" + code, 'refundRule');
	}
	/*重置搜索*/
...
<div class="content" style="background: #DCE7F1">
	<div id="c_head" class="drop">
		...
		<div>
			<label>规则编码:<input id="srm_code" name="" type="text" class="int" />
