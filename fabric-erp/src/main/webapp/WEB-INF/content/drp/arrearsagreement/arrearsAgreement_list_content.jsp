...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="drp_contract_orders" /></th>
			<th><s:text name="drp_order_sum" /></th>
			<th><s:text name="drp_amount_owed" /></th>
			<th><s:text name="drp_arrears_agreement" /></th>
			<th><s:text name="drp_legal" /></th>
			<th><s:text name="drp_whethes_signature" /></th>
			<th><s:text name="drp_repayment_dates" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">xx合同</a></td>
				<td><a href="#" style="color: gray;">20万</a></td>
				<td><a href="#" style="color: gray;">15万</a></td>
				<td><a href="#" style="color: gray;">xx协议</a></td>
				<td><a href="#" style="color: gray;">二郎神</a></td>
				<td><a href="#" style="color: gray;">已签字</a></td>
				<td><a href="#" style="color: gray;">2013-1-2</a></td>
