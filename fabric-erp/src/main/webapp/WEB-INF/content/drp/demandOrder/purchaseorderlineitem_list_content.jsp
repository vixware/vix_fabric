...
<table id="itemTable" class="list">
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity">
			...
			%>
			<tr>
				<td style="cursor: pointer;" onclick="chooseItemForPrice('${entity.id}','${entity.code}','${entity.name}','${entity.measureUnit.name}')">${entity.code}</td>
				<td style="cursor: pointer;" onclick="chooseItemForPrice('${entity.id}','${entity.code}','${entity.name}','${entity.measureUnit.name}')">${entity.name}</td>
				<td style="cursor: pointer;" onclick="chooseItemForPrice('${entity.id}','${entity.code}','${entity.name}','${entity.measureUnit.name}')">${entity.price}</td>
			</tr>
		</s:iterator>
		<%
