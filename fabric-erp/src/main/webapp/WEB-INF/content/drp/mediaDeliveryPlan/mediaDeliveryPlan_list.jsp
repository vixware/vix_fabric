...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/drp/mediaDeliveryPlanAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function searchForRightContent(){
	loadName();
	pager("start","${vix}/drp/mediaDeliveryPlanAction!goSingleList.action?name="+name,'mediaPlan');
}
...
function loadRoot(){
	$('#name').val("");
	$('#selectId').val("");
	pager("start","${vix}/drp/mediaDeliveryPlanAction!goSingleList.action?name=",'mediaPlan');
}
//排序 
function orderBy(orderField){
	...
	pager("start","${vix}/drp/mediaDeliveryPlanAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name+"&parentId="+$("#selectId").val(),'mediaPlan');
}
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/drp/mediaDeliveryPlanAction!goSingleList.action?name="+name,'mediaPlan');
}
</script>
<div class="sub_menu">
	<h2>
...
<div class="content">
	...
	<div id="number">
		...
		<ul id="numBox" class="numBox">
			<s:iterator value="mediaPlanList" var="c">
		...
		<div id="right">
			<div class="right_content" id="a1">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a> </span> <span><a class="previous" onclick="currentPager('previous');"></a> </span> <em>(<b class="mediaPlanInfo"></b> <s:text name='cmn_to' /> <b class="mediaPlanTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a> </span> <span><a class="end" onclick="currentPager('end');"></a> </span>
					</div>
				</div>
				<div id="mediaPlan" class="table"></div>
				<div class="pagelist drop">
					<ul>
