...
<script type="text/javascript">
	...
	function deleteEntity(id) {
		asyncbox.confirm('确定要删除该数据么?', '提示信息', function(action) {
			if (action == 'ok') {
				$.ajax({
				url : '${vix}/drp/customerFeedbackmanagementAction!deleteById.action?id=' + id,
				cache : false,
				success : function(html) {
					showMessage(html);
					setTimeout("", 1000);
					pager("start", "${vix}/drp/customerFeedbackmanagementAction!goSingleList.action", 'customerFeedback');
				}
				});
			}
		});
	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.feedbackTime}</a></td>
				<td><a href="#" style="color: gray;">${entity.processPerson}</a></td>
				<td><a href="#" style="color: gray;">${entity.processResult}</a></td>
				<td><a href="#" style="color: gray;">${entity.processTime}</a></td>
				<td>
