...
<script type="text/javascript">
	...
	function deleteEntity(id) {
		asyncbox.confirm('确定要删除该数据么?', '提示信息', function(action) {
			if (action == 'ok') {
				$.ajax({
				url : '${vix}/drp/marketInformationManagementAction!deleteById.action?id=' + id,
				cache : false,
				success : function(html) {
					showMessage(html);
					setTimeout("", 1000);
					pager("start", "${vix}/drp/marketInformationManagementAction!goSingleList.action", 'brand');
				}
				});
			}
		});
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_name" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			...
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_telephone" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_fax" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_mailbox" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_address1" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
