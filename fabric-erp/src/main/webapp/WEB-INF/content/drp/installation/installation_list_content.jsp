	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;"><s:date format="yyyy-MM-dd hh:mm:ss" name="%{#entity.installdate}" /></a></td>
				<td><a href="#" style="color: gray;">${entity.workingHours }</a></td>
				<td><a href="#" style="color: gray;">${entity.transactor }</a></td>
				<td><a href="#" style="color: gray;">${entity.installCost }</a></td>
				<td>
