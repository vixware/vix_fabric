...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_serial_number" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_theme" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_type" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_state" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_department" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_person_in_charge" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('code');"><s:text name="drp_activity_time" />&nbsp;<img id="brandImg_code" src="${vix}/common/img/arrow.gif"></span></th>
