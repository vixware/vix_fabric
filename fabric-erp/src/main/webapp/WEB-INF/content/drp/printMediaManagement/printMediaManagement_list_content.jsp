	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.mediaColumn }</a></td>
				<td><a href="#" style="color: gray;">${entity.section }</a></td>
				<td><a href="#" style="color: gray;">${entity.price }</a></td>
				<td><a href="#" style="color: gray;">${entity.introductions }</a></td>
				<td><a href="#" style="color: gray;">${entity.contactPerson }</a></td>
