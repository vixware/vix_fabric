...
<script type="text/javascript">
	...
	function saveOrUpdatePlan() {
		...
		if ($('#purchasePlanForm').validationEngine('validate')) {
			$.post('${vix}/drp/salesProductionPlanningAction!saveOrUpdate.action', {
			...
			'piJson' : piJson
				...
				showMessage(result);
				setTimeout("", 1000);
				loadContent('${vix}/drp/salesProductionPlanningAction!goList.action?menuId=menuOrder');
			});
		}
	}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/drp/salesProductionPlanningAction!goList.action');">日配销售生产计划单 </a></li>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateOrder()" href="#"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <a href="#"><img width="22" height="22" title="保存并提交审批"
							src="${vix}/common/img/dt_submit.png" /></a> <a href="#" onclick="loadContent('${vix}/drp/salesProductionPlanningAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a></span> <strong><b>生产计划单</b></strong>
				</dt>
				<dd class="clearfix">
