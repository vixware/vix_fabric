...
function saleOrderStatus(status) {
	pager("start", "${vix}/drp/storesTextDemandAction!goSingleList.action?status=" + status, 'channelDistributor');
}
/* 最近使用 */
function leastRecentlyUsed(days) {
	pager("start", "${vix}/drp/storesTextDemandAction!goSingleList.action?days=" + days, 'channelDistributor');
}
</script>
<div class="sub_menu">
	<h2>
