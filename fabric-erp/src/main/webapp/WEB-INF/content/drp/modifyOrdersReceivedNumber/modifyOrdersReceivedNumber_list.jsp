...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/drp/modifyOrdersReceivedNumberAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/drp/modifyOrdersReceivedNumberAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/drp/modifyOrdersReceivedNumberAction!goSingleList.action?name="+name,'brand');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/drp/modifyOrdersReceivedNumberAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'brand');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/drp/modifyOrdersReceivedNumberAction!goSingleList.action?name="+name,'brand');
}
