	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.tvProgram }</a></td>
				<td><a href="#" style="color: gray;">${entity.channelName }</a></td>
				<td><a href="#" style="color: gray;">${entity.percentageCoverage }</a></td>
				<td><a href="#" style="color: gray;">${entity.columnName }</a></td>
				<td><a href="#" style="color: gray;">${entity.ratingsSectionPercentage }</a></td>
				<td><a href="#" style="color: gray;">${entity.targetAudienceRate }</a></td>
				<td><a href="#" style="color: gray;">${entity.advertisingTime }</a></td>
				<td><a href="#" style="color: gray;">${entity.advertisingPrice }</a></td>
				<td>
