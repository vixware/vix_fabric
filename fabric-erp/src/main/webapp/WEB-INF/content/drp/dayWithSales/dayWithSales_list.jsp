...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/drp/dayWithSalesAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/drp/dayWithSalesAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/drp/dayWithSalesAction!goSingleList.action?name="+name,'stockRecords');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/drp/dayWithSalesAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'stockRecords');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/drp/dayWithSalesAction!goSingleList.action?name="+name,'stockRecords');
}
