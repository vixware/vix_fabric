...
<script type="text/javascript">
	function saveOrUpdateChannelDistributor (){
		if ($ ('#channelDistributorForm').validationEngine ('validate')){
			$.post ('${vix}/drp/sparePartsAction!saveOrUpdate.action' , {
			...
			'channelDistributor.accessory' : $ ("#accessory").val ()
				...
				showMessage (result);
				setTimeout ("" , 1000);
				loadContent ('${vix}/drp/sparePartsAction!goList.action');
			});
		}else{
			return false;
		}
	...
	function chooseParentOrganization (){
		$.ajax ({
		url : '${vix}/drp/sparePartsAction!goChooseOrganization.action' ,
		cache : false ,
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/drp/sparePartsAction!goList.action');">配件管理 </a></li>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateChannelDistributor()" href="#"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <a href="#"><img width="22" height="22" title="保存并提交审批"
							src="${vix}/common/img/dt_submit.png" /></a> <a href="#" onclick="loadContent('${vix}/drp/sparePartsAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a></span> <strong><b>新增</b></strong>
				</dt>
				<dd class="clearfix">
