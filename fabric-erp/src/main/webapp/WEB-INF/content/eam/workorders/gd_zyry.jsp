...
function gd_chooseTreeNode(){
	...
	asyncbox.open({  
	    ...
	    width:800,
	    height:400,
	    url: "${vix}/eam/workOrdersAction!gdChooseRY.action",  
	...
	<div id="right">
		<div id="newtab1">
			<div class="top_tool_btn">
				<label style="margin-left: 30px;"> <input name="" type="button" onclick="javascript:return gd_chooseTreeNode();" class="btn" value="选择人员" /> &nbsp;&nbsp;
				</label>
			</div>
			<table class="select_list_tab list borderlist">
				...
				<!-- 
				  <tr>
				  	...
				  	<td align="center">12313213123</td>
