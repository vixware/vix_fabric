...
function saveOrUpdate(id){
	var title = '新增设备';
	var url = '${vix}/eam/accountManageAction!goSaveOrUpdate.action';
	if(id>0){
		title = '设备信息';
		if(id>0)
			url += '?id='+id;
...
<div class="content">
	<div id="c_head" class=" drop">
		...
		<div search_page_id="tab_home" class="grid_search search_simple">
			<label><input type="text" name="eqName" class="int more" placeholder="设备名称" id="nameS"></label> <strong id="lb_search_advanced"><s:text name='cmn_advance_search' /></strong>
		</div>
		<div class="grid_search search_advanced">
			<label> 设备编号 <input name="eqCode" type="text" class="int" />
			</label> <label> 制造商 <input name="madeName" type="text" class="int" />
			</label> <label> 供应商 <input name="supplyName" type="text" class="int" />
		...
		<div id="left" class="ui-resizable" style="height: 500px;">
			...
			<div class="left_content" style="height: 500px;">
				<div style="padding-left: 4px;">
					<img src="${vix}/common/img/file.png" style="padding-right: 5px;" /> <a href="javascript:void(0);" onclick="_tabLocateUrl('${vix}/eam/accountManageAction!goListContent.action','tab_home')"><s:text name='cmn_rootDirectory' /></a>
				</div>
...
<!--
				...
				function onClick(event, treeId, treeNode, clickFlag) {
					...
					_tabLocateUrl("${vix}/eam/accountManageAction!goListContent.action?parentEqCode="+treeNode.eqCode,'tab_home');
				}
		...
		<div id="right">
			<div id="tab_content" class="tabbable addable_tab">
				<ul id="myTab" class="right_menu nav nav-tabs">
					<li pageId="tab_home" class="current"><a href="#tab_home" page="${vix}/eam/accountManageAction!goListContent.action"> <img src="img/mail.png" alt="" /> <s:text name='eam_accountmanagement' />
					</a></li>
				</ul>
