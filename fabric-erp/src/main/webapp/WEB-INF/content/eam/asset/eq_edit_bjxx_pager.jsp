...
<!-- 列表区  -->
<table id="eq_bjxx_grid_table" class="list table" pager='<s:property value="pager.genPagerInfoJsonStr()" escape="false"/>'>
	<thead>
		<tr class="alt">
			<!-- 
			<th width="50">
				<div class="list_check">
					<div class="drop">
						<label><input type="checkbox" class="grid_check_all">
						</label>
						<ul>
							<li><a href="#">所有</a></li>
							<li><a href="#">其他</a></li>
 ...
 -->
	...
	<tbody>
		<s:iterator value="pager.resultList" var="entity" status="s">
			<tr>
				<!-- 
				<td><input value="${entity.id}" type="checkbox" class="grid_check" />
				</td>
 -->
				<td>
				...
				<td><span style="color: gray;">${entity.partCode}</span></td>
				<td><span style="color: gray;">${entity.partName}</span></td>
				<td><span style="color: gray;">${entity.specType}</span></td>
				<td><span style="color: gray;">${entity.depotCode}</span></td>
				<td><span style="color: gray;">${entity.placeCode}</span></td>
