	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">备件名称</span></td>
				<td><a href="###" style="color: gray; text-decoration: underline;">所属设备</a></td>
				<td><span style="color: gray;">备件数量</span></td>
				<td><span style="color: gray;">备件说明</span></td>
