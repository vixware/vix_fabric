	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">提交人</span></td>
				<td><span style="color: gray;">故障时间</span></td>
				<td><span style="color: gray;">故障描述</span></td>
				<td><span style="color: gray;">处理状态</span></td>
				<td style="padding-top: 2px;"><a href="javascript:void(0);" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='cmn_update'/>"> 审批 </a></td>
			</tr>
		</s:iterator>
		<%
