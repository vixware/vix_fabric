	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">code_20130607</span></td>
				<td><span style="color: gray;">关于采购4.0寸手机外壳的抽取</span></td>
				<td><span style="color: gray;">单一</span></td>
				<td><span style="color: gray;">类型A</span></td>
				<td><span style="color: gray;">一般</span></td>
				<td><span style="color: gray;">2013-05-15</span></td>
				<td>
