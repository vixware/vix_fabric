	...
	<div class="npcontent clearfix">
		...
		<div class="atable">
			<div class="task_list">
				...
				<table width="100%" class="newtab">
					<tr>
						<th style="text-align: center">所有联系人</th>
					</tr>
					<tr>
						<td class="np_border">
							<table width="100%">
								<tr>
									<s:iterator value="customerAccount.contactPersons" var="cp">
										<td style="text-align: center;" align="center">
											<p align="center">
												<img border="0" src="img/n2.png"><br> <a href="javascript:;">${cp.personName}</a><br> <b>${cp.mobile}</b><img border="0" align="Baseline" src="img/sphone.png"><br>
										</td>
									</s:iterator>
								</tr>
							</table>
