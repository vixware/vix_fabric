		...
		<div class="box order_table" style="line-height: normal;">
			<table class="table-padding020">
				...
				<tr height="30">
					...
					<td><input id="birthday" name="contactPerson.birthday" value="${contactPerson.birthdayStr}" type="text" onfocus="showTime('birthday','yyyy-MM-dd')" class="validate[custom[date]] text-input" /> <img onclick="showTime('birthday','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
				</tr>
				<tr height="30">
