...
function loadGiftDetail(){
	$.ajax({
		  url:'${vix}/mdm/item/purchasePriceConditionGiftAction!goListContent.action?type=pcpa&pcaId='+$("#pcpaId").val(),
		  cache: false,
...
function saveOrUpdatePriceConditionGiftDetail(id){
	$.ajax({
		  url:'${vix}/mdm/item/purchasePriceConditionGiftAction!goSaveOrUpdate.action?type=pcpa&id='+id+"&pcaId="+$("#pcpaId").val(),
		  cache: false,
		  success: function(html){
			  asyncbox.open({
				 	modal:true,
		...
		<div class="box order_table" style="line-height: normal;">
			<table>
				...
				<tr height="30">
					...
					<td name="regionalTd"><s:select id="regionalId" list="%{regionalList}" headerKey="-1" headerValue="----无----" listValue="name" listKey="id" value="%{priceConditionPriceArea.regional.id}" multiple="false" theme="simple"></s:select></td>
				</tr>
