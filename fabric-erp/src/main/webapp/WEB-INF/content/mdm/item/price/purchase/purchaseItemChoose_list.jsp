...
function searchForRightContent(){
	loadName();
	pager("start","${vix}/mdm/item/purchaseItemPriceAction!goListContent.action?type=choose&name="+name+"&categoryId="+$("#selectId").val(),'itemPriceManage');
}
loadName();
//载入分页列表数据
pager("start","${vix}/mdm/item/purchaseItemPriceAction!goListContent.action?type=choose&name="+name,'itemPriceManage');
bindSwitch();
bindSearch();
$.returnValue = "";
var itemId = "";
...
function currentPagerForItemChoose(tag){
	loadName();
	pager(tag,"${vix}/mdm/item/purchaseItemPriceAction!goListContent.action?type=choose&name="+name,'itemPriceManage');
}
</script>
<div class="content">
