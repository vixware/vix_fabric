...
function searchForRightContent(){
	loadName();
	pager("start","${vix}/mdm/item/itemAction!goChooseListContent.action?name="+name+"&categoryId="+$("#selectId").val(),'itemForChoose');
}
loadName();
//载入分页列表数据
pager("start","${vix}/mdm/item/itemAction!goChooseListContent.action?name="+name,'itemForChoose');
bindSwitch();
bindSearch();
$.returnValue = "";
var itemId = "";
...
function currentPagerForItemChoose(tag){
	loadName();
	pager(tag,"${vix}/mdm/item/itemAction!goChooseListContent.action?name="+name,'itemForChoose');
}
</script>
<div class="content">
