...
function loadGiftDetail(){
	$.ajax({
		  url:'${vix}/mdm/item/purchasePriceConditionGiftAction!goListContent.action?type=pcca&pcaId='+$("#pccaId").val(),
		  cache: false,
...
function saveOrUpdatePriceConditionGiftDetail(id){
	$.ajax({
		  url:'${vix}/mdm/item/purchasePriceConditionGiftAction!goSaveOrUpdate.action?type=pcca&id='+id+"&pcaId="+$("#pccaId").val(),
		  cache: false,
		  success: function(html){
			  asyncbox.open({
				 	modal:true,
...
function deletePriceConditionGiftEntity(id){
	asyncbox.confirm('确定要删除该赠品么?','<s:text name='vix_message'/>',function(action){
		if(action == 'ok'){
			$.ajax({
				  url:'${vix}/mdm/item/purchasePriceConditionGiftAction!deleteById.action?id='+id,
				  cache: false,
				  success: function(html){
		...
		<div class="box order_table" style="line-height: normal;">
			<table>
				...
				<tr height="30">
					...
					<td name="regionalTd" align="right">地域:&nbsp;</td>
					<td name="regionalTd"><s:select id="regionalId" list="%{regionalList}" headerKey="-1" headerValue="----无----" listValue="name" listKey="id" value="%{priceConditionCountArea.regional.id}" multiple="false" theme="simple"></s:select></td>
				</tr>
				<tr id="purchaseFrameworkAgreementTr" height="30">
				...
				<tr id="saleFrameworkAgreementTr" height="30">
				...
				<tr id="customerAccountCategoryTr" height="30">
				...
				<tr id="itemCategoryTr" height="30">
				...
				<tr id="customerAccountGroupTr" height="30">
				...
				<tr id="channelDistributorTr" height="30">
				...
				<tr id="customerAccountTr" height="30">
					<td align="right">客户:</td>
				...
				<tr id="customerAccountAndItemTr" height="30">
					<td align="right">客户:</td>
				...
				<tr id="priceTypeTr" height="30">
					...
					<td><input id="unit" name="priceConditionCountArea.unit" value="${priceConditionCountArea.unit}"/></td> --%>
