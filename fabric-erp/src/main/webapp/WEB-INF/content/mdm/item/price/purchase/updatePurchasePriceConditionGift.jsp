...
loadName();
//载入分页列表数据
pager("start","${vix}/mdm/item/purchaseItemPriceAction!goListContent.action?name="+name,'itemPriceManage');
//排序 
function orderBy(orderField){
	...
	pager("start","${vix}/mdm/item/purchaseItemPriceAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'itemPriceManage');
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/mdm/item/purchaseItemPriceAction!goListContent.action?name="+name+'&companyCode='+$("#companyCode").val(),'itemPriceManage');
}
function addPriceConditionGift(){
	if($('#priceConditionGiftForm').validationEngine('validate')){
		$.post('${vix}/mdm/item/purchasePriceConditionGiftAction!saveOrUpdate.action',
...
function searchForContent(){
	...
	pager("start","${vix}/mdm/item/purchaseItemPriceAction!goListContent.action?name="+name+"&categoryId="+categoryId,'itemPriceManage');
}
function reset(){
	$("#itemCategoryId").val("");
	$("#itemCategory").val("");
