...
<input type="hidden" id="hasdeleteTotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="hasdeletePageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="hasdeleteTotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="hasdeleteOrderField" value="${pager.orderField}" />
<input type="hidden" id="hasdeleteOrderBy" value="${pager.orderBy}" />
<input type="hidden" id="hasdeleteInfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tr>
		<th width="5%">
