...
<script type="text/javascript">
	function goShowCanlendar(tag) {
				...
				callback : function(action) {
					if (action == 'ok') {
						if ($('#calendarsform').validationEngine('validate')) {
							...
							'calendars.isRemind' : $(":radio[name=isRemind][checked]").val(),
		...
		events : function(start, end, callback) {
			var params = {};
			$.ajax({
			url : "${vix}/common/canlendarAction!goCanlendarList.action?tag=" + tag,
			cache : false,
			type : "post",
			data : params,
			dataType : 'json',
...
<div class="sub_menu">
	...
	<div class="drop">
		<ul>
			<li><a href="#"><span>日程类型</span> </a>
				<ul>
					<li><a href="#" onclick="goShowCanlendar(0);">全部</a></li>
					<li><a href="#" onclick="goShowCanlendar(1);">任务</a></li>
					<li><a href="#" onclick="goShowCanlendar(2);">安排</a></li>
					<li><a href="#" onclick="goShowCanlendar(3);">通告 </a></li>
					<li><a href="#" onclick="goShowCanlendar(4);">提醒 </a></li>
					<li><a href="#" onclick="goShowCanlendar(5);">新闻 </a></li>
				</ul></li>
		</ul>
	</div>
</div>
