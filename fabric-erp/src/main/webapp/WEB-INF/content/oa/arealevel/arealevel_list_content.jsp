...
<input type="hidden" id="areaLevelTotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="areaLevelPageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="areaLevelTotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="areaLevelOrderField" value="${pager.orderField}" />
<input type="hidden" id="areaLevelOrderBy" value="${pager.orderBy}" />
<input type="hidden" id="areaLevelInfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="5%">
			...
			<th onclick="orderBy('status');" width="20%">地区名称&nbsp;</th>
			<th width="5%">操作</th>
		</tr>
		<%
			int count = 0;
