...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('startTime');">开始时间&nbsp;<img id="trendsImg_startTime" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('endTime');">结束时间&nbsp;<img id="trendsImg_endTime" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('remarks');">备注&nbsp;<img id="trendsImg_remarks" src="${vix}/common/img/arrow.gif">
			</th>
				...
				<tr>
					...
					<td>
						<div class="untitled" style="position: static; display: inline;">
							<s:if test="#entity.bookingSituation ==0 || #entity.bookingSituation ==2">
								<a href="#" onclick="saveOrUpdate('${entity.id}',$('#parentId').val());">修改</a>
							</s:if>
						</div>
						<div class="untitled" style="position: static; display: inline;">
							<s:if test="#entity.bookingSituation ==0 || #entity.bookingSituation ==2 || #entity.bookingSituation ==3">
