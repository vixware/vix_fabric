...
<div class="content">
	...
	<div class="box cardTable">
		<form id="brandForm">
			<input type="hidden" id="id" name="id" value="${displacementType.id}" />
			<table width="100%">
				<tr>
					<th class="tr" width="150">序号：</th>
					<td><input id="code" name="displacementType.code" value="${displacementType.code}" type="text" style="width: 200px;" class="ipt" /> <span style="color: red;">*</span></td>
				</tr>
				<tr>
					<th class="tr" width="150">排量类型名称：</th>
					<td><input id="name" name="displacementType.name" value="${displacementType.name}" type="text" style="width: 200px;" class="ipt" /> <span style="color: red;">*</span></td>
				</tr>
				<tr>
					<th align="right">是否生效：</th>
					<td><s:radio list="#{'0':'是','1':'否'}" name="disabled" value="%{displacementType.disabled}" theme="simple"></s:radio></td>
				</tr>
			</table>
		</form>
	</div>
