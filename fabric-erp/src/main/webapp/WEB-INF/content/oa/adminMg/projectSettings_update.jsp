...
<div class="content">
	...
	<div class="box cardTable">
		<form id="brandForm">
			<input type="hidden" id="id" name="id" value="${workPlanType.id}" /> <input type="hidden" id="code" name="code" value="${workPlanType.code}" />
			<table width="100%">
				<tr>
					<th class="tr" width="150">序号：</th>
					<td><input id="orderNumber" name="workPlanType.orderNumber" value="${workPlanType.orderNumber}" type="text" style="width: 200px;" class="ipt" /></td>
				</tr>
				<tr>
					<th class="tr" width="150">计划类型名称：</th>
					<td><input id="name" name="workPlanType.name" value="${workPlanType.name}" type="text" style="width: 200px;" class="ipt" /></td>
				</tr>
			</table>
		</form>
	</div>
