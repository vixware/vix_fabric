...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%" style="cursor: pointer;" onclick="orderBy('bookCodes');">编码&nbsp;<img id="outBoundImg_bookCodes" src="${vix}/common/img/arrow.gif">
			</th>
			<th width="20%" style="cursor: pointer;" onclick="orderBy('bookNames');">名称&nbsp;<img id="outBoundImg_bookNames" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('createTime');">借用/归还日期&nbsp;<img id="outBoundImg_createTime" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('recipientsWho');">借用/归还人&nbsp;<img id="outBoundImg_recipientsWho" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('uploadPersonName');">经办人&nbsp;<img id="outBoundImg_uploadPersonName" src="${vix}/common/img/arrow.gif">
			</th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.bookCodes }</a></td>
					<td><a href="#" style="color: gray;">${entity.bookNames }</a></td>
					...
					<td><a href="#" style="color: gray;"> <s:if test="%{#entity.isTemp==0}">借用</s:if> <s:elseif test="%{#entity.isTemp==1}">归还</s:elseif>
					</a></td>
					<td>
						<div class="untitled">
