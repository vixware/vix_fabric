		...
		<form id="brandForm">
			...
			<table width="100%">
				<tr>
					...
					<td><input id="code" name="vehicleType.code" value="${vehicleType.code}" type="text" style="width: 200px;" class="ipt" /> <span style="color: red;">*</span></td>
				</tr>
				<tr>
					<th class="tr" width="150">车辆类型名称：</th>
					<td><input id="name" name="vehicleType.name" value="${vehicleType.name}" type="text" style="width: 200px;" class="ipt" /> <span style="color: red;">*</span></td>
				</tr>
				<tr>
					<th align="right">是否生效：</th>
					<td><s:radio list="#{'0':'是','1':'否'}" name="disabled" value="%{vehicleType.disabled}" theme="simple"></s:radio></td>
				</tr>
			</table>
		</form>
	</div>
