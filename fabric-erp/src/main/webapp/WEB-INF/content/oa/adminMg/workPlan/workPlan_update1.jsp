...
function tabs(title,content,style){
	...
	function saveOrUpdateOrder1(){
		...
		if($('#orderForm').validationEngine('validate')){
			$.post('${vix}/oa/workPlanAction!saveOrUpdate1.action',
				...
				function(result){
					showMessage(result);
					setTimeout("",1000);
					loadContent('${vix}/oa/workPlanAction!goSaveOrUpdate.action?menuId=menuContract');
				} 
			);
		}
	}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/oa/workPlanAction!goSaveOrUpdate.action?pageNo=${pageNo}');">进度日志 </a></li>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="saveOrUpdateOrder1">
					<span class="no_line"> <a onclick="saveOrUpdateOrder();"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <a href="#"><img width="22" height="22" title="保存并提交审批"
							src="${vix}/common/img/dt_submit.png" /></a> <a href="#" onclick="loadContent('${vix}/oa/workPlanAction!goSaveOrUpdate.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a>
