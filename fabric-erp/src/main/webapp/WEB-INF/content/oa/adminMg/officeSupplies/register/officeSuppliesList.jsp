...
function addBookBorrow(){
	if($('#saleBookBorrowForm').validationEngine('validate')){
		$.post('${vix}/oa/officeSuppliesRegisterAction!saveOrUpdateOSRI.action',
			{'officeSuppliesRegisterItem.id':$("#officeSuppliesRegisterItemId").val(),
			 'officeSuppliesRegisterItem.officeSupplies.id':$("#officeSuppliesId").val(),
			 'officeSuppliesRegisterItem.officeSuppliesRegister.id':$("#id").val(),
			 'officeSuppliesRegisterItem.model':$("#model").val(),
			 'officeSuppliesRegisterItem.officeSuppliesCode':$("#officeSuppliesCode").val(),
			 'officeSuppliesRegisterItem.officeName':$("#officeName").val(),
			 'officeSuppliesRegisterItem.prickle':$("#prickle").val(),
			 'officeSuppliesRegisterItem.supplier':$("#supplier").val(),
			 'officeSuppliesRegisterItem.lowestVigilance':$("#lowestVigilance").val(),
			 'officeSuppliesRegisterItem.lowestVigilance':$("#lowestVigilance").val(),
			 'officeSuppliesRegisterItem.numberOfRecipients':$("#numberOfRecipients").val(),
			 'officeSuppliesRegisterItem.borrowNumber':$("#borrowNumber").val()
			},
			function(result){
				showMessage(result);
				setTimeout("",1000);
			...
			<div class="right_content" style="height: 390px;">
				<form id="saleBookBorrowForm">
					<div class="box order_table" style="line-height: normal;">
						<table class="table-padding020">
							<tr height="30">
								...
								<td><input id="model" name="officeSuppliesRegisterItem.model" value="${officeSuppliesRegisterItem.model}" type="text" class="validate[required] text-input" /></td>
							</tr>
							<tr height="30">
								<th align="right">办公用品名称:&nbsp;</th>
								<td><input id="officeName" name="officeSuppliesRegisterItem.officeName" value="${officeSuppliesRegisterItem.officeName}" type="text" class="validate[required] text-input" /></td>
							</tr>
							<tr height="30">
								<th align="right">计量单位:&nbsp;</th>
								<td><input id="prickle" name="officeSuppliesRegisterItem.prickle" value="${officeSuppliesRegisterItem.prickle}" type="text" class="validate[required] text-input" /></td>
							</tr>
							<tr height="30">
								<th align="right">供应商:&nbsp;</th>
								<td><input id="supplier" name="officeSuppliesRegisterItem.supplier" value="${officeSuppliesRegisterItem.supplier}" type="text" /></td>
							</tr>
							<tr height="30">
								<th align="right">最低警戒库存:&nbsp;</th>
								<td><input id="lowestVigilance" name="officeSuppliesRegisterItem.lowestVigilance" value="${officeSuppliesRegisterItem.lowestVigilance}" type="text" /></td>
							</tr>
							<tr height="30">
								<th align="right">最高警戒库存:&nbsp;</th>
								<td><input id="maximumVigilance" name="officeSuppliesRegisterItem.maximumVigilance" value="${officeSuppliesRegisterItem.maximumVigilance}" type="text" /></td>
							</tr>
							<tr height="30">
								<th align="right">当前库存:&nbsp;</th>
								<td><input id="numberOfRecipients" name="officeSuppliesRegisterItem.numberOfRecipients" value="${officeSuppliesRegisterItem.numberOfRecipients}" type="text" /></td>
							</tr>
							<tr height="30">
								<th align="right">领用数量:&nbsp;</th>
								<td><s:hidden id="officeSuppliesId" name="officeSuppliesId" value="%{officeSuppliesRegisterItem.officeSupplies.id}" theme="simple" /> <input id="borrowNumber" name="officeSuppliesRegisterItem.borrowNumber" value="${officeSuppliesRegisterItem.borrowNumber}" type="text" class="validate[required] text-input" /> <span style="color: red;">*</span>
								</td>
							</tr>
						</table>
					...
					<div style="padding-left: 150px; padding-top: 15px;">
						<s:if test="OfficeSuppliesRegisterItem.id > 0">
