...
function deleteEntity(id){
	asyncbox.confirm('确定要删除该图书么?','提示信息',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
		...
		<tr class="alt">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.bookCode}</a></td>
					<td><a href="#" style="color: gray;">${entity.bookType}</a></td>
					<td><a href="#" style="color: gray;">${entity.author}</a></td>
					<td><a href="#" style="color: gray;">${entity.press}</a></td>
