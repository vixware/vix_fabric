		...
		<div class="box order_table" style="line-height: normal;">
			<table style="margin: 0 auto;">
				<tr style="display: none;">
					<td><s:radio list="#{'0':'私有','1':'公共'}" id="wabtype" name="wabtype" value="%{wab.wabtype==0}" theme="simple"></s:radio></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="tc_copay">
							<input type="text" value="${wab.email}" name="email" id="email"> <a class="tc_texticon" href="javascript:showHiddenEmail('sub_email');"><span>+</span></a>
						</div>
