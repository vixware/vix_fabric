...
<div class="content" style="margin-top: 15px; overflow: hidden">
	<form id="brandForm">
		<input type="hidden" id="id" name="id" value="${newsComment.id}" />
		<div class="box order_table" style="line-height: normal;">
			<table class="table-padding020">
				<tr>
					<td><textarea id="commentscontent" name="commentscontent">${newsComment.commentscontent}</textarea> <script type="text/javascript">
				...
				<tr>
					<td><input id="updateTime" class="sweet-tooltip" data-text-tooltip="时间格式 yyyy-MM-dd HH:mm:ss" name="updateTime" value="<fmt:formatDate value='${newsComment.updateTime}' type='both' pattern='yyyy-MM-dd' />" type="hidden" style="width: 190px; height: 25px;" /></td>
				</tr>
			</table>
		</div>
	</form>
