...
function unsentMessages1(id){
	$.ajax({
		  url:'${vix}/oa/messageManagementAction!goSaveOrUpdate.action?id='+id,
	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.sendDate}" type="both" pattern="yyyy-MM-dd" /></a></td>
