...
<div class="content">
	...
	<div class="box cardTable">
		<form id="brandForm" method="post" enctype="multipart/form-data">
			<input type="hidden" id="id" name="id" value="${managementUploader.id}" />
			<table width="100%">
				<tr>
					<th class="tr" width="150">文档名称：</th>
					<td><input id="title" name="managementUploader.title" value="${managementUploader.title}" type="text" style="width: 200px;" class="ipt" /></td>
				</tr>
				<tr>
					<th class="tr" width="150">文档类型：</th>
					<td><input id="fileType" name="managementUploader.fileType" value="${managementUploader.fileType}" type="text" style="width: 200px;" class="ipt" /></td>
				</tr>
				<tr>
					<th>上传文件：</th>
				...
				<tr>
					<th>文件备注：</th>
					<td colspan="3" style="padding-top: 5px;"><textarea id="note" name="managementUploader.note" rows="1" cols="1" style="width: 90%; height: 50px;"><s:property value="managementUploader.note" escape="false" /></textarea></td>
				</tr>
			</table>
		</form>
	</div>
