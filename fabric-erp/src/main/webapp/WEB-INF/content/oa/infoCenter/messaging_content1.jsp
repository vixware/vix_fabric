...
loadMenuContent('${vix}/oa/main/oaMainAction!goMenuContent.action');
	...
	function messaging(){
		$.ajax({
			  url:'${vix}/oa/messageManagementAction!goMessagingList.action',
	...
	function unsentMessages(){
		$.ajax({
			  url:'${vix}/oa/messageManagementAction!goUnsentMessages.action',
			  success: function(html){
				  $('#page1').html(html);
	...
	function sendMessages(){
		$.ajax({
			  url:'${vix}/oa/messageManagementAction!goSendMessages.action',
			  success: function(html){
				  $('#page1').html(html);
	...
	function uploader(){
		$.ajax({
			  url:'${vix}/oa/messageManagementAction!goUploader.action',
			  success: function(html){
				  $('#page1').html(html);
		...
		<div class="addleft">
			...
			<ul class="listlib">
				...
				<li class="liston"><strong><s:text name="oa_not_sent_message" /></strong>
					<ul>
						<li><strong class="home" onclick="unsentMessages(0);">查看消息</strong></li>
					</ul></li>
				<li class="liston"><strong><s:text name="查看附件" /></strong>
					<ul>
						<li><strong class="home" onclick="uploader(0)">查看附件</strong></li>
					</ul></li>
				<li class="liston"><strong><s:text name="oa_dialogue_records_management" /></strong>
					<ul>
						<li><strong class="home">记录列表</strong></li>
					</ul></li>
			</ul>
		</div>
