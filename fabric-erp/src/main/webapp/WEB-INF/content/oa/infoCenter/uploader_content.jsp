	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="${vix}/oa/messageManagementAction!downloadEqDocument.action?id=${entity.id}">${entity.id}</a></td>
				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						<a href="${vix}/oa/messageManagementAction!downloadEqDocument.action?id=${entity.id}">下载</a> <a href="#" onclick="deleteManagement(${entity.id},this);">删除</a>
					</div>
				</td>
			</tr>
		</s:iterator>
