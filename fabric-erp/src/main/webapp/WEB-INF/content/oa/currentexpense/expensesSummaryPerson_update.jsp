...
<script type="text/javascript">
	function saveOrUpdateCurrentExpense() {
		if ($('#currentExpenseForm').validationEngine('validate')) {
			$.post('${vix}/oa/expensesSummaryPersonAction!saveOrUpdate.action', {
			...
			'currentExpense.memo' : $("#memo").val()
				...
				showMessage(result);
				setTimeout("", 1000);
				loadContent('${vix}/oa/expensesSummaryPersonAction!goList.action');
			});
		} else {
			return false;
		}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">行政办公 </a></li>
				<li><a href="#">报销管理 </a></li>
				<li><a href="#" onclick="loadContent('${vix}/oa/expensesSummaryPersonAction!goList.action');">日常费用报销 </a></li>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateCurrentExpense();"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <a href="#"
						onclick="loadContent('${vix}/oa/expensesSummaryPersonAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a>
								...
								<dd style="display: block;">
									<table style="border: none;">
										<tr>
											...
											<td><input id="employeeName" name="employeeName" value="${currentExpense.employee.name }" type="text" style="width: 250px;"><input class="btn" type="button" value="选择" onclick="chooseEmployees();" /> <s:hidden id="employeeId" name="currentExpense.employee.id" value="%{currentExpense.employee.id}" theme="simple" /></td>
