...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="oa_brand_model" /></th>
			<th><s:text name="oa_license_plate_number" /></th>
			<th><s:text name="oa_driver" /></th>
			<th><s:text name="oa_type" /></th>
			<th><s:text name="oa_date_purchase" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">兰博基尼</a></td>
					<td><a href="#" style="color: gray;">京A12B11</a></td>
					<td><a href="#" style="color: gray;">啸天犬</a></td>
					<td><a href="#" style="color: gray;">跑车</a></td>
					<td><a href="#" style="color: gray;">2013年3月3日</a></td>
					<td><a href="#" style="color: gray;">可用</a></td>
