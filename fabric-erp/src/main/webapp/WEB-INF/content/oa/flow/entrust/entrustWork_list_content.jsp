...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');">流程名称&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('id');">委托人&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('id');">被委托人&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('id');">有效期&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td>一直有效</td>
				<td>已启用</td>
				<td><a href="#" title="停用"> 停用 </a> <a href="#" title="编辑"> 编辑 </a> <a href="#" title="删除"> 删除 </a></td>
			</tr>
			...
			<tr>
				...
				<td>张三</td>
				<td>李四</td>
				<td>2013-11-25 13:59:59 至 2013-11-26 14:00:02</td>
				<td>已启用</td>
				<td><a href="#" title="停用"> 停用 </a> <a href="#" title="编辑"> 编辑 </a> <a href="#" title="删除"> 删除 </a></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>张三</td>
				<td>李四</td>
				<td>2013-11-19 11:00:12 至 2013-11-28 11:00:16</td>
				<td>已启用</td>
				<td><a href="#" title="停用"> 停用 </a> <a href="#" title="编辑"> 编辑 </a> <a href="#" title="删除"> 删除 </a></td>
			</tr>
			<tr>
				...
				<td>张三</td>
				<td>李四</td>
				<td>2013-08-09 16:13:23 至 2013-08-10 15:13:37</td>
				<td>已启用</td>
				<td><a href="#" title="停用"> 停用 </a> <a href="#" title="编辑"> 编辑 </a> <a href="#" title="删除"> 删除 </a></td>
			</tr>
			<tr>
