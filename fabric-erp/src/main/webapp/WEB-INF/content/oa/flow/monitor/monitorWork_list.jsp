...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/oa/flow/oaFlowMonitorWorkAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/oa/flow/oaFlowMonitorWorkAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/oa/flow/oaFlowMonitorWorkAction!goSingleList.action?code="+code,'order');
			});
		  }
	});
}
...
function showOrder(id){
	$.ajax({
		  url:'${vix}/oa/flow/oaFlowMonitorWorkAction!showOrder.action?id='+id,
		  cache: false,
		  success: function(html){
			  $("#mainContent").html(html);
		  }
...
function orderBy(orderField){
	...
	pager("start","${vix}/oa/flow/oaFlowMonitorWorkAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&code="+code,'order');
}

bindSearch();
function currentPager(tag){
	loadCode();
	pager(tag,"${vix}/oa/flow/oaFlowMonitorWorkAction!goSingleList.action?code="+code,'order');
}
...
<div class="content">
	<div class="drop" id="c_head">
		...
		<div>
			<label>流水号：<input type="text" class="int" id="codeS"></label> <label>流程名称：<input type="text" class="int" name=""> 工作名称/文号：<input type="text" class="int" name=""><input type="button" value="<s:text name='cmn_search'/>" class="btn" onclick="searchForContent();" /><input type="button"
