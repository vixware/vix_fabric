...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');">开始时间&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('id');">附件&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td></td>
				<td>执行中</td>
				<td><a href="#" title="流程图"> 流程图 </a> <a href="#" title="催办"> 催办 </a> <a href="#" title="关注"> 关注 </a></td>
			</tr>
			...
			<tr>
				...
				<td></td>
				<td>执行中</td>
				<td><a href="#" title="流程图"> 流程图 </a> <a href="#" title="催办"> 催办 </a> <a href="#" title="取消关注"> 取消关注 </a></td>
			</tr>
			<tr>
				<td><input id="chkId" name="chkId" value="${entity.id}" type="checkbox" onchange="selectCount()" /></td>
				<td>18594</td>
			...
			<tr>
				...
				<td>18596</td>
				<td>工作交办</td>
				<td>工作交办(2013-11-30 15:06:31)</td>
				<td>2013-11-30 15:06:42</td>
				<td></td>
				<td>执行中</td>
				<td><a href="#" title="流程图"> 流程图 </a> <a href="#" title="催办"> 催办 </a> <a href="#" title="关注"> 关注 </a></td>
			</tr>
