...
<!--
	...
	function addOrderMemo(){
		loadContent('${vix}/oa/flow/oaFlowMonitorWorkAction!goList.action');
	}
...
<div class="sub_menu">
	<h2>
		<i> <a href="#"><img alt="" src="img/icon_14.gif">
			...
			<s:text name="help" /></a>
		</i> <strong><img alt="" src="img/drp_channel.png">公文拟稿</strong>
	</h2>
</div>
...
<div class="content">
	<form id="order">
		<div class="order">
			<dl>
				<dt>
					<span class="no_line"> <a onclick="addOrderMemo();" href="#"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消" src="${vix}/common/img/dt_cancelback.png" /></a>
						<a href="#"><img width="22" height="22" alt="禁用" src="${vix}/common/img/dt_disable.png" /></a> <a href="#"><img width="22" height="22" alt="删除" src="${vix}/common/img/dt_delete.png" /></a> <a href="#"><img width="22" height="22" alt="审批通过" src="${vix}/common/img/dt_aprroval.png" /></a> <a href="#"><img width="22" height="22" alt="驳回"
							src="${vix}/common/img/dt_reject.png"></a> <a href="#"><img width="22" height="22" alt="上一条" src="${vix}/common/img/dt_before.png"></a> <a href="#"><img width="22" height="22" alt="下一条" src="${vix}/common/img/dt_next.png"></a> <a href="#"><img width="22" height="22" alt="打印" src="${vix}/common/img/dt_print.png"></a>
					...
					<div class="order_table">
						<table>
							...
							<tr height="40">
								...
								<td colspan="3"><input type="text" id="memo" name="entityForm.memo" value="${entity.memo}" /></td>
							</tr>
						</table>
					</div>
