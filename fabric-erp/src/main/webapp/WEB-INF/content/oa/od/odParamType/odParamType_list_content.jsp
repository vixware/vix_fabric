...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');">名称&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('code');">类别&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('memo');">公文数&nbsp;<img src="${vix}/common/img/arrow.gif"></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td>行政</td>
				<td>20</td>
				<td><a href="#" onclick="saveOrUpdate('${entity.id}');" title="编辑"> 编辑 </a></td>
			</tr>
			<tr>
				<td><input id="chkId" name="chkId" value="${entity.id}" type="checkbox" onchange="selectCount()" /></td>
				<td>上行文</td>
