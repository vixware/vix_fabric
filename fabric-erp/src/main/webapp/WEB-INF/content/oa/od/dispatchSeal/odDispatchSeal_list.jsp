...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/oa/od/odDispatchSealAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/oa/od/odDispatchSealAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/oa/od/odDispatchSealAction!goSingleList.action?code="+code,'order');
			});
		  }
	});
}
...
function showOrder(id){
	$.ajax({
		  url:'${vix}/oa/od/odDispatchSealAction!showOrder.action?id='+id,
		  cache: false,
		  success: function(html){
			  $("#mainContent").html(html);
		  }
...
function orderBy(orderField){
	...
	pager("start","${vix}/oa/od/odDispatchSealAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&code="+code,'order');
}

bindSearch();
function currentPager(tag){
	loadCode();
	pager(tag,"${vix}/oa/od/odDispatchSealAction!goSingleList.action?code="+code,'order');
}
...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="img/oa_approval.png" alt="" /> <s:text name="oa_xtbg" /></a></li>
				<li><a href="#"><s:text name="公文管理" /> </a></li>
				<li><a href="#"><s:text name="发文管理" /> </a></li>
				<li><a href="#" onclick="loadContent('${vix}/oa/odDispatchSealAction!goList.action?pageNo=${pageNo}');"><s:text name="套红盖章" /> </a></li>
			</ul>
		</div>
	</h2>
	<%-- <div class="drop">
