				...
				<td><s:if test="tag != 'choose'">
					...
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#"></a></i> <i><a href="#" title="<s:text name='show'/>" onclick="showOrder('${entity.id}');"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='update'/>"></a></i> <b>${entity.code}</b>
							</strong>
							<p>${entity.memo}</p>
						</div>
					</div></td>
