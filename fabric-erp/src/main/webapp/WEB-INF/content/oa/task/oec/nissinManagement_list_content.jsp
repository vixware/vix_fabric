...
function deleteEntity(id){
	asyncbox.confirm('确定要删除该日清管理么?','<s:text name='日清管理'/>',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('endTime');">结束时间&nbsp;<img id="taskImg_endTime" src="${vix}/common/img/arrow.gif">
			</th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<%-- <td><a href="#" style="color: gray;">${entity.transactor}</a></td> --%>
