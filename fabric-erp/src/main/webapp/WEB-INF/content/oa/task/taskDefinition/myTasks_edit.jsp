...
<div class="content">
	...
	<div class="box cardTable">
		<form id="brandForm" method="post" enctype="multipart/form-data">
			<input type="hidden" id="id" name="id" value="${uploader.id}" /> <input type="hidden" id="executionFeedbackId" name="uploader.executionFeedback.id" value="${uploader.executionFeedback.id}" />
			<table width="100%">
				<tr>
					<th class="tr" width="150">文档名称：</th>
					<td><input id="title" name="uploader.title" value="${uploader.title}" type="text" style="width: 200px;" class="ipt" /></td>
				</tr>
				<tr>
					<th class="tr" width="150">文档类型：</th>
					<td><input id="fileType" name="uploader.fileType" value="${uploader.fileType}" type="text" style="width: 200px;" class="ipt" /></td>
				</tr>
				<tr>
					<th>上传文件：</th>
				...
				<tr>
					<th>文件备注：</th>
					<td colspan="3" style="padding-top: 5px;"><textarea id="note" name="uploader.note" rows="1" cols="1" style="width: 90%; height: 50px;"><s:property value="uploader.note" escape="false" /></textarea></td>
				</tr>
			</table>
		</form>
	</div>
