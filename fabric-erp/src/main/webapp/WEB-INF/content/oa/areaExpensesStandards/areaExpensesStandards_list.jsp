...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/oa/areaExpensesStandardsAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
			  ...
			  asyncbox.open({
					...
					callback : function(action){
						if(action == 'ok'){
							...
							$.post('${vix}/oa/areaExpensesStandardsAction!saveOrUpdate.action',
									 {
									...
									function(result){
										showMessage(result);
										setTimeout("", 1000);
										loadContent('${vix}/oa/areaExpensesStandardsAction!goList.action');
									}
								 );
							}else {
								return false;
...
function searchForRightContent(){
	loadName();
	pager("start","${vix}/oa/areaExpensesStandardsAction!goSingleList.action?name="+name,'areaExpensesStandards');
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/oa/areaExpensesStandardsAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name+"&parentId="+$("#selectId").val(),'areaExpensesStandards');
}

function categoryPager(tag){
	loadName();
	pager(tag,"${vix}/oa/areaExpensesStandardsAction!goSingleList.action?name="+name,'areaExpensesStandards');
}
bindSearch();
</script>
<div class="sub_menu">
		...
		<div id="left" class="ui-resizable" style="height: 500px;">
			...
			<script type="text/javascript">	
				...
				function onClick(event, treeId, treeNode, clickFlag) {
					...
					pager("start","${vix}/oa/areaExpensesStandardsAction!goSingleList.action?id="+treeNode.id+"&treeType="+treeNode.treeType,"areaExpensesStandards");
				}
