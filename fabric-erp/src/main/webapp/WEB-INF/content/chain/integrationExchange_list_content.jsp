...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="cbm_card_number" /></th>
			<th><s:text name="cbm_compellation" /></th>
			<th><s:text name="cbm_contact_phone_number" /></th>
			<th><s:text name="cbm_integral_source" /></th>
			<th><s:text name="cbm_integral" /></th>
			<th><s:text name="cbm_exchange_items" /></th>
			<th><s:text name="cbm_redeem_points" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">保温杯</a></td>
					<td><a href="#" style="color: gray;">5000分</a></td>
					<td><a href="#" style="color: gray;">兑换成功</a></td>
					<td>
