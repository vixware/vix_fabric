...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="170"><s:text name="drp_coding" /></th>
			<th width="170"><s:text name="drp_theme" /></th>
			<th><s:text name="drp_store" /></th>
			<th><s:text name="drp_store_person" /></th>
			<th><s:text name="drp_evaluation" /></th>
			<th><s:text name="drp_evaluation_people" /></th>
			<th><s:text name="drp_score" /></th>
			<th><s:text name="drp_evaluation_time" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">xxx门店评分</a></td>
					<td><a href="#" style="color: gray;">xx门店</a></td>
					<td><a href="#" style="color: gray;">哮天犬</a></td>
					<td><a href="#" style="color: gray;">优</a></td>
					<td><a href="#" style="color: gray;">二郎神</a></td>
					<td><a href="#" style="color: gray;">98分</a></td>
