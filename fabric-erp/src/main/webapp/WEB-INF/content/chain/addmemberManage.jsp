...
<div class="sub_menu">
	...
	<div id="breadCrumb" class="breadCrumb module">
		<ul>
			...
			<li><a href="#"><s:text name="chain_member_management" /> </a></li>
			<a href="#"><s:text name="chain_member" /> </a>
		</ul>
	</div>
</div>
		...
		<div class="order">
			<dl>
				<dt>
					...
					</span> <strong> <b><s:text name="chain_member" /> </b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
						...
						<div class="voucher newvoucher">
							<dl>
								...
								<dd style="display: block;">
									<p>
										<span><i>会员昵称：</i><input name="warehouseCode" type="text" size="20" /> </span><span><i>会员名称：</i><input name="warehouseCode" type="text" size="20" /> </span><span><i>生日：</i><input id="time3" name="ufts" type="text" /><img onclick="showTime('time3','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22"
											align="middle"> </span>
									</p>
									<p>
										<span><i>电话：</i><input name="poCode" type="text" size="20" /> </span><span><i>手机：</i><input name="poCode" type="text" size="20" /> </span><span><i>E-mail：</i><input name="poCode" type="text" size="20" /> </span>
									</p>
									<p>
										<span><i>会员等级：</i><input name="poCode" type="text" size="20" /> </span><span><i>交易量：</i><input name="spplierCode" type="text" size="20" class="validate[required] text-input sweet-tooltip" /> </span><span><i>交易额：</i><input name="personCode" type="text" size="20" class="validate[required] text-input sweet-tooltip" /> </span>
									</p>
									<p>
										<span><i>积分：</i><input name="spplierCode" type="text" size="20" class="validate[required] text-input sweet-tooltip" /> </span><span><i>状态：</i><input name="personCode" type="text" size="20" class="validate[required] text-input sweet-tooltip" /> </span>
									</p>
									<p>
										<i>备注：</i>
										<textarea class=spplierCode rows="1" style="width: 450px"></textarea>
									</p>
								</dd>
							</dl>
						</div>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							...
							<li class="current"><a onclick="javascript:$('#a2').attr('style','');tab(3,2,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />常用地址</a></li>
							<%-- <li><a
								onclick="javascript:$('#a3').attr('style','');tab(3,3,'a',event);opentt();"><img
									src="${vix}/common/img/mail.png" alt="" />地址项</a>
							</li> --%>
						</ul>
					</div>
