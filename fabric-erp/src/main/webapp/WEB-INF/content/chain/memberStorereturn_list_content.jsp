...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="170"><s:text name="drp_order_on" /></th>
			<th><s:text name="drp_order_date" /></th>
			<th><s:text name="drp_business_type" /></th>
			<th><s:text name="drp_sales_type" /></th>
			<th width="170"><s:text name="drp_customer_name" /></th>
			<th><s:text name="drp_refund_amount" /></th>
			<th><s:text name="drp_payment_terms" /></th>
			<th><s:text name="drp_department" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">销售</a></td>
					<td><a href="#" style="color: gray;">销售xx</a></td>
					<td><a href="#" style="color: gray;">xxx集团</a></td>
					<td><a href="#" style="color: gray;">80万</a></td>
					<td><a href="#" style="color: gray;">刷卡</a></td>
					<td><a href="#" style="color: gray;">销售部</a></td>
					<td><a href="#" style="color: gray;">哮天犬</a></td>
					<td>
