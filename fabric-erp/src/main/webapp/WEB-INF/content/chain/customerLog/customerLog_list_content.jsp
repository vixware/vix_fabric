		...
		<tr class="alt">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.respusername }</a></td>
					<td><a href="#" style="color: gray;">${entity.vipcardid }</a></td>
					<td><a href="#" style="color: gray;">${entity.logtitle }</a></td>
					<td><a href="#" style="color: gray;">${entity.logtext }</a></td>
					<td><a href="#" style="color: gray;">${entity.menuid }</a></td>
					<td><a href="#" style="color: gray;">${entity.menuname }</a></td>
					<td><a href="#" style="color: gray;">${entity.pointValue }</a></td>
					<td><a href="#" style="color: gray;">${entity.logremark }</a></td>
					<td>
