...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/chain/counterSalesRecordsAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/chain/counterSalesRecordsAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/chain/counterSalesRecordsAction!goSingleList.action?name="+name,'salesOrder');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/chain/counterSalesRecordsAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'salesOrder');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/chain/counterSalesRecordsAction!goSingleList.action?name="+name,'salesOrder');
}
		...
		<div id="left" class="ui-resizable" style="height: 500px;">
			...
			<script type="text/javascript">	
				...
				function onClick(event, treeId, treeNode, clickFlag) {
					...
					pager("start","${vix}/chain/counterSalesRecordsAction!goSingleList.action?id="+treeNode.id+"&treeType="+treeNode.treeType,"salesOrder");
				}
