...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="drp_sales_amount" /></th>
			<th><s:text name="drp_income_integration" /></th>
			<th><s:text name="drp_integration_itncome_time" /></th>
			<th><s:text name="drp_original_integral" /></th>
			<th><s:text name="drp_total_points" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">300元</a></td>
					<td><a href="#" style="color: gray;">300分</a></td>
					<td><a href="#" style="color: gray;">2013-1-1</a></td>
					<td><a href="#" style="color: gray;">600分</a></td>
					<td><a href="#" style="color: gray;">900分</a></td>
					<td>
