...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');" width="5%"><s:text name="cmn_id" />&nbsp; <s:if test="%{pager.orderField == 'id' && pager.orderBy == 'asc' }">
			...
			<th width="200"><s:text name="drp_theme" /></th>
			<th><s:text name="drp_type" /></th>
			<th><s:text name="drp_priority" /></th>
			<th width="170"><s:text name="drp_release_department" /></th>
			<th width="170"><s:text name="drp_release_time" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">xxx政策</a></td>
					<td><a href="#" style="color: gray;">计划</a></td>
					<td><a href="#" style="color: gray;">一等级</a></td>
					<td><a href="#" style="color: gray;">策划部</a></td>
