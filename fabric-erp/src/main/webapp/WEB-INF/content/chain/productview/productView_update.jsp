...
<script type="text/javascript">
	...
	function saveOrUpdateSettlementStatement() {
		if ($('#settlementStatementForm').validationEngine('validate')) {
			...
			'settlementStatement.currencyType.id' : $("#currencyTypeId").val(),
	...
	function initdata() {
		$("#currencyTypeId").val('${settlementStatement.currencyType.id }');
	}
	initdata();
</script>
<div class="sub_menu">
...
<input type="hidden" id="supplierId" name="supplierId" value="${settlementStatement.supplier.id }" />
<div class="content">
	<form id="settlementStatementForm">
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateSettlementStatement()" href="#"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"> </a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /> </a> <a href="#"
						onclick="loadContent('${vix}/chain/productViewAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><s:select id="currencyTypeId" headerKey="-1" headerValue="--请选择--" list="%{currencyTypeList}" listValue="name" listKey="id" value="" multiple="false" theme="simple" class="validate[required] text-input"></s:select> <span style="color: red;">*</span></td>
										</tr>
										<tr>
