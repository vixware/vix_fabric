...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/chain/productViewAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/chain/productViewAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/chain/productViewAction!goSingleList.action?name="+name,'settlementStatement');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/chain/productViewAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'settlementStatement');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/chain/productViewAction!goSingleList.action?name="+name,'settlementStatement');
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#"> <s:text name="cbm_product_view" />
				</a></li>
			</ul>
		</div>
	</h2>
