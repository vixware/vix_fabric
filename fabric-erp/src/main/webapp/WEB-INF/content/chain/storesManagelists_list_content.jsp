...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="cbm_number" /></th>
			<th><s:text name="cbm_shop_name" /></th>
			<th><s:text name="cbm_contact" /></th>
			<th><s:text name="cbm_phone" /></th>
			<th><s:text name="cbm_format" /></th>
			<th><s:text name="cbm_type" /></th>
			<th><s:text name="cbm_mode_operation" /></th>
			<th><s:text name="cbm_founded" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">123</a></td>
					<td><a href="#" style="color: gray;">永旺国际商城</a></td>
					<td><a href="#" style="color: gray;">马云</a></td>
					<td><a href="#" style="color: gray;">18866668888</a></td>
					<td><a href="#" style="color: gray;">好</a></td>
					<td><a href="#" style="color: gray;">商城</a></td>
					<td><a href="#" style="color: gray;">零售</a></td>
