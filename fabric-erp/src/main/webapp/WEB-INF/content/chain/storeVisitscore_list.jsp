...
<div class="content">
	<div class="drop" id="c_head">
		...
		<div class="search_advanced">
			<label><s:text name="drp_coding1" /><input type="text" class="int" name=""> </label><label><s:text name="drp_store1" /><input type="text" class="int" name=""> </label><label><s:text name="drp_evaluation_time1" /><input type="text" class="int" name=""> </label>
		</div>
	</div>
	<div id="number">
