...
function deleteById(id){
	$.ajax({
		  url:'${vix}/chain/cardManagementAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/chain/cardManagementAction!goSingleList.action?name="+name,'brand');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/chain/cardManagementAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'brand');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/chain/cardManagementAction!goSingleList.action?name="+name,'brand');
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#"> <s:text name="cbm_membership_management" />
				</a></li>
				<li><a href="#"><s:text name="cbm_membership_card_management" /> </a></li>
			</ul>
		</div>
	</h2>
	<div class="drop">
...
<div class="content">
	<div class="drop" id="c_head">
		...
		<div class="search_advanced">
			<label><s:text name="drp_card_number1" /><input type="text" class="int" name=""> </label><label><s:text name="ldm_name1" /><input type="text" class="int" name=""> </label><label><s:text name="drp_joined1" /><input type="text" class="int" name=""> </label>
		</div>
	</div>
	<div id="number">
