	...
	$.ajax({
		  ...
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/drp/storeReturnRecordsAction!goSingleList.action?name="+name,'brand');
			});
		  }
	});
}
...
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/drp/storeReturnRecordsAction!goSingleList.action?name="+name,'brand');
}
