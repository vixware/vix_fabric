...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="100"><s:text name="cbm_coding" /></th>
			<th><s:text name="cbm_compellation" /></th>
			<th width="100"><s:text name="cbm_source" /></th>
			<th><s:text name="cbm_telephone" /></th>
			<th><s:text name="cbm_integral" /></th>
			<th><s:text name="cbm_state" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">购物积分</a></td>
					<td><a href="#" style="color: gray;">100-123456</a></td>
					<td><a href="#" style="color: gray;">8000分</a></td>
					<td><a href="#" style="color: gray;">正常</a></td>
					<td><a href="#" style="color: gray;">2013-3-15</a></td>
					<td>
