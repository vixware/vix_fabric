...
function deleteEntity(id){
	asyncbox.confirm('确定要删除该元数据么?','<s:text name='vix_message'/>',function(action){
		if(action == 'ok'){
			deleteById(id);
		}
	});
...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('metaDataDisplayName');" width="70%">名称&nbsp; <s:if test="%{pager.orderField == 'metaDataDisplayName' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
