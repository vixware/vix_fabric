		...
		<dl>
				...
				<form id="sysParamForm">
					...
					<div class="order_table">
						<table>
							...
							<tr>
								<th>值类型:</th>
								<td colspan="3"><s:radio list="#{\"select\":\"选择数据 \",\"text\":\"文本\",\"sql\":\"SQL\",\"hql\":\"HQL\"}" name="entityForm.valueType" value="%{entity.valueType}" theme="simple"></s:radio></td>
			...
			<div class="clearfix" style="background: #FFF; position: relative;">
				...
				<div class="right_menu">
					<ul>
						<li class="current"><img src="${vix}/common/img/mail.png" alt="" />预处理值</li>
					</ul>
				</div>
