...
<input type="hidden" id="dataRowMethodTotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="dataRowMethodPageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="dataRowMethodTotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="dataRowMethodOrderField" value="${pager.orderField}" />
<input type="hidden" id="dataRowMethodOrderBy" value="${pager.orderBy}" />
<input type="hidden" id="dataRowMethodInfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="5%">
