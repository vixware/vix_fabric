...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('orgCode');" width="10%"><span style="cursor: pointer;" onclick="orderBy('orgCode');"> 编码&nbsp;<img id="categoryImg_orgCode" src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('fullName');" width="40%"><span style="cursor: pointer;" onclick="orderBy('fullName');"> 全称&nbsp;<img id="categoryImg_fullName" src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('fs');" width="10%"><span style="cursor: pointer;" onclick="orderBy('fs');"> 简称&nbsp;<img id="categoryImg_fs" src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('unitType');" width="10%"><span style="cursor: pointer;" onclick="orderBy('unitType');"> 组织单元类型&nbsp;<img id="categoryImg_unitType" src="${vix}/common/img/arrow.gif"></th>
			<th width="10%">操作</th>
		</tr>
		<% int count = 0; %>
				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#" onclick="deleteEntity('${entity.id}');" title="删除"><img src="${vix}/common/img/icon_12.png" /></a></i> <i><a href="#" onclick="showOrganizationUnit('${entity.id}');" title="<s:text name='cmn_show'/>"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}','');" title="修改"><img
										src="${vix}/common/img/icon_edit.png" /></a></i> <!-- 小i标题 --> <b></b>
							</strong>
							<!-- 小i内容 -->
							<p></p>
						</div>
