...
<script type="text/javascript">
    ...
    function saveOrUpdate() {
	    $.ajax({
	    url : '${vix}/common/measureUnitTypeAction!goSaveOrUpdate.action',
	    cache : false,
		    ...
		    callback : function(action) {
			    if (action == 'ok') {
				    if ($('#measureUnitTypeForm').validationEngine('validate')) {
					    $.post('${vix}/common/measureUnitTypeAction!saveOrUpdateUnitType.action', {
					    ...
					    'measureUnitType.name' : $("#measureUnitTypeName").val(),
						    ...
						    showMessage(result);
						    setTimeout("", 1000);
						    loadContent('${vix}/common/measureUnitTypeAction!goList.action');
					    });
				    } else {
					    return false;
				    }
    ...
    function deleteById(id) {
	    $.ajax({
	    url : '${vix}/common/measureUnitTypeAction!deleteById.action?id=' + id,
	    cache : false,
	    success : function(html) {
		    asyncbox.success(html, "提示信息", function(action) {
			    loadContent('${vix}/common/measureUnitTypeAction!goSingleList.action');
		    });
	    }
	    });
    }
    ...
    function searchForContent() {
	    loadName();
	    pager("start", "${vix}/common/measureUnitTypeAction!goSingleList.action?name=" + name, 'measureUnitType');
    }
    ...
    function orderBy(orderField) {
	    ...
	    pager("start", "${vix}/common/measureUnitTypeAction!goSingleList.action?orderField=" + orderField + "&orderBy=" + orderBy + "&name=" + name, 'measureUnitType');
    }

    function currentPager(tag) {
	    loadName();
	    pager(tag, "${vix}/common/measureUnitTypeAction!goSingleList.action?name=" + name, 'measureUnitType');
    }
</script>
<div class="sub_menu">
	<h2>
...
<div class="content">
	...
	<div id="number">
		...
		<ul id="numBox" class="numBox">
			...
			<s:iterator value="measureUnitTypeList" var="c">
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a> </span> <span><a class="previous" onclick="currentPager('previous');"></a> </span> <em>(<b class="measureUnitTypeInfo"></b> <s:text name='cmn_to' /> <b class="measureUnitTypeTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a> </span> <span><a class="end" onclick="currentPager('end');"></a> </span>
					</div>
				</div>
				<div id="measureUnitType" class="table"></div>
				<div class="pagelist drop">
					<ul>
