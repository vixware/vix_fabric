...
function loadChoosMetaDataId(){
	...
	vixAjaxSend(
			'${vix}/common/model/orginialBaseMetaDataAction!findMetaDataByName.action',
			queryString,
			function(result){
				//var msgObj = $.parseJSON(result);
				//var msg = msgObj.msg;
...
function loadPropertyMetaDataGrid(){
	...
	$('#dgdB1').datagrid({
		...
		striped: true,
		collapsible:true,
		url:'${vix}/common/model/orginialBaseMetaDataDefineAction!goPropertyObjList.action?metaDataName='+metaDataName,
		remoteSort: false,
		idField:'id',
		frozenColumns:[[
...
function loadExtPropertyMetaDataGrid(){
	...
	$('#dgdB1').datagrid({
		...
		striped: true,
		collapsible:true,
		url:'${vix}/common/model/orginialBaseMetaDataDefineAction!goExtPropertyObjList.action?metaDataName='+metaDataName,
		remoteSort: false,
		idField:'id',
		frozenColumns:[[
			{field:'ck',checkbox:true},
				...
				if(idVal!=''){
					asyncbox.confirm('确定要删除么?','提示信息',function(action){
						if(action == 'ok'){
							...
							$.post('${vix}/common/model/orginialBaseMetaDataDefineAction!deleteExtById.action',
								queryString,
								function(result){
									showMessage(result);
									setTimeout("", 1000);
...
function saveExtPropertyGrid(){
	...
	$.post('${vix}/common/model/orginialBaseMetaDataDefineAction!saveOrUpdateExt.action',
		paramStr,
		function(result){
			showMessage(result);
			setTimeout("", 1000);
