...
<input type="hidden" id="orginialVarTotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="orginialVarPageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="orginialVarTotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="orginialVarOrderField" value="${pager.orderField}" />
<input type="hidden" id="orginialVarOrderBy" value="${pager.orderBy}" />
<input type="hidden" id="orginialVarInfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="5%">
