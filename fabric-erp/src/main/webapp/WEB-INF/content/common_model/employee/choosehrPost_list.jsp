...
<div class="right_content">
	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				<th width="50">选择</th>
				<th onclick="orderBy('postsysCode');">职务编号</th>
				<th onclick="orderBy('postsysName');">职务名称</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.postsysCode}" type="radio" onclick="chkChange(this,'${entity.postsysCode}','${entity.postsysName}')" /></td>
					<%-- <td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td> --%>
					<td>${entity.postsysCode}</td>
					<td>${entity.postsysName}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
