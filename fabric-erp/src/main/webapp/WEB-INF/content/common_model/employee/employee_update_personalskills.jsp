							...
							<form id="employeeEssForm">
								<table style="border: none;">
									...
									<tr>
										...
										<td><input id="subordinatePosition" name="entityForm.subordinatePosition" value="${entity.subordinatePosition }" type="text" size="30" class="validate[required] text-input" /> <span style="color: red;">*</span> <input type="hidden" id="positionid" name="positionid" value="${entity.positionid }" /> <input class="btn" type="button"
											value="选择" onclick="choosePosition();" /></td>
										<td align="right">所属职称：</td>
										<td><input id="subordinateTitle" name="entityForm.subordinateTitle" value="${entity.subordinateTitle }" type="text" size="30" class="validate[required] text-input" /> <span style="color: red;">*</span> <input type="hidden" id="titleid" name="titleid" value="${entity.titleid }" /> <input class="btn" type="button" value="选择"
		...
		<div class="clearfix" style="background: #FFF; position: relative;">
			...
			<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
				<div style="padding: 8px;">
					<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/common/org/employeeOrgAction!getLanguageAbilityJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
					...
					<script type="text/javascript">
							...
							function addItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddLanguageAbility.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#daForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateLanguageAbility.action?id=${entity.id}', {
							...
							function editItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddLanguageAbility.action?id=${entity.id}&lid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteLanguageAbilityById.action?lId='+row.id,cache: false});
								}
							}
			...
			<div id="a2" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlReceivedAddress" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlReceivedAddressTb',url: '${vix}/common/org/employeeOrgAction!getComputerLevelJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addcItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddComputerLevel.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#caForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateComputerLevel.action?id=${entity.id}', {
							...
							function editcItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddComputerLevel.action?id=${entity.id}&cid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removecItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteComputerLevelById.action?cId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a3" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlDeliveryPlan" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlDeliveryPlanTb',url: '${vix}/common/org/employeeOrgAction!getWorkQualifyJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addwItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddWorkQualify.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#waForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateWorkQualify.action?id=${entity.id}', {
							...
							function editwItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddWorkQualify.action?id=${entity.id}&wid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removewItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteWorkQualifyById.action?wId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a4" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlInvoice" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlInvoiceTb',url: '${vix}/common/org/employeeOrgAction!getDegreeJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function adddItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddDegree.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#deForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateDegree.action?id=${entity.id}', {
																'degree.id' : $("#daId").val(),
							...
							function editdItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddDegree.action?id=${entity.id}&did='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removedItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteDegreeById.action?dId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a5" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlPriceConditions" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlPriceConditionsTb',url: '${vix}/common/org/employeeOrgAction!getTrainingJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addtItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddTraining.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dtForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateTraining.action?id=${entity.id}', {
							...
							function edittItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddTraining.action?id=${entity.id}&tid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removetItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteTrainingById.action?tId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a6" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlTechtitle" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlTechtitleTb',url: '${vix}/common/org/employeeOrgAction!getTechtitleJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addTechtitleItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddTechtitle.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dechtitleForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateTechtitle.action?id=${entity.id}', {
							...
							function editTechtitleItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddTechtitle.action?id=${entity.id}&teid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeTechtitleItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteTechtitleById.action?teId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a7" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlTechachieve" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlTechachieveTb',url: '${vix}/common/org/employeeOrgAction!getTechachieveJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addTechachieveItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddTechachieve.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dtechachieveForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateTechachieve.action?id=${entity.id}', {
							...
							function editTechachieveItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddTechachieve.action?id=${entity.id}&ctcid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeTechachieveItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteTechachieveById.action?ctcId='+row.id,cache: false});
								}
							}
					</script>
				</div>
