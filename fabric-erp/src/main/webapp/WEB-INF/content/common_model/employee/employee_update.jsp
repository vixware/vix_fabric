...
function swichContent(tabId){
	...
	if(tabId=="essentialinformation"){
		urlVal = '${vix}/common/org/employeeOrgAction!goSaveOrUpdateEss.action?id='+employeeId+"&parentId=${parentId}";
	}else if(tabId=="personalskills"){
		urlVal = '${vix}/common/org/employeeOrgAction!goSaveOrUpdatePer.action?id='+employeeId;
	}else if(tabId=="relationship"){
		urlVal = '${vix}/common/org/employeeOrgAction!goSaveOrUpdateRel.action?id='+employeeId;
	}else if(tabId=="workingsituation"){
		urlVal = '${vix}/common/org/employeeOrgAction!goSaveOrUpdateWork.action?id='+employeeId;
	}
	$.ajax({
		  url:urlVal,
		  cache: false,
	...
	<div class="order">
		<dl>
			<dt id="orderTieleFixd">
				<span class="no_line"> <a onclick="saveOrUpdateEss();"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="javascript:void(0)" onclick="saveOrAdd();"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <a href="#"
					onclick="loadContent('${vix}/common/org/employeeOrgAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a>
