		...
		<div class="clearfix" style="background: #FFF; position: relative;">
			...
			<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
				<div style="padding: 8px;">
					<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/common/org/employeeOrgAction!getWorkRecordJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
					...
					<script type="text/javascript">
							...
							function addItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddWorkRecord.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#daForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateWorkRecord.action?id=${entity.id}', {
							...
							function editItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddWorkRecord.action?id=${entity.id}&wordreid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteWorkRecordById.action?wordreId='+row.id,cache: false});
								}
							}
			...
			<div id="a2" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlReceivedAddress" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlReceivedAddressTb',url: '${vix}/common/org/employeeOrgAction!getPoliticalStatusJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addcItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddPoliticalStatus.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#caForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdatePoliticalStatus.action?id=${entity.id}', {
							...
							function editcItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddPoliticalStatus.action?id=${entity.id}&pid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removecItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deletePoliticalStatusById.action?pId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a3" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlDeliveryPlan" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlDeliveryPlanTb',url: '${vix}/common/org/employeeOrgAction!getSoldierTuneInfoJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addwItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddSoldierTuneInfo.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#waForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateSoldierTuneInfo.action?id=${entity.id}', {
							...
							function editwItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddSoldierTuneInfo.action?id=${entity.id}&soid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removewItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteSoldierTuneInfoById.action?soId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a4" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlInvoice" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlInvoiceTb',url: '${vix}/common/org/employeeOrgAction!getAwardInfoJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function adddItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddAwardInfo.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#deForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateAwardInfo.action?id=${entity.id}', {
							...
							function editdItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddAwardInfo.action?id=${entity.id}&awid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removedItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteAwardInfoById.action?awId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a5" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlPriceConditions" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlPriceConditionsTb',url: '${vix}/common/org/employeeOrgAction!getPunInfoJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addtItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddPunInfo.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dtForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdatePunInfo.action?id=${entity.id}', {
																'punInfo.id' : $("#daId").val(),
							...
							function edittItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddPunInfo.action?id=${entity.id}&punid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removetItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deletePunInfoById.action?punId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a6" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlTechtitle" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlTechtitleTb',url: '${vix}/common/org/employeeOrgAction!getPartPostionInfoJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addTechtitleItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddPartPostionInfo.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dechtitleForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdatePartPostionInfo.action?id=${entity.id}', {
							...
							function editTechtitleItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddPartPostionInfo.action?id=${entity.id}&partid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeTechtitleItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deletePartPostionInfoById.action?partId='+row.id,cache: false});
								}
							}
					</script>
				</div>
