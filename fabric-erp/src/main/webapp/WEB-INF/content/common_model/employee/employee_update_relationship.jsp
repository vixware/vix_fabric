		...
		<div class="clearfix" style="background: #FFF; position: relative;">
			...
			<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
				<div style="padding: 8px;">
					<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/common/org/employeeOrgAction!getRetireInfoJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
					...
					<script type="text/javascript">
							...
							function addItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddRetireInfo.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#daForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateRetireInfo.action?id=${entity.id}', {
							...
							function editItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddRetireInfo.action?id=${entity.id}&lrid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteRetireInfoById.action?lrId='+row.id,cache: false});
								}
							}
			...
			<div id="a2" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlReceivedAddress" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlReceivedAddressTb',url: '${vix}/common/org/employeeOrgAction!getRedeployInfoJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addcItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddRedeployInfo.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#caForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateRedeployInfo.action?id=${entity.id}', {
							...
							function editcItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddRedeployInfo.action?id=${entity.id}&creid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removecItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteRedeployInfoById.action?creId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a3" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlDeliveryPlan" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlDeliveryPlanTb',url: '${vix}/common/org/employeeOrgAction!getAboardJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addwsItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddAboard.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#waForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateAboard.action?id=${entity.id}', {
																'aboard.id' : $("#daId").val(),
							...
							function editwsItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddAboard.action?id=${entity.id}&abid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removewsItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteAboardById.action?abId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a4" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlInvoice" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlInvoiceTb',url: '${vix}/common/org/employeeOrgAction!getFamilyRelationshipJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function adddItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddFamilyRelationship.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#deForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateFamilyRelationship.action?id=${entity.id}', {
							...
							function editdItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddFamilyRelationship.action?id=${entity.id}&faid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removedItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteFamilyRelationshipById.action?faId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a5" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlPriceConditions" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlPriceConditionsTb',url: '${vix}/common/org/employeeOrgAction!getDisabilityDiseaseInforJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addtItem(){
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddDisabilityDiseaseInfor.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dtForm').validationEngine('validate')){
															$.post('${vix}/common/org/employeeOrgAction!saveOrUpdateDisabilityDiseaseInfor.action?id=${entity.id}', {
							...
							function edittItem(){
								...
								$.ajax({
									  url:'${vix}/common/org/employeeOrgAction!goAddDisabilityDiseaseInfor.action?id=${entity.id}&disaid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removetItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/common/org/employeeOrgAction!deleteTrainingById.action?disaId='+row.id,cache: false});
								}
							}
					</script>
				</div>
