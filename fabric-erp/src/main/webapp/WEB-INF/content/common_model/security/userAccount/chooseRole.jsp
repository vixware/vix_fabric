...
pager("start","${vix}/common/security/userAccountAction!goChooseRoleList.action?tag=${tag}&chkStyle=${chkStyle}","chk");
//排序 
function subOrderBy(orderField){
	...
	pager("start","${vix}/common/security/userAccountAction!goChooseRoleList.action?tag=${tag}&chkStyle=${chkStyle}&orderField="+orderField+"&orderBy="+orderBy,"chk");
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/common/security/userAccountAction!goChooseRoleList.action?tag=${tag}&chkStyle=${chkStyle}&name="+name,'chk');
}
</script>
