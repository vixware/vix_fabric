...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<%-- <th onclick="orderBy('authType');" width="10%">
				编号&nbsp;
			...
			<th onclick="orderBy('name');" width="15%"><span style="cursor: pointer;" onclick="orderBy('name');"> 名称&nbsp;<img id="categoryImg_name" src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('displayName');" width="20%"><span style="cursor: pointer;" onclick="orderBy('displayName');"> 显示名称&nbsp;<img id="categoryImg_displayName" src="${vix}/common/img/arrow.gif"></th>
			<th onclick="orderBy('authType');" width="10%"><span style="cursor: pointer;" onclick="orderBy('authType');"> 类型&nbsp;<img id="categoryImg_authType" src="${vix}/common/img/arrow.gif"></th>
			<th width="20%">备注&nbsp;</th>
			<th width="25%">操作</th>
		</tr>
		<% int count = 0; %>
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><s:if test="%{#entity.authType.equals(\"M\")}">菜单</s:if> <s:elseif test="%{#entity.authType.equals(\"F\")}">功能</s:elseif></td>
				<td>${entity.memo}</td>
				<td><a href="#" onclick="saveOrUpdate('${entity.id}','${entity.bizType}');" title="修改"> <img src="${vix}/common/img/icon_edit.png" />
				</a> <a href="#" onclick="deleteEntity('${entity.id}');" title="删除"> <img src="${vix}/common/img/icon_12.png" />
				</a>
					<div class="untitled" style="position: static; display: inline;">
						<span><img alt="" src="img/icon_untitled.png"></span>
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#"></a></i> <i><a href="#" title="查看"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}','');" title="修改"></a></i>
							<%--$('#parentId').val() --%> <b>${entity.name}</b>
							</strong>
							<p>${entity.memo}</p>
						</div>
					</div></td>
