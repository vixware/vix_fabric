...
function chooseParentAuthority(){
	$.ajax({
		  url:'${vix}/common/security/authority/authorityAction!goChooseAuthority.action',
		  cache: false,
...
function addResource(){
	$.ajax({
		  url:'${vix}/common/security/resourceAction!goChooseResource.action?tag=choose',
		  cache: false,
		  success: function(html){
			  asyncbox.open({
				 	modal:true,
		...
		<form action="" id="authorityForm" name="authorityForm">
			...
			<table>
				<tr>
					...
					<td colspan="3"><input type="hidden" id="parentTreeId" name="parentTreeId" value="${parentTreeId}" /> <input type="text" id="parentTreeName" name="parentTreeName" readonly="readonly" value="${parentTreeName}" /> <input class="btn" type="button" value="选择" onclick="chooseParentAuthority();" /></td>
				</tr>
				<tr height="40">
