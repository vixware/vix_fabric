...
pager("start","${vix}/common/security/userAccountAction!goChooseUserAccountList.action?tag=${tag}","chk");
//排序 
function subOrderBy(orderField){
	...
	pager("start","${vix}/common/security/userAccountAction!goChooseUserAccountList.action?tag=${tag}&orderField="+orderField+"&orderBy="+orderBy,"chk");
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/common/security/userAccountAction!goChooseUserAccountList.action?tag=${tag}&name="+name,'chk');
}
</script>
