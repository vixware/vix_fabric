...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<%-- <th onclick="orderBy('roleCode');" width="20%">
				<span style="cursor: pointer;" onclick="orderBy('roleCode');">
				编码&nbsp;<img id="roleImg_roleCode" src="${vix}/common/img/arrow.gif">
			</th> --%>
			<th onclick="orderBy('name');" width="25%"><span style="cursor: pointer;" onclick="orderBy('name');"> &nbsp;角色名<img id="roleImg_name" src="${vix}/common/img/arrow.gif"></th>
			<th width="20%">开始时间</th>
			<th width="20%">结束时间</th>
			<th width="15%">备注</th>
			<th width="15%"><s:text name="cmn_operate" /></th>
		</tr>
		<% int count = 0; %>
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><s:if test="tag != 'choose'">
						...
						<a href="#" onclick="toAuthority('${entity.id}');" title="授权"> <img src="${vix}/common/img/icon_sec_auth.png" />
						</a>
						<a href="#" onclick="toRoleColConfig('${entity.id}');" title="列权限配置"> <img src="${vix}/common/img/iconfont-quanxianxiugai.png" />
						</a>
						<a href="#" onclick="deleteEntity('${entity.id}');" title="<s:text name='cmn_delete'/>"> <img src="${vix}/common/img/icon_12.png" />
						</a>

						<a href="#" onclick="toRolePdc('${entity.id}');" title="首页面配置"> <img src="${vix}/common/img/win_btn_03.png" />
						</a>
