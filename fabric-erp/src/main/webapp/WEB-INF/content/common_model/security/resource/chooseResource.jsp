...
pager("start","${vix}/common/security/resourceAction!goChooseResourceList.action?tag=${tag}","chk");
//排序 
function subOrderBy(orderField){
	...
	pager("start","${vix}/common/security/resourceAction!goChooseResourceList.action?tag=${tag}&orderField="+orderField+"&orderBy="+orderBy,"chk");
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/common/security/resourceAction!goChooseResourceList.action?tag=${tag}&name="+name,'chk');
}
</script>
