...
<input type="hidden" id="moduleTotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="modulePageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="moduleTotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="moduleOrderField" value="${pager.orderField}" />
<input type="hidden" id="moduleOrderBy" value="${pager.orderBy}" />
<input type="hidden" id="moduleInfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="5%">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.moduleCode }</a></td>
