...
function chooseParentBusinessOrg(){
	$.ajax({
		  url:'${vix}/pm/org/pmOrgAction!goChooseBusinessOrg.action',
		  cache: false,
					...
					callback : function(action,returnValue){
						if(action == 'ok'){
							if(returnValue != undefined){
								...
								$("#parentId").val("");
								$("#parentTreeName").val("");
								asyncbox.success("请选择业务组织信息!","提示信息");
							}
						}
					},
...
<div class="content" style="margin-top: 15px; overflow: hidden">
	...
	<div class="box order_table" style="line-height: normal;">
		<form action="" id="pmOrgForm" name="pmOrgForm">
			<s:hidden id="id" name="entityForm.id" value="%{entity.id}" theme="simple" />
			<table>
				<tr>
					<td align="right">上级业务组织:&nbsp;</td>
					<td colspan="3"><input type="hidden" id="parentId" name="parentIdStr" value="${parentIdStr}" /> <input type="hidden" id="parentTreeType" name="parentTreeType" value="${parentTreeType}" /> <input type="text" id="parentTreeName" name="parentTreeName" readonly="readonly" value="${parentTreeName}" /> <input class="btn" type="button"
						value="选择" onclick="chooseParentBusinessOrg();" /></td>
				</tr>
				<tr height="40">
					<td align="right">编码:&nbsp;</td>
					<td><input type="text" id="businessOrgCode" name="entityForm.businessOrgCode" value="${entity.businessOrgCode}" data-text-tooltip="必须填写！" class="sweet-tooltip" style="border: 1px solid rgb(204, 204, 204); background: none repeat scroll 0% 0% rgb(255, 255, 255);" /></td>
					<td align="right">名称:&nbsp;</td>
					<td><input type="text" id="businessOrgName" name="entityForm.businessOrgName" value="${entity.businessOrgName}" data-text-tooltip="必须填写！" class="sweet-tooltip" style="border: 1px solid rgb(204, 204, 204); background: none repeat scroll 0% 0% rgb(255, 255, 255);" /></td>
				</tr>
				...
				<tr height="40">
					...
					<td colspan="3"><s:radio id="bizOrgType" list="#{\"O\":\"部门\",\"R\":\"角色\",\"E\":\"人员\"}" name="bizOrgType" value="%{entity.bizOrgType}" onchange="changeBizOrgType(this.value);" theme="simple"></s:radio></td>
				</tr>
				<tr>
					<td align="right">业务组织:&nbsp;</td>
					<td colspan="3"><input type="hidden" id="bizOrgIds" name="bizOrgIds" value="${bizOrgIds}" /> <%-- <input type="hidden" id="parentTreeType" name="parentTreeType" value="${parentTreeType}"/> --%> <input type="text" id="bizOrgNames" name="bizOrgNames" readonly="readonly" value="${bizOrgNames}" /> <input class="btn" type="button" value="选择"
						onclick="addBizOrgObject();" /> <input class="btn" type="button" value="清空" onclick="clearBizOrgType();" /></td>
				</tr>
				<!-- <tr height="30">
