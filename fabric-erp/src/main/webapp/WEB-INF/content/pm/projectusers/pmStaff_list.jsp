	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">项目管理</a></li>
				<li><a href="#">项目一览</a></li>
				<li><a href="#" onclick="loadContent('${vix}/crm/pm/pmStaffListAction!goList.action');">人员一览</a></li>
			</ul>
		</div>
	</h2>
</div>
	...
	<div class="npcontent clearfix">
		...
		<div class="np_left clearfix" id="common_table">
			...
			<div class="task_list">
				<table width="100%">
					<tr>
						<th colspan="4">人员名称：<b>${customerAccount.name}</b></th>
					</tr>
					<tr>
						<td class="ar">项目人员：</td>
