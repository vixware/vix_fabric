...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/pm/changeManageAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/pm/changeManageAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/pm/changeManageAction!goSingleList.action?name="+name,'changeRecord');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/pm/changeManageAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'changeRecord');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/pm/changeManageAction!goSingleList.action?name="+name,'changeRecord');
}
