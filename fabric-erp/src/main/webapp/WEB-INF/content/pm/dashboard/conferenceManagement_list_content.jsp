	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td>xx会议</td>
				<td><span style="color: gray;">第一会议室</span></td>
				<td><span style="color: gray;">2013-11-15</span></td>
				<td><span style="color: gray;">2013-11-18</span></td>
				<td><span style="color: gray;">3天</span></td>
				<td><span style="color: gray;">正在进行</span></td>
				<td><span style="color: gray;">阿萨</span></td>
				<td>
