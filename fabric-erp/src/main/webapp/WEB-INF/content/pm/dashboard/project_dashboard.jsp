...
<link href="css/asyncBox/skins/default.css" type="text/css" rel="stylesheet" />
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#"><s:text name="仪表盘" /></a></li>
				<li><a href="#"><s:text name="项目仪表盘" /></a></li>
			</ul>
		</div>
	</h2>
</div>
	...
	<div class="npcontent clearfix">
		<div class="np_right">
			<div class="np_right_box">
				<div class="nprb_title">任务进度</div>
				<div id="container" style="min-width: 200px; margin: 0 auto"></div>
			</div>
			<div class="np_right_box">
				<div class="nprb_title">错误状态</div>
			...
			<div class="np_right_box">
				...
				<ul class="datelist">
					<li class="clearfix">
						<div class="np_date">
							<strong>十一月</strong><span>30</span>
						</div>
						<div class="np_date_text">
							<strong>总帐报表</strong><span class="red">lace by 215 days</span> by Tricia Boyle
						</div>
					</li>
					<li class="clearfix">
						<div class="np_date">
