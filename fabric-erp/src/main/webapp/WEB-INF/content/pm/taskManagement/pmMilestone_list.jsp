												...
												<dd>
													<table width="100%">
														...
														<tr>
															...
															<td><input name="" type="checkbox" value="" /></td>
															<td><img src="img/list_icon_24.gif" /> FRAC项目</td>
															<td id="owner-link_19491201"><a href="javascript:;" class="hn" id="owner_span_19491201" onclick="openOwnerOptions('19491201','owner','townerdiv','owner-link_');">任意成员 <span class="morearrow" style="visibility: hidden;">▼</span></a></td>
															<td id="priority-link_19491201"><a href="javascript:;" class="hn" id="priority_span_19491201" onclick="openOptions('19491201','priority','prioritydiv','priority-link_');">中&nbsp;<span class="morearrow" style="visibility: hidden;">▼</span></a></td>
															<td id="sdatecal_19491201" onclick="showTime('sdate_19491201','dd/MM/yy');" class="cursor"><input type="text" class="setDate" id="sdate_19491201" value="12/09/12" readonly="readonly" /><span class="morearrow" style="visibility: hidden;">▼</span></td>
															<td id="edatecal_19491201" onclick="showTime('edate_19491201','dd/MM/yy');"><input type="text" class="setDate" id="edate_19491201" value="12/09/12" readonly="readonly" /><span class="morearrow" style="visibility: hidden;">▼</span></td>
															<td id="dur-link_19491201" onclick="openOptions('19491201','duration','durdiv','dur-link_');" class="cursor">1 天 <span class="morearrow" style="visibility: hidden;">▼</span></td>
															<td id="status-link_19491201"><a href="javascript:;" class="hn" id="status_span_19491201" onclick="openOptions('19491201','status','statusdiv','status-link_');">开始&nbsp;<span class="morearrow" style="visibility: hidden;">▼</span></a></td>
															<td>张三</td>
															<td id="percomp-link_19491201" onclick="openOptions('19491201','percomp','percompdiv','percomp-link_');">
																<div id="perdisp_19491201" class="w60px cursor" title="10% 完成">
																	<div class="w50px fl">
																		<div class="greenbar fl" style="width: 5px; height: 10px;"></div>
																		<div class="redbar fl" style="width: 45px; height: 10px;"></div>
																	</div>
									...
									<td valign="top" class="rhsdivbg" width="292" style="width: 256px;">
										<div class="np_right" id="followBox" style="position: relative; height: 1940px;">
											<div class="np_right_box" id="follow" style="position: absolute;">
												...
												<ul class="npr_list">
													<li><a href="javascript:;" onclick="javascript:$('#addtlistid').show();scrollInViewPart('addtlistid');">New Task List</a></li>
													<li><a href="javascript:;" onclick="javascript:$('#todoexpid').show();">Export</a></li>
												</ul>
												<div class="npr_form">
													<div class="npr_form_title">FILTER BY</div>
													<p>
														Owner<br />
														<select name="">
