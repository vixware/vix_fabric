...
<table class="list" style="width: 1200px;">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('name');" width="15%">标的&nbsp; <s:if test="%{pager.orderField == 'name' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('description');" width="15%">地址&nbsp; <s:if test="%{pager.orderField == 'description' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('createTime');" width="10%">开始时间&nbsp; <s:if test="%{pager.orderField == 'createTime' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('endTime');" width="8%">结束时间&nbsp; <s:if test="%{pager.orderField == 'endTime' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'endTime' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('updateTime');" width="8%">持续时间&nbsp; <s:if test="%{pager.orderField == 'updateTime' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'updateTime' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			...
			<th onclick="orderBy('lifetime');" width="8%">创建人&nbsp; <s:if test="%{pager.orderField == 'lifetime' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
