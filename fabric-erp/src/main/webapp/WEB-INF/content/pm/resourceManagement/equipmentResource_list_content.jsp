...
<table class="list" style="width: 1200px;">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('description');" width="15%">描述&nbsp; <s:if test="%{pager.orderField == 'description' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('status');" width="10%">状态&nbsp; <s:if test="%{pager.orderField == 'status' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('serviceCondition');" width="10%">使用情况&nbsp; <s:if test="%{pager.orderField == 'serviceCondition' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('consumeRate');" width="8%">耗损率&nbsp; <s:if test="%{pager.orderField == 'consumeRate' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('consumeUnit');" width="8%">耗损单位&nbsp; <s:if test="%{pager.orderField == 'consumeUnit' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('lifetime');" width="8%">寿命&nbsp; <s:if test="%{pager.orderField == 'lifetime' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
