...
<table class="list" style="width: 1200px;">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('linkman');" width="15%">联系人&nbsp; <s:if test="%{pager.orderField == 'linkman' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'linkman' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('phone');" width="10%">电话&nbsp; <s:if test="%{pager.orderField == 'phone' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'phone' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			...
			<th onclick="orderBy('rank');" width="8%">等级&nbsp; <s:if test="%{pager.orderField == 'rank' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'rank' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('createDate');" width="8%">创建时间&nbsp; <s:if test="%{pager.orderField == 'createDate' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
