...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="15%">员工名称</th>
			<th width="15%">迟到时间(小时)</th>
			<th width="15%">早退时间(小时)</th>
			<th width="15%">出勤天数</th>
			<th width="15%">请假天数</th>
			<th width="15%">旷工天数</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.lagTime }</span></td>
				<td><span style="color: gray;">${entity.earlyTime }</span></td>
				<td><span style="color: gray;">${entity.attendanceDays }</span></td>
				<td><span style="color: gray;">${entity.absenceOfTime }</span></td>
				<td><span style="color: gray;">${entity.workTime }</span></td>
				<td>
