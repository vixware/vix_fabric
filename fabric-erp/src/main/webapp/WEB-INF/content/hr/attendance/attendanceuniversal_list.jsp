	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">考勤管理</a></li>
				<li><a href="#">考勤设置</a></li>
				<li><a href="#" onclick="loadContent('${vix}/hr/attendanceUniversalAction!goList.action');">通用考勤制度</a></li>
			</ul>
		</div>
	</h2>
	<div class="drop">
		...
		<div id="right">
			<div style="overflow: hidden; padding: 10px 0 0;">
				<ul class="np_tab clearfix">
					<li class="current"><a href="javascript:;" onclick="javascript:tab(6,1,'np',event)">通用考勤制度</a></li>
				</ul>
					...
					<div class="nt">
						...
						<div class="nt_line">
							<table>
								<tr>
									<td>刷卡时间间隔</td>
									<td><input type="text" name="" value="5" class="ipt" />分钟</td>
								</tr>
							</table>
						</div>
					</div>
					<div class="nt">
						<div class="nt_title">考勤时间计算规则</div>
						<div class="nt_line">
							<table>
								<tr>
									<td>迟到早退最小计算单位</td>
									<td><input type="text" name="" value="1" class="ipt" />分钟 取整方式 <select name="">
											<option>进一</option>
											<option>去尾</option>
											<option>取整</option>
									</select> <label><input name="" type="radio" value="" />整段取整</label> <label><input name="" type="radio" value="" />整班次取整</label></td>
								</tr>
								<tr>
									<td>旷工最小计算单位</td>
									<td><input type="text" name="" value="30" class="ipt" />分钟 取整方式 <select name="">
											<option>进一</option>
											<option>去尾</option>
											<option>取整</option>
									</select> <label><input name="" type="radio" value="" />整段取整</label> <label><input name="" type="radio" value="" />整班次取整</label></td>
								...
								<tr>
									<td>请假时间</td>
									<td><input type="text" name="" value="" class="ipt" />分钟 取整方式 <select name="">
											<option>进一</option>
											<option>去尾</option>
											<option>取整</option>
									</select> <label><input name="" type="radio" value="" />整班次取整</label></td>
								</tr>
								<tr>
									<td>加班最小计算单位</td>
									<td><input type="text" name="" value="30" class="ipt" />分钟 取整方式 <select name="">
											...
											<option>去尾</option>
											<option>取整</option>
									</select> <label><input name="" type="radio" value="" />整段取整</label></td>
								</tr>
							</table>
						</div>
					</div>
					<div class="nt">
						<div class="nt_title">其他规则</div>
						<div class="nt_line">
							<table>
								<tr>
									<td><label><input name="" type="checkbox" value="" />迟到早退扣实际出勤时间</label></td>
									<td><label><input name="" type="checkbox" value="" />加班班段统计迟到、早退情况</label></td>
								</tr>
								<tr>
									<td><label><input name="" type="checkbox" value="" />加班班段统计欠卡、签卡次数</label></td>
									<td><label><input name="" type="checkbox" value="" />加班班段统计旷工时间</label></td>
								</tr>
							</table>
						</div>
					</div>
