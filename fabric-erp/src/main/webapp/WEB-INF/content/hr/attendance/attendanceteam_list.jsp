	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">考勤管理</a></li>
				<li><a href="#">考勤设置</a></li>
				<li><a href="#" onclick="loadContent('${vix}/hr/attendanceTeamAction!goList.action');">考勤班组</a></li>
			</ul>
		</div>
	</h2>
	<div class="drop">
...
<div class="content">
	<div id="c_head" class=" drop">
		...
		<div>
			<label>班组编码:<input id="srm_code" name="" type="text" class="int" /></label> <label> <input id="simpleSearch" name="" type="button" class="btn" value="<s:text name='cmn_search'/>" onclick="searchForContent(0);" /> <input id="simpleReset" name="" type="button" class="btn" value="<s:text name='cmn_reset'/>" onclick="resetForContent(0);" />
			</label> <strong id="lb_search_advanced" onclick="changeDisplay();"><s:text name='cmn_advance_search' /></strong>
		</div>
		<div class="search_advanced">
			<label>班组名称:<input id="srm_name" name="" type="text" class="int" /></label> <label>班组编码:<input id="srm_contacts" name="" type="text" class="int" /></label> <label> <input name="" type="button" class="btn" value="<s:text name='cmn_search'/>" onclick="searchForContent(1);" /> <input name="" type="button" class="btn"
		...
		<div id="right">
			<div style="overflow: hidden; padding: 10px 0 0;">
				<ul class="np_tab clearfix">
					<li class="current"><a href="javascript:;" onclick="javascript:tab(6,1,'np',event)">考勤班组</a></li>
				</ul>
				<div class="np_clist" id="np1">
					<div class="nt">
						<div class="nt_title">班组信息</div>
						<div class="nt_line">
							<table>
								<tr>
									<td>班组编码</td>
