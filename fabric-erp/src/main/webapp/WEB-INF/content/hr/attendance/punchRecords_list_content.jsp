	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.cardNumber }</span></td>
				<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.creCardDate}" type="both" pattern="yyyy-MM-dd HH:mm:ss" /></a></td>
				<td><span style="color: gray;">${entity.operator }</span></td>
