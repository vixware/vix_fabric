...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="hr_theme" /></th>
			<th><s:text name="hr_attendance_time" /></th>
			<th><s:text name="hr_mode" /></th>
			<th>审核人</th>
			<th width="90">审核时间</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">考勤管理</span></td>
				<td><span style="color: gray;">2013-02-10</span></td>
				<td><span style="color: gray;">执行中</span></td>
				<td><span style="color: gray;">李曼</span></td>
				<td width="90"><span style="color: gray;">2013-01-20</span></td>
				<td>
