	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">考勤管理</a></li>
				<li><a href="#">考勤设置</a></li>
				<li><a href="#" onclick="loadContent('${vix}/hr/attendanceFrequencyAction!goList.action');">考勤班次</a></li>
			</ul>
		</div>
	</h2>
	<div class="drop">
...
<div class="content">
	<div id="c_head" class=" drop">
		...
		<div>
			<label>班次编码:<input id="srm_code" name="" type="text" class="int" /></label> <label> <input id="simpleSearch" name="" type="button" class="btn" value="<s:text name='cmn_search'/>" onclick="searchForContent(0);" /> <input id="simpleReset" name="" type="button" class="btn" value="<s:text name='cmn_reset'/>" onclick="resetForContent(0);" />
			</label> <strong id="lb_search_advanced" onclick="changeDisplay();"><s:text name='cmn_advance_search' /></strong>
		</div>
		<div class="search_advanced">
			<label>班次名称:<input id="srm_name" name="" type="text" class="int" /></label> <label>班次编码:<input id="srm_contacts" name="" type="text" class="int" /></label> <label> <input name="" type="button" class="btn" value="<s:text name='cmn_search'/>" onclick="searchForContent(1);" /> <input name="" type="button" class="btn"
		...
		<div id="right">
			<div style="overflow: hidden; padding: 10px 0 0;">
				<ul class="np_tab clearfix">
					<li class="current"><a href="javascript:;" onclick="javascript:tab(6,1,'np',event)">考勤班次</a></li>
				</ul>
				<div class="np_clist" id="np1">
					<div class="nt">
						<div class="nt_title">班次信息</div>
						<div class="nt_line">
							<table>
								<tr>
									<td><label><input name="" type="checkbox" value="" />启用班次</label></td>
								</tr>
								<tr>
									<td>班次编码</td>
					...
					<div class="nt">
						<div class="nt_title">班次考勤规则</div>
						<div class="nt_line">
							<table>
								<tr>
									<td>迟到时间：不足</td>
									<td><input type="text" name="" value="0" class="ipt" />分钟忽略不计；超过<input type="text" name="" value="0" class="ipt" />分钟计为旷工</td>
								</tr>
								<tr>
									<td>早退时间：不足</td>
									<td><input type="text" name="" value="0" class="ipt" />分钟忽略不计；超过<input type="text" name="" value="0" class="ipt" />分钟计为旷工</td>
					...
					<div class="nt">
						<div class="nt_title">班段信息</div>
						<div class="nt_line">
							<table>
								<tr>
									<td><label>班段1<input name="" type="checkbox" value="" />加班段
									</label></td>
								</tr>
								<tr>
									<td><label><input name="" type="checkbox" value="" />签到</label></td>
									<td>起始刷卡时间</td>
									<td><input id="proposedTime" name="proposedTime" value="<fmt:formatDate value='${hrRecruitplan.proposedTime }' type='both' pattern='yyyy-MM-dd HH:mm:ss' />" readonly="readonly" type="text" /> <img onclick="showTime('proposedTime','yyyy-MM-dd HH:mm:ss')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
									<td>上班时间</td>
									<td><input id="proposedTimes" name="proposedTimes" value="<fmt:formatDate value='${hrRecruitplan.proposedTimes }' type='both' pattern='yyyy-MM-dd HH:mm:ss'  />" readonly="readonly" type="text" /> <img onclick="showTime('proposedTimes','yyyy-MM-dd HH:mm:ss')" src="${vix}/common/img/datePicker.gif" width="16" height="22"
										align="absmiddle"></td>
								</tr>
								<tr>
									<td><label><input name="" type="checkbox" value="" />签退</label></td>
									<td>起始刷卡时间</td>
									<td><input id="proposedTimess" name="proposedTimes" value="<fmt:formatDate value='${hrRecruitplan.proposedTimess }' type='both' pattern='yyyy-MM-dd HH:mm:ss' />" readonly="readonly" type="text" /> <img onclick="showTime('proposedTimess','yyyy-MM-dd HH:mm:ss')" src="${vix}/common/img/datePicker.gif" width="16" height="22"
										align="absmiddle"></td>
									<td>下班时间</td>
									<td><input id="proposedTimesss" name="proposedTimesss" value="<fmt:formatDate value='${hrRecruitplan.proposedTimesss }' type='both' pattern='yyyy-MM-dd HH:mm:ss' />" readonly="readonly" type="text" /> <img onclick="showTime('proposedTimesss','yyyy-MM-dd HH:mm:ss')" src="${vix}/common/img/datePicker.gif" width="16" height="22"
										align="absmiddle"></td>
								</tr>
							</table>
						</div>
