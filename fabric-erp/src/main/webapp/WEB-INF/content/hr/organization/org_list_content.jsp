...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="hr_person_charge" /></th>
			<th><s:text name="hr_creation_time" /></th>
			<th><s:text name="hr_effective_start_time" /></th>
			<th width="60"><s:text name="hr_org_level" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">人力资源组织架构</span></td>
				<td><span style="color: gray;">编制内</span></td>
				<td><span style="color: gray;">贺卫东</span></td>
				<td><span style="color: gray;">2013-06-04</span></td>
				<td><span style="color: gray;">2013-06-01</span></td>
				<td width="60"><span style="color: gray;">最高级别</span></td>
				<td>
