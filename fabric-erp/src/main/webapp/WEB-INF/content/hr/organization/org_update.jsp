	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<a href="#"><s:text name="hr_org_structure" /></a>
			</ul>
		</div>
	</h2>
</div>
							...
							<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											<td align="right">组织架构码：</td>
											<td><input name="" type="text" size="30" /></td>
											<td align="right">组织级别：</td>
										...
										<tr>
											...
											<td><textarea class=warehouseCode rows="3" style="width: 300px"></textarea></td>
										</tr>
									</table>
									<!-- 
								<p>
