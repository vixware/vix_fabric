...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th>部门负责人</th>
			<th><s:text name="hr_unit_to_which_belong" /></th>
			<th><s:text name="hr_grade" /></th>
			<th width="90"><s:text name="hr_creation_time" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">在职</span></td>
				<td><span style="color: gray;">林燕萍</span></td>
				<td><span style="color: gray;">北京海星有限责任公司</span></td>
				<td><span style="color: gray;">二级</span></td>
				<td width="90"><span style="color: gray;">2000-05-05</span></td>
