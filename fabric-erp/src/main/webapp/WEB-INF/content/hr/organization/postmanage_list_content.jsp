...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="hr_direct_supervisor" /></th>
			<th><s:text name="hr_post_grades" /></th>
			<th><s:text name="hr_starttime" /></th>
			<th width="90"><s:text name="hr_endtime" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">人力资源岗位管理</span></td>
				<td><span style="color: gray;">人资部</span></td>
				<td><span style="color: gray;">总经办公室</span></td>
				<td><span style="color: gray;">第三级</span></td>
				<td><span style="color: gray;">2013-06-01</span></td>
				<td width="40"><span style="color: gray;">9999-12-31</span></td>
				<td>
