...
<!--
	...
	$(function(){
		$("#salaryProjectItemForm").validationEngine();
	...
	function saveOrUpdateSalaryProjectOption(){
		...
		if(boDataRow.length<=0){
			showMessage("必须为职员添加业务组织！");
			setTimeout("", 1000);
			return;
		} */
		if($('#salaryProjectItemForm').validationEngine('validate')){
			var queryString = $('#salaryProjectItemForm').formSerialize(); 
			$.post('${vix}/hr/salary/salaryProjectItemAction!saveOrUpdate.action',
				queryString,
				function(result){
					showMessage(result);
					setTimeout("", 1000);
					loadContent('${vix}/hr/salary/salaryProjectItemAction!goList.action');
	...
	<dl>
		<dt>
			<span class="no_line"> <a href="#" onclick="saveOrUpdateSalaryProjectOption()"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消"
				...
				</div> <a href="#"><img width="22" height="22" alt="导出" src="${vix}/common/img/dt_export.png"></a> <a href="#" onclick="loadContent('${vix}/hr/salary/salaryProjectItemAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a>
							...
							<form id="salaryProjectItemForm">
								...
								<table style="border: none;">
									<tr height="40">
										...
										<td width="35%"><input type="text" id="salaryItemCode" name="entityForm.salaryItemCode" value="${entity.salaryItemCode}" data-text-tooltip="必须填写！" class="sweet-tooltip" style="border: 1px solid rgb(204, 204, 204); background: none repeat scroll 0% 0% rgb(255, 255, 255);" /> <%--
									...
									<tr>
										...
										<td colspan="3">
											...
											<input type="text" id="formular" name="entityForm.formular" readonly="readonly" value="${entity.formular}"/>
											 --%> <textarea id="formular" rows="5" cols="100">${entity.formular}</textarea>
										</td>
									</tr>
								</table>
							</form>
