	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">85844102</span></td>
				<td><span style="color: gray;">85844102</span></td>
				<td><span style="color: gray;">张海峰</span></td>
				<td><span style="color: gray;">5000</span></td>
				<td><span style="color: gray;">工资定义模型</span></td>
				<td><span style="color: gray;">自定义</span></td>
				<td><span style="color: gray;">已定义</span></td>
				<td width="40"><span style="color: gray;">2013-11-11</span></td>
				<td>
