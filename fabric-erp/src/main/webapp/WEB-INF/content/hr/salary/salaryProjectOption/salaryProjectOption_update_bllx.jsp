							...
							<form id="salaryProjectOptionForm">
								...
								<table style="border: none;">
									...
									<tr>
										...
										<td colspan="3">
											<%-- <input type="hidden" id="metaDataId" name="metaDataId" value="${metaDataId}"/> --%> <input type="hidden" id="metaData" name="entityForm.metaData" value="${entity.metaData}" /> <%-- <span id="parentTreeName"><s:property value="parentTreeName"/></span> --%> <input type="text" id="metaDataName" name="entityForm.metaDataName"
											readonly="readonly" value="${entity.metaDataName}" /> <input class="btn" type="button" value="选择" onclick="chooseMetaData();" />
										</td>
									</tr>
								</table>
							</form>
