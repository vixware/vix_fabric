	...
	$.post('${vix}/hr/probationAction!saveOrUpdateHrBecomeRegular.action',
		{
			...
			'hrBecomeRegular.age':$("#age").val(),	
			'hrBecomeRegular.iDNumber':$("#iDNumber").val(),	
			'hrBecomeRegular.jiaAddress':$("#jiaAddress").val(),	
			'hrBecomeRegular.legalRepresentative':$("#legalRepresentative").val(),	
			'hrBecomeRegular.telephone':$("#telephone").val(),	
			'hrBecomeRegular.fax':$("#fax").val(),	
			'hrBecomeRegular.yiName':$("#yiName").val(),	
			'hrBecomeRegular.yiAddress':$("#yiAddress").val(),	
			'hrBecomeRegular.yiFamily':$("#yiFamily").val(),	
			'hrBecomeRegular.yiFamilySuggestion':$("#yiFamilySuggestion").val(),	
			'hrBecomeRegular.bridgeProtocol':$("#bridgeProtocol").val(),	
			'hrBecomeRegular.leaveStartDate':$("#leaveStartDate").val(),	
			'hrBecomeRegular.leaveEndDate':$("#leaveEndDate").val(),	
			'types':types
		},
		function(result){
			showMessage(result);
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/probationAction!goSaveOrUpdate.action');">返聘</a></li>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong><b><s:text name="新增人事事务-返聘" /> </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><input name="" id="age" type="text" size="30" value="${hrBecomeRegular.age}" /></td>
											<td align="right">身份证号：</td>
											<td><input name="" id="iDNumber" type="text" size="30" value="${hrBecomeRegular.iDNumber}" class="validate[required] text-input" /><span style="color: red;">*</span></td>
										</tr>
										<tr>
											<td align="right">甲方地址：</td>
											<td><input name="" id="jiaAddress" type="text" size="30" value="${hrBecomeRegular.jiaAddress}" /></td>
											<td align="right">法定代表人：</td>
											<td><input name="" id="legalRepresentative" type="text" size="30" value="${hrBecomeRegular.legalRepresentative}" /></td>
										</tr>
										<tr>
											<td align="right">电话：</td>
											<td><input name="" id="telephone" type="text" size="30" value="${hrBecomeRegular.telephone}" /></td>
											<td align="right">传真：</td>
											<td><input name="" id="fax" type="text" size="30" value="${hrBecomeRegular.fax}" /></td>
										</tr>
										<tr>
											<td align="right">乙方名称：</td>
											<td><input name="" id="yiName" type="text" size="30" value="${hrBecomeRegular.yiName}" class="validate[required] text-input" /><span style="color: red;">*</span></td>
											<td align="right">乙方住址：</td>
											<td><input name="" id="yiAddress" type="text" size="30" value="${hrBecomeRegular.yiAddress}" /></td>
										</tr>
										<tr>
											<td align="right">返聘后所属部门 ：</td>
											<td><input id="afterThePromotionDepartment" name="parentId" value="${hrBecomeRegular.afterThePromotionDepartment}" type="text" size="30" class="validate[required] text-input" /></td>
											<td align="right">返聘后职位 ：</td>
											<td><input id="afterThePromotionPost" name="parentId" value="${hrBecomeRegular.afterThePromotionPost}" type="text" size="30" class="validate[required] text-input" /> <input type="hidden" id="parentId" name="parentId" value="${hrCategory.parentCategory.id }" /> <input class="btn" type="button" value="选择"
										...
										<tr>
											...
											<td align="right">返聘类型 ：</td>
											<td><select id="becomeFullMemberState" class="validate[required] text-input">
													<option value="">请选择</option>
													<option value="1">技术顾问</option>
													<option value="2">业务顾问</option>
											</select></td>
										</tr>
										<tr>
										...
										<tr>
											<td align="right">返聘开始时间：</td>
											<td><input id="leaveStartDate" name="leaveStartDate" value="<fmt:formatDate value='${hrBecomeRegular.leaveStartDate }' type='both' pattern='yyyy-MM-dd' />" readonly="readonly" type="text" /> <img onclick="showTime('leaveStartDate','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
											<td align="right">返聘结束时间 ：</td>
											<td><input id="leaveEndDate" name="leaveEndDate" value="<fmt:formatDate value='${hrBecomeRegular.leaveEndDate }' type='both' pattern='yyyy-MM-dd' />" readonly="readonly" type="text" /> <img onclick="showTime('leaveEndDate','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
										</tr>
										<tr>
											<td align="right">乙方家属：</td>
											<td><input name="" id="yiFamily" type="text" size="30" value="${hrBecomeRegular.yiFamily}" /></td>
										</tr>
										<tr>
											<td align="right">乙方家属意见：</td>
											<td colspan="2"><textarea id="yiFamilySuggestion" name="yiFamilySuggestion" class="example" rows="2" style="width: 250px">${hrBecomeRegular.yiFamilySuggestion }</textarea></td>
										</tr>
										<tr>
											<td align="right">返聘协议：</td>
											<td colspan="2"><textarea id="bridgeProtocol" name="bridgeProtocol" class="example" rows="2" style="width: 250px">${hrBecomeRegular.bridgeProtocol }</textarea></td>
										</tr>
									</table>
								</dd>
							</dl>
