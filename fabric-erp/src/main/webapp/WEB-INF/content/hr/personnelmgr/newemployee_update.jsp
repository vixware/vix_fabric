...
<!--
	...
	$('#dgdA1').datagrid({
		...
		frozenColumns:[[
			...
			{field:'ship',title:'进入单位  ',width:110,
				formatter:function(value,rec){
					return '<span>北京市名城股份有限公司 </span>';
				}
			},   
			{field:'invoicedocument',title:'单位子范围  ',width:130,
				formatter:function(value,rec){
					return '<span>智能手机 </span>';
				}
			}
		]],
		columns:[[
			{field:'specification',title:'工资范围',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			{field:'itemType',title:'姓名',width:150,
				formatter:function(value,rec){
					return '<span>IPhone4s</span>';
				}	
			},
			{field:'amount',title:'工号  ',width:150,
				formatter:function(value,rec){
					return '<span>10000台 </span>';
				}
			},
			{field:'sum',title:'身份证号  ',width:150,
				formatter:function(value,rec){
					return '<span>50000000 </span>';
				}
			},
			{field:'netprice',title:'出生日期  ',width:150,
				formatter:function(value,rec){
					return '<span>5000</span>';
				}
			},
			{field:'coin',title:'出生地  ',width:150,
				formatter:function(value,rec){
					return '<span>人民币 </span>';
				}
			},
			{field:'supplier',title:'户口性质  ',width:150,
				formatter:function(value,rec){
					return '<span>富士康集团</span>';
				}
			},
			{field:'receivingwarehouse',title:'婚姻状况  ',width:150,
				formatter:function(value,rec){
					return '<span>渔湾码头二号仓库 </span>';
				}
			},
			{field:'jiaohuodate',title:'部门 ',width:150,
				formatter:function(value,rec){
					return '<span>2012-10-01</span>';
				}
			},
			{field:'zhiwei',title:'职位 ',width:150,
				formatter:function(value,rec){
					return '<span>2012-10-01</span>';
				}
			},
			{field:'yuangongzu',title:'员工组  ',width:150,
				formatter:function(value,rec){
					return '<span>2012-10-01</span>';
				}
			},
			{field:'yuangongzizu',title:'员工子组  ',width:150,
				formatter:function(value,rec){
					return '<span>2012-10-01</span>';
				}
			},
			{field:'jinrushijian',title:'进入时间  ',width:150,
				formatter:function(value,rec){
					return '<span>2012-10-01</span>';
				}
			},
			{field:'jinruyuanyin',title:'进入原因  ',width:150,
				formatter:function(value,rec){
					return '<span>2012-10-01</span>';
				}
			}
	...
	$('#dgdA2').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'ship',title:'批准文号   ',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130523 </span>';
				}
			},   
			{field:'invoicedocument',title:'批文日期  ',width:130,
				formatter:function(value,rec){
					return '<span>智能手机 </span>';
				}
			}
		...
		columns:[[
			{field:'specification',title:'变动时间 ',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			...
			{field:'amount',title:'变动原因  ',width:150,
				formatter:function(value,rec){
					return '<span>10000台 </span>';
				}
			},
			{field:'sum',title:'变动前所在单位 ',width:150,
				formatter:function(value,rec){
					return '<span>50000000 </span>';
				}
			},
			{field:'netprice',title:'变动前所在部门  ',width:150,
				formatter:function(value,rec){
					return '<span>5000</span>';
				}
			},
			{field:'coin',title:'变动前所在岗位  ',width:150,
				formatter:function(value,rec){
					return '<span>人民币 </span>';
				}
			},
			{field:'supplier',title:'变动后所在单位   ',width:150,
				formatter:function(value,rec){
					return '<span>富士康集团</span>';
				}
			},
			{field:'receivingwarehouse',title:'变动后所在部门  ',width:150,
				formatter:function(value,rec){
					return '<span>渔湾码头二号仓库 </span>';
				}
			},
			{field:'jiaohuodate',title:'变动后所在岗位 ',width:150,
				formatter:function(value,rec){
					return '<span>2012-10-01</span>';
				}
			}	
	...
	$('#dgdA3').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'ship',title:'人员编号   ',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130523 </span>';
				}
			},   
			{field:'invoicedocument',title:'姓名 ',width:130,
				formatter:function(value,rec){
					return '<span>智能手机 </span>';
				}
			}
		...
		columns:[[
			{field:'specification',title:'退出类型 ',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			{field:'itemType',title:'岗位状态',width:150,
				formatter:function(value,rec){
					return '<span>IPhone4s</span>';
				}	
			},
			{field:'amount',title:'雇佣状态  ',width:150,
				formatter:function(value,rec){
					return '<span>10000台 </span>';
				}
			},
			{field:'sum',title:'职位  ',width:150,
				formatter:function(value,rec){
					return '<span>50000000 </span>';
				}
			},
			{field:'netprice',title:'操作原因  ',width:150,
				formatter:function(value,rec){
					return '<span>5000</span>';
				}
			}
...
{field:'name',title:'姓名',width:150,
	formatter:function(value,rec){
		return '<span>智能娱乐型手机  </span>';
			...
			{field:'specification',title:'调动原因',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			{field:'itemType',title:'调动日期',width:150,
				formatter:function(value,rec){
					return '<span>IPhone4s</span>';
				}	
			},
			{field:'amount',title:'调出单位 ',width:150,
				formatter:function(value,rec){
					return '<span>10000台 </span>';
				}
			},
			{field:'sum',title:'调出单位部门 ',width:150,
				formatter:function(value,rec){
					return '<span>50000000 </span>';
				}
			},
			{field:'netprice',title:'调出单位职位  ',width:150,
				formatter:function(value,rec){
					return '<span>5000</span>';
				}
			},
			{field:'coin',title:'调入单位  ',width:150,
				formatter:function(value,rec){
					return '<span>人民币 </span>';
				}
			},
			{field:'supplier',title:'调入单位部门  ',width:150,
				formatter:function(value,rec){
					return '<span>富士康集团</span>';
				}
			},
			{field:'receivingwarehouse',title:'调入单位职位  ',width:150,
				formatter:function(value,rec){
					return '<span>渔湾码头二号仓库 </span>';
				}
			}
...
{field:'name ',title:'姓名',width:150,
	formatter:function(value,rec){
		return '<span>智能娱乐型手机  </span>';
			...
			{field:'specification',title:'借调原因 ',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			{field:'itemType',title:'借调日期',width:150,
				formatter:function(value,rec){
					return '<span>IPhone4s</span>';
				}	
			},
			{field:'amount',title:'借调前单位  ',width:150,
				formatter:function(value,rec){
					return '<span>10000台 </span>';
				}
			},
			{field:'sum',title:'借调前部门 ',width:150,
				formatter:function(value,rec){
					return '<span>50000000 </span>';
				}
			},
			{field:'netprice',title:'借调前职位  ',width:150,
				formatter:function(value,rec){
					return '<span>5000</span>';
				}
			},
			{field:'coin',title:'借调后单位  ',width:150,
				formatter:function(value,rec){
					return '<span>人民币 </span>';
				}
			},
			{field:'supplier',title:'借调后部门  ',width:150,
				formatter:function(value,rec){
					return '<span>富士康集团</span>';
				}
			},
			{field:'receivingwarehouse',title:'借调后职位  ',width:150,
				formatter:function(value,rec){
					return '<span>渔湾码头二号仓库 </span>';
				}
			}
	...
	$('#dgdA6').datagrid({
		...
		columns:[[
			{field:'specification',title:'操作类型',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			{field:'itemType',title:'操作原因',width:150,
				formatter:function(value,rec){
					return '<span>IPhone4s</span>';
				}	
			},
			{field:'amount',title:'岗位状态   ',width:150,
				formatter:function(value,rec){
					return '<span>10000台 </span>';
				}
			},
			{field:'sum',title:'雇佣状态   ',width:150,
				formatter:function(value,rec){
					return '<span>50000000 </span>';
				}
			},
			{field:'netprice',title:'职位 ',width:150,
				formatter:function(value,rec){
					return '<span>5000</span>';
				}
			}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<a href="#" onclick="loadContent('${vix}/hr/newEmployeeAction!goSaveOrUpdate.action');">新增</a>
			...
			<dl>
							...
							<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										<tr>
											<td align="right">进入单位 ：</td>
											<td><select style="width: 50"><option>请选择</option></select></td>
											<td align="right">单位子范围 ：</td>
											<td><select style="width: 50"><option>请选择</option></select></td>
										</tr>
										<tr>
											<td align="right">工资范围 ：</td>
											<td><select style="width: 50"><option>请选择</option></select></td>
										...
										<tr>
											...
											<td><input id="csDate" name="" type="text" /> <img onclick="showTime('csDate','yyyy-MM-dd HH:mm')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
							...
							<dl>
								...
								<p>
								 ...
								 -->
									<table style="border: none;">
										<tr>
											<td align="right">进入单位时间：</td>
											<td><input id="jinruDate" name="" type="text" /> <img onclick="showTime('jinruDate','yyyy-MM-dd HH:mm')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
											<td align="right">进入原因：</td>
											<td><input name="" type="text" size="30" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input id="pizhunDate" name="" type="text" /> <img onclick="showTime('pizhunDate','yyyy-MM-dd HH:mm')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
										</tr>
										<tr>
											<td align="right">是否家属员工：</td>
											<td><select style="width: 50"><option>请选择</option></select></td>
											<td align="right">备注：</td>
											<td><textarea class=warehouseCode rows="3" style="width: 200px"></textarea></td>
										</tr>
									</table>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							<%--<li class="current"><a onclick="javascript:tab(8,1,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />员工新增</a></li>
					 	<li><a onclick="javascript:$('#a2').attr('style','');tab(8,2,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />身份变动</a></li>
						<li><a onclick="javascript:$('#a3').attr('style','');tab(8,3,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />员工退出</a></li>
						<li><a onclick="javascript:$('#a4').attr('style','');tab(8,4,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />员工调动</a></li>
						<li><a onclick="javascript:$('#a5').attr('style','');tab(8,5,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />员工借调</a></li>
						<li><a onclick="javascript:$('#a6').attr('style','');tab(8,6,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />员工调入/调出</a></li>--%>
							<li><a onclick="javascript:$('#a7').attr('style','');tab(8,7,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />审批</a></li>
							<li><a onclick="javascript:$('#a8').attr('style','');tab(8,8,'a',event)"><img src="${vix}/common/img/attachment.png" alt="" />附件</a></li>
						</ul>
					</div>
