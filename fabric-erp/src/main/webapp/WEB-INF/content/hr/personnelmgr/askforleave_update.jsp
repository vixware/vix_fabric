...
function saveOrAdd(){
	...
	$.post('${vix}/hr/probationAction!saveOrUpdateHrBecomeRegular.action',
		...
		function(result){
			showMessage(result);
			setTimeout("",1000);
			loadContent('${vix}/hr/probationAction!goSaveOrUpdateAskForLeave.action');
		}
	 );
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/probationAction!goSaveOrUpdateAskForLeave.action');">请假</a></li>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong><b><s:text name="新增人事事务-请假" /> </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><select id="leaveType" class="validate[required] text-input">
													<option value="">请选择</option>
										...
										<tr>
											...
											<td><input name="" id="leaveName" type="text" size="30" value="${hrBecomeRegular.leaveName}" /></td>
										</tr>
									</table>
								</dd>
							</dl>
