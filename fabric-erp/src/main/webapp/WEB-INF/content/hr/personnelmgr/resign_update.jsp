...
function saveOrAdd(){
	...
	$.post('${vix}/hr/probationAction!saveOrUpdateHrBecomeRegular.action',
		...
		function(result){
			showMessage(result);
			setTimeout("",1000);
			loadContent('${vix}/hr/probationAction!goSaveOrUpdateXresign.action');
		}
	 );
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/probationAction!goSaveOrUpdateXresign.action');">离职</a></li>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong><b><s:text name="新增人事事务-离职" /> </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
