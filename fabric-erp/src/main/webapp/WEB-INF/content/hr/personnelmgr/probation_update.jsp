...
function saveOrAdd(){
	...
	$.post('${vix}/hr/probationAction!saveOrUpdateHrBecomeRegular.action',
		...
		function(result){
			showMessage(result);
			setTimeout("",1000);
			loadContent('${vix}/hr/probationAction!goSaveOrUpdate.action');
		}
	 );
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/probationAction!goSaveOrUpdate.action');">转正</a></li>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong><b><s:text name="新增人事事务-转正" /> </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
							...
							<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											<td align="right">试用期所属部门 ：</td>
											<td><input id="probationDepartment" name="parentId" value="${hrBecomeRegular.probationDepartment}" type="text" size="30" class="validate[required] text-input" />
											<%--  <input
												type="hidden" id="parentId" name="parentId"
												value="${hrCategory.parentCategory.id }" /> <input
												class="btn" type="button" value="选择"
												onclick="chooseParentCategory(1);" /> <span
												style="color: red;">*</span> --%></td>
											<td align="right">试用期职位 ：</td>
										...
										<tr>
											<td align="right">转正后所属部门 ：</td>
											<td><input id="afterThePromotionDepartment" name="parentId" value="${hrBecomeRegular.afterThePromotionDepartment}" type="text" size="30" class="validate[required] text-input" /> <%--  <input
												type="hidden" id="parentId" name="parentId"
												value="${hrCategory.parentCategory.id }" /> <input
												class="btn" type="button" value="选择"
												onclick="chooseParentCategory(2);" /> <span
												style="color: red;">*</span> --%></td>
											<td align="right">转正后职位 ：</td>
										...
										<tr>
											<td align="right">审批人评价：</td>
											<td><textarea id="approvalEvaluate" name="approvalEvaluate" class="example" rows="2" style="width: 250px">${hrBecomeRegular.approvalEvaluate }</textarea></td>
											<td align="right">转正原因 ：</td>
											<td><textarea id="becomeFullMembercause" name="becomeFullMembercause" class="example" rows="2" style="width: 250px">${hrBecomeRegular.becomeFullMembercause }</textarea></td>
										</tr>
										<tr>
											<td align="right">试用期表现：</td>
											<td><textarea id="trialPeriod" name="trialPeriod" class="example" rows="2" style="width: 250px">${hrBecomeRegular.trialPeriod }</textarea></td>
										</tr>
									</table>
								</dd>
							</dl>
