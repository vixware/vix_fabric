...
function saveOrAdd(){
	...
	$.post('${vix}/hr/probationAction!saveOrUpdateHrBecomeRegular.action',
		...
		function(result){
			showMessage(result);
			setTimeout("",1000);
			loadContent('${vix}/hr/probationAction!goSaveOrUpdateXtaffTurnover.action');
		}
	 );
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/probationAction!goSaveOrUpdateXtaffTurnover.action');">异动</a></li>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong><b><s:text name="新增人事事务-异动" /> </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td align="right">异动状态 ：</td>
											<td><select id="becomeFullMemberState" class="validate[required] text-input">
													<option value="">请选择</option>
													<option value="1">已异动</option>
													<option value="2">未异动</option>
											</select></td>
										</tr>
										<tr>
