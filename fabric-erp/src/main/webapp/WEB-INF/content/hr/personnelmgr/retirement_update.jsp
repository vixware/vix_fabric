	...
	$.post('${vix}/hr/probationAction!saveOrUpdateHrBecomeRegular.action',
		{
			...
			'hrBecomeRegular.remarks':$("#remarks").val(),	
...
function saveOrAdd(){
	...
	$.post('${vix}/hr/probationAction!saveOrUpdateHrBecomeRegular.action',
		...
		function(result){
			showMessage(result);
			setTimeout("",1000);
			loadContent('${vix}/hr/probationAction!goSaveOrUpdateRetirement.action');
		}
	 );
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/probationAction!goSaveOrUpdateRetirement.action');">离退休</a></li>
			</ul>
		</div>
	</h2>
</div>
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong><b><s:text name="新增人事事务-离退休" /> </b><i></i> </strong>
				</dt>
							...
							<dd style="display: block;">
								<table style="border: none;">
									...
									<tr>
										...
										<td><input name="" id="remarks" type="text" size="30" value="${hrBecomeRegular.remarks}" /></td>
									</tr>
									<tr>
