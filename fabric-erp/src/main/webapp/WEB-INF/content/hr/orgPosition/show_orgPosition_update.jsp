			...
			<dl>
				<dt>
					<span class="no_line"> <a href="#"><img width="22" height="22" title="禁用" src="${vix}/common/img/dt_disable.png" /> </a> <a href="#"><img width="22" height="22" title="锁定" src="${vix}/common/img/dt_locked.png" /> </a><a href="#"><img width="22" height="22" title="删除" src="${vix}/common/img/dt_delete.png" /> </a> <a href="#"><img
							width="22" height="22" title="审批通过" src="${vix}/common/img/dt_aprroval.png" /> </a> <a href="#"><img width="22" height="22" title="驳回" src="${vix}/common/img/dt_reject.png"> </a> <a href="#"><img width="22" height="22" title="上一条" src="${vix}/common/img/dt_before.png"> </a> <a href="#"><img width="22" height="22" title="下一条"
							src="${vix}/common/img/dt_next.png"> </a> <a href="#"><img width="22" height="22" title="打印" src="${vix}/common/img/dt_print.png"> </a>
						...
						</div> <a href="#"><img width="22" height="22" title="导出" src="${vix}/common/img/dt_export.png"> </a> <a href="#" onclick="loadContent('${vix}/hr/position/orgPositionAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
								...
								<dd style="display: block;">
									<table style="border: none;">
										<tr>
											...
											<td><input id="code" name="entityForm.code" readonly="readonly" value="${entity.organizationUnit.orgCode}" type="text" class="validate[required] text-input" /><span style="color: red;">*</span></td>
											<td align="right">岗位名称:&nbsp;</td>
											<td><input id="posName" name="entityForm.posName" readonly="readonly" value="${entity.posName}" type="text" class="validate[required] text-input" /><span style="color: red;">*</span></td>
										</tr>
										<tr>
											<td align="right">岗位序号:&nbsp;</td>
											<td><input id="postNumber" name="entityForm.postNumber" type="text" readonly="readonly" value="${entity.postNumber}" /></td>
											<td align="right">岗位性质:&nbsp;</td>
											<td><input id="jobNature" name="entityForm.jobNature" type="text" readonly="readonly" value="${entity.jobNature}" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input id="personAmount" name="entityForm.personAmount" type="text" readonly="readonly" value="${entity.personAmount}" /></td>
											<td align="right">职务:&nbsp;</td>
											<td><s:select list="%{orgJobList}" listKey="id" listValue="jobName" name="entityForm.orgJob.id" readonly="readonly" value="%{entity.orgJob.id}" theme="simple"></s:select></td>
										</tr>
										<tr>
											<td align="right">岗位薪级标准:&nbsp;</td>
											<td><input id="postSalaryScale" name="entityForm.postSalaryScale" type="text" readonly="readonly" value="${entity.postSalaryScale}" /></td>
											<td align="right">标准薪点:&nbsp;</td>
											<td><input id="standardPayPoint" name="entityForm.standardPayPoint" type="text" readonly="readonly" value="${entity.standardPayPoint}" /></td>
										</tr>
									</table>
								</dd>
							</dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										<tr>
											...
											<td><input id="standardPointValue" name="entityForm.standardPointValue" type="text" readonly="readonly" value="${entity.standardPointValue}" /></td>
											<td align="right">岗位薪级:&nbsp;</td>
											<td><input id="postPayScale" name="entityForm.postPayScale" type="text" readonly="readonly" value="${entity.postPayScale}" /></td>
										</tr>
										<tr>
											<td align="right">有毒有害作业种类:&nbsp;</td>
											<td><input id="toxicAndHazardousTypes" name="entityForm.toxicAndHazardousTypes" type="text" readonly="readonly" value="${entity.toxicAndHazardousTypes}" /></td>
											<td align="right">发放标准:&nbsp;</td>
											<td><input id="paymentStandards" name="entityForm.paymentStandards" type="text" readonly="readonly" value="${entity.paymentStandards}" /></td>
										</tr>
										<tr>
											<td align="right">有毒有害接害类型:&nbsp;</td>
											<td><input id="toxicAndHarmfulToDamageType" name="entityForm.toxicAndHarmfulToDamageType" type="text" readonly="readonly" value="${entity.toxicAndHarmfulToDamageType}" /></td>
											<td align="right">干部职级:&nbsp;</td>
											<td><input id="ranksOfCadres" name="entityForm.ranksOfCadres" type="text" readonly="readonly" value="${entity.ranksOfCadres}" /></td>
										</tr>
										<tr>
											<td align="right">是否特殊工种岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.whetherParticularTypesOfWorkStatus" value="1" theme="simple"></s:radio></td>
											<td align="right">是否有毒害岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.arePoisonedJobs" value="1" theme="simple"></s:radio></td>
										</tr>
										<tr>
											<td align="right">是否点检岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.whetherPointInspectionPosts" value="1" theme="simple"></s:radio></td>
											<td align="right">是否虚构岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.whetherFictitiousJobs" value="1" theme="simple"></s:radio></td>
										</tr>
										<tr>
											<td align="right">是否运行岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.whetherToRunTheJob" value="1" theme="simple"></s:radio></td>
											<td align="right">是否定员岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.whetherCapacityPosts" value="1" theme="simple"></s:radio></td>
										</tr>
										<tr>
											<td align="right">是否检修岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.whetherMaintenanceJobs" value="1" theme="simple"></s:radio></td>
											<td align="right">是否班组长:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.whetherTheTeamLeader" value="1" theme="simple"></s:radio></td>
										</tr>
										<tr>
											<td align="right">是否部门负责岗位:&nbsp;</td>
											<td><s:radio list="#{\"0\":\"是\",\"1\":\"否\"}" name="entityForm.isChargeDep" value="1" theme="simple"></s:radio></td>
