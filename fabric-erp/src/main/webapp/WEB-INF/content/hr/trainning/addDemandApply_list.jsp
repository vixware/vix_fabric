	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				...
				<th onclick="orderBy('applicationName');">申请名称</th>
				<th onclick="orderBy('applicationDepartment');">申请部门</th>
				<th onclick="orderBy('applicationDate');">申请日期</th>
				<th onclick="orderBy('numberOfParticipants');">参与人数</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.applicationName}" type="radio" onclick="chkChange(this,'${entity.id}',${entity.applicationName},'${entity.applicationDepartment}','${entity.applicationDate}','${entity.numberOfParticipants}')" /></td>
					<td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td>
					<td>${entity.applicationName}</td>
					<td>${entity.applicationDepartment}</td>
					<td><fmt:formatDate value="${entity.applicationDate}" type="both" pattern="yyyy-MM-dd" /></a></td>
					<td>${entity.numberOfParticipants}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
