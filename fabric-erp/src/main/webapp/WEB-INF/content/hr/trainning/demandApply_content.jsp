...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('departmentOrPersonnel');">申请部门或人员&nbsp;<img id="categoryImg_departmentOrPersonnel" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('courseCategory');">培训方式&nbsp;<img id="categoryImg_courseCategory" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('applicationDate');">申请日期&nbsp;<img id="categoryImg_applicationDate" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('proposedTrainingInstitutions');">建议培训机构&nbsp;<img id="categoryImg_proposedTrainingInstitutions" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('numberOfParticipants');">参与人数&nbsp;<img id="categoryImg_numberOfParticipants" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('contactway');">联系方式&nbsp;<img id="categoryImg_contactway" src="${vix}/common/img/arrow.gif">
			</th>
			<th width="80">备注</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.departmentOrPersonnel}</span></td>
				<td><span style="color: gray;">${entity.courseCategory}</span></td>
				<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.applicationDate}" type="both" pattern="yyyy-MM-dd" /></a></td>
				<td><span style="color: gray;">${entity.proposedTrainingInstitutions}</span></td>
				<td><span style="color: gray;">${entity.numberOfParticipants}</span></td>
				<td><span style="color: gray;">${entity.contactway}</span></td>
