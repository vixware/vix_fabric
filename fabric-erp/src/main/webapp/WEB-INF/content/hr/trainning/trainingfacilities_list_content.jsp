...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('facilitiesCode');">设施编码&nbsp;<img id="categoryImg_facilitiesCode" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('facilitiesName');">设施名称&nbsp;<img id="categoryImg_facilitiesName" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('facilitiesType');">设施类别&nbsp;<img id="categoryImg_facilitiesType" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('facilitiesNumber');">数量&nbsp;<img id="categoryImg_facilitiesNumber" src="${vix}/common/img/arrow.gif">
			</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.facilitiesCode}</span></td>
				<td><span style="color: gray;">${entity.facilitiesName}</span></td>
				<td><span style="color: gray;">${entity.facilitiesType}</span></td>
				<td><span style="color: gray;">${entity.facilitiesNumber}</span></td>
				<td>
					<div class="untitled" style="position: static; display: inline;">
						<span><img alt="" src="img/icon_untitled.png"></span>
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#" onclick="deleteEntity(${entity.id });"></a></i> <i><a href="#" onclick="saveOrUpdate(${entity.id });" title="<s:text name='查看修改'/>"></a></i> <i><a href="#" onclick="saveOrUpdate(${entity.id });" title="<s:text name='cmn_update'/>"></a></i> <!-- 小i标题 --> <b>${entity.facilitiesName}</b>
							</strong>
							<!-- 小i内容 -->
							<p>${entity.remarsks }</p>
						</div>
