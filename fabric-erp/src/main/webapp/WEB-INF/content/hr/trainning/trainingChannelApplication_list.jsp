	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				...
				<th onclick="orderBy('lecturerCode');">编码</th>
				<th onclick="orderBy('lecturerName');">姓名</th>
				<th onclick="orderBy('lecturerPosition');">职位</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.lecturerCode}" type="radio" onclick="chkChange(this,'${entity.id}',${entity.lecturerCode},'${entity.lecturerName}','${entity.lecturerPosition}')" /></td>
