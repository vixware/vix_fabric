...
<div class="right_content">
	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				<th width="50">选择</th>
				<th onclick="orderBy('teacherCode');">教师编号</th>
				<th onclick="orderBy('teacherName');">教师姓名</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.teacherCode}" type="radio" onclick="chkChange(this,${entity.teacherCode},'${entity.teacherName}')" /></td>
