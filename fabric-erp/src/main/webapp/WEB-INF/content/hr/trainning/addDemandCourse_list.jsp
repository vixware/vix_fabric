	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				...
				<th onclick="orderBy('courseCode');">课程编号</th>
				<th onclick="orderBy('courseName');">课程名称</th>
				<th onclick="orderBy('courseeducation');">课程内容</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.courseCode}" type="radio" onclick="chkChange(this,'${entity.id}',${entity.courseCode},'${entity.courseName}','${entity.courseeducation}')" /></td>
					<td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td>
					<td>${entity.courseCode}</td>
					<td>${entity.courseName}</td>
					<td>${entity.courseeducation}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
