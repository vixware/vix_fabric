	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				...
				<th onclick="orderBy('facilitiesCode');">设施编号</th>
				<th onclick="orderBy('facilitiesName');">设施名称</th>
				<th onclick="orderBy('facilitiesNumber');">数量</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.facilitiesCode}" type="radio" onclick="chkChange(this,'${entity.id}',${entity.facilitiesCode},'${entity.facilitiesName}','${entity.facilitiesNumber}')" /></td>
					<td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td>
					<td>${entity.facilitiesCode}</td>
					<td>${entity.facilitiesName}</td>
					<td>${entity.facilitiesNumber}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
