...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('departmentOrPerson');">发送部门或人员&nbsp;<img id="categoryImg_departmentOrPerson" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('companyOrDepartment');">通知部门或人员&nbsp;<img id="categoryImg_companyOrDepartment" src="${vix}/common/img/arrow.gif">
			</th>
			<th>通知开始时间</th>
			<th>通知结束时间</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.departmentOrPerson}</span></td>
				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i><a href="#" onclick="deleteEntity('${entity.id}');"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='cmn_update'/>"></a></i> <!-- 小i标题 --> <b>${entity.noticeTheName } </b>
							</strong>
							<!-- 小i内容 -->
