	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				...
				<th onclick="orderBy('planName');">计划名称</th>
				<th onclick="orderBy('planDepartment');">部门与人员</th>
				<th onclick="orderBy('courseTotalCost');">课程总费用</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.planName}" type="radio" onclick="chkChange(this,'${entity.id}',${entity.planName},'${entity.planDepartment}','${entity.courseTotalCost}')" /></td>
					<td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td>
					<td>${entity.planName}</td>
					<td>${entity.planDepartment}</td>
					<td>${entity.courseTotalCost}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
