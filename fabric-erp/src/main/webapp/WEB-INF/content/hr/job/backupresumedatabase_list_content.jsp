	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">秦娇</span></td>
				<td><span style="color: gray;">女</span></td>
				<td><span style="color: gray;">24</span></td>
				<td><span style="color: gray;">硕士</span></td>
				<td><span style="color: gray;">项目总监</span></td>
				<td><span style="color: gray;">营销策划部</span></td>
				<td width="90"><span style="color: gray;">2013-06-01</span></td>
