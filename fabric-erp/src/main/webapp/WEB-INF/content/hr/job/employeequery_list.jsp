...
function chooseParentCategory(tag){
	$.ajax({
		  url:'${vix}/hr/employeeQueryAction!goChooseCategory.action',
		  cache: false,
		  success: function(html){
			  asyncbox.open({
				 	modal:true,
...
function saveOrUpdateOrder(){
	...
	if($('#replanForm').validationEngine('validate')){
		$.post('${vix}/hr/employeeQueryAction!saveOrUpdate.action',
			{
			...
			function(result){
				showMessage(result);
				setTimeout("",1000);
				loadContent('${vix}/hr/employeeQueryAction!goList.action?menuId=menuOrder');
			}
		 );
	}
}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/employeeQueryAction!goList.action');">员工个人信息</a></li>
			</ul>
		</div>
	</h2>
</div>
...
<div class="content">
	<form id="replanForm">
		<div class="order">
			<dl>
				<dt>
					<span class="no_line"> <a onclick="saveOrUpdateOrder();" href="#"><img width="22" height="22" title="保存" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" title="保存并提交审批" src="${vix}/common/img/dt_submit.png" /></a> <a href="#"
						onclick="loadContent('${vix}/hr/hrEmpstaffselfAction!goSaveOrUpdate.action');"><img width="22" height="22" title="返回" alt="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong> <b>员工个人信息 </b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
