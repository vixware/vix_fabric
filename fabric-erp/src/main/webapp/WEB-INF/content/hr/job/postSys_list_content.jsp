...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('postsysCode');">职务编码&nbsp;<img id="categoryImg_postsysCode" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('postsysName');">职务名称&nbsp;<img id="categoryImg_postsysName" src="${vix}/common/img/arrow.gif">
			</th>
			<th>职务类型</th>
			<th>职级</th>
			<th>职等</th>
			<th>职权</th>
			<th style="cursor: pointer;" onclick="orderBy('theDepartment');">职务名称&nbsp;<img id="categoryImg_theDepartment" src="${vix}/common/img/arrow.gif">
			</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.postsysCode}</span></td>
				<td><span style="color: gray;">${entity.postsysName}</span></td>
				<td><span style="color: gray;">${entity.postsysTypes.name}</span></td>
				<td><span style="color: gray;">${entity.rank.name}</span></td>
				<td><span style="color: gray;">${entity.grading.name}</span></td>
				<td><span style="color: gray;">${entity.powers.name}</span></td>
				<td><span style="color: gray;">${entity.theDepartment}</span></td>
				<td>
