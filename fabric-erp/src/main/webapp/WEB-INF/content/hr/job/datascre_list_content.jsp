...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="hr_age" /></th>
			<th><s:text name="hr_highest_degree" /></th>
			<th><s:text name="hr_job_title" /></th>
			<th><s:text name="hr_candidates_corporate_sector" /></th>
			<th width="70"><s:text name="cmn_operate" /></th>
		</tr>
		<% int count =0; %>
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">牛琳</span></td>
				<td><span style="color: gray;">女</span></td>
				<td><span style="color: gray;">24</span></td>
				<td><span style="color: gray;">本科</span></td>
				<td><span style="color: gray;">人资专员</span></td>
				<td><span style="color: gray;">人力资源部</span></td>
