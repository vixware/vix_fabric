...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('programName');">计划主题&nbsp;<img id="categoryImg_projectTraining" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('org');">提出计划部门&nbsp;<img id="categoryImg_org" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('responsibleForOrgUnit');">组织部门&nbsp;<img id="categoryImg_responsibleForOrgUnit" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('schemer');">计划人&nbsp;<img id="categoryImg_schemer" src="${vix}/common/img/arrow.gif">
			</th>
			<th>提出计划时间</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.programName}</span></td>
				<td><span style="color: gray;">${entity.org}</span></td>
				<td><span style="color: gray;">${entity.responsibleForOrgUnit}</span></td>
				<td><span style="color: gray;">${entity.schemer}</span></td>
				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#" onclick="deleteEntity('${entity.id}');"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='查看修改'/>"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='cmn_update'/>"></a></i> <!-- 小i标题 --> <b>${entity.schemer} </b>
							</strong>
							<!-- 小i内容 -->
							<p>${entity.programName}</p>
						</div>
					</div>
				</td>
			</tr>
