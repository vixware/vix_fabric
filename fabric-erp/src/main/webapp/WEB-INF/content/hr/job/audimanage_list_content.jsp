...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('candidateName');">应聘人姓名&nbsp;<img id="categoryImg_candidateName" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('employmentObjective');">应聘职位&nbsp;<img id="categoryImg_employmentObjective" src="${vix}/common/img/arrow.gif">
			</th>
			<th style="cursor: pointer;" onclick="orderBy('applicantsDepartment');">应聘部门&nbsp;<img id="categoryImg_applicantsDepartment" src="${vix}/common/img/arrow.gif">
			</th>
			<th>人员类型</th>
			<th>预计到岗日期</th>
			<th>面试人</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;"> <c:if test="${null == entity.typesOfOersonnel }">
						</c:if> <c:if test="${entity.typesOfOersonnel == '1' }">
							候选面试人员
						</c:if> <c:if test="${entity.typesOfOersonnel == '2' }">
							选中待面试人员
						</c:if>
				</span></td>

				<td><span style="color: gray;"><fmt:formatDate value="${entity.expectedArrivalDate}" type="both" pattern="yyyy-MM-dd" /></a></td>
				<td><span style="color: gray;">${entity.interviewer}</span></td>
				<td>
					<div class="untitled" style="position: static; display: inline;">
						<span><img alt="" src="img/icon_untitled.png"></span>
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#" onclick="deleteEntity(${'entity.id'});"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='cmn_show'/>"></a> </i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='cmn_update'/>"></a> </i> <b>${entity.candidateName}</b>
							</strong>
							<p>${entity.interviewAssessment}</p>
						</div>
					</div>
				</td>
			</tr>
