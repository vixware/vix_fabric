	...
	<div class="table">
		<table class="list">
			<tr class="alt">
				...
				<th onclick="orderBy('programName');">计划主题</th>
				<th onclick="orderBy('org');">提出计划部门</th>
				<th onclick="orderBy('schemer');">计划人</th>
			</tr>
			<s:iterator value="pager.resultList" var="entity" status="s">
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.programName}" type="radio" onclick="chkChange(this,'${entity.id}','${entity.programName}','${entity.org}','${entity.schemer}')" /></td>
					<td>${s.count + (pager.pageSize * (pager.pageNo -1))}</td>
					<td>${entity.programName}</td>
					<td>${entity.org}</td>
					<td>${entity.schemer}</td>
				</tr>
			</s:iterator>
		</table>
	</div>
