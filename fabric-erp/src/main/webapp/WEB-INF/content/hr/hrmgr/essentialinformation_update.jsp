...
<!--
	...
	$('#dgdA1').datagrid({
		...
		frozenColumns:[[
			...
			{field:'ship',title:'标题 ',width:110,
				formatter:function(value,rec){
					return '<span>谢朝阳  </span>';
				}
			},   
			{field:'itemType',title:'名称 ',width:150,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'amount',title:'格式',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			{field:'ybcode',title:'功能 ',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			...
			{field:'department',title:'语言 ',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			...
			{field:'telephone',title:'移动电话',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
	...
	$('#dgdA2').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'orderCode',title:'角色名称',width:110,
				formatter:function(value,rec){
					return '<span>人资专员 </span>';
				}
			},   
			{field:'contry',title:'角色类型',width:100,
				formatter:function(value,rec){
	...
	$('#dgdA3').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'itemCode',title:'用户帐号',width:110,
				formatter:function(value,rec){
					return '<span>02159642</span>';
				}
			},   
			{field:'itemName',title:'是否停用 ',width:200,
				formatter:function(value,rec){
					return '<span>否 </span>';
				}
			}
		...
		columns:[[
			{field:'amount',title:'验证方式',width:100,
				formatter:function(value,rec){
					return '<span>内部验证</span>';
				}
			},
			...
			{field:'recieveWareHouse',title:'帐号有效期 ',width:200,
				formatter:function(value,rec){
	...
	$('#dgdA4').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'itemType',title:'起始菜单',width:100,
				formatter:function(value,rec){
					return '<span>电子产品固件</span>';
				}	
			},
			{field:'netTotal',title:'登录语言',width:300,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'coin',title:'输出设备',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'yonghushiqu',title:'用户时区',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'adminshiqu',title:'系统时区',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			}
		...
		<div class="order">
			<dl>
				<dt>
					...
					</span> <strong> <b>员工信息管理基本信息</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							<li class="current"><a onclick="javascript:tab(8,1,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />联系方式</a></li>
							<li><a onclick="javascript:$('#a2').attr('style','');tab(8,2,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />角色</a></li>
							<li><a onclick="javascript:$('#a3').attr('style','');tab(8,3,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />帐号</a></li>
							<li><a onclick="javascript:$('#a4').attr('style','');tab(8,4,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />默认</a></li>
							<li><a onclick="javascript:$('#a5').attr('style','');tab(8,5,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />参数</a></li>
