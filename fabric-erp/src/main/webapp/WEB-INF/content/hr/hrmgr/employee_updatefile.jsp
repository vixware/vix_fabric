...
function toSwithEmpTab(tabId){
	...
	var employeeId = $("#employeeId").val();//employeeId
	if(employeeId!=""){
		//能够切换
...
function swichContent(tabId){
	...
	if(tabId=="essentialinformation"){
		urlVal = '${vix}/hr/employeeOrgFileAction!goSaveOrUpdateEss.action?id='+employeeId+"&parentId=${parentId}";
	}else if(tabId=="personalskills"){
		urlVal = '${vix}/hr/employeeOrgFileAction!goSaveOrUpdatePer.action?id='+employeeId;
	}else if(tabId=="relationship"){
		urlVal = '${vix}/hr/employeeOrgFileAction!goSaveOrUpdateRel.action?id='+employeeId;
	}else if(tabId=="workingsituation"){
		urlVal = '${vix}/hr/employeeOrgFileAction!goSaveOrUpdateWork.action?id='+employeeId;
	}
	$.ajax({
		  url:urlVal,
		  cache: false,
...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="img/hr_addemp.png" alt="" />
					<s:text name="hr_humanr_resources" /></a></li>
				<li><a href="#" onclick="loadContent('${vix}/hr/employeeOrgFileAction!goList.action');">员工管理</a></li>
				<li><a href="#" onclick="loadContent('${vix}/hr/employeeOrgFileAction!goList.action');">员工信息管理</a></li>
			</ul>
		</div>
	</h2>
</div>
	...
	<div class="order">
		<dl>
			<dt id="orderTieleFixd">
				<span class="no_line"> <a onclick="saveOrUpdateEss();"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#" onclick="loadContent('${vix}/hr/employeeOrgFileAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a>
				</span> <strong> <b>职员信息 </b> <i></i>
				</strong>
			</dt>
