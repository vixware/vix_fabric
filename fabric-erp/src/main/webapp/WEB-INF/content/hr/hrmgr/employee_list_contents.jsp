...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('staffJobNumber');" width="30%">员工职号&nbsp; <s:if test="%{pager.orderField == 'staffJobNumber' && pager.orderBy == 'asc' }">
			...
			<th onclick="orderBy('name');" width="20%">姓名&nbsp; <s:if test="%{pager.orderField == 'name' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			<c:if test="${'1' == entity.employeeType }">
				<% count++; %>
				<tr>
