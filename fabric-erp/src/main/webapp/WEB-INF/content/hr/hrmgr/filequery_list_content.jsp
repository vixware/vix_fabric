	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">12458216</span></td>
				<td><span style="color: gray;">赵永明</span></td>
				<td><span style="color: gray;">251204198005041258</span></td>
				<td><span style="color: gray;">男</span></td>
				<td><span style="color: gray;">内蒙古鄂尔多斯市</span></td>
				<td><span style="color: gray;">1980-05-04</span></td>
				<td><span style="color: gray;">大学本科</span></td>
				<td><span style="color: gray;">财务部</span></td>
				<td><span style="color: gray;">2005-08-05</span></td>
				<td>
