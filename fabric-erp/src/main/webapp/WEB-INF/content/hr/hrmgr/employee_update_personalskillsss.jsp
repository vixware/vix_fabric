	...
	<dl>
		<div class="clearfix" style="background: #FFF; position: relative;">
			<div class="right_menu">
				<ul>
					<li class="current"><a onclick="javascript:tab(7,1,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />语言能力</a></li>
					<li><a onclick="javascript:$('#a2').attr('style','');tab(7,2,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />计算机水平</a></li>
					<li><a onclick="javascript:$('#a3').attr('style','');tab(7,3,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />技术工人职业资格</a></li>
					<li><a onclick="javascript:$('#a4').attr('style','');tab(7,4,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />学历学位情况</a></li>
					<li><a onclick="javascript:$('#a5').attr('style','');tab(7,5,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />培训情况</a></li>
					<li><a onclick="javascript:$('#a6').attr('style','');tab(7,6,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />专业技术职务</a></li>
					<li><a onclick="javascript:$('#a7').attr('style','');tab(7,7,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />专业技术成果</a></li>
				</ul>
			</div>
			<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
				<div style="padding: 8px;">
					<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/hr/hrmgr/employeessAction!getLanguageAbilityJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
					...
					<script type="text/javascript">
							...
							function addItem(){
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddLanguageAbility.action?id=${entity.id}',
									  cache: false,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#daForm').validationEngine('validate')){
															$.post('${vix}/hr/hrmgr/employeessAction!saveOrUpdateLanguageAbility.action?id=${entity.id}', {
							...
							function editItem(){
								...
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddLanguageAbility.action?id=${entity.id}&lid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/hr/hrmgr/employeessAction!deleteLanguageAbilityById.action?lId='+row.id,cache: false});
								}
							}
			...
			<div id="a2" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlReceivedAddress" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlReceivedAddressTb',url: '${vix}/hr/hrmgr/employeessAction!getComputerLevelJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addcItem(){
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddComputerLevel.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#caForm').validationEngine('validate')){
															$.post('${vix}/hr/hrmgr/employeessAction!saveOrUpdateComputerLevel.action?id=${entity.id}', {
							...
							function editcItem(){
								...
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddComputerLevel.action?id=${entity.id}&cid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removecItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/hr/hrmgr/employeessAction!deleteComputerLevelById.action?cId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a3" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlDeliveryPlan" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlDeliveryPlanTb',url: '${vix}/hr/hrmgr/employeessAction!getWorkQualifyJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addwItem(){
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddWorkQualify.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#waForm').validationEngine('validate')){
															$.post('${vix}/hr/hrmgr/employeessAction!saveOrUpdateWorkQualify.action?id=${entity.id}', {
							...
							function editwItem(){
								...
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddWorkQualify.action?id=${entity.id}&wid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removewItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/hr/hrmgr/employeessAction!deleteWorkQualifyById.action?wId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a4" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlInvoice" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlInvoiceTb',url: '${vix}/hr/hrmgr/employeessAction!getDegreeJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function adddItem(){
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddDegree.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#deForm').validationEngine('validate')){
															$.post('${vix}/hr/hrmgr/employeessAction!saveOrUpdateDegree.action?id=${entity.id}', {
																'degree.id' : $("#daId").val(),
							...
							function editdItem(){
								...
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddDegree.action?id=${entity.id}&did='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removedItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/hr/hrmgr/employeessAction!deleteDegreeById.action?dId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a5" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlPriceConditions" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlPriceConditionsTb',url: '${vix}/hr/hrmgr/employeessAction!getTrainingJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addtItem(){
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddTraining.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dtForm').validationEngine('validate')){
															$.post('${vix}/hr/hrmgr/employeessAction!saveOrUpdateTraining.action?id=${entity.id}', {
							...
							function edittItem(){
								...
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddTraining.action?id=${entity.id}&tid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removetItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/hr/hrmgr/employeessAction!deleteTrainingById.action?tId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a6" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlTechtitle" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlTechtitleTb',url: '${vix}/hr/hrmgr/employeessAction!getTechtitleJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addTechtitleItem(){
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddTechtitle.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dechtitleForm').validationEngine('validate')){
															$.post('${vix}/hr/hrmgr/employeessAction!saveOrUpdateTechtitle.action?id=${entity.id}', {
							...
							function editTechtitleItem(){
								...
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddTechtitle.action?id=${entity.id}&teid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeTechtitleItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/hr/hrmgr/employeessAction!deleteTechtitleById.action?teId='+row.id,cache: false});
								}
							}
					</script>
				</div>
			...
			<div id="a7" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
				<div style="padding: 8px;">
					<table id="dlTechachieve" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlTechachieveTb',url: '${vix}/hr/hrmgr/employeessAction!getTechachieveJson.action?employeeId=${entity.id}'">
						<thead>
							<tr>
								<th data-options="field:'employeeCode',align:'center',width:120,editor:'text'">员工编码</th>
					...
					<script type="text/javascript">
							...
							function addTechachieveItem(){
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddTechachieve.action?id=${entity.id}',
									  cache: false,
									  success: function(html){
									 	  asyncbox.open({
											 	modal:true,
												...
												callback : function(action){
													if(action == 'ok'){
														if($('#dtechachieveForm').validationEngine('validate')){
															$.post('${vix}/hr/hrmgr/employeessAction!saveOrUpdateTechachieve.action?id=${entity.id}', {
							...
							function editTechachieveItem(){
								...
								$.ajax({
									  url:'${vix}/hr/hrmgr/employeessAction!goAddTechachieve.action?id=${entity.id}&ctcid='+rows.id,
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
							...
							function removeTechachieveItem(){
								...
								if(row){
									...
									$.ajax({url:'${vix}/hr/hrmgr/employeessAction!deleteTechachieveById.action?ctcId='+row.id,cache: false});
								}
							}
					</script>
				</div>
