...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th>员工编号</th>
			<th><s:text name="hr_name" /></th>
			<th><s:text name="hr_sex" /></th>
			<th><s:text name="hr_their_department" /></th>
			<th><s:text name="hr_post" /></th>
			<th><s:text name="hr_category_person" /></th>
			<th width="40"><s:text name="hr_employment_form" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">02130258</span></td>
				<td><span style="color: gray;">赵永明</span></td>
				<td><span style="color: gray;">男</span></td>
				<td><span style="color: gray;">财务部</span></td>
				<td><span style="color: gray;">财务总监</span></td>
				<td><span style="color: gray;">管理类</span></td>
				<td width="60"><span style="color: gray;">正式工</span></td>
				<td>
