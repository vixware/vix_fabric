...
<!--
	...
	$('#dgdA1').datagrid({
		...
		frozenColumns:[[
			...
			{field:'ship',title:'${vv:varView("vix_mdm_item")}编码 ',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130523 </span>';
				}
			},   
			{field:'invoicedocument',title:'名称 ',width:130,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'specification',title:'型号 ',width:150,
				formatter:function(value,rec){
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/fileQueryAction!goList.action');"><s:text name="hr_file_query" /></a></li>
				<a href="#">新增档案</a>
			</ul>
		</div>
	</h2>
			...
			<dl>
				<dt>
					<span class="no_line"> <a onclick="saveOrUpdateCustomer();" href="#"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消"
						...
						</div> <a href="#"><img width="22" height="22" alt="导出" src="${vix}/common/img/dt_export.png"></a> <a href="#" onclick="loadContent('${vix}/hr/fileQueryAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong> <b>新增档案查询</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><input id="birthdayDate" name="" type="text" /> <img onclick="showTime('birthdayDate','yyyy-MM-dd HH:mm')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
										</tr>
										<tr>
