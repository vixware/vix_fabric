...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('code');">员工职号&nbsp; <s:if test="%{pager.orderField == 'code' && pager.orderBy == 'asc' }">
			...
			<th onclick="orderBy('idNumber');">身份证号&nbsp; <s:if test="%{pager.orderField == 'idNumber' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'idNumber' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('name');">姓名&nbsp; <s:if test="%{pager.orderField == 'name' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('gender');">性别&nbsp; <s:if test="%{pager.orderField == 'gender' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('birthplace');">出生地&nbsp; <s:if test="%{pager.orderField == 'birthplace' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'birthplace' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('qualificationsCode');">学历&nbsp; <s:if test="%{pager.orderField == 'qualificationsCode' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'qualificationsCode' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('organizationUnit.id');">所在部门&nbsp; <s:if test="%{pager.orderField == 'organizationUnit.id' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'organizationUnit.id' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('isDemission');">是否离职&nbsp; <s:if test="%{pager.orderField == 'isDemission' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td>${entity.qualificationsCode}</td>
				<td>${entity.organizationUnit.fs}</td>
