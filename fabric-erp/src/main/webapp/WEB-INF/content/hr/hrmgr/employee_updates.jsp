...
function swichContent(tabId){
	...
	if(tabId=="essentialinformation"){
		urlVal = '${vix}/hr/employeesAction!goSaveOrUpdateEss.action?id='+employeeId+"&parentId=${parentId}";
	}else if(tabId=="personalskills"){
		urlVal = '${vix}/hr/employeesAction!goSaveOrUpdatePer.action?id='+employeeId;
	}else if(tabId=="relationship"){
		urlVal = '${vix}/hr/employeesAction!goSaveOrUpdateRel.action?id='+employeeId;
	}else if(tabId=="workingsituation"){
		urlVal = '${vix}/hr/employeesAction!goSaveOrUpdateWork.action?id='+employeeId;
	}
	$.ajax({
		  url:urlVal,
		  cache: false,
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/hr/employeesAction!goSaveOrUpdate.action');">在职管理</a></li>
			</ul>
		</div>
	</h2>
</div>
	...
	<div class="order">
		<dl>
			<dt id="orderTieleFixd">
				<span class="no_line"> <a onclick="saveOrUpdateEss();"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#" onclick="loadContent('${vix}/hr/employeesAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"></a>
				</span> <strong> <b>在职管理 </b> <i></i>
				</strong>
			</dt>
