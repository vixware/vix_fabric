...
<!--
	...
	$('#dgdA1').datagrid({
		...
		frozenColumns:[[
			...
			{field:'ship',title:'角色名称  ',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130523 </span>';
				}
			},   
			{field:'invoicedocument',title:'角色类型  ',width:130,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'specification',title:'角色  ',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			{field:'itemType',title:'角色权限',width:150,
				formatter:function(value,rec){
					return '<span>IPhone4s</span>';
				}	
			},
			{field:'amount',title:'权限名称 ',width:150,
				formatter:function(value,rec){
	...
	$('#dgdA2').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'orderCode',title:'帐号 ',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130514</span>';
				}
			},   
			{field:'contry',title:'帐号状态 ',width:100,
				formatter:function(value,rec){
					return '<span>中国  </span>';
				}
			},
			{field:'province',title:'密码 ',width:100,
				formatter:function(value,rec){
					return '<span>河北省  </span>';
				}
			},
			{field:'city',title:'帐号有效期 ',width:100,
				formatter:function(value,rec){
					return '<span>邯郸市 </span>';
				}	
			},
			{field:'district',title:'帐号验证信息 ',width:100,
				formatter:function(value,rec){
					return '<span>上城区 </span>';
				}
			},
			{field:'detail',title:'已绑定邮箱 ',width:200,
				formatter:function(value,rec){
					return '<span>河北省邯郸市上城区上城路10号 </span>';
				}
			},
			{field:'postcode',title:'已绑定手机',width:100,
				formatter:function(value,rec){
	...
	$('#dgdA3').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'itemCode',title:'名称 ',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130514</span>';
				}
			},   
			{field:'itemName',title:'类型',width:200,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'amount',title:'规则 ',width:100,
				formatter:function(value,rec){
					return '<span>10000</span>';
				}
			},
			{field:'recieveWareHouse',title:'详细信息 ',width:200,
				formatter:function(value,rec){
					return '<span>北京市丰台区和平路80号XX仓库</span>';
				}
			},
			{field:'materialBatches',title:'备注 ',width:100,
				formatter:function(value,rec){
					return '<span>张三</span>';
				}
			}
			...
			<dl>
							...
							<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											<td align="right">职称授予时间：</td>
											<td><input id="zhichengDate" name="" type="text" /> <img onclick="showTime('zhichengDate','yyyy-MM-dd HH:mm')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
										</tr>
									</table>
									<!-- 
								<p>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							<li class="current"><a onclick="javascript:tab(8,1,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />角色</a></li>
							<li><a onclick="javascript:$('#a2').attr('style','');tab(8,2,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />帐号</a></li>
							<li><a onclick="javascript:$('#a3').attr('style','');tab(8,3,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />个性设置</a></li>
