...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');"><s:text name="hr_things_coding" />&nbsp; <s:if test="%{pager.orderField == 'id' && pager.orderBy == 'asc' }">
			...
			<th><s:text name="hr_operator" /></th>
			<th><s:text name="hr_time" /></th>
