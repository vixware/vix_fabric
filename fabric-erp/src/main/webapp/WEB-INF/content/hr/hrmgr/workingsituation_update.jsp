...
<!--
	...
	$('#dgdA1').datagrid({
		...
		columns:[[
			...
			{field:'itemType',title:'所在单位 ',width:150,
				formatter:function(value,rec){
					return '<span>vixware@163.com</span>';
				}	
			},
			{field:'amount',title:'所在部门',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			{field:'wherethepost',title:'所在岗位',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			{field:'rank',title:'职级',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			{field:'professionalexperience',title:'专业经历',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			{field:'witnesses',title:'证明人',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			},
			{field:'officesymbol',title:'任职文号',width:150,
				formatter:function(value,rec){
					return '<span>北京市朝阳区学院路15号  </span>';
				}
			}
	...
	$('#dgdA2').datagrid({
		...
		frozenColumns:[[
			...
			{field:'contry',title:'姓名 ',width:100,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'province',title:'身份证号',width:100,
				formatter:function(value,rec){
					return '<span>发布撤销招聘信息</span>';
				}
			},
			{field:'city',title:'政治面貌 ',width:100,
				formatter:function(value,rec){
					return '<span>四级 </span>';
				}	
			},
			{field:'participateinpartytime',title:'参加党派时间 ',width:100,
				formatter:function(value,rec){
					return '<span>四级 </span>';
				}	
			},
			{field:'joinapartisanunit',title:'参加党派时所在单位 ',width:100,
				formatter:function(value,rec){
					return '<span>四级 </span>';
				}	
			}
	...
	$('#dgdA3').datagrid({
		...
		frozenColumns:[[
			...
			{field:'itemName',title:'开始日 ',width:200,
				formatter:function(value,rec){
					return '<span>否 </span>';
				}
			}
		...
		columns:[[
			{field:'amount',title:'至',width:100,
				formatter:function(value,rec){
					return '<span>手机验证</span>';
				}
			},
			{field:'recieveWareHouse',title:'复转类型 ',width:200,
				formatter:function(value,rec){
					return '<span>9999-12-31</span>';
				}
			},
			{field:'materialBatches',title:'军衔一级代码',width:100,
				formatter:function(value,rec){
					return '<span>18546213695</span>';
				}
			},
			{field:'rankoftwocode',title:'军衔二级代码',width:100,
				formatter:function(value,rec){
					return '<span>18546213695</span>';
				}
			},
			...
			{field:'wherethetroops',title:'所在部队',width:100,
				formatter:function(value,rec){
					return '<span>18546213695</span>';
				}
			}
	...
	$('#dgdA4').datagrid({
		...
		columns:[[
			...
			{field:'awardslevel',title:'荣誉奖励级别',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'awardsname',title:'荣誉奖励名称',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'awardsreasons',title:'荣誉奖励原因',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'awardsthedateofapproval',title:'荣誉奖励批准日期',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'awardsapprovedfilename',title:'荣誉奖励批准文件名',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'awardsapprovedfilenumber',title:'荣誉奖励批准文件号',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'awardsapprovedfilenameoftheauthority',title:'荣誉奖励批准机关名称',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			}
	...
	$('#dgdA5').datagrid({
		...
		columns:[[
			...
			{field:'netTotal',title:'惩戒类别',width:200,
				formatter:function(value,rec){
					return '<span>D:\appendix\营业执照.jpg</span>';
				}
			},
			{field:'netPrice',title:'惩戒名称',width:100,
				formatter:function(value,rec){
					return '<span>2013-04-23</span>';
				}
			},
			{field:'operate',title:'惩戒原因',width:100,
				formatter:function(value,rec){
					return '<span><a href="#">下载</a></span>';
				}
			},
			{field:'disciplinarydateofapproval',title:'惩戒批准日期',width:100,
				formatter:function(value,rec){
					return '<span><a href="#">下载</a></span>';
				}
			},
			{field:'disciplinaryapprovalofthefilename',title:'惩戒批准文件名',width:100,
				formatter:function(value,rec){
					return '<span><a href="#">下载</a></span>';
				}
			},
			{field:'disciplinaryapprovaldocument',title:'惩戒批准文件号',width:100,
				formatter:function(value,rec){
					return '<span><a href="#">下载</a></span>';
				}
			},
			{field:'disciplinaryapprovalauthorityname',title:'惩戒批准机关名称',width:100,
				formatter:function(value,rec){
					return '<span><a href="#">下载</a></span>';
				}
			},
			{field:'revocationofdisciplinarydate',title:'撤销惩戒日期',width:100,
				formatter:function(value,rec){
					return '<span><a href="#">下载</a></span>';
				}
			}
	...
	$('#dgdA6').datagrid({
		...
		columns:[[
			{field:'itemType',title:'性别',width:100,
				formatter:function(value,rec){
					return '<span>电子产品固件</span>';
				}	
			},
			{field:'amount',title:'出生日期',width:100,
				formatter:function(value,rec){
					return '<span>10000</span>';
				}
			},
			{field:'netTotal',title:'兼职类型',width:100,
				formatter:function(value,rec){
					return '<span>2,000,000</span>';
				}
			},
			{field:'coin',title:'兼职岗位名称',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'parttimestartdate',title:'兼职开始日期',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'parttimeenddate',title:'兼职结束日期 ',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
			{field:'positionssort',title:'岗位排序 ',width:100,
				formatter:function(value,rec){
					return '<span>RMB</span>';
				}
			},
		...
		<div class="order">
			<dl>
				<dt>
					...
					</span> <strong> <b>员工信息管理工作情况</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							...
							<li><a onclick="javascript:$('#a7').attr('style','');tab(8,7,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />兼任情况</a></li>
