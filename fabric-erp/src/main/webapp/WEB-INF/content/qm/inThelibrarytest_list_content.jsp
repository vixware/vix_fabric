...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('productNumber');"><s:text name="qm_production_date" />&nbsp;<img id="brandImg_productNumber" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('productNumber');"><s:text name="qm_sampling_specifications" />&nbsp;<img id="brandImg_productNumber" src="${vix}/common/img/arrow.gif"></th>
