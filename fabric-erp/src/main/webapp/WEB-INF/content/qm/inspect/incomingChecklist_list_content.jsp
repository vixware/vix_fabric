...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('receiptNumber');"><s:text name="qm_document_number" />&nbsp;<img id="incomingImg_receiptNumber" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('itemName');"><s:text name="qm_materials_name" />&nbsp;<img id="incomingImg_itemName" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('itemCode');"><s:text name="qm_material_model" />&nbsp;<img id="incomingImg_itemCode" src="${vix}/common/img/arrow.gif"></th>
			<th><s:text name="qm_sampling_standard" /></th>
			<th><s:text name="检验日期" /></th>
