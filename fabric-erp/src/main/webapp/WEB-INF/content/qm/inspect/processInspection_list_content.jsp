...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('participant');"><s:text name="报检人" />&nbsp;<img id="brandImg_participant" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('inspectionDate');"><s:text name="报检日期" />&nbsp;<img id="brandImg_inspectionDate" src="${vix}/common/img/arrow.gif"></th>
