...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('processCode');"><s:text name="工序编码" />&nbsp;<img id="brandImg_processCode" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('processName');"><s:text name="工序名称" />&nbsp;<img id="brandImg_processName" src="${vix}/common/img/arrow.gif"></th>
			<th>样品等级</th>
			<th>报废处理</th>
			<th>退货处理</th>
			<th>负责人</th>
