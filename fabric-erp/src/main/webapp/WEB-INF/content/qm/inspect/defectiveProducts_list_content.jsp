...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('receiptNumber');"><s:text name="qm_document_number" />&nbsp;<img id="brandImg_receiptNumber" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('itemName');"><s:text name="qm_materials_name" />&nbsp;<img id="brandImg_itemName" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('itemCode');"><s:text name="编码" />&nbsp;<img id="brandImg_itemCode" src="${vix}/common/img/arrow.gif"></th>
			<th><s:text name="qm_scrapped_handle" /></th>
			<th><s:text name="qm_return_processing" /></th>
			<th><s:text name="qm_inspection_people" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;"><fmt:formatDate value="${entity.inspectionDate}" type="both" pattern="yyyy-MM-dd" /></a>
