...
<div class="content">
	...
	<div class="box cardTable">
		<form id="brandForm">
			<input type="hidden" id="id" name="id" value="${checkListtemplate.id}" />
			<table width="100%">
				<tr>
					<th class="tr" width="150">编码：</th>
					<td><input id="code" name="checkListtemplate.code" value="${checkListtemplate.code}" type="text" style="width: 200px;" class="ipt" /></td>
				</tr>
				<tr>
					<th class="tr" width="150">内容：</th>
					<td colspan="3"><textarea id="name" class="example" rows="1" style="width: 200px; height: 54px;">${checkListtemplate.name}</textarea></td>
				</tr>
				<tr>
					<th class="tr" width="150">备注：</th>
					<td colspan="3"><textarea id="memo" class="memo" rows="1" style="width: 200px; height: 54px;">${checkListtemplate.memo}</textarea></td>
				</tr>
				<tr>
