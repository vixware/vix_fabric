...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th style="cursor: pointer;" onclick="orderBy('productNumber');"><s:text name="qm_sample_name" />&nbsp;<img id="brandImg_productNumber" src="${vix}/common/img/arrow.gif"></th>
			<th style="cursor: pointer;" onclick="orderBy('productNumber');"><s:text name="qm_sample_number" />&nbsp;<img id="brandImg_productNumber" src="${vix}/common/img/arrow.gif"></th>
			<th><s:text name="qm_executor" /></th>
			<th><s:text name="qm_retention_samples_date" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">AIS123</a></td>
					<td><a href="#" style="color: gray;">30个</a></td>
					<td><a href="#" style="color: gray;">啸天犬</a></td>
					<td><a href="#" style="color: gray;">2013-1-12</a></td>
