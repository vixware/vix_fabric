...
function addSalesOrderItem(){
	...
	if($('#saleOrderItemForm').validationEngine('validate')){
		$.post('${vix}/purchase/purchaseInquireAction!saveOrUpdatePurchaseInquireItem.action',
			{ 'purchaseItem.id':$("#my_item_page #purchaseApplyItemId").val(),
			  ...
			  'purchaseItem.purchaseInquire.id':$("#id").val(),
...
function chooseItemForPrice(id,code,name,price){
	$.post('${vix}/purchase/purchaseInquireAction!loadPurchaseItemInfo.action',
		{'id':id},
		function(json){
			if(json){
