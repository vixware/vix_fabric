	...
	<div class="box order_table" style="line-height: normal;">
		<table class="table-padding020">
			...
			<tr height="30">
				...
				<td><input id="deliveryDate" name="deliveryDate" type="text" readonly="readonly" onclick="showTime('deliveryDate','yyyy-MM-dd')" /> <img onclick="showTime('deliveryDate','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
			</tr>
			<tr height="30">
				<td align="right">创建日期：</td>
				<td><input id="createTime" name="createTime" type="text" readonly="readonly" onclick="showTime('createTime','yyyy-MM-dd')" /> <img onclick="showTime('createTime','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
