...
function addSalesOrderItem(){
	...
	if($('#saleOrderItemForm').validationEngine('validate')){
		$.post('${vix}/purchase/purchaseInboundAction!saveOrUpdatePurchaseInboundItem.action',
			{ 'purchaseItem.id':$("#my_item_page #purchaseApplyItemId").val(),
			  ...
			  'purchaseItem.purchaseInbound.id':$("#id").val(),
...
function chooseItemForPrice(id,code,name,price){
	$.post('${vix}/purchase/purchaseInboundAction!loadPurchaseItemInfo.action',
		{'id':id},
		function(json){
			if(json){
