...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%"><s:text name="pur_procurement_description" /></th>
			<th width="20%"><s:text name="pur_application_department" /></th>
			<th width="20%"><s:text name="pur_applicant" /></th>
			<th width="10%"><s:text name="cmn_mode" /></th>
			<th width="20%"><s:text name="pur_application_time" /></th>
