...
function choosePurchasePlan (){
	$.ajax ({
			url : '${vix}/purchase/purchaseOrderAction!goChoosePurchasePlan.action' ,
			cache : false ,
			success : function (html){
				asyncbox
						.open ({
						...
						callback : function (action , returnValue){
							if (action == 'ok'){
								if (returnValue != ''){
									$.ajax ({
											url : '${vix}/purchase/purchaseOrderAction!converterPlanToOrder.action?purchasePlanid='+returnValue+"&id=${purchaseOrder.id}",
											cache : false ,
		...
		<div class="order">
			<dl>
				<dt id="orderTitleFixd">
					...
					</span> <strong> <b>新增采购订单(来源自采购计划单)</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										<tr>
											...
											<td colspan="3"><font color="red">采购计划单</font> <input class="btn" type="button" value="取单" onclick="choosePurchasePlan();" /></td>
										</tr>
										<tr>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					...
					$('#soAttach').datagrid({
						...
						<div style="padding: 8px;">
							<table id="soAttach" style="height: 450px; margin: 6px;"></table>
						</div>
					</div>
