	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/purchase/purchaseInvoiceAction!goList.action');">普通采购发票</a></li>
			</ul>
		</div>
	</h2>
</div>
...
<div class="content">
	<form id="purchaseInvoiceForm">
		<div class="order">
			<dl>
				<dt>
					<span class="no_line"> <a href="#" onclick="saveOrUpdateOrder()"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /></a> <a href="#"
						onclick="loadContent('${vix}/purchase/purchaseInvoiceAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong> <b>新增普通采购发票</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
												...
												.ready(function() {
													$('#textExt')
															...
															.bind('getSuggestions', function(e, data) {
																var list = [ 'Acdsee', 'Basic', 'Closure', 'Cobol', 'Delphi', 'Erlang', 'Fortran', 'Go', 'Groovy', 'Haskel', 'Im', 'Java', 'JavaScript', 'King', 'Leo', 'Menu', 'No', 'OCAML', 'PHP', 'Perl', 'Python', 'Query', 'Ruby', 'Scala', 'Time', 'UTC', 'Vv', 'What', 'Xx', 'Yang', 'Zero' ], textext = $(e.target)
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					...
					<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
						<div style="padding: 8px;">
							<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/purchase/purchaseInvoiceAction!getPurchaseInvoiceItemJson.action?id=${purchaseInvoice.id}',onClickRow: onDlClickRow">
								<thead>
									<tr>
										...
										<th data-options="field:'amount',width:200,align:'center',editor:'numberbox'">单价数量</th>
										<th data-options="field:'price',width:200,align:'center',editor:'numberbox'">单价</th>
										<th data-options="field:'netTotal',width:200,align:'center',editor:'numberbox'">总额</th>
