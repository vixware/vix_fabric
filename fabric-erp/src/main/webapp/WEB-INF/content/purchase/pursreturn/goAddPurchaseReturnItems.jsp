...
function addSalesOrderItem(){
	...
	if($('#saleOrderItemForm').validationEngine('validate')){
		$.post('${vix}/purchase/purchaseReturnAction!saveOrUpdatePurchaseReturnItem.action',
			{ 'purchaseItem.id':$("#my_item_page #purchaseApplyItemId").val(),
			  ...
			  'purchaseItem.purchaseReturn.id':$("#id").val(),
...
function chooseItemForPrice(id,code,name,price){
	$.post('${vix}/purchase/purchaseReturnAction!loadPurchaseItemInfo.action',
		{'id':id},
		function(json){
			if(json){
