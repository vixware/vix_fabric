...
<script type="text/javascript">
	function goShowBeforeAndAfterPurchaseReturn(id, str) {
		$.ajax({
		url : '${vix}/purchase/purchaseReturnAction!goShowBeforeAndAfterPurchaseReturn.action?id=' + id + "&str=" + str,
		cache : false,
		...
		<dl>
			<dt id="orderTitleFixd">
				<span class="no_line"> <a href="#"><img width="22" height="22" title="禁用" src="${vix}/common/img/dt_disable.png" /> </a> <a href="#"><img width="22" height="22" title="锁定" src="${vix}/common/img/dt_locked.png" /> </a><a href="#"><img width="22" height="22" title="删除" src="${vix}/common/img/dt_delete.png" /> </a> <a href="#"><img
						width="22" height="22" title="审批通过" src="${vix}/common/img/dt_aprroval.png" /> </a> <a href="#"><img width="22" height="22" title="驳回" src="${vix}/common/img/dt_reject.png"> </a> <a href="#" onclick="goShowBeforeAndAfterPurchaseReturn('${purchaseReturn.id}','before');"><img width="22" height="22" title="上一条"
						src="${vix}/common/img/dt_before.png"> </a> <a href="#" onclick="goShowBeforeAndAfterPurchaseReturn('${purchaseReturn.id}','after');"><img width="22" height="22" title="下一条" src="${vix}/common/img/dt_next.png"> </a> <a href="#" onclick="goPrintPurchaseReturn('${purchaseReturn.id}');"><img width="22" height="22" title="打印"
					...
					</div> <a href="#"><img width="22" height="22" title="导出" src="${vix}/common/img/dt_export.png"> </a> <a href="#" onclick="loadContent('${vix}/purchase/purchaseReturnAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a></span> <strong><b>采购退货 </b><i></i> </strong>
			</dt>
			<dd class="clearfix">
							...
							<dd style="display: block;">
								<table style="border: none;">
									<tr>
										...
										<td><input id="code" name="code" value="${purchaseReturn.code }" type="text" size="30" class="validate[required] text-input" /><span style="color: red;">*</span></td>
										<td align="right">主题：</td>
										<td><input id="name" name="name" value="${purchaseReturn.name }" type="text" size="30" class="validate[required] text-input" /><span style="color: red;">*</span></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input id="supplierName" name="supplierName" value="${purchaseReturn.supplierName }" type="text" size="30" class="validate[required] text-input" /> <span style="color: red;">*</span> <input class="btn" type="button" value="选择" onclick="chooseRadioSupplier();" /></td>
										<td align="right">需求部门：</td>
										<td><input id="requireDepartment" name="requireDepartment" value="${purchaseReturn.requireDepartment }" type="text" size="30" /> <input class="btn" type="button" value="选择" onclick="chooseRequireDepartment();" /></td>
									</tr>
									<tr>
										...
										<td><input id="taxRate" name="taxRate" value="${purchaseReturn.taxRate }" type="text" size="30" /></td>
									</tr>
									<tr>
										<td align="right">过账日期：</td>
										<td><input id="postingDate" name="postingDate" value="<s:date name="purchaseReturn.postingDate" format="yyyy-MM-dd"/>" type="text" readonly="readonly" onclick="showTime('postingDate','yyyy-MM-dd')" /> <img onclick="showTime('postingDate','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
										<td align="right">交货日期：</td>
										<td><input id="deliveryDate" name="deliveryDate" value="<s:date name="purchaseReturn.deliveryDate" format="yyyy-MM-dd"/>" readonly="readonly" type="text" class="validate[required] text-input" onclick="showTime('deliveryDate','yyyy-MM-dd')" /><span style="color: red;">*</span> <img onclick="showTime('deliveryDate','yyyy-MM-dd')"
											src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
									</tr>
									<tr>
										<td align="right">采购人：</td>
										<td><input id="purchasePerson" name="purchasePerson" value="${purchaseReturn.purchasePerson }" type="text" size="30" class="validate[required] text-input" /><span style="color: red;">*</span></td>
										<td align="right">联系人：</td>
										<td><input id="contactPerson" name="contactPerson" value="${purchaseReturn.contactPerson }" type="text" size="30" /></td>
									</tr>
									<tr>
										<td align="right">退货原因：</td>
										<td><input id="reason" name="reason" value="${purchaseReturn.reason }" type="text" size="50" /></td>
									</tr>
								</table>
							</dd>
						</dl>
