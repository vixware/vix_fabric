...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%"><s:text name="srm_specifications" /></th>
			<th width="10%"><s:text name="sa_quantityonhand" /></th>
			<th width="10%"><s:text name="cmn_mode" /></th>
			<th width="10%">仓库</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">itemCode_20130529</span></td>
				<td><span style="color: gray;">4.0寸手机外壳</span></td>
				<td><span style="color: gray;">电子产品固件</span></td>
				<td><span style="color: gray;">盒</span></td>
				<td><span style="color: gray;">20000</span></td>
				<td><span style="color: gray;">良好</span></td>
				<td><span style="color: gray;">和平仓库</span></td>
