...
<input type="hidden" id="orderTypeTotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="orderTypePageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="orderTypeTotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="orderTypeOrderField" value="${pager.orderField}" />
<input type="hidden" id="orderTypeOrderBy" value="${pager.orderBy}" />
<input type="hidden" id="orderTypeInfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="50">
