...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="img/cmn_setting.png" alt="" /> <s:text name="cmn_supplyChain" /></a></li>
				<li><a href="#"><s:text name="pur_purchase_manage" /></a></li>
				<li><a href="#"><s:text name='pur_procurement_set' /></a></li>
				<a href="#"><s:text name='pur_options' /></a>
			</ul>
		</div>
	</h2>
			...
			<div id="lnp1">
				...
				<div class="np_clist" id="np1">
					<form method="get">
						...
						<div class="nt">
							<div class="nt_title">
								<input type="checkbox" name="WhetherToAutomaticallyIntoTheUnitPrice" />&nbsp;入库单是否自动带入单价
							</div>
							<div class="nt_line">
								<table>
									<tbody>
