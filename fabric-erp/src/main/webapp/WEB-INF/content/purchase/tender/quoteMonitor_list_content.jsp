				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#" onclick="deleteEntity('${entity.id}');" title="删除"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="查看报价"></a></i> <i><a href="#" title="<s:text name='cmn_update'/>"></a></i> <b>${entity.title}</b>
							</strong>
							<p>${entity.title}</p>
						</div>
					</div>
