...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="15%"><s:text name="sa_accountingmonth" /></th>
			<th width="20%"><s:text name="sa_startdate" /></th>
			<th width="20%"><s:text name="sa_asofthedateof" /></th>
			<th width="20%"><s:text name="sa_whetherthebill" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">10月</span></td>
				<td><span style="color: gray;">2013-10-1</span></td>
				<td><span style="color: gray;">2013-10-31</span></td>
				<td><span style="color: gray;">是</span></td>
				<td>
					<div class="untitled" style="position: static; display: inline;">
						<span><img alt="" src="img/icon_untitled.png"></span>
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close" onclick="deleteEntity('${entity.id}');"><a href="#"></a></i> <i><a href="#" title="<s:text name='cmn_show'/>"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}',$('#parentId').val());" title="<s:text name='cmn_update'/>"></a></i> <b></b>
							</strong>
							<p></p>
						</div>
					</div>
