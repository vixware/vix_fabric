...
<script type="text/javascript">
	...
	pager("start", "${vix}/purchase/purchasePlanAction!goSubRadioSingleList.action?temp=1", "supplier");

	function currentPager(tag) {
		pager(tag, "${vix}/purchase/purchasePlanAction!goSubRadioSingleList.action?temp=1", 'supplier');
	}
	var code = "";
	function loadCode() {
		code = $('#srm_code').val();
	...
	function searchForContent(i) {
		loadCode();
		pager("start", "${vix}/purchase/purchasePlanAction!goSubRadioSingleList.action?searchContent=" + code, 'supplier');
	}
	/*重置搜索*/
