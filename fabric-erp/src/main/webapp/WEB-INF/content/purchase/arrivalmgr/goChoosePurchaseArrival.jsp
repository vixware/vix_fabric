...
<script type="text/javascript">
	$.returnValue = "";
	pager("start", "${vix}/purchase/purchaseArrivalAction!goPurchaseArrivalList.action?temp=1", "purchaseArrival");
	function currentPager(tag) {
		pager(tag, "${vix}/purchase/purchaseArrivalAction!goPurchaseArrivalList.action", 'purchaseArrival');
	}
	var code = "";
	function loadCode() {
		code = $('#srm_code').val();
	...
	function searchForContent(i) {
		loadCode();
		pager("start", "${vix}/purchase/purchaseArrivalAction!goPurchaseArrivalList.action?searchContent=" + code, 'purchaseArrival');
	}
	/*重置搜索*/
