...
<script type="text/javascript">
	...
	//载入分页列表数据
	pager("start", "${vix}/inventory/shelfLifeEarlyWarningAction!goSingleList.action?1=1", 'inventoryCurrentStock');
	//排序 
	function orderBy(orderField) {
		...
		pager("start", "${vix}/inventory/shelfLifeEarlyWarningAction!goSingleList.action?orderField=" + orderField + "&orderBy=" + orderBy, 'inventoryCurrentStock');
	}
	function currentPager(tag) {
		pager(tag, "${vix}/inventory/shelfLifeEarlyWarningAction!goSingleList.action?1=1", 'inventoryCurrentStock');
	}
	/* 搜索 */
	function searchForContent() {
		...
		loadGoodsCode();
		loadGoodsName();
		pager("start", "${vix}/inventory/shelfLifeEarlyWarningAction!goSingleList.action?searchContent=" + searchContent + "&goodsCode=" + goodsCode + "&goodsName=" + goodsName, 'inventoryCurrentStock');
	}
