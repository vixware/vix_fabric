...
<script type="text/javascript">
	function loadCurrentExpenseDetail() {
		$.ajax({
		url : '${vix}/inventory/inboundWarehouseAction!goListOrderBatchContent.action?id=' + $("#id").val(),
		cache : false,
...
<div class="sub_menu">
	...
	<div class="drop">
		<a href="#" onclick="loadContent('${vix}/inventory/inboundWarehouseAction!goList.action?pageNo=${pageNo}');"><span>返回</span> </a>
	</div>
</div>
