			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a href="#"><img width="22" height="22" title="禁用" src="${vix}/common/img/dt_disable.png" /> </a> <a href="#"><img width="22" height="22" title="锁定" src="${vix}/common/img/dt_locked.png" /> </a><a href="#"><img width="22" height="22" title="删除" src="${vix}/common/img/dt_delete.png" /> </a> <a href="#"
						...
						</div> <a href="#"><img width="22" height="22" title="导出" src="${vix}/common/img/dt_export.png"> </a> <a href="#" onclick="loadContent('${vix}/inventory/inboundWarehouseAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a></span> <strong><b>入库调整单 </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
							...
							<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											<th>入库时间：</th>
											<td><input id="createTime" name="createTime" value="${stockRecords.createTime}" type="text" readonly="readonly" /><img onclick="showTime('createTime','yyyy-MM-dd HH:mm:ss')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
											<th>收货仓库：</th>
					...
					<div class="order_table">
						<table>
							<tr>
								...
								<th>总金额：</th>
								<td><input id="totalamount" name="totalamount" value="${stockRecords.totalamount}" type="text" readonly="readonly" /></td>
							</tr>
						</table>
					</div>
				</dd>
