...
loadMenuContent('${vix}/inventory/inventoryMainAction!goMenuContent.action');
	...
	pager ("start" , "${vix}/inventory/batchStandingBookAction!goInvStockRecordLinesList.action?1=1" , "invStockRecordLines");
	function currentPager (tag){
		pager (tag , "${vix}/inventory/batchStandingBookAction!goInvStockRecordLinesList.action" , "invStockRecordLines");
	}
	...
	function searchForContent (i){
		loadCode ();
		pager ("start" , "${vix}/inventory/batchStandingBookAction!goInvStockRecordLinesList.action?searchContent=" + code , 'invStockRecordLines');
	}
	/*重置搜索*/
	...
	function srmStatus (status){
		pager ("start" , "${vix}/inventory/batchStandingBookAction!goInvStockRecordLinesList.action?status=" + status , 'invStockRecordLines');
	}
	//最近使用
	function srmRecent (rencentDate){
		pager ("start" , "${vix}/inventory/batchStandingBookAction!goInvStockRecordLinesList.action?updateTime=" + rencentDate , 'invStockRecordLines');
	}
</script>
