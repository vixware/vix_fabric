		...
		<div class="widget-body no-padding">
			<div style="margin: 5px;">
				<div class="form-group" style="margin: 0 5px;">
					...
					<button type="button" class="btn btn-primary" onclick="$('#selectName').val('');chooseEmployeeTable.ajax.reload();">
...
<script type="text/javascript">
	...
	var chooseEmployeeColumns = [ {
		...
		"data" : function(data) {
			return "<div class='project-members'><a href='javascript:void(0)'>" + data.name + "</a></div> ";
		}
	}, {
		"data" : function(data) {
			return data.warehousePerson;
		}
	} ];
	var selectType = chooseType == "multi" ? "2" : "1";
	var isGenerateIndex = chooseType == "multi" ? "1" : "0";
	var chooseEmployeeTable = initDataTable("chooseEmployeeTableId", "${nvix}/nvixnt/vixntWarehouseAction!getSingleList.action", chooseEmployeeColumns, function(page, pageSize, orderField, orderBy) {
		var warehouseName = $("#selectName").val();
