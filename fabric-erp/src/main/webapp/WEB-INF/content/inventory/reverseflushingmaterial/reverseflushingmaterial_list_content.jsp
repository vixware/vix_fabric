...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th>领料日期</th>
			<th><s:text name="wim_the_warehouse" /></th>
			<th><s:text name="wim_warehouse_keeper" /></th>
			<th><s:text name="wim_reviewed_by" /></th>
			<th><s:text name="wim_approval_status" /></th>
			<th><s:text name="wim_date_audit" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.warehousecode }</a></td>
				...
				<td><a href="#" style="color: gray;">${entity.checkdate }</a></td>
				<td><div class="untitled" style="position: static; display: inline;">
