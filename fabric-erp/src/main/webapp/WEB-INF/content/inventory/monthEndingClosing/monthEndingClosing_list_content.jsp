	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.tvcode }</a></td>
				<td><a href="#" style="color: gray;">${entity.name }</a></td>
				<td><a href="#" style="color: gray;">${entity.outwarehousecode }</a></td>
				<td><a href="#" style="color: gray;">${entity.inwarehousecode }</a></td>
				<td><a href="#" style="color: gray;">${entity.ordertype }</a></td>
