...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="15%"><s:text name="srm_suppliers" /></th>
			<th width="20%"><s:text name="srm_order_name" /></th>
			<th width="10%"><s:text name="cmn_mode" /></th>
			<th width="15%"><s:text name="srm_procurement_staff" /></th>
			<th width="20%"><s:text name="srm_order_time" /></th>
