...
function deleteById(id){
	$.ajax({
		  url:'${vix}/srm/tempAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/srm/tempAction!goApprovalContent.action?name="+name,'brand');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/srm/tempAction!goApprovalContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'brand');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/srm/tempAction!goApprovalContent.action?name="+name,'brand');
}
...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="img/approval.png" alt="" /> <s:text name="cmn_supplyChain" /></a></li>
				<li><a href="#">采购管理</a></li>
				<li><a href="#">采购审批</a></li>
			</ul>
		</div>
	...
	<div class="drop">
		<p>
			<a href="#" onclick="deleteByIds();"><span><s:text name='cmn_delete' /></span></a> <a href="#"><span><s:text name='cmn_report' /></span></a> <a href="#"><span><s:text name='cmn_check' /></span></a> <a href="#"><span><s:text name='cmn_export' /></span></a>
		</p>
	</div>
</div>
<div class="content">
