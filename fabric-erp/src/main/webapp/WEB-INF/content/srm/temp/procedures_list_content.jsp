...
<div class="content">
	...
	<div class="npcontent clearfix">
		<div class="np_left_title">
			<h2>采购流程设置</h2>
			<!-- 
				<p><a onclick="javascript:addContract();" href="javascript:;" class="abtn"><span>新建</span></a></p>
				 -->
		</div>
						...
						<div class="nt">
							...
							<div class="nt_line">
								<table width="100%">
									<tbody>
										<tr class="alt">
											<td align="right"><label><input type="radio" name="IntoTheUnitPriceMethod" /></label></td>
											<td><label>手工录入</label></td>
											<td align="right"><label><input type="radio" name="IntoTheUnitPriceMethod" /></label></td>
											<td><label>参考成本</label></td>
											<td align="right"><label><input type="radio" name="IntoTheUnitPriceMethod" checked="checked" /></label></td>
						...
						<div class="nt">
							...
							<div class="nt_line">
								<table width="100%">
									<tbody>
										<tr class="alt">
											<td align="right"><label><input type="radio" name="MonovalentEntryWay" /></label></td>
											<td><label>手工录入</label></td>
											<td align="right"><label><input type="radio" name="MonovalentEntryWay" /></label></td>
											<td><label>取自供应商存货价格表价格</label></td>
											<td align="right"><label><input type="radio" name="MonovalentEntryWay" checked="checked" /></label></td>
						...
						<div class="nt">
							...
							<div class="nt_line">
								<table width="100%">
									<tbody>
										<tr class="alt">
											<td align="right"><label><input type="radio" name="WhetherTheSuppliersTakePrice" /></label></td>
