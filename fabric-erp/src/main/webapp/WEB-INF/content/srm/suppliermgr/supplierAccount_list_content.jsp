...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');" width="15%"><s:text name="cmn_id" />&nbsp; <s:if test="%{pager.orderField == 'id' && pager.orderBy == 'asc' }">
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.account }</span></td>
				<td><span style="color: gray;">${entity.password }</span></td>
				<td><span style="color: gray;"> <c:if test="${'0' == entity.enable }">
							否
						</c:if> <c:if test="${'1' == entity.enable }">
							是
						</c:if>
				</span></td>
				<td>
