...
<script type="text/javascript">
	...
	function saveOrUpdateOrder(){
		...
		if($('#supplierForm').validationEngine('validate')){
			$.post('${vix}/srm/searchSupplierAction!saveOrUpdate.action?parentId='+$("#parentId").val(),
					{
						'supplier.id':$("#id").val(),
					...
					function(result){
						showMessage(result);
						setTimeout("",1000);
						loadContent('${vix}/srm/searchSupplierAction!goList.action?menuId=menuOrder');
					}
				 );
		}
	}
	...
	function chooseSupplierCategory(){
		$.ajax({
			  url:'${vix}/srm/searchSupplierAction!goChooseSupplierCategory.action',
			  cache: false,
...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="img/srm_searchSupplier.png" alt="" /> <s:text name="cmn_supplyChain" /></a></li>
				<li><a href="#"><s:text name="srm_supp_rela_manage" /></a></li>
				<li><a href="#"><s:text name='srm_supp_manage' /></a></li>
				<a href="#" onclick="loadContent('${vix}/srm/searchSupplierAction!goList.action');">供应商寻源</a>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateOrder();" href="#"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消"
						...
						</div> <a href="#"><img width="22" height="22" alt="导出" src="${vix}/common/img/dt_export.png"></a> <a href="#" onclick="loadContent('${vix}/srm/searchSupplierAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
									...
									<table style="border: none;">
										...
										<tr>
											...
											<td><select id="status" name="status" style="width: 50">
													<option value="2" selected="selected">待建档</option>
											</select></td>
										</tr>
									</table>
								</dd>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					...
					<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
						<div style="padding: 8px;">
							<table id="dlAptitudeInfo" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlAptitudeInfoTb',url: '${vix}/srm/searchSupplierAction!getSupplierAptitudeInfoJson.action?id=${supplier.id}',onClickRow: onDlClickRow">
								<thead>
									<tr>
					...
					<div id="a2" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
						<div style="padding: 8px;">
							<table id="dlAddress" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlAddressTb',url: '${vix}/srm/searchSupplierAction!getAddressJson.action?id=${supplier.id}',onClickRow: onDlClickRow2">
								<thead>
									<tr>
					...
					<div id="a3" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
						<div style="padding: 8px;">
							<table id="dlBankInfo" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlBankInfoTb',url: '${vix}/srm/searchSupplierAction!getBankInfoJson.action?id=${supplier.id}',onClickRow: onDlClickRow3">
								<thead>
									<tr>
										<th data-options="field:'id',align:'center',width:120">编号</th>
					...
					<div id="a4" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
						<div style="padding: 8px;">
							<table id="dlAccountingInfo" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlAccountingInfoTb',url: '${vix}/srm/searchSupplierAction!getAccountingInfoJson.action?id=${supplier.id}',onClickRow: onDlClickRow4">
								<thead>
									<tr>
										<th data-options="field:'id',align:'center',width:120">编号</th>
					...
					<div id="a5" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
						<div style="padding: 8px;">
							<table id="dlCreditInfo" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlCreditInfoTb',url: '${vix}/srm/searchSupplierAction!getCreditInfoJson.action?id=${supplier.id}',onClickRow: onDlClickRow5">
								<thead>
									<tr>
										<th data-options="field:'id',align:'center',width:120">编号</th>
					...
					<div id="a6" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
						<div style="padding: 8px;">
							<table id="dlIndicators" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlIndicatorsTb',url: '${vix}/srm/searchSupplierAction!getIndicatorsJson.action?id=${supplier.id}',onClickRow: onDlClickRow6">
								<thead>
									<tr>
										<th data-options="field:'id',align:'center',width:120">编号</th>
					...
					<div id="a7" style="width: 100%; visibility: hidden; position: absolute; top: -5000px;">
						<script type="text/javascript">
					$('#soAttach').datagrid({
						url: '${vix}/srm/searchSupplierAction!getAttachmentsJson.action?id=${supplier.id}',
						title: '附件',
						width: 900,
						height: '450',
						fitColumns: true,
						...
						toolbar:[{
							...
							handler:function(){
								...
								$.ajax({
									  url:'${vix}/srm/searchSupplierAction!addAttachments.action',
									  cache: false,
									  success: function(html){
										  asyncbox.open({
											 	modal:true,
												...
												callback : function(action,returnValue){
													if(action == 'ok'){
														uploadFile('${vix}/srm/searchSupplierAction!uploadAttachments.action?id=${supplier.id}','fileToUpload');
							...
							handler:function(){
								...
								for(var i =0;i<rows.length;i++){
									...
									$.ajax({url:'${vix}/srm/searchSupplierAction!deleteAttachFile.action?afId='+rows[i].id,cache: false});
								}
							}
						}]
					});
