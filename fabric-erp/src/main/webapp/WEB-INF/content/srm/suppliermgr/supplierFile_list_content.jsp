...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="15%">编码</th>
			<th width="20%">名称</th>
			<th width="15%"><s:text name="srm_contact_information" /></th>
			<th width="10%">联系人</th>
			<th width="10%"><s:text name="pur_type" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.contacts }</span></td>
				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#" onclick="deleteEntity('${entity.id}');" title="删除"></a></i> <i><a href="#" title="查看"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="<s:text name='cmn_update'/>"></a></i> <b>${entity.id}</b>
							</strong>
							<p>${entity.name}</p>
						</div>
					</div>
