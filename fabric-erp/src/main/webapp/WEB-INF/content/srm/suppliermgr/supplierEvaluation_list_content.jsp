...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%"><s:text name="srm_supplier_code" /></th>
			<th width="15%"><s:text name="eam_suppliername" /></th>
			<th width="10%">质量水平</th>
			<th width="10%">价格水平</th>
			<th width="10%">退货情况</th>
			<th width="10%">拒收情况</th>
			<th width="10%">按时交货率</th>
			<th width="10%">服务评价</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.qualityLevel }</span></td>
				<td><span style="color: gray;">${entity.priceLevel }</span></td>
				<td><span style="color: gray;">${entity.returnGoods }</span></td>
				<td><span style="color: gray;">${entity.rejectInfo }</span></td>
				<td><span style="color: gray;">${entity.onTimeDelivery }</span></td>
				<td><span style="color: gray;">${entity.serviceEvaluation }</span></td>
				<td>
