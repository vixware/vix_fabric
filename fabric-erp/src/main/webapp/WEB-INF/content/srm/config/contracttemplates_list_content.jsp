...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');" width="15%">编码&nbsp; <s:if test="%{pager.orderField == 'id' && pager.orderBy == 'asc' }">
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td>srm_20130510</td>
				<td><span style="color: gray;">关于采购电子固件的合同模版</span></td>
				<td><span style="color: gray;">合格</span></td>
				<td><span style="color: gray;">使用中</span></td>
				<td><span style="color: gray;">2012-09-09</span></td>
