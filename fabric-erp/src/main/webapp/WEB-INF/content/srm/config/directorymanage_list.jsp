...
<script type="text/javascript">
	function saveOrUpdate(id, parentId) {
		var title = '新增供应商产品';
		var url = '${vix}/srm/directoryManagementAction!goSaveOrUpdate.action';
		var data = {};
		if (id > 0) {
			title = '编辑供应商产品';
			data.id = id;
...
<div class="content">
	<div id="c_head" class=" drop">
		...
		<div search_page_id="tab_home" class="grid_search search_simple">
			<label><input type="text" name="name" class="int more" placeholder="${vv:varView(" vix_mdm_item")}名称" id="nameS"></label><label><input type="button" value="<s:text name='cmn_search'/>" class="btn" onclick="searchForContent();"><input type="button" value="<s:text name='cmn_reset'/>" class="btn" name=""></label> <label>
	...
	<div class="box">
		<div id="left" class="ui-resizable" style="height: 500px;">
			...
			<script type="text/javascript">
				...
				async : {
				enable : true,
				url : "${vix}/srm/directoryManagementAction!findTreeToJson.action",
				...
				function onClick(event, treeId, treeNode, clickFlag) {
					...
					_tabLocateUrl("${vix}/srm/directoryManagementAction!goListContent.action?parentId=" + treeNode.id, 'tab_home');
				}
		...
		<div id="right">
			<div id="tab_content" class="tabbable addable_tab">
				<ul id="myTab" class="right_menu nav nav-tabs">
					<li pageId="tab_home" class="current"><a href="#tab_home" page="${vix}/srm/directoryManagementAction!goListContent.action"> <img src="img/mail.png" alt="" /> 供应商${vv:varView("vix_mdm_item")}
					</a></li>
				</ul>
