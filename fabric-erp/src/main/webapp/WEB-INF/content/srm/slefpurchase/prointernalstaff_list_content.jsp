...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');"><s:text name="cmn_id" />&nbsp; <s:if test="%{pager.orderField == 'id' && pager.orderBy == 'asc' }">
			...
			<th><s:text name="srm_material_name" /></th>
			<th><s:text name="srm_specifications" /></th>
			<th><s:text name="srm_unit" /></th>
			<th><s:text name="srm_price" /></th>
			<th><s:text name="srm_mode" /></th>
