...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/srm/issuedATenderInvitationAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/srm/issuedATenderInvitationAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/srm/issuedATenderInvitationAction!goListContent.action?name="+name,'brand');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/srm/issuedATenderInvitationAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'brand');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/srm/issuedATenderInvitationAction!goListContent.action?name="+name,'brand');
}
