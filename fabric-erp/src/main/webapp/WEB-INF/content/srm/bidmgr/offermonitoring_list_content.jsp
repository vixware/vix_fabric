...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="srm_project" /></th>
			<th><s:text name="srm_person_in_charge" /></th>
			<th><s:text name="srm_starttimes" /></th>
			<th><s:text name="srm_endtimes" /></th>
			<th><s:text name="srm_tender_time" /></th>
