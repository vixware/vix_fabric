...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="15%"><s:text name="pur_theme" /></th>
			<th width="10%"><s:text name="srm_mode" /></th>
			<th width="10%"><s:text name="srm_type" /></th>
			<th width="10%"><s:text name="srm_competitive_bidding" /></th>
			<th width="15%"><s:text name="srm_place_of_bid" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">关于XX电子产品的项目</span></td>
				<td><span style="color: gray;">已结束</span></td>
				<td><span style="color: gray;">电子产品</span></td>
				<td><span style="color: gray;">邀请招标</span></td>
				<td><span style="color: gray;">北京市朝阳区和平路12号</span></td>
				<td><span style="color: gray;">2013-03-05</span></td>
				<td><span style="color: gray;">2013-03-07</span></td>
				<td>
