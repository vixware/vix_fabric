...
function searchForContent(){
	loadQuoteSubject();
	pager("start","${vix}/sales/quotes/salesQuotationAction!goSubListContent.action?quoteSubject="+quoteSubject,'subSalesQuotation');
}
...
function orderBy(orderField){
	loadQuoteSubject();
	var orderBy = $("#subSalesQuotationOrderBy").val();
	if(orderBy == 'desc'){
		orderBy = "asc";
	}else{
		orderBy = 'desc';
	}
	pager("start","${vix}/sales/quotes/salesQuotationAction!goSubListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&quoteSubject="+quoteSubject,'subSalesQuotation');
}

bindSearch();
function currentPager(tag){
	loadQuoteSubject();
	pager(tag,"${vix}/sales/quotes/salesQuotationAction!goSubListContent.action?quoteSubject="+quoteSubject,'subSalesQuotation');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="subSalesQuotationInfo"></b> <s:text name='cmn_to' /> <b class="subSalesQuotationTotalCount"></b>)
