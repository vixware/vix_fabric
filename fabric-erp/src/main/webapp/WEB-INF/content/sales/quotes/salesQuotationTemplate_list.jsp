...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/sales/quotes/salesQuotationTemplateAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/sales/quotes/salesQuotationTemplateAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/sales/quotes/salesQuotationTemplateAction!goListContent.action?quoteSubject="+quoteSubject,'salesQuotationTemplate');
			});
		  }
	});
}
...
function orderBy(orderField){
	loadQuoteSubject();
	var orderBy = $("#salesQuotationTemplateOrderBy").val();
	if(orderBy == 'desc'){
		orderBy = "asc";
	}else{
		orderBy = 'desc';
	}
	pager("start","${vix}/sales/quotes/salesQuotationTemplateAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&quoteSubject="+quoteSubject,'salesQuotationTemplate');
}

bindSearch();
function currentPager(tag){
	loadQuoteSubject();
	pager(tag,"${vix}/sales/quotes/salesQuotationTemplateAction!goListContent.action?quoteSubject="+quoteSubject,'salesQuotationTemplate');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="salesQuotationTemplateInfo"></b> <s:text name='cmn_to' /> <b class="salesQuotationTemplateTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a></span> <span><a class="end" onclick="currentPager('end');"></a></span>
					</div>
				</div>
				<div id="salesQuotationTemplate" class="table"></div>
				<div class="pagelist drop">
					<ul>
