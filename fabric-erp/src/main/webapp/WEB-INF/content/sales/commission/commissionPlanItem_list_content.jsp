	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;"> <c:if test="${null == entity.formType }">
						</c:if> <c:if test="${entity.formType == 1 }">
							类型1
						</c:if> <c:if test="${entity.formType == 2 }">
							类型2
						</c:if>
				</span></td>
				<td><span style="color: gray;">${entity.requirePerson }</span></td>
				<td><span style="color: gray;"><fmt:formatDate value="${entity.appDate }" type="both" pattern="yyyy-MM-dd" /></span></td>
				<td>
