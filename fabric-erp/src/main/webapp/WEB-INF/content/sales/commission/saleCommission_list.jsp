...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/sales/commission/saleCommissionAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/sales/commission/saleCommissionAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/sales/commission/saleCommissionAction!goListContent.action?name="+name,'saleCommission');
			});
		  }
	});
}
...
function orderBy(orderField){
	loadName();
	var orderBy = $("#saleCommissionOrderBy").val();
	if(orderBy == 'desc'){
		orderBy = "asc";
	}else{
		orderBy = 'desc';
	}
	pager("start","${vix}/sales/commission/saleCommissionAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'saleCommission');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/sales/commission/saleCommissionAction!goListContent.action?name="+name,'saleCommission');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="saleCommissionInfo"></b> <s:text name='cmn_to' /> <b class="saleCommissionTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a></span> <span><a class="end" onclick="currentPager('end');"></a></span>
					</div>
				</div>
				<div id="saleCommission" class="table"></div>
				<div class="pagelist drop">
					<ul>
