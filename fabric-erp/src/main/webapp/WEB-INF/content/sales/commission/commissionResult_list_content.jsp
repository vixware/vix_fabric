	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.purchasePlanName }</span></td>
				<td><span style="color: gray;">${entity.supplierName }</span></td>
				<td><span style="color: gray;"> <c:if test="${null == entity.style }">
				...
				<td><span style="color: gray;">${entity.executeDepartment }</span></td>
				<td><span style="color: gray;">${entity.executePerson }</span></td>
				...
				<td>
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close" onclick="deleteEntity('${entity.id}');"><a href="#"></a></i> <i><a href="#" title="<s:text name='cmn_show'/>"></a></i> <i><a href="#" onclick="saveOrUpdate(${entity.id},$('#parentId').val());" title="<s:text name='cmn_update'/>"></a></i> <b>${entity.purchasePlanName}</b>
							</strong>
							<p>${entity.memo}</p>
						</div>
					</div>
