	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td width="20%"><span style="color: gray;">aCode20130524</span></td>
				<td><span style="color: gray;">螺丝</span></td>
				<td><span style="color: gray;">500</span></td>
				<td><span style="color: gray;">3cm</span></td>
				<td width="40"><span style="color: gray;">充足</span></td>
				<td>
