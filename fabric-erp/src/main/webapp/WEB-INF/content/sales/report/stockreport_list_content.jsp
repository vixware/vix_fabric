...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('outInvWarehouse.name');">单价&nbsp;<img id="wimTransvouchImg_outInvWarehouse" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('inInvWarehouse.name');">数量&nbsp;<img id="wimTransvouchImg_inInvWarehouse" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('tvdate');">金额&nbsp;<img id="wimTransvouchImg_tvdate" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('tvdate');">类型&nbsp;<img id="wimTransvouchImg_tvdate" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('status');">日期&nbsp;<img id="wimTransvouchImg_status" src="${vix}/common/img/arrow.gif"></span></th>
		</tr>
		<%
			int count = 0;
		%>
