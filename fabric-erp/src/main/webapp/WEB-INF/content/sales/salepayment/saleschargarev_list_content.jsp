	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">关于此次销售费用支出情况</span></td>
				<td><span style="color: gray;">￥2000</span></td>
				<td><span style="color: gray;">支出</span></td>
				<td><span style="color: gray;">林峰</span></td>
				<td><span style="color: gray;">已审</span></td>
				<td width="90"><span style="color: gray;">2013-05-30</span></td>
				<td>
