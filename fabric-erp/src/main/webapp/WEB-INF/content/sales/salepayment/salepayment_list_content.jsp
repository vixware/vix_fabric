...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="cmn_id" /></th>
			<th><s:text name="summary" /></th>
			<th>费用类型</th>
			<th>费用原因</th>
			<th>销售组织</th>
			<th>项目</th>
			<th><s:text name="sa_amountofmoney" /></th>
			<th><s:text name="sa_department" /></th>
			<th><s:text name="cmn_clerk" /></th>
			<th width="40"><s:text name="cmn_date" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">aCode20130523</span></td>
				<td><span style="color: gray;">此次项目涉及了各个模块的功能</span></td>
				<td><span style="color: gray;">办公</span></td>
				<td><span style="color: gray;">出差补助</span></td>
				<td><span style="color: gray;">销售三部</span></td>
				<td><span style="color: gray;">ERP项目</span></td>
				<td><span style="color: gray;">2000</span></td>
				<td><span style="color: gray;">财务部</span></td>
				<td><span style="color: gray;">刘勇</span></td>
				<td width="80"><span style="color: gray;">2013-04-06</span></td>
				<td>
