...
<!--
	...
	$('#dgdA1').datagrid({
		...
		columns:[[
			...
			{field:'receivingwarehouse',title:'总金额',width:150,
				formatter:function(value,rec){
					return '<span>100000</span>';
				}
			}
		]],
		pagination:true,
			...
			<dl>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							<li class="current"><a onclick="javascript:tab(8,1,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />明细项</a></li>
							<li><a onclick="javascript:$('#a2').attr('style','');tab(8,2,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />审批项</a></li>
							<li><a onclick="javascript:$('#a3').attr('style','');tab(8,3,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />附件项</a></li>
