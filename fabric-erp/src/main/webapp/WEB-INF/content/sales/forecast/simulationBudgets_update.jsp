	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/sales/forecast/simulationBudgetsAction!goList.action');">ATP模拟运算</a></li>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdatePlan();" href="#"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消"
						...
						</div> <a href="#"><img width="22" height="22" alt="导出" src="${vix}/common/img/dt_export.png"></a> <a href="#" onclick="loadContent('${vix}/sales/forecast/simulationBudgetsAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong> <b>新增ATP模拟运算</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
					...
					<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
						<div style="padding: 8px;">
							<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/purchase/purchasePlanAction!getPurchasePlanItemsJson.action?id=${purchasePlan.id}',onClickRow: onDlClickRow1">
								<thead>
									<tr>
										<th data-options="field:'month1',width:150,align:'center',editor:'text'">期初/模拟</th>
										<th data-options="field:'month2',width:150,align:'center',editor:'text'">起始日期</th>
										<th data-options="field:'month3',width:150,align:'center',editor:'text'">期初</th>
										<th data-options="field:'month4',width:150,align:'center',editor:'text'">预计收入</th>
										<th data-options="field:'month5',width:150,align:'center',editor:'text'">预计发出</th>
										<th data-options="field:'month6',width:150,align:'center',editor:'text'">ATP可用量</th>
									</tr>
								</thead>
							</table>
