		...
		<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '',onClickRow: onDlClickRow1">
			<thead>
				<tr>
					...
					<th data-options="field:'month2',width:200,align:'center',editor:'text'">说明</th>
					<th data-options="field:'month3',width:200,align:'center',editor:'text'">报价方案说明</th>
					<th data-options="field:'month4',width:150,align:'center',editor:'text'">存货名称</th>
					<th data-options="field:'month5',width:150,align:'center',editor:'text'">报价单价</th>
					<th data-options="field:'month6',width:150,align:'center',editor:'text'">状态</th>
					<th data-options="field:'month7',width:150,align:'center',editor:'text'">操作员</th>
				</tr>
			</thead>
		</table>
		<script type="text/javascript">
