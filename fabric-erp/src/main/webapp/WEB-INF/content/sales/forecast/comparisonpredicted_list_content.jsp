...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="20%"><s:text name="sa_subject" /></th>
			<th><s:text name="sa_predictionofnumberof" /></th>
			<th><s:text name="sa_thepinnumber" /></th>
			<th><s:text name="sa_predictionoftime" /></th>
			<th><s:text name="sa_year" /></th>
			<th width="40"><s:text name="sa_state" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td width="20%"><span style="color: gray;">关于IOS和Androd系统手机售卖数量</span></td>
				<td><span style="color: gray;">50000</span></td>
				<td><span style="color: gray;">60000</span></td>
				<td><span style="color: gray;">2012-12-20</span></td>
				<td><span style="color: gray;">2013年度</span></td>
				<td width="35"><span style="color: gray;">已完结</span></td>
				<td>
