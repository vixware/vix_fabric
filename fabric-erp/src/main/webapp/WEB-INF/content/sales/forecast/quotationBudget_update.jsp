	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">售前分析</a></li>
				<li><a href="#">模拟报价</a></li>
				<li><a href="#" onclick="loadContent('${vix}/sales/forecast/quotationBudgetAction!goList.action');">模拟报价运算</a></li>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdatePlan();" href="#"><img width="22" height="22" alt="保存" src="${vix}/common/img/dt_save.png"></a> <a href="#"><img width="22" height="22" alt="保存并新增" src="${vix}/common/img/dt_savenew.png" /></a> <a href="#"><img width="22" height="22" alt="取消"
						...
						</div> <a href="#"><img width="22" height="22" alt="导出" src="${vix}/common/img/dt_export.png"></a> <a href="#" onclick="loadContent('${vix}/sales/forecast/quotationBudgetAction!goList.action');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong> <b>新增模拟报价运算</b> <i></i>
					</strong>
				</dt>
				<dd class="clearfix">
							...
							<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											<td align="right">运算日期：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">报价方案编码：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">报价方案说明：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">存货编码：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">存货名称：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">规格型号：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">模拟版本号：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">材料成本：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">人工成本：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">制造费用：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">委外费用：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">辅助费用：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">管理费：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">仓储费：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">其他费用：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">分摊数量：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">报价成本：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">报价成本上浮百分比：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">报价单价：</td>
											<td><input type="text" size="30" /></td>
											<td align="right">含税单价：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" size="30" /></td>
											<td align="right">报价单价(原币)：</td>
											<td><input type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">含税单价(原币)：</td>
											<td><input type="text" size="30" /></td>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					...
					<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
						<div style="padding: 8px;">
							<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '${vix}/purchase/purchasePlanAction!getPurchasePlanItemsJson.action?id=${purchasePlan.id}',onClickRow: onDlClickRow1">
								<thead>
									<tr>
										<th data-options="field:'id2',align:'center',width:150,editor:'checkbox'">成本类型</th>
										<th data-options="field:'itemCode',align:'center',width:150,editor:'text'">子件/工作重心编码</th>
										<th data-options="field:'itemName',width:200,align:'center',editor:'text'">子件/工作重心名称</th>
										<th data-options="field:'specification',width:150,align:'center',editor:'text'">数量/工时</th>
										<th data-options="field:'specification2',width:150,align:'center',editor:'text'">单价/费率</th>
										<th data-options="field:'specification3',width:150,align:'center',editor:'text'">金额</th>
										<th data-options="field:'specification4',width:150,align:'center',editor:'text'">计量单位</th>
										<th data-options="field:'specification5',width:150,align:'center',editor:'text'">材料/成本加成率</th>
										<th data-options="field:'specification6',width:200,align:'center',editor:'text'">规格型号</th>
									</tr>
								</thead>
							</table>
