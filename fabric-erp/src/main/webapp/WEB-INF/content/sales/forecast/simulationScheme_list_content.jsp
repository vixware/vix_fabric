...
<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
	<div style="padding: 8px;">
		<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '',onClickRow: onDlClickRow1">
			<thead>
				<tr>
					<th data-options="field:'month1',width:150,align:'center',editor:'text'">编码</th>
					<th data-options="field:'month2',width:150,align:'center',editor:'text'">描述</th>
					<th data-options="field:'month3',width:100,align:'center',editor:'text'">MPS计划量</th>
					<th data-options="field:'month4',width:100,align:'center',editor:'text'">MRP计划量</th>
					<th data-options="field:'month5',width:100,align:'center',editor:'text'">采购在途量</th>
					<th data-options="field:'month6',width:100,align:'center',editor:'text'">已请购量</th>
					<th data-options="field:'month7',width:100,align:'center',editor:'text'">生产订单量</th>
					<th data-options="field:'month8',width:100,align:'center',editor:'text'">委外订单量</th>
					<th data-options="field:'month9',width:100,align:'center',editor:'text'">到货/在捡量</th>
				</tr>
			</thead>
		</table>
		<script type="text/javascript">
