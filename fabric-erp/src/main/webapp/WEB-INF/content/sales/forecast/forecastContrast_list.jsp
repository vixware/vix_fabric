...
function searchForContent(){
	loadCode();
	pager("start","${vix}/sales/forecast/forecastContrastAction!goListContent.action?code=",'forecast');
}
 
//载入分页列表数据
pager("start","${vix}/sales/forecast/forecastContrastAction!goListContent.action?code="+"&pageNo=${pageNo}",'forecast');
bindSearch();
function currentPager(tag){
	pager(tag,"${vix}/sales/forecast/forecastContrastAction!goListContent.action?code=",'forecast');
}
...
<div class="sub_menu">
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				<li><a href="#"><img src="${vix}/common/img/sale/saleForecast.png" alt="" />供应链</a></li>
				<li><a href="#">供应链</a></li>
				<li><a href="#">销售管理</a></li>
				<li><a href="#" onclick="loadContent('${vix}/sales/forecast/forecastContrastAction!goList.action');">预测列表</a></li>
			</ul>
		</div>
	</h2>
</div>
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="forecastInfo"></b> <s:text name="cmn_to" /> <b class="forecastTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a></span> <span><a class="end" onclick="currentPager('end');"></a></span>
					</div>
				</div>
				<div id="forecast" class="table" style="height: 468px;"></div>
				<div class="pagelist drop">
					<ul>
