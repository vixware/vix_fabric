...
<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
	<div style="padding: 8px;">
		<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '',onClickRow: onDlClickRow1">
			<thead>
				<tr>
					<th data-options="field:'month1',width:100,align:'center',editor:'text'">存货编码</th>
					<th data-options="field:'month2',width:150,align:'center',editor:'text'">存货名称</th>
					<th data-options="field:'month3',width:100,align:'center',editor:'text'">规格型号</th>
					<th data-options="field:'month4',width:100,align:'center',editor:'text'">主计量</th>
					<th data-options="field:'month5',width:100,align:'center',editor:'text'">数量</th>
					<th data-options="field:'month6',width:100,align:'center',editor:'text'">报价</th>
					<th data-options="field:'month7',width:100,align:'center',editor:'text'">含税单价</th>
					<th data-options="field:'month7',width:100,align:'center',editor:'text'">无税单价</th>
					<th data-options="field:'month7',width:100,align:'center',editor:'text'">无税金额</th>
				</tr>
			</thead>
		</table>
		<script type="text/javascript">
