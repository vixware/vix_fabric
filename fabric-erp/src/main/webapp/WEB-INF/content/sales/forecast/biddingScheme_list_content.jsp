		...
		<table id="dlLineItem" class="easyui-datagrid" style="height: 450px; margin: 6px;" data-options="rownumbers:true,pagination: true,iconCls: 'icon-edit',singleSelect: true,toolbar: '#dlLineItemTb',url: '',onClickRow: onDlClickRow1">
			<thead>
				<tr>
					...
					<th data-options="field:'month2',width:150,align:'center',editor:'text'">说明</th>
					<th data-options="field:'month3',width:150,align:'center',editor:'text'">材料取价法一</th>
					<th data-options="field:'month4',width:150,align:'center',editor:'text'">材料取价法二</th>
					<th data-options="field:'month5',width:150,align:'center',editor:'text'">材料取价法三</th>
					<th data-options="field:'month6',width:150,align:'center',editor:'text'">委外费用所属成本项目</th>
					<th data-options="field:'month7',width:150,align:'center',editor:'text'">委外费用计算法</th>
				</tr>
			</thead>
		</table>
		<script type="text/javascript">
