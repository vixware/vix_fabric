...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="20%"><s:text name="sa_forecastingmodel" /></th>
			<th width="15%"><s:text name="sa_modelname" /></th>
			<th><s:text name="cmn_mode" /></th>
			<th><s:text name="sa_source" /></th>
			<th><s:text name="sa_department" /></th>
			<th><s:text name="sa_time" /></th>
			<th width="40"><s:text name="cmn_clerk" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td width="20%"><span style="color: gray;">供应链销售管理预测模块软件</span></td>
				<td width="15%"><span style="color: gray;">销售管理预测模块软件</span></td>
				<td><span style="color: gray;">已完成</span></td>
				<td><span style="color: gray;">产品一部预测二组</span></td>
				<td><span style="color: gray;">软件开发部</span></td>
				<td><span style="color: gray;">2012-12-01</span></td>
				<td width="40"><span style="color: gray;">王涛</span></td>
				<td>
