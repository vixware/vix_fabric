								...
								<dd style="display: block;">
									<table>
										<tr height="40">
											...
											<td><input type="text" id="companyCode" name="companyCode" value="${billsCategory.companyCode}" readonly="readonly" /></td>
										</tr>
										<tr height="40">
					...
					<div id="a1" style="position: relative; z-index: 1; background: #FFF;">
						<script type="text/javascript">
                            ...
                            function billsPropertyDictionary(categoryCode) {
	                            $('#dlAddress2')
	                                    .datagrid({
	                                    url : '${vix}/sales/config/saleBillTypeAction!getBillsPropertyDictionaryJson.action?billsCategoryDictionaryCategoryCode=' + categoryCode,
	                                    width : 'auto',
	                                    height : 250,
	                                    pagination : true,
	                                    rownumbers : true,
