...
function saveOrUpdate(id){
	$.ajax({
		  url:'${vix}/sales/refund/returnRuleAction!goSaveOrUpdate.action?id='+id,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/sales/refund/returnRuleAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/sales/refund/returnRuleAction!goListContent.action?quoteSubject="+quoteSubject,'returnRule');
			});
		  }
	});
}
...
function orderBy(orderField){
	loadQuoteSubject();
	var orderBy = $("#returnRuleOrderBy").val();
	if(orderBy == 'desc'){
		orderBy = "asc";
	}else{
		orderBy = 'desc';
	}
	pager("start","${vix}/sales/refund/returnRuleAction!goListContent.action?orderField="+orderField+"&orderBy="+orderBy+"&quoteSubject="+quoteSubject,'returnRule');
}

bindSearch();
function currentPager(tag){
	loadQuoteSubject();
	pager(tag,"${vix}/sales/refund/returnRuleAction!goListContent.action?quoteSubject="+quoteSubject,'returnRule');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a></span> <span><a class="previous" onclick="currentPager('previous');"></a></span> <em>(<b class="returnRuleInfo"></b> <s:text name='cmn_to' /> <b class="returnRuleTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a></span> <span><a class="end" onclick="currentPager('end');"></a></span>
					</div>
				</div>
				<div id="returnRule" class="table"></div>
				<div class="pagelist drop">
					<ul>
