...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="15%">${vv:varView('vix_mdm_item')}编码</th>
			<th width="20%">${vv:varView('vix_mdm_item')}名称</th>
			<th width="10%">${vv:varView('vix_mdm_item')}类型</th>
			<th width="10%">销售数量</th>
			<th width="20%">税率</th>
			<th width="10%">单价</th>
			<th width="10%">操作</th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">${entity.itemCode}</span></td>
				<td><span style="color: gray;">${entity.itemName}</span></td>
				<td><span style="color: gray;">${entity.itemType }</span></td>
				<td><span style="color: gray;">${entity.amount }</span></td>
				<td><span style="color: gray;">${entity.tax}</span></td>
