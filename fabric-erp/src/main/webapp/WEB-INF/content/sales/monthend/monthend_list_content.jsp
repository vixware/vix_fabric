...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="sa_accountingmonth" /></th>
			<th><s:text name="sa_startdate" /></th>
			<th><s:text name="sa_asofthedateof" /></th>
			<th><s:text name="sa_whetherthebill" /></th>
			<th><s:text name="cmn_clerk" /></th>
			<th width="40"><s:text name="cmn_memo" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><span style="color: gray;">2013-03-31</span></td>
				<td><span style="color: gray;">2013-03-01</span></td>
				<td><span style="color: gray;">2013-03-30</span></td>
				<td><span style="color: gray;">是</span></td>
				<td><span style="color: gray;">吴丽丽</span></td>
				<td><span style="color: gray;">已结帐</span></td>
				<td>
