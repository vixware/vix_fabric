...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="20%"><s:text name="summary" /></th>
			<th><s:text name="sa_costtype" /></th>
			<th><s:text name="sa_amountofmoney" /></th>
			<th><s:text name="sa_department" /></th>
			<th><s:text name="cmn_clerk" /></th>
			<th width="90"><s:text name="cmn_date" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td width="15%"><span style="color: gray;">aCode20130523</span></td>
				<td width="20%"><span style="color: gray;">本功能是销售模块下的代垫费用</span></td>
				<td><span style="color: gray;">个人</span></td>
				<td><span style="color: gray;">1000</span></td>
				<td><span style="color: gray;">销售部</span></td>
				<td><span style="color: gray;">刘明</span></td>
				<td width="90"><span style="color: gray;">2013-05-01</span></td>
				<td>
