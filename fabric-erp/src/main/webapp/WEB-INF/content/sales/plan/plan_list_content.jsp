...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="20%"><s:text name="sa_productname" /></th>
			<th><s:text name="sa_numberofsales" /></th>
			<th><s:text name="sa_plantime" /></th>
			<th><s:text name="cmn_mode" /></th>
			<th><s:text name="sa_organizedepartment" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td width="20%"><span style="color: gray;">VIX电子商务管理系统</span></td>
				<td><span style="color: gray;">500</span></td>
				<td><span style="color: gray;">2012-11-05</span></td>
				<td><span style="color: gray;">计划已启动</span></td>
				<td><span style="color: gray;">策划部</span></td>
				<td width="40"><span style="color: gray;">董文斌</span></td>
				<td>
