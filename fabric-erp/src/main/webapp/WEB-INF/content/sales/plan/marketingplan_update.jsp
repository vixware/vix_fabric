...
<!--
	...
	$('#dgdA1').datagrid({
		...
		frozenColumns:[[
			...
			{field:'ship',title:'销售编码 ',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130523 </span>';
				}
			},   
			{field:'invoicedocument',title:'物品名称 ',width:130,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'specification',title:'物品型号 ',width:150,
				formatter:function(value,rec){
					return '<span>智能娱乐型手机  </span>';
				}
			},
			{field:'itemType',title:'物品类型',width:150,
				formatter:function(value,rec){
					return '<span>IPhone4s</span>';
				}	
			},
			{field:'amount',title:'订货数量 ',width:150,
				formatter:function(value,rec){
			...
			{field:'netprice',title:'净单价 ',width:150,
				formatter:function(value,rec){
					return '<span>5000</span>';
				}
			},
			{field:'coin',title:'货币 ',width:150,
				formatter:function(value,rec){
			...
			{field:'receivingwarehouse',title:'收货仓库 ',width:150,
				formatter:function(value,rec){
					return '<span>渔湾码头二号仓库 </span>';
				}
			},
			{field:'jiaohuodate',title:'交货日期 ',width:150,
				formatter:function(value,rec){
		...
		<%-- 下侧滚动条无锁定 
		 columns:[[
			...
			{field:'materialBatches',title:'物料批次',width:100,
				formatter:function(value,rec){
					return '<span>3</span>';
				}
			},
	...
	$('#dgdA3').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'saleOrderCode',title:'销售订单编号',width:110,
				formatter:function(value,rec){
					return '<span>aCode20130514</span>';
				}
			},   
			{field:'saleOrderItemCode',title:'销售订单项编码',width:200,
				formatter:function(value,rec){
					return '<span>aCode201305201650</span>';
				}
			},
			{field:'starttime',title:'开始时间',width:100,
				formatter:function(value,rec){
					return '<span>2013-05-01</span>';
				}
			},
			{field:'endtime',title:'结束时间',width:100,
				formatter:function(value,rec){
					return '<span>2013-05-31</span>';
				}
			},
			{field:'materialBatches',title:'备注',width:200,
				formatter:function(value,rec){
					return '<span>此次行业订单明细情况如下</span>';
				}
			}
		]],
		pagination:true,
	...
	$('#dgdA4').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'purchaseOrderCode',title:'销售发货单 ',width:110,
				formatter:function(value,rec){
					return '<span>pCode20130514</span>';
				}
			},
			{field:'companyId',title:'公司代码',width:110,
				formatter:function(value,rec){
					return '<span>cID20130514</span>';
				}
			}
		]],
		columns:[[
			{field:'specification',title:'单据类型',width:100,
				formatter:function(value,rec){
			...
			{field:'purchasePerson',title:'采购人',width:100,
				formatter:function(value,rec){
					return '<span>仓库A</span>';
				}
			},
	...
	$('#dgdA5').datagrid({
		...
		frozenColumns:[[
			{field:'ck',checkbox:true},
			{field:'itemCode',title:'物料编码',width:110,
				formatter:function(value,rec){
					return '<span>iCode20130514</span>';
				}
			},   
			{field:'itemName',title:'物料名称',width:200,
				formatter:function(value,rec){
		...
		columns:[[
			{field:'itemType',title:'物料类型',width:100,
				formatter:function(value,rec){
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<a href="#"><s:text name="sa_marketingplan" /></a>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><input id="documentDate" name="" type="text" /> <img onclick="showTime('documentDate','yyyy-MM-dd HH:mm')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
				...
				<div class="clearfix" style="background: #FFF; position: relative;">
					<div class="right_menu">
						<ul>
							<li class="current"><a onclick="javascript:tab(8,1,'a',event);"><img src="${vix}/common/img/mail.png" alt="" />销售项</a></li>
							<!--<li><a onclick="javascript:$('#a2').attr('style','');tab(8,2,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />地址项</a></li>
						<li><a onclick="javascript:$('#a3').attr('style','');tab(8,3,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />行业订单项</a></li>
						<li><a onclick="javascript:$('#a4').attr('style','');tab(8,4,'a',event)"><img src="${vix}/common/img/mail.png" alt="" />产品项</a></li>
