...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="20%"><s:text name="sa_planningtopics" /></th>
			<th><s:text name="sa_number" /></th>
			<th><s:text name="sa_plantime" /></th>
			<th><s:text name="sa_state" /></th>
			<th><s:text name="sa_department" /></th>
			<th width="40"><s:text name="sa_schemer" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td width="20%"><span style="color: gray;">针对2013年度销售软件销售情况计划</span></td>
				<td><span style="color: gray;">200</span></td>
				<td><span style="color: gray;">2012-11-05</span></td>
				<td><span style="color: gray;">计划已启动</span></td>
				<td><span style="color: gray;">策划部</span></td>
				<td width="40"><span style="color: gray;">潘阳</span></td>
				<td>
