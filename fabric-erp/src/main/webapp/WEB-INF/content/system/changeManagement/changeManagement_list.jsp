...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/system/changeManagementAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/system/changeManagementAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/system/changeManagementAction!goSingleList.action?name="+name,'changeRecord');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/system/changeManagementAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'changeRecord');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/system/changeManagementAction!goSingleList.action?name="+name,'changeRecord');
}
...
<div class="content">
	...
	<div id="number">
		...
		<ul id="numBox" class="numBox">
			...
			<s:iterator value="changeRecordList" var="c">
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a> </span> <span><a class="previous" onclick="currentPager('previous');"></a> </span> <em>(<b class="changeRecordInfo"></b> <s:text name='cmn_to' /> <b class="changeRecordTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a> </span> <span><a class="end" onclick="currentPager('end');"></a> </span>
					</div>
				</div>
				<div id="changeRecord" class="table"></div>
				<div class="pagelist drop">
					<ul>
