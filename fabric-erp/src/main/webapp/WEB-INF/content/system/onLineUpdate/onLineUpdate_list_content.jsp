...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="100"><s:text name="drp_serial_number" /></th>
			<th width="150"><s:text name="drp_theme" /></th>
			<th><s:text name="drp_budget_amount" /></th>
			<th><s:text name="drp_state" /></th>
			<th><s:text name="drp_department" /></th>
			<th><s:text name="drp_person_in_charge" /></th>
			<th><s:text name="drp_budget_time" /></th>
