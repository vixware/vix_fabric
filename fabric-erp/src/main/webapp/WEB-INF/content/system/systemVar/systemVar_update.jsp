	...
	<form id="systemVarForm">
		...
		<div class="box order_table" style="line-height: normal;">
			<table>
				...
				<tr height="40">
					<td align="right">值:&nbsp;</td>
					<td><input type="text" id="defaultValue" style="width: 80%;" name="entityForm.defaultValue" class="validate[required] text-input" value="${entity.defaultValue}" /><span style="color: red;">*</span></td>
				</tr>
				<tr height="40">
