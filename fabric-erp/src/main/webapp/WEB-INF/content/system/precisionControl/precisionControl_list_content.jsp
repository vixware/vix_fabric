...
<input type="hidden" id="selectId" name="selectId" value="${organizationId}" />
<!-- left -->
		...
		<div id="por_right" class="np_l_r clearfix" style="margin: 15px 0 0 0;">
			<div id="lnp1">
				<ul class="np_tab clearfix">
					<li class="current"><a href="javascript:;" onclick="javascript:tab(6,1,'np',event)">数据精度设置</a></li>
				</ul>
				<div class="np_clist" id="np1">
					<div class="nt">
						<div class="nt_line">
							<table width="100%" class="lineh30">
								...
								<tr>
									<td>存货体积小数位:</td>
									<td><input type="text" id="stockDimensionDecimal" name="stockDimensionDecimal" value="${ precisionControl.stockDimensionDecimal}" class="ipt time_aoto_input wb30"></td>
									<td>存货重量小数位:</td>
									<td><input type="text" id="stockWeightDecimal" name="stockWeightDecimal" value="${ precisionControl.stockWeightDecimal}" class="ipt time_aoto_input wb30"></td>
								</tr>
								<tr>
									<td>件数小数位:</td>
								...
								<tr>
									...
									<td>金额小数位:</td>
									<td><input type="text" id="amountDecimal" name="amountDecimal" value="${ precisionControl.amountDecimal}" class="ipt time_aoto_input wb30"></td>
								</tr>
								<tr>
									<td>开票单价小数位:</td>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="msgtable">
						<tr>
							<td colspan="5" class="tc" style="padding: 10px 0;"><input name="" type="button" value="保存" class="btn" onclick="saveOrUpdate($('#selectId').val());" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="" type="button" value="重置" class="btn" onclick="reset();" /></td>
						</tr>
					</table>
				</div>
			</div>
