...
function saveOrUpdateModuleCategory(id,pageNo){
	$.ajax({
		  url:'${vix}/system/warningSourceAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/system/warningSourceAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/system/warningSourceAction!goSingleList.action?name="+name,'moduleCategory');
			});
		  }
	});
}
...
function orderBy(orderField){
	...
	pager("start","${vix}/system/warningSourceAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy+"&name="+name,'moduleCategory');
}

bindSearch();
function currentPager(tag){
	loadName();
	pager(tag,"${vix}/system/warningSourceAction!goSingleList.action?name="+name,'moduleCategory');
}
...
function searchForContent(tag){
	loadName();
	if(tag==0){
     	pager("start","${vix}/system/warningSourceAction!goSingleList.action?content="+name+"&tag="+tag,'moduleCategory');
	}else {
	    pager("start","${vix}/system/warningSourceAction!goSingleList.action?outwarehousecodes="+outwarehousecodes+"&inwarehousecodes="+inwarehousecodes+"&code1="+code1+"&tag="+tag,'moduleCategory');
	}
}
/* 重置 */
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#">预警中心</a></li>
				<li><a href="#">预警源设置 </a></li>
			</ul>
		</div>
	</h2>
	<div class="drop">
		<p>
			<a href="#" onclick="saveOrUpdateModuleCategory(0);"><span><s:text name='cmn_add' /> </span> </a>
		</p>
	</div>
</div>
<div class="content">
	...
	<div id="number">
		...
		<ul id="numBox" class="numBox">
			...
			<s:iterator value="moduleCategoryList" var="c">
				<li><a href="#" onclick="saveOrUpdateModuleCategory(${c.id});">${c.code}</a></li>
			</s:iterator>
		</ul>
	</div>
	<!-- c_head -->
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a> </span> <span><a class="previous" onclick="currentPager('previous');"></a> </span> <em>(<b class="moduleCategoryInfo"></b> <s:text name='cmn_to' /> <b class="moduleCategoryTotalCount"></b>)
						</em> <span><a class="next" onclick="currentPager('next');"></a> </span> <span><a class="end" onclick="currentPager('end');"></a> </span>
					</div>
				</div>
				<div id="moduleCategory" class="table"></div>
				<div class="pagelist drop">
					<ul>
