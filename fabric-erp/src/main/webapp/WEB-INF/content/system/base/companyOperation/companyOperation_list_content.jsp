...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('orgName');" width="30%">名称&nbsp; <s:if test="%{pager.orderField == 'orgName' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'orgName' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('orgType');" width="10%">类型&nbsp; <s:if test="%{pager.orderField == 'orgType' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'orgType' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('briefName');" width="10%">简称&nbsp; <s:if test="%{pager.orderField == 'briefName' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'briefName' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
			</th>
			<th onclick="orderBy('country');" width="10%">所属国家&nbsp; <s:if test="%{pager.orderField == 'country' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
			...
			<th onclick="orderBy('area');" width="10%">地区&nbsp; <s:if test="%{pager.orderField == 'area' && pager.orderBy == 'asc' }">
					<img src="${vix}/common/img/arrow_down.gif">
				</s:if> <s:elseif test="%{pager.orderField == 'area' && pager.orderBy == 'desc' }">
					<img src="${vix}/common/img/arrow_up.gif">
				</s:elseif> <s:else>
					<img src="${vix}/common/img/arrow.gif">
				</s:else>
				...
				<td><a href="#" onclick="saveOrUpdate('${entity.id}','');" title="修改"> <img src="${vix}/common/img/icon_edit.png" />
					...
					<div class="untitled" style="position: static; display: inline;">
						...
						<div class="popup" style="display: none; top: -7px;">
							<strong> <i class="close"><a href="#"></a></i> <i><a href="#" title="查看"></a></i> <i><a href="#" onclick="saveOrUpdate('${entity.id}');" title="修改"></a></i> <b>${entity.orgName}</b>
							</strong>
							<p>${entity.address}</p>
						</div>
					</div></td>
