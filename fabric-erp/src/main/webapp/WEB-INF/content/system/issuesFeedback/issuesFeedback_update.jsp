...
<script type="text/javascript">
	...
	function saveOrUpdateOrder (){
		...
		if ($ ('#order').validationEngine ('validate')){
			$.post ('${vix}/system/issuesFeedbackAction!saveOrUpdate.action' , {
			...
			'dlJson' : dlJson
				...
				showMessage (result);
				setTimeout ("" , 1000);
				loadContent ('${vix}/system/issuesFeedbackAction!goList.action');
			});
		}
	}
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateOrder()" href="#"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"> </a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_savenew.png" /> </a> <a href="#"><img width="22" height="22" title="取消"
							...
							height="22" title="打印" src="${vix}/common/img/dt_print.png"> </a> <a href="#"><img width="22" height="22" title="导出" src="${vix}/common/img/dt_export.png"> </a> <a href="#" onclick="loadContent('${vix}/system/issuesFeedbackAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回"
							src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong><b>问题反馈 </b><i></i> </strong>
				</dt>
				<dd class="clearfix">
