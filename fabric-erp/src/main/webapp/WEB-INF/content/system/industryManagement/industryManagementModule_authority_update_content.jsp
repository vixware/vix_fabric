...
function initAuthorityData(){
	$('#dataColGrid').treegrid({
		...
		collapsible:true, */
		singleSelect:true,
		//url:'${vix}/system/industryManagementAction!findAuthorityTreeData.action?treeId=${treeId}&industryMgtModuleId=${industryMgtModuleId}&bizType=${bizType}',
		url:'${vix}/system/industryManagementAction!findAuthorityTreeData.action',
		queryParams:{treeId:'${treeId}',industryMgtModuleId:'${industryMgtModuleId}',bizType:'${bizType}'},
		//remoteSort: false,
		idField:'id',
