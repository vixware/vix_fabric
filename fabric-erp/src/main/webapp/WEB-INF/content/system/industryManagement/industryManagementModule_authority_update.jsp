...
<div class="content">
	<div id="c_head" class=" drop">
		...
		<div>
			<label>行业模块：${imm.industryManagement.name}(${imm.module.name}) </label> <label>权限类别：<s:select list="bizTypeMap" id="authorityBizType" listKey="key" listValue="value" onchange="initAuthorityTree();" theme="simple"></s:select>
