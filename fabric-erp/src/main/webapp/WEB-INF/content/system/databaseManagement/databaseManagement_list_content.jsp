		...
		<tr class="alt">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.dataBaseName }</a></td>
					<td><a href="#" style="color: gray;">${entity.dataBaseType }</a></td>
					<td><a href="#" style="color: gray;">${entity.dataBaseServerIp }</a></td>
