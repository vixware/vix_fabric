...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_certificate_numbers" /></th>
			<th><s:text name="ldm_certificate_name" /></th>
			<th><s:text name="ldm_effective_time" /></th>
			<th><s:text name="ldm_holder" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">xx证件</a></td>
				<td><a href="#" style="color: gray;">2011-3-1 至 2018-3-1</a></td>
				<td><a href="#" style="color: gray;">王xx</a></td>
				<td><a href="#" style="color: gray;">有效</a></td>
				<td>
