...
<table id="itemTable" class="list">
	<tr class="alt">
		<th style="cursor: pointer;" onclick="orderBy('code');" width="20%">编码&nbsp;<img id="itemPriceManageImg_code" src="${vix}/common/img/arrow.gif"> </span></th>
		<th style="cursor: pointer;" onclick="orderBy('name');" width="60%">名称&nbsp;<img id="itemPriceManageImg_name" src="${vix}/common/img/arrow.gif"> </span></th>
		<th width="20%">规格</th>
	</tr>
	<%
		int count = 0;
