...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');"><s:text name="ldm_order_no" /></th>
			<th>主题</th>
			<th>客户名称</th>
			<th>发运地</th>
			<th>目的地</th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.outerId}</a></td>
					<td><a href="#" style="color: gray;">${entity.name}</a></td>
					<td><a href="#" style="color: gray;">${entity.customerAccount.shorterName}</a></td>
					<td><a href="#" style="color: gray;">${entity.source}</a></td>
					<td><a href="#" style="color: gray;">${entity.target}</a></td>
