...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');"><s:text name="ldm_numbers" />&nbsp; <s:if test="%{pager.orderField == 'id' && pager.orderBy == 'asc' }">
			...
			<th><s:text name="ldm_customer_name" /></th>
			<th><s:text name="ldm_amount" /></th>
			<th><s:text name="ldm_state" /></th>
			<th><s:text name="ldm_offerer" /></th>
			<th><s:text name="ldm_offer_time" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">xx报价</a></td>
					<td><a href="#" style="color: gray;">sxs</a></td>
					<td><a href="#" style="color: gray;">1000万</a></td>
					<td><a href="#" style="color: gray;">良好</a></td>
					<td><a href="#" style="color: gray;">哮天犬</a></td>
					<td><a href="#" style="color: gray;">2013-2-27</a></td>
					<td>
