...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_models" /></th>
			<th><s:text name="ldm_car_number" /></th>
			<th><s:text name="ldm_state" /></th>
			<th><s:text name="ldm_rent_time" /></th>
			<th><s:text name="ldm_start_date" /></th>
			<th><s:text name="ldm_deadline" /></th>
			<th><s:text name="ldm_occupants" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">suv</a></td>
					<td><a href="#" style="color: gray;">89</a></td>
					<td><a href="#" style="color: gray;">良好</a></td>
					<td><a href="#" style="color: gray;">2013-2-25</a></td>
					<td><a href="#" style="color: gray;">2013-2-25</a></td>
					<td><a href="#" style="color: gray;">2013-2-25</a></td>
