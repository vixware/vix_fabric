...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th onclick="orderBy('id');"><s:text name="ldm_order_no" />&nbsp; <s:if test="%{pager.orderField == 'id' && pager.orderBy == 'asc' }">
			...
			<th><s:text name="ldm_total_amount" /></th>
			<th><s:text name="ldm_collection_amount" /></th>
			<th>收货地址</th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">A123456</a></td>
					<td><a href="#" style="color: gray;">sxs</a></td>
					<td><a href="#" style="color: gray;">1000万</a></td>
					<td><a href="#" style="color: gray;">800万</a></td>
					<td><a href="#" style="color: gray;">深圳</a></td>
