	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.loadBillCode}</a></td>
				<td><a href="#" style="color: gray;">${entity.name}</a></td>
				<td><a href="#" style="color: gray;">${entity.delegateDate}</a></td>
				<td><a href="#" style="color: gray;">${entity.shipper}</a></td>
				<td><a href="#" style="color: gray;">${entity.counterman}</a></td>
