	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.shippingOrderCode}</a></td>
				<td><a href="#" style="color: gray;">${entity.committedTime}</a></td>
				<td><a href="#" style="color: gray;">${entity.consignmentSide}</a></td>
				<td><a href="#" style="color: gray;">${entity.receivingOrders}</a></td>
				<td><a href="#" style="color: gray;">${entity.clearingForm}</a></td>
