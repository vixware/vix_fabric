...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_warehouse_code" /></th>
			<th><s:text name="ldm_warehouse_name" /></th>
			<th><s:text name="ldm_warehouse_address" /></th>
			<th><s:text name="ldm_warehouse_type" /></th>
			<th><s:text name="ldm_warehouse_status" /></th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">启用</a></td>
					<td>
