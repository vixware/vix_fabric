...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_numbers" /></th>
			<th>姓名</th>
			<th><s:text name="ldm_gender" /></th>
			<th><s:text name="ldm_certificate_number" /></th>
			<th>学历</th>
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.scode }</a></td>
					<td><a href="#" style="color: gray;">${entity.name }</a></td>
					<td><a href="#" style="color: gray;">${entity.sex }</a></td>
					<td><a href="#" style="color: gray;">${entity.identityNumber }</a></td>
					<td><a href="#" style="color: gray;">${entity.educationalBackground }</a></td>
