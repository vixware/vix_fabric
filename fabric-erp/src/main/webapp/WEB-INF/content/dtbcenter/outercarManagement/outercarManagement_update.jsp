...
<script type="text/javascript">
	function saveOrUpdateVehicle() {
		if ($('#vehicleForm').validationEngine('validate')) {
			$.post('${vix}/dtbcenter/outercarManagementAction!saveOrUpdate.action', {
			'vehicle.id' : $("#id").val(),
			...
			'vehicle.chassisNumber' : $("#chassisNumber").val()
				...
				showMessage(result);
				setTimeout("", 1000);
				loadContent('${vix}/dtbcenter/outercarManagementAction!goList.action');
			});
		}
	}
	...
	<h2>
		...
		<div id="breadCrumb" class="breadCrumb module">
			<ul>
				...
				<li><a href="#" onclick="loadContent('${vix}/dtbcenter/outercarManagementAction!goList.action');"><s:text name="dtbcenter_vehiclemanagement" /> </a></li>
			</ul>
		</div>
	</h2>
</div>
			...
			<dl>
				<dt id="orderTitleFixd">
					<span class="no_line"> <a onclick="saveOrUpdateVehicle()" href="#"><img width="22" height="22" title="保存" src="${vix}/common/img/dt_save.png"> </a> <a href="#"><img width="22" height="22" title="保存并新增" src="${vix}/common/img/dt_saveandupdate.png" /> </a> <a href="#"><img width="22" height="22" title="保存并提交审批"
							src="${vix}/common/img/dt_submit.png" /> </a> <a href="#" onclick="loadContent('${vix}/dtbcenter/outercarManagementAction!goList.action?pageNo=${pageNo}');"><img width="22" height="22" title="返回" src="${vix}/common/img/dt_goback.png"> </a>
					</span> <strong><b>外车管理 </b> </strong>
				</dt>
				<dd class="clearfix">
								...
								<dd style="display: block;">
									<table style="border: none;">
										...
										<tr>
											...
											<td><input id="carryingcapacity" name="carryingcapacity" value="${vehicle.carryingcapacity }" type="text" size="20" class="validate[required] text-input" /><select id="carryingcapacityUnit" name="carryingcapacityUnit" class="validate[required] text-input">
										...
										<tr>
											...
											<td><input id="vehicleLength" name="vehicleLength" value="${vehicle.vehicleLength }" type="text" size="20" class="validate[required] text-input" /><select id="vehicleLengthUnit" name="vehicleLengthUnit" class="validate[required] text-input">
													<option value="cm" selected="selected">cm</option>
													<option value="m">m</option>
											</select><span style="color: red;">*</span></td>
											<td align="right">车宽：</td>
											<td><input id="vehicleWidth" name="vehicleWidth" value="${vehicle.vehicleWidth }" type="text" size="20" class="validate[required] text-input" /><select id="vehicleWidthUnit" name="vehicleWidthUnit" class="validate[required] text-input">
													<option value="cm" selected="selected">cm</option>
													<option value="m">m</option>
											</select><span style="color: red;">*</span></td>
										</tr>
										<tr>
											...
											<td><input id="vehicleHeight" name="vehicleHeight" value="${vehicle.vehicleHeight }" type="text" size="20" class="validate[required] text-input" /><select id="vehicleHeightUnit" name="vehicleHeightUnit" class="validate[required] text-input">
													<option value="cm" selected="selected">cm</option>
													<option value="m">m</option>
											</select><span style="color: red;">*</span></td>
											<td align="right">容量：</td>
											<td><input id="capacity" name="capacity" value="${vehicle.capacity }" type="text" size="20" /><select id="capacityUnit" name="capacityUnit">
													<option value="cm³" selected="selected">cm³</option>
													<option value="m³">m³</option>
											</select></td>
										</tr>
										<tr>
											...
											<td><input id="driverTelephone" name="driverTelephone" value="${vehicle.driverTelephone }" type="text" size="30" /></td>
										</tr>
										<tr>
											...
											<td><input id="licensePlateDate" name="licensePlateDate" value="${vehicle.licensePlateDate}" type="text" readonly="readonly" /><img onclick="showTime('licensePlateDate','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
										</tr>
										<tr>
											<td align="right">所属承运商：</td>
											<td><input id="carrier" name="carrier" value="${vehicle.carrier }" type="text" size="30" /></td>
											<td align="right">使用年限：</td>
											<td><input id="useYear" name="useYear" value="${vehicle.useYear }" type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">建档日期：</td>
											<td><input id="documnetDate" name="documnetDate" value="${vehicle.documnetDate}" type="text" readonly="readonly" /><img onclick="showTime('documnetDate','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
											<td align="right">行驶里程上限：</td>
											<td><input id="mileageTopLimit" name="mileageTopLimit" value="${vehicle.mileageTopLimit }" type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">里程表读数：</td>
											<td><input id="odometerReading" name="odometerReading" value="${vehicle.odometerReading }" type="text" size="30" /></td>
											<td align="right">重车百公里油耗：</td>
											<td><input id="oilWearWithHeavy" name="oilWearWithHeavy" value="${vehicle.oilWearWithHeavy }" type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">轻车百公里油耗：</td>
											<td><input id="oilWearWithEmpty" name="oilWearWithEmpty" value="${vehicle.oilWearWithEmpty }" type="text" size="30" /></td>
											<td align="right">制造商：</td>
											<td><input id="producer" name="producer" value="${vehicle.producer }" type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">出厂日期：</td>
											<td><input id="dateOfManufacture" name="dateOfManufacture" value="${vehicle.dateOfManufacture}" type="text" readonly="readonly" /><img onclick="showTime('dateOfManufacture','yyyy-MM-dd')" src="${vix}/common/img/datePicker.gif" width="16" height="22" align="absmiddle"></td>
											<td align="right">发动机号：</td>
											<td><input id="engineCode" name="engineCode" value="${vehicle.engineCode }" type="text" size="30" /></td>
										</tr>
										<tr>
											<td align="right">车架号：</td>
											<td><input id="frameNumber" name="frameNumber" value="${vehicle.frameNumber }" type="text" size="30" /></td>
											<td align="right">底盘号：</td>
											<td><input id="chassisNumber" name="chassisNumber" value="${vehicle.chassisNumber }" type="text" size="30" /></td>
										</tr>
										<tr>
