...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_station_numbers" /></th>
			<th><s:text name="ldm_station_name" /></th>
			<th><s:text name="ldm_position" /></th>
			<th><s:text name="ldm_capacity" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">xx车库</a></td>
				<td><a href="#" style="color: gray;">马甸</a></td>
				<td><a href="#" style="color: gray;">100台</a></td>
				<td><a href="#" style="color: gray;">啊三</a></td>
