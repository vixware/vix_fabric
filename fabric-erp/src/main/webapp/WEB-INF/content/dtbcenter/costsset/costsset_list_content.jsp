		...
		<tr class="alt">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				<tr>
					...
					<td><a href="#" style="color: gray;">${entity.costCode }</a></td>
					<td><a href="#" style="color: gray;">${entity.costName }</a></td>
					<td><a href="#" style="color: gray;">${entity.costType }</a></td>
					<td><a href="#" style="color: gray;">${entity.calculationFormula }</a></td>
					<td><a href="#" style="color: gray;">${entity.payments }</a></td>
