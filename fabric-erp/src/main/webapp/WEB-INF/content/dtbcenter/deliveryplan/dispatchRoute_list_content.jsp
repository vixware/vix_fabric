...
<div class="right_content">
	<div class="table">
		<table class="list">
			<tr class="alt">
				<th width="50">选择</th>
				<th onclick="orderBy('code');">线路序号</th>
				<th onclick="orderBy('name');">线路名称</th>
				<th onclick="orderBy('name');">起始地</th>
				<th onclick="orderBy('name');">目的地</th>
				<th onclick="orderBy('name');">里程</th>
			</tr>
			<%
				int count = 0;
			%>
