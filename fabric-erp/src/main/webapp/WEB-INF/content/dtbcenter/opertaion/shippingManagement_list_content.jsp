...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_originating_in" /></th>
			<th><s:text name="ldm_destination" /></th>
			<th><s:text name="ldm_consignment_time" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">北京xx地</a></td>
				<td><a href="#" style="color: gray;">深圳xx地</a></td>
