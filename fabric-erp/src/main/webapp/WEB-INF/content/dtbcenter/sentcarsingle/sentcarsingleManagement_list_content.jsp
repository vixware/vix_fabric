...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_driver" /></th>
			<th><s:text name="ldm_scheduling_people" /></th>
			<th><s:text name="ldm_switching_time" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.scheduleCode }</a></td>
				<td><a href="#" style="color: gray;">${entity.name }</a></td>
				<td><a href="#" style="color: gray;">${entity.vehicleNO }</a></td>
				<td><a href="#" style="color: gray;">${entity.driver }</a></td>
				<td><a href="#" style="color: gray;">${entity.scheduler }</a></td>
				<td><a href="#" style="color: gray;">${entity.scheduleTime }</a></td>
