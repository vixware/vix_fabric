	...
	<div class="table">
		<table class="list">
			...
			<s:iterator value="pager.resultList" var="entity" status="s">
				...
				%>
				<tr>
					<td><input id="chkBrandId" name="chkBrandId" value="${entity.id}" type="radio" onclick="chkChange(this,'${entity.id}','${entity.vehicleNO}','${entity.carryingcapacity}','${entity.capacity}','${entity.driver}','${entity.driverTelephone}')" /></td>
