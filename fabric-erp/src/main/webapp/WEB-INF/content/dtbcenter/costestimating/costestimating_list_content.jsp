	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">${entity.saleOrderCode }</a></td>
				<td><a href="#" style="color: gray;">${entity.directCost }</a></td>
				<td><a href="#" style="color: gray;">${entity.indirectCost }</a></td>
				<td><a href="#" style="color: gray;">${entity.total }</a></td>
