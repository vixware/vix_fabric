...
<script type="text/javascript">
	...
	pager ("start" , "${vix}/dtbcenter/costEstimatingAction!goCostItemList.action?temp=1" , "radio");
	//排序 
	function subOrderBy (orderField){
		...
		pager ("start" , "${vix}/dtbcenter/costEstimatingAction.action?orderField=" + orderField + "&orderBy=" + orderBy , "radio");
	}
	function currentPager (tag){
		pager (tag , "${vix}/dtbcenter/costEstimatingAction.action" , 'radio');
	}
	...
	function searchForContent (i){
		loadCode ();
		pager ("start" , "${vix}/dtbcenter/costEstimatingAction!goCostItemList.action?searchContent=" + code , 'radio');
	}
	/*重置搜索*/
	...
	function srmStatus (status){
		pager ("start" , "${vix}/dtbcenter/costEstimatingAction!goCostItemList.action?status=" + status , 'radio');
	}
	//最近使用
	function srmRecent (rencentDate){
		pager ("start" , "${vix}/dtbcenter/costEstimatingAction!goCostItemList.action?updateTime=" + rencentDate , 'radio');
	}
</script>
