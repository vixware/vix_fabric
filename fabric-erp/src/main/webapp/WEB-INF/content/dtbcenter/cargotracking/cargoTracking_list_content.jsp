...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><s:text name="ldm_customer_numbers" /></th>
			<th><s:text name="ldm_theme" /></th>
			<th><s:text name="ldm_customer_name" /></th>
			<th><s:text name="ldm_complaints_level" /></th>
			<th><s:text name="ldm_complaints_type" /></th>
			<th><s:text name="ldm_treatment" /></th>
			<th><s:text name="ldm_complaints_time" /></th>
			<th><s:text name="ldm_person_in_charge" /></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" style="color: gray;">xx车</a></td>
				<td><a href="#" style="color: gray;">sxs</a></td>
				<td><a href="#" style="color: gray;">最高级</a></td>
				<td><a href="#" style="color: gray;">物流</a></td>
				<td><a href="#" style="color: gray;">正在处理</a></td>
				<td><a href="#" style="color: gray;">2013-1-31</a></td>
				<td><a href="#" style="color: gray;">王五</a></td>
				<td>
