...
function saveOrUpdate(id,pageNo){
	$.ajax({
		  url:'${vix}/business/customerAction!goSaveOrUpdate.action?id='+id+"&pageNo="+pageNo,
		  cache: false,
...
function deleteById(id){
	$.ajax({
		  url:'${vix}/business/customerAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/business/customerAction!goSingleList.action?name="+name,'customer');
			});
		  }
	});
}
...
loadName();
//载入分页列表数据
pager("start","${vix}/business/customerAction!goSingleList.action?1=1",'customer');
//排序 
function orderBy(orderField){
	...
	pager("start","${vix}/business/customerAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy,'customer');
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/business/customerAction!goSingleList.action?name="+name,'customer');
}
		...
		<div id="right">
			<div class="right_content">
				<div class="pagelist drop">
					...
					<div>
						<span><a class="start" onclick="currentPager('start');"></a> </span> <span><a class="previous" onclick="currentPager('previous');"></a> </span> <em>(<b class="customerInfo"></b> <s:text name='cmn_to' /> <b class="customerTotalCount"></b>)
