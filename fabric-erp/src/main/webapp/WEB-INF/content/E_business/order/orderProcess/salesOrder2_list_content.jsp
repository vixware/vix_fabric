...
<input type="hidden" id="salesOrder2TotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="salesOrder2PageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="salesOrder2TotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="salesOrder2OrderField" value="${pager.orderField}" />
<input type="hidden" id="salesOrder2OrderBy" value="${pager.orderBy}" />
<input type="hidden" id="salesOrder2InfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="5%">
