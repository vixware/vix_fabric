...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th><span style="cursor: pointer;" onclick="orderBy('channelDistributor.name');">网店&nbsp;<img id="orderBatchImg_channelDistributor" src="${vix}/common/img/arrow.gif"></span></th>
			<th><span style="cursor: pointer;" onclick="orderBy('receiverAddress');">地址&nbsp;<img id="orderBatchImg_receiverAddress" src="${vix}/common/img/arrow.gif"></span></th>
			...
			<th><span style="cursor: pointer;" onclick="orderBy('payTypeCn');">付款方式&nbsp;<img id="orderBatchImg_payTypeCn" src="${vix}/common/img/arrow.gif"></span></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" onclick="pophtml('${entity.id}');" title="配货"><img src="${vix}/common/img/e_delivery.png" /></a></td>
			</tr>
		</s:iterator>
		<%
