...
<input type="hidden" id="salesOrder1TotalCountHidden" value="${pager.totalCount}" />
<input type="hidden" id="salesOrder1PageNoHidden" value="${pager.pageNo}" />
<input type="hidden" id="salesOrder1TotalPageHidden" value="${pager.totalPage}" />
<input type="hidden" id="salesOrder1OrderField" value="${pager.orderField}" />
<input type="hidden" id="salesOrder1OrderBy" value="${pager.orderBy}" />
<input type="hidden" id="salesOrder1InfoHidden" value="${(pager.pageNo-1)*pager.pageSize+1}-${(pager.pageNo-1)*pager.pageSize+pager.pageSize}" />
<table class="list">
	<tbody>
		<tr class="alt">
			<th width="5%">
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" onclick="pophtml('${entity.id}');" style="color: gray;">${entity.invWarehouse.name }</a></td>
