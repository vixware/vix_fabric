	...
	$.ajax({
		  ...
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/business/pickingOutAction!goSingleList.action?name="+name,'orderBatch');
			});
		  }
	});
}
...
loadName();
//载入分页列表数据
pager("start","${vix}/business/pickingOutAction!goSingleList.action?orderBatchId="+$("#orderBatchId").val(),'orderBatch');
//排序 
function orderBy(orderField){
	...
	pager("start","${vix}/business/pickingOutAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy,'orderBatch');
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/business/pickingOutAction!goSingleList.action?name="+name,'orderBatch');
}
//配货出库
function pophtml(id){
	$.ajax({
