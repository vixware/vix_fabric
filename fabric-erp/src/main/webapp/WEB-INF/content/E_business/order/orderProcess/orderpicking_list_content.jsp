	...
	<tbody>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" onclick="pophtml('${entity.id}');" style="color: gray;"><s:if test="%{#entity.channel.channelTypeId==1}">淘宝商城</s:if> <s:elseif test="%{#entity.channel.channelTypeId==3}">京东商城</s:elseif></a></td>
				<td><a href="#" onclick="pophtml('${entity.id}');" style="color: gray;">${entity.channelDistributor.name }</a></td>
				<td><a href="#" onclick="pophtml('${entity.id}');" style="color: gray;"><span style="color: red;">${entity.invWarehouse.name }</span></a></td>
				<td><a href="#" onclick="pophtml('${entity.id}');" style="color: gray;"><span style="color: red;">${entity.logistics.name }</span></a></td>
				...
				<td><a href="#" onclick="pophtml('${entity.id}');" style="color: gray;">${entity.createTime }</a></td>
				<td>
