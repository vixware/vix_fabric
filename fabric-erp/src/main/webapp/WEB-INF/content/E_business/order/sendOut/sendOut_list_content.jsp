...
<table class="list">
	<tbody>
		<tr class="alt">
			...
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('buyerNick');">买家昵称&nbsp;<img id="orderBatchImg_buyerNick" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="15%"><span style="cursor: pointer;" onclick="orderBy('channelDistributor.name');">来源网店&nbsp;<img id="orderBatchImg_channelDistributor" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('receiverMobile');">联系电话&nbsp;<img id="orderBatchImg_receiverMobile" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="25%"><span style="cursor: pointer;" onclick="orderBy('buyerMessage');">买家留言&nbsp;<img id="orderBatchImg_buyerMessage" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('dealState');">处理状态&nbsp;<img id="orderBatchImg_dealState" src="${vix}/common/img/arrow.gif"></span></th>
			<th width="10%"><span style="cursor: pointer;" onclick="orderBy('status');">订单状态&nbsp;<img id="orderBatchImg_status" src="${vix}/common/img/arrow.gif"></span></th>
		...
		<s:iterator value="pager.resultList" var="entity" status="s">
			...
			<tr>
				...
				<td><a href="#" onclick="sendOut('${entity.id}');" title="发货"><img src="${vix}/common/img/inv_rop_18x18.png" /></a></td>
			</tr>
		</s:iterator>
		<%
