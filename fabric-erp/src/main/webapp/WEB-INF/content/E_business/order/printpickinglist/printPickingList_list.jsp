...
function deleteById(id){
	$.ajax({
		  url:'${vix}/business/printPickingListAction!deleteById.action?id='+id,
		  cache: false,
		  success: function(html){
			asyncbox.success(html,"提示信息",function(action){
				pager("start","${vix}/business/printPickingListAction!goSingleList.action?name="+name,'orderBatch');
			});
		  }
	});
}
...
loadName();
//载入分页列表数据
pager("start","${vix}/business/printPickingListAction!goSingleList.action?orderBatchId="+$("#orderBatchId").val(),'orderBatch');
//排序 
function orderBy(orderField){
	...
	pager("start","${vix}/business/printPickingListAction!goSingleList.action?orderField="+orderField+"&orderBy="+orderBy,'orderBatch');
}

function currentPager(tag){
	loadName();
	pager(tag,"${vix}/business/printPickingListAction!goSingleList.action?name="+name,'orderBatch');
}
var orderid = "";
...
function goPrint(id,pageNo){
	$.ajax({
		  url:'${vix}/business/printPickingListAction!goPrint.action?businussOrderId='+orderid,
		  cache: false,
		  success: function(html){
		  	$("#mainContent").html(html);
		  }
