                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div style="float: left">' +
                      '<div for="daterangepicker_start">' + this.locale.fromLabel + '</div>' +
                      '<input class="input-mini" type="text" name="daterangepicker_start" value="" disabled="disabled" style="background-color: #ffffff;" />' +
                    '</div>' +
                    '<div style="float: left; padding-left: 0px">' +
                      '<div for="daterangepicker_end">' + this.locale.toLabel + '</div>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" value="" disabled="disabled" style="background-color: #ffffff;" />' +
                    '</div>' +
                    '<button class="btn btn-small btn-success" disabled="disabled" style="margin-top:15px;">' + this.locale.applyLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
