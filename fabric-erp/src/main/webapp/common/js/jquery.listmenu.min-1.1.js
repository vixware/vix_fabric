...
(function($) {
	...
	}; $.fn.listmenu.defaults = { includeNums: true, includeOther: false, flagDisabled: true, noMatchText: '没有匹配项！', showCounts: true, menuWidth: null, cols: { count: 4, gutter: 40 }, onClick: null };
})(jQuery);
