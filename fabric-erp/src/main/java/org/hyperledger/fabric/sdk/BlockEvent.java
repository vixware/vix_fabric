...
public class BlockEvent extends BlockInfo {
	...
	/**
	 * creates a BlockEvent object by parsing the input Block and retrieving its
	 * constituent Transactions
	 *
	 * @param eventHub
	 *            a Hyperledger Fabric Block message
	 * @throws InvalidProtocolBufferException
	 * @see Block
	 */
	public BlockEvent(EventHub eventHub, Event event) throws InvalidProtocolBufferException {
	...
	public List<TransactionEvent> getTransactionEventsList() {
