...
/**
 * A transaction context emits events 'submitted', 'complete', and 'error'. Each
 * transaction context uses exactly one tcert.
 */
public class TransactionContext {
	...
	public TransactionContext(Channel channel, User user, CryptoSuite cryptoPrimitives) {
		...
		this.verify = !"".equals(channel.getName()); // if name is not blank not
														// system channel and
														// need verify.
	...
	/*
	 * Implementation of an example ASN .1 structure. * < pre > *MyStructure:: =
	 * SEQUENCE { *version INTEGER DEFAULT 0, *created GeneralizedTime,
	 * *baseData OCTET STRING, *extraData[0] UTF8String OPTIONAL,
	 * *commentData[1] UTF8String OPTIONAL } * <pre > *
	 */
	public static class MyStructure implements ASN1Encodable {
		...
		public MyStructure(String mspid, byte[] idbytes) {
