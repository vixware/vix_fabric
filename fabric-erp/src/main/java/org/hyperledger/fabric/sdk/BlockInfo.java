...
public class BlockInfo {
	...
	// public TransactionEnvelopeInfo getEnvelopeInfo(int index) throws
		...
		public class TransactionActionInfo {
			...
			public int getChaincodeInputArgsCount() {
				if (getChaincodeInputArgsCount < 0) {
					getChaincodeInputArgsCount = transactionAction.getPayload().getChaincodeProposalPayload().getChaincodeInvocationSpec().getChaincodeInput().getChaincodeInput().getArgsCount();
				}
			...
			public byte[] getChaincodeInputArgs(int index) {
				...
				ChaincodeInput input = transactionAction.getPayload().getChaincodeProposalPayload().getChaincodeInvocationSpec().getChaincodeInput().getChaincodeInput();
			...
			public byte[] getProposalResponsePayload() {
				...
				ByteString retByteString = transactionAction.getPayload().getAction().getProposalResponsePayload().getExtension().getResponsePayload();
			...
			public TxReadWriteSetInfo getTxReadWriteSet() {
				...
				TxReadWriteSet txReadWriteSet = transactionAction.getPayload().getAction().getProposalResponsePayload().getExtension().getResults();
