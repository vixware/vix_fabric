...
public class ChannelConfiguration {
	...
	/**
	 * The null constructor for the ChannelConfiguration wrapper. You will need
	 * to use the {@link #setChannelConfiguration(byte[])} method to populate
	...
	/**
	 * constructs a ChannelConfiguration object with the actual configuration
	 ...
	 *
	 * @param channelConfigurationAsBytes
	 *            the byte array containing the serialized channel configuration
	 */
