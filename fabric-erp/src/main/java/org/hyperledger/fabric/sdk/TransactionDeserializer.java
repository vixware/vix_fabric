...
class TransactionDeserializer {
	...
	private final Map<Integer, WeakReference<TransactionActionDeserializer>> transactionActions = Collections.synchronizedMap(new WeakHashMap<Integer, WeakReference<TransactionActionDeserializer>>());
