...
class PayloadDeserializer {
	...
	// ChannelHeader.parseFrom(plh.getChannelHeader());
	...
	//
	//// TransactionDeserializer ts = new
	// TransactionDeserializer(getPayload().getData());
	////
	//// for (TransactionActionDeserializer transactionActionDeserialize :
	// ts.getTransactionActions()) {
	////
	...
	////
	//// ChaincodeActionPayload tap =
	// ChaincodeActionPayload.parseFrom(ta.getPayload());//<<<
	//// FabricProposal.ChaincodeProposalPayload ccpp =
	// FabricProposal.ChaincodeProposalPayload.parseFrom(tap.getChaincodeProposalPayload());
	//// Chaincode.ChaincodeInput cinput =
	// Chaincode.ChaincodeInput.parseFrom(ccpp.getInput());
	////
	...
	////
	//// // FabricProposalResponse.ProposalResponsePayload cpr =
	// FabricProposalResponse.ProposalResponsePayload.parseFrom(cae.getProposalResponsePayload());
	//// FabricProposalResponse.ProposalResponsePayload cpr =
	// FabricProposalResponse.ProposalResponsePayload.parseFrom(cae.getProposalResponsePayload());
	//// FabricProposal.ChaincodeAction ca =
	// FabricProposal.ChaincodeAction.parseFrom(cpr.getExtension());
	////
	//// FabricProposalResponse.Response rsp = ca.getResponse();
	//// System.out.println(String.format(" resp message= %s, status=%d", new
	// String(rsp.getPayload().toByteArray()), rsp.getStatus()));
	////
	...
	// Rwset.TxReadWriteSet.parseFrom(ca.getResults());
	////
	...
	// */
	//
	//// private void getChannelIDFromBlock() throws
