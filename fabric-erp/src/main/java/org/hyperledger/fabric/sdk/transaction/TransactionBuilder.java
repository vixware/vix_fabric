...
public class TransactionBuilder {
	...
	private Common.Payload createTransactionCommonPayload(FabricProposal.Proposal chaincodeProposal, ByteString proposalResponsePayload, Collection<FabricProposalResponse.Endorsement> endorsements) throws InvalidProtocolBufferException {
		...
		// We need to remove any transient fields - they are not part of what
		// the peer uses to calculate hash.
