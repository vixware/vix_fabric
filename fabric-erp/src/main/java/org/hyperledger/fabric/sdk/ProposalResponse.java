...
public class ProposalResponse extends ChaincodeResponse {
	...
	public boolean verify(CryptoSuite crypto) {
		...
		if (isVerified()) { // check if this proposalResponse was already
							// verified by client code
			return isVerified();
		}
	...
	/**
	 * getChaincodeActionResponseStatus returns the what chaincode executions
	...
	/**
	 * getChaincodeActionResponseReadWriteSetInfo get this proposals read write
	 * set.
	 *
