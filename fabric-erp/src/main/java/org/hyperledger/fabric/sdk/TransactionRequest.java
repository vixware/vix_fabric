...
/**
 * A base transaction request common for InstallProposalRequest,trRequest, and
 * QueryRequest.
 */
public class TransactionRequest {
	...
	// The chaincode ID as provided by the 'submitted' event emitted by a
	// TransactionContext
	...
	/**
	 * Set the user context for this request. This context will override the
	 * user context set on {@link HFClient#setUserContext(User)}
	 *
	 * @param userContext
	...
	/**
	 * Some proposal responses from Fabric are not signed. We default to always
	 * verify a ProposalResponse. Subclasses should override this method if you
	 * do not want the response signature to be verified
	 *
	...
	/**
	 * sets the endorsementPolicy associated with the chaincode of this
	 * transaction
	 *
	 * @param policy
	 *            a Policy object
	...
	/**
	 * returns the Policy object associated with the chaincode of this
	 * transaction
	 *
	...
	/**
	 * Gets the timeout for a single proposal request to endorser in
	 * milliseconds.
	 *
	 * @return the timeout for a single proposal request to endorser in
	 *         milliseconds
	 */
	...
	/**
	 * Sets the timeout for a single proposal request to endorser in
	 * milliseconds.
	 *
	 * @param proposalWaitTime
	 *            the timeout for a single proposal request to endorser in
	 *            milliseconds
	 */
