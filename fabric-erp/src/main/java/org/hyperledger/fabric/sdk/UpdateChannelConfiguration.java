...
public class UpdateChannelConfiguration {
	...
	/**
	 * The constructor for the UpdateChannelConfiguration wrapper. You will need
	 * to use the
	 * {@link Channel#updateChannelConfiguration(UpdateChannelConfiguration,
	 * byte[]...)} method to populate the update channel configuration
	 */
	public UpdateChannelConfiguration() {
	}

	/**
	 * constructs a UpdateChannelConfiguration object with the actual
	 * configuration gotten from the file system
	 *
	 * @param configFile
	 *            The file containing the channel configuration.
	 * @throws IOException
	 */
	 ...
	 *
	 * @param configAsBytes
	 *            the byte array containing the serialized channel configuration
	 */
	 ...
	 *
	 * @param updateChannelConfigurationAsBytes
	 *            the byte array containing the serialized channel configuration
	 */
	...
	/**
	 * @return the channel configuration serialized per protobuf and ready for
	 *         inclusion into channel configuration
	 */
