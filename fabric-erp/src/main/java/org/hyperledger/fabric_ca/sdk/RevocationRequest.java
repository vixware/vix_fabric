...
/**
 * A RevocationRequest defines the attributes required to revoke credentials
 * with member service.
 */
public class RevocationRequest {
	...
	// Constructor
	public RevocationRequest(String caNmae, String id, String serial, String aki, String reason) throws Exception {
		if (isNullOrEmpty(id)) {
	...
	private JsonObject toJsonObject() {
		...
		if (enrollmentID != null) {
			// revoke all enrollments of this user, serial and aki are ignored
			// in this case
