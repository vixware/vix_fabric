...
/**
 * An enrollment request is information required to enroll the user with member
 * service.
 */
public class EnrollmentRequest {

	// A PEM-encoded string containing the CSR (Certificate Signing Request)
	// based on PKCS #10
	private String csr;
	...
	/**
	 * The certificate signing request if it's not supplied it will be
	 * generated.
	 *
	 * @param csr
	 */
	 ...
	 * @param label
	 * @param keypair
	 *            Keypair used to sign or create the certificate if needed.
	 */
	...
	/**
	 * The Key pair to create the signing certificate if not supplied it will be
	 * generated.
	 *
	 * @param keypair
	 */
