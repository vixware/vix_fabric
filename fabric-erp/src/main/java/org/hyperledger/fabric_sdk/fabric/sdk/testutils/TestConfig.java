 ...
 */
package org.hyperledger.fabric_sdk.fabric.sdk.testutils;
...
public class TestConfig {
	...
	private TestConfig() {
		...
		try {
			...
			// logger.warn(String.format("Failed to load any test configuration
			// from: %s. Using toolkit defaults",
			// DEFAULT_CONFIG));
		} finally {
			...
			defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.ca_location", "http://47.104.62.75:7054");
			defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://47.104.62.75:7051, peer1.org1.example.com@grpc://47.104.62.75:7056");
			defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://47.104.62.75:7050");
			defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://47.104.62.75:7053,peer1.org1.example.com@grpc://47.104.62.75:7058");
			...
			//defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.ca_location", "http://47.104.62.75:8054");
			//defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpc://47.104.62.75:8051,peer1.org2.example.com@grpc://47.104.62.75:8056");
			//defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpc://47.104.62.75:7050");
			//defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpc://47.104.62.75:8053, peer1.org2.example.com@grpc://47.104.62.75:8058");
	...
	private Properties getEndPointProperties(final String type, final String name) {
		...
		//File cert = new File("D:\\work\\workspace\\fabric\\fabric-erp\\src\\test\\fixture\\sdkintegration\\e2e-2Orgs\\channel\\crypto-config\\ordererOrganizations".replace("orderer", type)+"\\example.com\\orderers\\orderer.example.com\\tls\\server.crt");
		if (!cert.exists()) {
	...
	public String getTestChannelPath() {
		return "C:\\work\\fabric-erp\\src\\test\\fixture\\sdkintegration\\e2e-2Orgs\\channel";
		//return "D:\\work\\workspace\\fabric\\fabric-erp\\src\\test\\fixture\\sdkintegration\\e2e-2Orgs\\channel\\";
