...
public class ChaincodeEndorsementPolicyTest {
	...
	/**
	 * Test method for
	 * {@link org.hyperledger.fabric.sdk.ChaincodeEndorsementPolicy#ChaincodeEndorsementPolicy()}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link org.hyperledger.fabric.sdk.ChaincodeEndorsementPolicy#fromFile(File)}
	 * (java.io.File)}.
	 *
	 * @throws IOException
	 */
	...
	/**
	 * Test method for
	 * {@link org.hyperledger.fabric.sdk.ChaincodeEndorsementPolicy#fromBytes(byte[])}.
	 */
	@Test
	...
	// org.hyperledger.fabric.sdk.ChaincodeEndorsementPolicy#fromBytes(byte[])}.
	// */
	// @Test
	...
	// ;
	// fakePolicy.fromBytes(testInput);
	// assertEquals(fakePolicy.getChaincodeEndorsementPolicyAsBytes(),
	// testInput);
	// }
