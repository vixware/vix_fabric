...
public class TestUtils {
	 ...
	 *
	 * The Config instance is initialized once on startup which means that its
	 * properties don't change throughout its lifetime. This method allows a
	 * Config property to be changed temporarily for testing purposes
	 *
	 * @param key
	 *            The key of the property (eg Config.LOGGERLEVEL)
	 * @param value
	 *            The new value
