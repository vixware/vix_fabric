...
public class TestConfigHelper {
	 ...
	 * interference from other test suites. Depending on what order JUnit
	 * decides to run the tests, Config could have been instantiated earlier and
	 * could contain values that make the tests here fail.
	 *
	...
	/**
	 * clearCaConfig "resets" Config used by fabric_ca so that the Config
	 * testcases can run without interference from other test suites.
	 *
	 * @throws SecurityException
	 * @throws NoSuchFieldException
	 * @throws IllegalAccessException
	...
	/**
	 * customizeConfig() 
	 * sets up the properties listed by env var CONFIG_OVERRIDES 
	 * The value of the env var is
	 * <i>property1=value1,property2=value2</i> and so on where each
	 * <i>property</i> is a property from the SDK's config file.
	 *
	 * @throws NoSuchFieldException
	 * @throws SecurityException
	 * @throws IllegalArgumentException
