...
package org.hyperledger.fabric_sdk.fabric.sdk.transaction;
...
public class InstallProposalBuilderTest {
	...
	// Tests that both chaincodeSource and chaincodeInputStream are not
	// specified together
	@Test
	...
	// Tests that a chaincode path has been specified for GO_LANG code using a
	// File
	@Test
	...
	// Tests that a chaincode path has been specified for GO_LANG code using an
	// InputStream
	@Test
