...
public class PeerClientTest {
	...
	// SampleStore(System.getProperty("user.home")+"/test.properties"));
	...
	// TimeUnit.SECONDS.sleep(10);// deployment takes time, so wait for it to
	// complete before making a query or invoke call
	// } catch(CertificateException | RegistrationException |
	// EnrollmentException | InterruptedException cex) {
	// cex.printStackTrace();// TODO: Handle the exception properly
	// }
	// }
	//
	//
	// public static ChaincodeResponse deploy() throws RegistrationException,
	// EnrollmentException, ProposalException {
	...
	// request.setArgs(new ArrayList<>(Arrays.asList("init", "a", "700", "b",
	// "20000")));
	...
	// }
	//
	// public static ChaincodeResponse deployJava() throws
	// RegistrationException, EnrollmentException {
	// InstallProposalRequest request = new InstallProposalRequest();
	...
	// EnrollmentException, ChaincodeException {
	...
	// request.setArgs(new ArrayList<>(Arrays.asList("invoke", "a", "b",
	// "200")));
	// request.setChaincodeID(deployResponse.getChaincodeID());
	// request.setChaincodeName(deployResponse.getChaincodeID());
	// SampleUser user = getUser("User1", "bank_a");
	...
	//
	// @Test
	// public void testQueryJava() throws RegistrationException,
	// EnrollmentException, ChaincodeException {
	// testInvokeJava();
	// QueryRequest request = new QueryRequest();
	// request.setArgs(new ArrayList<>(Arrays.asList("query", "a")));
	...
	//
	// @Test
	// public void testInvokeJava() throws RegistrationException,
	// EnrollmentException, ChaincodeException {
	// InvokeRequest request = new InvokeRequest();
	// request.setArgs(new ArrayList<>(Arrays.asList("invoke", "a", "b",
	// "200")));
	...
	// }
	//
	// private static SampleUser getUser(String enrollmentId, String
	// affiliation) throws RegistrationException, EnrollmentException {
	// SampleUser user = testChain.getUser(enrollmentId);
	// if (!user.isRegistered()) {
	// RegistrationRequest registrationRequest = new RegistrationRequest();
	// registrationRequest.setEnrollmentID(enrollmentId);
	// registrationRequest.setAffiliation(affiliation);
	// //registrationRequest.setAccount(); TODO setAccount missing from
	// registrationRequest?
