...
public class ConfigTest {
	...
	public void testGetConfigSystemProperty() throws Exception {
		...
		// Get the original value of the property so that we can restore it
		// later
	...
	// It may be better to actually set the individual values (via a system
	// property)
	...
	public void testGetters() {
		...
		// Boolean params
		// Not sure how best to deal with these, as they will always return
		// either true or false
		// So, for coverage, let's simply call the method to ensure they don't
		// throw exceptions...
