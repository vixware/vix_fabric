...
package org.hyperledger.fabric_sdk.fabricca.sdk;
...
public class MockHFCAClient extends HFCAClient {
	...
	@Override
	public JsonObject httpPost(String url, String body, String authHTTPCert) throws Exception {
		...
		if (httpPostResponse == null) {
			...
			// TODO: HFCAClient could do with some minor refactoring to avoid
			// duplicating this code here!!
	...
	public static MockHFCAClient createNewInstance(String name, String url, Properties properties) throws MalformedURLException, InvalidArgumentException {
