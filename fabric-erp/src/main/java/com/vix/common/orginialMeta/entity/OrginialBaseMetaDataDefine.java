 ...
 *
 */
public class OrginialBaseMetaDataDefine extends BaseEntity {
    ...
    /** 元数据对象  */
    private OrginialBaseMetaData baseMetaData;
    ...
    public OrginialBaseMetaData getBaseMetaData() {
        return baseMetaData;
    }

    public void setBaseMetaData(OrginialBaseMetaData baseMetaData) {
