...
@Component
//@Scope("prototype")
public class OrginialBaseMetaDataDefineHqlProvider extends HqlProvider {
    ...
    public String entityAsName() {
        return "orginialBaseMetaDataDefine";
    }
    ...
    public StringBuilder findBaseMetaDataCategoryList(Map<String,Object> params ){
 	   ...
 	   sb.append(" from ").append(OrginialBaseMetaDataDefine.class.getName()).append(" ").append(ename);
 	   sb.append(" where 1=1 ");
