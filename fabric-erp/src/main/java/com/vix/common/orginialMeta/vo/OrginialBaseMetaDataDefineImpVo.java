 ...
 *
 */
public class OrginialBaseMetaDataDefineImpVo {
	...
	public OrginialBaseMetaDataDefineImpVo() {
		super();
	}
	
	public OrginialBaseMetaDataDefineImpVo(String metaDataCode, String propertyName,
