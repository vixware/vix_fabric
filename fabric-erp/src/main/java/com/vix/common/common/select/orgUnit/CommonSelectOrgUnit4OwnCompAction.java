...
@Controller
@Scope("prototype")
public class CommonSelectOrgUnit4OwnCompAction extends BaseAction{
	...
	public String goChooseOrgUnit(){
        ...
        return "goChooseOrgUnit4OwnComp";
    }
    ...
    private void loadOrg(String nodeId,String nodeTreeType){
        try{
        	...
        	List<OrgView> orgUnitList = organizationUnitService.findOrgView4OwnCompList(nodeId,unitType);
            ...
            for(int i =0; i<count; i++){
            	...
            	List<OrgView> subList = organizationUnitService.findOrgViewList(org.getId(),unitType);
