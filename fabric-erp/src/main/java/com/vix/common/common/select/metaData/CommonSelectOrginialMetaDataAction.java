...
@Controller
@Scope("prototype")
public class CommonSelectOrginialMetaDataAction extends BaseAction{
    ...
    public void findTreeToJson() {
		try {
			...
			List<OrginialBaseMetaDataCategory> listMetaDataCate = null;//baseMetaDataCategoryService.findAllBaseMetaDataCategory();
