...
@Deprecated
public class VixRememberMeAuthenticationFilter  extends GenericFilterBean implements ApplicationEventPublisherAware {
    ...
    public VixRememberMeAuthenticationFilter(AuthenticationManager authenticationManager,
