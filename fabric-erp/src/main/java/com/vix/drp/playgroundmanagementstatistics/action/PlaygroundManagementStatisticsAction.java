package com.vix.drp.playgroundmanagementstatistics.action;
...
import com.vix.drp.playgroundmanagementstatistics.hql.PlaygroundManagementStatisticsHqlProvider;
...
@Controller
@Scope("prototype")
public class PlaygroundManagementStatisticsAction extends BaseAction {
	...
	@Resource(name = "playgroundManagementStatisticsHqlProvider")
	private PlaygroundManagementStatisticsHqlProvider playgroundManagementStatisticsHqlProvider;
	...
	public String goList() {
		try {
			...
			oparams.put("type," + SearchCondition.ANYLIKE, "5");
			...
			for (int i = 0; i < dayList1.size(); i++) {
				...
				Double sumAmount = 0d;
				StringBuilder hql = playgroundManagementStatisticsHqlProvider.findSalesOrder(params);
			...
			channelDistributorList = playgroundManagementStatisticsService.findAllByConditions(ChannelDistributor.class, params);
	...
	public void getAgeStatisticList() {
		...
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findCustomerCountAgeList(params);
	...
	public void getClassifiedRevenueList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findClassifiedRevenueList(params);
	...
	public void getConsumerPeopleReportList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findConsumerPeopleReportList(params);
	...
	public void getCustomerCountList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findCustomerCountList(params);
	...
	public void getDayIncomeSummaryList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findSalesOrderList(params);
	...
	public void getEquipmentCoinNumberList() {
		...
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findEquipmentCoinNumberList(params);
	...
	public void getEquipmentSalesList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findTranLogList(params);
	...
	public void getGoodsStatisticsList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findGoodsStatisticsList(params);
	...
	public void getGradeRatioList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findMemberShipCardList(params);
	...
	public void getCustomerSexList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findCustomerAccountList(params);
	...
	public void getGroupIncomeStatementList() {
		try {
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findGroupIncomeStatementList(params);
	...
	public void getMonthAccountBalanceList() {
		try {
			...
			// 获取当前登录用户所在的公司或供应商
			/*
			 * if (SecurityUtil.getCurrentEmpId() != null) { // 获取当前员工信息
			 * Employee employee =
			 * playgroundManagementStatisticsService.findEntityById(Employee.
			 * class, SecurityUtil.getCurrentEmpId()); if (employee != null) {
			 * params.put("companyCode", employee.getCompanyCode()); } }
			 */
			...
			StringBuilder hql = playgroundManagementStatisticsHqlProvider.findMonthAccountBalanceList(params);
