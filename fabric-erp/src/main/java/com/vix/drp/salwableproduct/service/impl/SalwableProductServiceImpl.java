 ...
 * 
 */
package com.vix.drp.salwableproduct.service.impl;
 ...
 * @date 2013-6-27
 */
@Service("salwableProductService")
public class SalwableProductServiceImpl extends BaseHibernateServiceImpl implements ISalwableProductService {
