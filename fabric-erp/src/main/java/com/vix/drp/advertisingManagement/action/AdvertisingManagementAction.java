package com.vix.drp.advertisingManagement.action;
...
@Controller
@Scope("prototype")
public class AdvertisingManagementAction extends BaseAction {
	...
	public String goList() {
		try {
			advertisingManagementList = advertisingManagementController.doListAdvertisingManagementList(null);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return GO_LIST;
