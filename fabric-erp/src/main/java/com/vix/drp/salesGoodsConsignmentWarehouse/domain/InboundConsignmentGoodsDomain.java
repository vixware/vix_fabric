 ...
 * 
 */
package com.vix.drp.salesGoodsConsignmentWarehouse.domain;
 ...
 * @date 2013-6-27
 */
@Component("inboundConsignmentGoodsDomain")
@Transactional
public class InboundConsignmentGoodsDomain extends BaseDomain{
	...
	public StockRecordLines saveOrUpdateStockRecordLines(StockRecordLines stockRecordLines) throws Exception {
