 ...
 */
public class PurchaseInboundItems extends BaseEntity {

	private static final long serialVersionUID = 8890537299100023610L;
	...
	public Double getIsUseReplace() {
		return isUseReplace;
	}

	public void setIsUseReplace(Double isUseReplace) {
