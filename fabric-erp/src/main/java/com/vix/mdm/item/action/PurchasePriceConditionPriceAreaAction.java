...
@Controller
@Scope("prototype")
public class PurchasePriceConditionPriceAreaAction extends BaseAction {
	private static final long serialVersionUID = 1L;

	private String id;
	private PriceConditionPriceArea priceConditionPriceArea;
	private Map<String, String> pcpaMap = PriceConditionConstantInitialization.getPurchasePriceConditionConstantMap();
	...
	public void setCustomerAccountGroupList(List<CustomerAccountGroup> customerAccountGroupList) {
