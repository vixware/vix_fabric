...
@Controller
@Scope("prototype")
public class SalePriceConditionCountAreaAction extends BaseAction {
	private static final long serialVersionUID = 1L;

	
	private String id;
	private PriceConditionCountArea priceConditionCountArea;
	private Map<String,String> pccaMap = PriceConditionConstantInitialization.getSalePriceConditionConstantMap();
	...
	public String saveOrUpdate() {
		boolean isSave = true;
		try {
			if(null != priceConditionCountArea.getId() && !"".equals(priceConditionCountArea.getId())){
				isSave = false;
			}else{
