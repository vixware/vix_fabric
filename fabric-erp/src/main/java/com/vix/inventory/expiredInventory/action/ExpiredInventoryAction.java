package com.vix.inventory.expiredInventory.action;
...
@Controller
@Scope("prototype")
public class ExpiredInventoryAction extends BaseAction {

	private static final long serialVersionUID = 1L;
	Logger logger = Logger.getLogger(ExpiredInventoryAction.class);
	@Autowired
	...
	public String goList() {
		try {
			...
			params.put("massunitEndTime," + SearchCondition.MORETHANANDEQUAL, new Date());
