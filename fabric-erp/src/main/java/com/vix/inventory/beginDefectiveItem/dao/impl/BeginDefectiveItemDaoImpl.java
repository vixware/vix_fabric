package com.vix.inventory.beginDefectiveItem.dao.impl;
...
@Repository("beginDefectiveItemDao")
public class BeginDefectiveItemDaoImpl extends BaseHibernateDaoImpl implements IBeginDefectiveItemDao {
