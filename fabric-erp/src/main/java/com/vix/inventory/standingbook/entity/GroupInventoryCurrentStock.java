...
/**
 * 组合商品 com.vix.inventory.standingbook.entity.GroupInventoryCurrentStock
 *
 * @author bjitzhang
 *
 * @date 2015年5月11日
...
public class GroupInventoryCurrentStock extends BaseEntity {
	...
	public GroupInventoryCurrentStock() {
	}
