 ...
 * 
 */
package com.vix.inventory.shelfLife.controller;
...
import com.vix.inventory.shelfLife.domain.ShelfLifeDomain;
...
public class ShelfLifeController {
	...
	Logger logger = Logger.getLogger(ShelfLifeController.class);

	@Autowired
	private ShelfLifeDomain shelfLifeDomain;
	...
	public Pager doListInventoryCurrentStock(Map<String, Object> params, Pager pager) throws Exception {
		...
		return shelfLifeDomain.findInventoryCurrentStockPager(params, pager);
	}
	...
	public List<InventoryCurrentStock> doListInventoryCurrentStockList(Map<String, Object> params) throws Exception {
		// 3. 执行查询操作
		// 6. 日志处理 log(); 每个Action中独立定义;记录操作日志、记录性能数据;
		return shelfLifeDomain.findInventoryCurrentStockList(params);
	}
