 ...
 * 
 */
package com.vix.inventory.shelfLifeEarlyWarning.domain;
 ...
 * @date 2013-6-27
 */
@Component("shelfLifeEarlyWarningDomain")
@Transactional
public class ShelfLifeEarlyWarningDomain extends BaseDomain{
