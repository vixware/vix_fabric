 ...
 * 
 */
package com.vix.inventory.barCodeManagement.controller;
...
import com.vix.inventory.barCodeManagement.domain.BarCodeManagementDomain;
 ...
 * @date 2013-6-27
 */
@Controller("barCodeManagementController")
@Scope("prototype")
public class BarCodeManagementController {

	Logger logger = Logger.getLogger(BarCodeManagementController.class);

	@Autowired
	private BarCodeManagementDomain barCodeManagementDomain;
	@Autowired
	...
	public BaseCoder doSaveWimBatchs(BaseCoder baseCoder, ItemToBaseCoder itemToBaseCoder) throws Exception {
		...
		baseCoder1 = barCodeManagementDomain.merge(baseCoder);
		itemToBaseCoder.setBaseId(baseCoder1.getId());
		barCodeManagementDomain.mergeItemToBaseCoder(itemToBaseCoder);
	...
	public EncodingRulesTableInTheMiddle doSaveEncodingRulesTableInTheMiddle(EncodingRulesTableInTheMiddle encodingRulesTableInTheMiddle) throws Exception {
		...
		baseCoder1 = barCodeManagementDomain.mergeEncodingRulesTableInTheMiddle(encodingRulesTableInTheMiddle);
		if (baseCoder1.getCodingPreview() != null && !"".equals(baseCoder1.getCodingPreview())) {
			...
			if (baseCoder1 != null && baseCoder1.getBillType() != null) {
				...
				baseCoder1 = barCodeManagementDomain.mergeEncodingRulesTableInTheMiddle(baseCoder1);
			}
		}
		return baseCoder1;
	}
