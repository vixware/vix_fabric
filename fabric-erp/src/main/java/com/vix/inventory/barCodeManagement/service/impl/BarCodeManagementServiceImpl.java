 ...
 * 
 */
package com.vix.inventory.barCodeManagement.service.impl;
...
import com.vix.inventory.barCodeManagement.hql.BarCodeManagementHqlProvider;
 ...
 * @date 2013-6-27
 */
@Service("barCodeManagementService")
public class BarCodeManagementServiceImpl extends BaseHibernateServiceImpl implements IBarCodeManagementService {
	/**
	 * 
	 */
	...
	@Resource(name = "barCodeManagementHqlProvider")
	private BarCodeManagementHqlProvider barCodeManagementHqlProvider;
	...
	public List<ItemCatalog> findItemCatalogList(String parentItemCatalogId) throws Exception {
		...
		StringBuilder hql = barCodeManagementHqlProvider.findItemCatalogList(params);
