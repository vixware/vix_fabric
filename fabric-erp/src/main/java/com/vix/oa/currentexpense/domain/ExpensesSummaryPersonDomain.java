 ...
 * @date 2013-6-27
 */
@Component("expensesSummaryPersonDomain")
@Transactional
public class ExpensesSummaryPersonDomain extends BaseDomain{
	...
	public void deleteExpenseAccountSummary(ExpenseAccountSummary expenseAccountSummary) throws Exception {
