...
public class PeriodicTransaction extends BaseEntity{
	...
	/** 重复类型  0 按日重复  1 按周重复  2 按月重复 3 按年重复 4按工作日重复*/
    public Integer repeatsType;
	/**
	 * 说明
	 */
    ...
    public PeriodicTransaction(String id) {
        super();
        setId(id);
    }
	...
	public void setRepetitionTime(Date repetitionTime) {
		this.repetitionTime = repetitionTime;
	}

	public Integer getRepeatsType() {
		return repeatsType;
	}

	public void setRepeatsType(Integer repeatsType) {
