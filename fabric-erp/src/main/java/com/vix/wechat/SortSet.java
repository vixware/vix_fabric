 ...
 * 用法示例：
 * 
 * Set<PromotionRule> ruleSet = medicine.getPromotionRuleSet(); List
 * <PromotionRule> ruleList = null; if(null != ruleSet){ ruleList = new
 * ArrayList<PromotionRule>(ruleSet); //根据id排序 SortSet scm = new SortSet("id");
