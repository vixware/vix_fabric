...
public class UserAgentUtil {
	 ...
	 */
	public static boolean isMobile(String via,String userAgent) {
		if(StringUtils.isEmpty(via) || StringUtils.isEmpty(userAgent)){
			return false;
		}
	...
	public static boolean isPC(String userAgent) {
		...
		if (ua.indexOf("android")!=-1) {
			return false;
		}else if ((ua.indexOf("palmsource")!=-1)||(ua.indexOf("blazer")!=-1)) {
			return false;
		}else if ((ua.indexOf("windows nt")!=-1)||(ua.indexOf("windows me")!=-1)||(ua.indexOf("windows 9")!=-1)
				||(ua.indexOf("win9")!=-1)) {
			return true;
		}
		else if ((ua.indexOf("macintosh")!=-1)||(ua.indexOf("mac_powerpc")!=-1)||(ua.indexOf("os=mac")!=-1)
				||(ua.indexOf("win9")!=-1)) {
			return true;
		}
		else if ((ua.indexOf("i386")!=-1)||(ua.indexOf("i586")!=-1)||(ua.indexOf("i686")!=-1)||(ua.indexOf("konquerer")!=-1)
				||(ua.indexOf("sunos")!=-1)||(ua.indexOf("netbsd")!=-1)) {
			return true;
		}
	 ...
	 * @return
	 */
	public static boolean isPad(String via,String userAgent) {
		if(StringUtils.isEmpty(userAgent)){
			return false;
		}
		if(isMobile(via,userAgent)){
			return true;
		}
