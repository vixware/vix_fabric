package com.vix.nvix.mdm.item.dao.impl;
...
import com.vix.nvix.mdm.item.dao.INvixntItemDao;

@Repository("nvixntItemDao")
public class NvixntItemDaoImpl extends BaseHibernateDaoImpl implements INvixntItemDao {
	...
	public List<List<Object>> findItemSpecification(String specTableName, String itemId) throws Exception {
		...
		if (null != ep && null != ep.getObjectExpand() && null != tenantId && !"".equals(tenantId)) {
			...
			sql.append(" where SYS_OBJECTEXPAND_ID = ");
