...
public class PadUtils {
	...
	public static int getNumberVal(Integer val) {
	...
	private static String HanDiviStr[] = new String[] { "", "拾", "佰", "仟", "万", "亿" };

	/**
	 * 判断对象是否Empty(null或元素为0)<br>
	 * 空格也为空 实用于对如下对象做判断:String Collection及其子类 Map及其子类
	 * 
	 * @param pObj
	 *            待检查对象
