...
public class StrUtils {
	...
	public static String trimLastSubstring(StringBuilder sb) {
		...
		/*
		 * for (first = 0; first < sb.length(); first++) if
		 * (!Character.isWhitespace(sb.charAt(first))) break;
		 */
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * String em="com.org.UserAccount"; int index =
		 * StringUtils.lastIndexOf(em, "."); System.out.println(index);
		...
		for (int i = 0; i < 1000000; i++) {
			String su = StrUtils.genShortUUID();

			if (suMap.containsKey(su)) {
	...
	/**
	 * 将查询条件的键转换下作为hql中的插叙条件 如aa.bb转为aa_bb aa.bb.cc转为aa_bb_cc
	 * 
	 * @param paramKey
	 * @return
	 */
