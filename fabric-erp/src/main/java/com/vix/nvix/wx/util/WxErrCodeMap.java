...
public class WxErrCodeMap {
	...
	static void initErrMap() {
		...
		errMap.put(-1, "系统繁忙，此时请开发者稍候再试");
		errMap.put(0, "请求成功");
		errMap.put(40001, "获取access_token时AppSecret错误，或者access_token无效。请开发者认真比对AppSecret的正确性，或查看是否正在为恰当的公众号调用接口");
		errMap.put(40002, "不合法的凭证类型");
		errMap.put(40003, "不合法的OpenID，请开发者确认OpenID（该用户）是否已关注公众号，或是否是其他公众号的OpenID");
		...
		errMap.put(40013, "不合法的AppID，请开发者检查AppID的正确性，避免异常字符，注意大小写");
		errMap.put(40014, "不合法的access_token，请开发者认真比对access_token的有效性（如是否过期），或查看是否正在为恰当的公众号调用接口");
		...
		errMap.put(42001, "access_token超时，请检查access_token的有效期，请参考基础支持-获取access_token中，对access_token的详细机制说明");
		...
		errMap.put(48001, "api功能未授权，请确认公众号已获得该接口，可以在公众平台官网-开发者中心页中查看接口权限");
		errMap.put(50001, "用户未授权该api");
		errMap.put(61451, "参数错误(invalidparameter)");
		errMap.put(61452, "无效客服账号(invalidkf_account)");
		errMap.put(61453, "客服帐号已存在(kf_accountexsited)");
		errMap.put(61454, "客服帐号名长度超过限制(仅允许10个英文字符，不包括@及@后的公众号的微信号)(invalidkf_acountlength)");
		errMap.put(61455, "客服帐号名包含非法字符(仅允许英文+数字)(illegalcharacterinkf_account)");
		errMap.put(61456, "客服帐号个数超过限制(10个客服账号)(kf_accountcountexceeded)");
		errMap.put(61457, "无效头像文件类型(invalidfiletype)");
		errMap.put(61450, "系统错误(systemerror)");
		errMap.put(61500, "日期格式错误");
		errMap.put(61501, "日期范围错误");
		errMap.put(9001001, "POST数据参数不合法");
		errMap.put(9001002, "远端服务不可用");
		errMap.put(9001003, "Ticket不合法");
		errMap.put(9001004, "获取摇周边用户信息失败");
		errMap.put(9001005, "获取商户信息失败");
		errMap.put(9001006, "获取OpenID失败");
		errMap.put(9001007, "上传文件缺失");
		errMap.put(9001008, "上传素材的文件类型不合法");
		errMap.put(9001009, "上传素材的文件尺寸不合法");
		errMap.put(9001010, "上传失败");
		errMap.put(9001020, "帐号不合法");
		errMap.put(9001021, "已有设备激活率低于50%，不能新增设备");
		errMap.put(9001022, "设备申请数不合法，必须为大于0的数字");
		errMap.put(9001023, "已存在审核中的设备ID申请");
		errMap.put(9001024, "一次查询设备ID数量不能超过50");
		errMap.put(9001025, "设备ID不合法");
		errMap.put(9001026, "页面ID不合法");
		errMap.put(9001027, "页面参数不合法");
		errMap.put(9001028, "一次删除页面ID数量不能超过10");
		errMap.put(9001029, "页面已应用在设备中，请先解除应用关系再删除");
		errMap.put(9001030, "一次查询页面ID数量不能超过50");
		errMap.put(9001031, "时间区间不合法");
		errMap.put(9001032, "保存设备与页面的绑定关系参数错误");
		errMap.put(9001033, "门店ID不合法");
		errMap.put(9001034, "设备备注信息过长");
		errMap.put(9001035, "设备申请参数不合法");
		errMap.put(9001036, "查询起始值begin不合法");
	}
}
