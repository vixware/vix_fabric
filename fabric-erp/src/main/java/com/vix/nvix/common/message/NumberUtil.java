...
public class NumberUtil {
	...
	/**
	 * 
	 * @Title: round @param @param value @param @param scale @param @param
	 * roundingMode # * float/double的精度取值方式分为以下几种: <br>
	 * java.math.BigDecimal.ROUND_UP <br> java.math.BigDecimal.ROUND_DOWN <br>
	 * java.math.BigDecimal.ROUND_CEILING <br> java.math.BigDecimal.ROUND_FLOOR
	 * <br> java.math.BigDecimal.ROUND_HALF_UP<br>
	 * java.math.BigDecimal.ROUND_HALF_DOWN <br>
	 * java.math.BigDecimal.ROUND_HALF_EVEN <br>
	 * 
	 * 
	 * @param @return 设定文件 @return double 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: round @Description:格式化BigDecimal @param @param bd @param @param
	 * scale @param @param roundingMode @param @return 设定文件 @return double
	 * 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: roudFormat @Description: 格式化四位小数 @param @param dd @param @return
	...
	public static double formatDoubleStringToTwoDecimal(String doubleString) {
		if (null != doubleString) {
			if (NumberUtil.isDoubleNumeric(doubleString)) {
	...
	/**
	 * @Title: isNumeric @Description: 判断是否为数字 @param @param str @param @return
	...
	/**
	 * @Title: isNumeric @Description: 判断是否为Double数字 @param @param
