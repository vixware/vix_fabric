...
@Controller
@Scope("prototype")
public class ActionHistoryAction extends BaseAction {
	...
	public String goListContent(){
		try {
			...
			if(null != id && !"".equals(id)){
				List<ActionHistory> pcList = baseHibernateService.findAllByEntityClassAndAttribute(ActionHistory.class, "crmProject.id", id);
	...
	public String deleteByIds() {
		try {
			if(null != ids && !"".equals(ids)){
				...
				baseHibernateService.batchDelete(ActionHistory.class,delIds);
				renderText(DELETE_SUCCESS);
			}else{
