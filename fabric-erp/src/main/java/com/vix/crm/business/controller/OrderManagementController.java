...
import com.vix.crm.business.domain.OrderManagementDomain;
...
public class OrderManagementController {
	...
	@Autowired
	private OrderManagementDomain orderManagementDomain;
	...
	public Pager doListSalesOrderPager(Map<String, Object> params, Pager pager) throws Exception {
		...
		// 3.执行保存操作
		p = orderManagementDomain.findSalesOrderPager(params, pager);
	...
	public List<ChannelDistributor> doListChannelDistributorList(Map<String, Object> params) throws Exception {
		...
		beforeEventTrigger("PO_CREATE_BEFORE");
		// 3. 执行查询操作
		channelDistributorList = orderManagementDomain.findChannelDistributorList(params);
		// 4. 触发事件 afterEventSaveOrder(parameter); 抽象方法，需要重载；
		afterEventTrigger("PO_CREATE_AFTER");
	...
	public List<MessageTemplate> doListMessageTemplateList(Map<String, Object> params) throws Exception {
		...
		beforeEventTrigger("PO_CREATE_BEFORE");
		// 3. 执行查询操作
		messageTemplateList = orderManagementDomain.findMessageTemplateList(params);
		// 4. 触发事件 afterEventSaveOrder(parameter); 抽象方法，需要重载；
		afterEventTrigger("PO_CREATE_AFTER");
	...
	public List<SalesOrder> doListSalesOrderList(Map<String, Object> params) throws Exception {
		...
		beforeEventTrigger("PO_CREATE_BEFORE");
		// 3. 执行查询操作
		salesOrderList = orderManagementDomain.findSalesOrderList(params);
		// 4. 触发事件 afterEventSaveOrder(parameter); 抽象方法，需要重载；
		afterEventTrigger("PO_CREATE_AFTER");
	...
	public Order doListOrderById(String id) throws Exception {
		...
		// 3.执行查询操作
		order = orderManagementDomain.findOrderById(id);
		// 4. 触发事件 afterEventSaveOrder(parameter); 抽象方法，需要重载；
		afterEventTrigger("PO_CREATE_AFTER");
	...
	public ExpeditingSetting doSaveExpeditingSetting(ExpeditingSetting expeditingSetting) throws Exception {
		...
		// 3.执行查询操作
		expeditingSetting1 = orderManagementDomain.saveExpeditingSetting(expeditingSetting);
		// 4. 触发事件 afterEventSaveOrder(parameter); 抽象方法，需要重载；
		afterEventTrigger("PO_CREATE_AFTER");
