...
@Controller
@Scope("prototype")
public class CustomerAccountScheduleAction extends BaseAction {
	...
	public String goListContent(){
		try {
			...
			if(null != id && !"".equals(id)){
				List<Schedule> pcList = baseHibernateService.findAllByEntityClassAndAttribute(Schedule.class, "customerAccount.id", id);
