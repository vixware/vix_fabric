 ...
 * 优惠券同步接口
 * 
 * @类全名 com.rest.ebusiness.CouponUpLoadController
 *
 * @author zhanghaibing
 *
 * @date 2016年11月12日
...
@Controller
@RequestMapping(value = "restService/CouponUpLoad")
public class CouponUpLoadController extends NvixBaseController {
	@Resource(name = "standingBookHqlProvider")
	private StandingBookHqlProvider standingBookHqlProvider;

	@RequestMapping(value = "CouponUpLoad", method = RequestMethod.POST)
	@ResponseBody
	public void CouponUpLoad(HttpServletRequest request, HttpServletResponse response) throws Exception {
