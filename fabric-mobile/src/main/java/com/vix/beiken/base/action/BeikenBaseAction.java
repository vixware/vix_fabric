package com.vix.beiken.base.action;
...
import com.vix.beiken.base.util.OAuthTokenData;
import com.vix.beiken.base.util.WeixinOAuthToken;
import com.vix.beiken.base.util.WxpWeixinSite;
import com.vix.beiken.base.util.WxpWeixinTicket;
...
import com.vix.wechat.util.WxQyUtil;

import net.sf.json.JSONObject;

@Controller
@Scope("request")
public class BeikenBaseAction extends VixSecAction {
	...
	public static String redirect_ip = "www.diandoc.com";
	public static String domain_url = "http://www.diandoc.com";
	...
	public void dealWechatTicket() throws Exception {
		...
		if (wxpWeixinSite != null) {
			...
			if (wxpWeixinTicket != null) {
				...
				String url = getRequest().getRequestURL() + "?" + getRequest().getQueryString();
